...
intTotalRecords=xmlHttp.responseText;
    ...
    if(xmlHttp.readyState==4)
    {
        ...
        {  
			...
			for(i=0;i<XMLOrders.length;i++){
				...
				(function(prmIndex){
					//alert( (intTotalRecords/prmIndex+1));
			...
			// Redirect to the order export web page after 30 seconds			
			setTimeout(function(){redirecttolist();}, 30000);
