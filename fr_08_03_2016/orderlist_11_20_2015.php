    ...
    <tr><td>&nbsp;</td></tr>
 	<tr><td>
    		<table width="100%" border="0">
                ...
                <tr><td>&nbsp;</td>
                	<td align="right"><img id="imgClose" alt="Close" src="../images/close.png" style="float:right;" /> <img id="btnCreateFile" alt="Create File" src="../images/exceldw.gif" onclick="ExportFile();LoadNotTransferList();" style="float:right;" /> <img id="imgUpdate" alt="Update" src="../images/ok.png" /> 
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
