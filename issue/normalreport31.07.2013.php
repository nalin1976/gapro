...
?>			</td>
		...
		$strSQL = "select issuesdetails.intIssueNo,issuesdetails.intMatDetailID,issuesdetails.intMatRequisitionNo,issuesdetails.intMatReqYear, matitemlist.strItemDescription, issuesdetails.strColor, issuesdetails.strSize, issuesdetails.dblQty,  stocktransactions.strUnit from issuesdetails, matitemlist,
stocktransactions where issuesdetails.intStyleId = '" . $row["intStyleId"] . "' AND 
issuesdetails.strBuyerPONO='".$row["strBuyerPONO"]."' And matitemlist.intItemSerial = issuesdetails.intMatDetailID AND issuesdetails.intIssueNo = $intIssueNo AND issuesdetails.intIssueYear = $year AND 
