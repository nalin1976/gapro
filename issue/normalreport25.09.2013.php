  ...
  <tr>
	...
	?>
      ...
      <tr>
        ...
        <td colspan="8" class="normalfntTAB">
...
issuesdetails.intGrnNo,issuesdetails.intMatDetailID,issuesdetails.intMatRequisitionNo,issuesdetails.intMatReqYear, matitemlist.strItemDescription, issuesdetails.strColor, issuesdetails.strSize, issuesdetails.dblQty,  stocktransactions.strUnit from issuesdetails, matitemlist,specificationdetails ,
stocktransactions where issuesdetails.intStyleId = '" . $row["intStyleId"] . "' AND 
issuesdetails.strBuyerPONO='".$row["strBuyerPONO"]."' And specificationdetails.strMatDetailID =  issuesdetails.intMatDetailID
And specificationdetails.intStyleId =  issuesdetails.intStyleId And matitemlist.intItemSerial =  stocktransactions.intMatDetailID AND issuesdetails.intIssueNo = $intIssueNo AND issuesdetails.intIssueYear = $year AND 
