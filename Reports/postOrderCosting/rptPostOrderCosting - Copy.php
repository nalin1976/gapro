...
<tr>
  <td align="center" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	$totQty				= round($orderQty+($orderQty*$exPercent/100),0);
    ...
    <tr>
      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="normalfnt"><b>Style No</b></td>
          <td><b>:</b></td>
          ...
          <td width="55%" valign="bottom"><table width="80%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="38%" border="0" cellspacing="1" cellpadding="2"  class="normalfnt" bgcolor="#000000">
                ...
                <tr bgcolor="#FFFFFF">
                  <td height="20">EXCESS QTY PCS</td>
                  <td class="normalfntRite"><?php echo number_format($exQty)?></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td height="20">CUTTABLE QTY PCS</td>
                  <td class="normalfntRite"><?php echo number_format($totQty)?></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                ...
                <tr bgcolor="#FFFFFF">
                  <td width="58%" height="20">CUT QTY PCS</td>
                  <td width="42%" class="normalfntRite"><?php echo $rowCost["cutQty"]; ?></td>
                  </tr>
                <tr bgcolor="#FFFFFF" >
                  <td height="20">SHIPPED QTY PCS</td>
...
<tr>
  ...
  <tr>
    <td height="53" colspan="20"><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#000000">
      <tr class="bcgcolor-tblrowWhite">
        <td width="18%" rowspan="2" align="left" valign="bottom"><img src="../../images/items.png" alt="items" /></td>
        ...
        <td width="5%" rowspan="2"  class="bcgl1txt1" valign="bottom"><img src="../../images/orderQty.png" /></td>
        ...
        <td width="5%" rowspan="2"  class="bcgl1txt1"><span class="vertical-text" style="vertical-align:-70px;  margin:0 0 0 -10px;">Recut Qty</span></td>
        ...
        <td width="5%" rowspan="2" class="bcgl1txt1" valign="bottom"><img src="../../images/vari_pre_post.png" /></td>
        <td colspan="3" class="bcgl1txt1B">INVOICE COSTING</td>
        <td width="4%" rowspan="2" class="bcgl1txt1B" valign="bottom"><img src="../../images/vari_pre_inv.png" /></td>
        <td width="4%" rowspan="2" class="bcgl1txt1B" valign="bottom"><img src="../../images/vari_post_inv.png" /></td>
...
?>
	  <tr>
		...
		<td colspan="20" class="bcgl1txt1"></td>
	  </tr>
<?php
...
?>
		...
		<td class="normalfntRiteTAB"><?php echo number_format($row_order["recutQty"],$deciQty)?></td>
...
?>
	...
	<td colspan="15" height="7"></td>
	  ...
	  <tr>
		...
		<td class="normalfnt"><div align="right"><?php echo number_format($TotQty,$deciQty);?></div></td>
		<td class="normalfnt">&nbsp;</td>
		<td class="bcgl1txt1">w</td>
