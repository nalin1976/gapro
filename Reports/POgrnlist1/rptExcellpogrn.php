...
$sql="select GH.intGrnNo,GH.intGRNYear,GH.intPoNo,GH.intYear,GH.dtmRecievedDate,GD.intStyleId,GD.strBuyerPONO,MSC.StrCatName,MIL.strItemDescription,GD.strColor,GD.strSize,MIL.strUnit,  GD.dblQty,GD.dblPoPrice,GD.dblInvoicePrice,GD.dblPaymentPrice,  GD.dblExcessQty,GD.dblBalance,GH.strInvoiceNo,O.strOrderNo,O.strStyle,GH.intStatus,PD.dblUnitPrice,S.strTitle
FROM grndetails GD 
