...
<script src="reconciliation.js" type="text/javascript"></script>
...
function viewReport()
{
	...
	if(document.getElementById("cboStyle").value!='')
		url	+=	'&StyleNo='+URLEncode(document.getElementById("cboStyle").value);		
...
function ShowExcelReport(){
	...
	url = 'rptreconciliationxlsrpt.php?';
	
	if(document.getElementById("cboMainStores").value!='')
		url	+=	'&mainStores='+document.getElementById("cboMainStores").value;
			
	if(document.getElementById("cboStyle").value!='')
		url	+=	'&StyleNo='+document.getElementById("cboStyle").value;
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0" class="bcgl1">
          <tr>
            <td height="25" class="mainHeading">Order Item Reconciliation </td>
          </tr>
          <tr>
            <td height="96">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td colspan="3" class="normalfnt"><table width="100%" border="0" class="bcgl1">
                      ...
                      <td><select name="cboStyle" class="txtbox" id="cboStyle" style="width:285px" onchange="GetScNo(this)" >
                        <?php
...
inner join specification S on O.intStyleId=S.intStyleId Order By strOrderNo";
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="cboSc" class="txtbox" id="cboSc" style="width:285px" onchange="GetStyleId(this)" >
                          <?php
						$ScNo = $_POST["cboSc"];
...
inner join specification S on O.intStyleId=S.intStyleId Order By intSRNO DESC";
                    ...
                    <tr>
                        ...
                        <tr><td colspan="4"> <div style="display:none" id="viewMerchand">
	...
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"". $row["intUserID"] ."\">" . $row["Name"]  ."</option>" ;
			...
			?>
                    ...
                    <tr>
                      <td colspan="4" class="normalfnt"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
          ...
          <tr>
           ...
           <!--  </a>-->
             <img src="../../images/exceldw.gif"  border="0" onclick="ShowExcelReport();" />
