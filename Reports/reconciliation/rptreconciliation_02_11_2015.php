...
matitemlist.intMainCatID ASC";
		...
		$resItemDetails = $db->RunQuery($sqlItem);
			...
			echo "<tr><td class='lineleft'>&nbsp;".$rowItems['strItemDescription']."</td><td class='lineleft'>&nbsp;".$_size."</td><td class='lineleft'>&nbsp;".$_color."</td><td class='linecenter'>".$rowItems['strUnit']."</td><td class='lineright'>".number_format($_dblPOPrice,5)."&nbsp;</td><td class='lineright'>".number_format($_dblPOQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblRcvdQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblRcvPercentage,2)."%&nbsp;</td><td class='lineright'>".number_format($_dblRetSupQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblTRInQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblTROutQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblIssuedQty,2)."&nbsp;</td><td class='lineright'>".number_format($_dblStockInHand,2)."&nbsp;</td><td class='lineright'>".number_format($_dblBalPercentage,2)."%&nbsp;</td><td class='linerightend'>".number_format($_dblStockValue,2)."&nbsp;</td></tr>";	
