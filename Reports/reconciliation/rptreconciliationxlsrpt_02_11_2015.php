...
while($rowStores=mysql_fetch_array($resStores)){
	...
	$objPHPExcel->getActiveSheet()->getStyle('Q'.$iHeaderRowNum)->applyFromArray($styleArray);
	$objPHPExcel->getActiveSheet()->getStyle('Q'.$iHeaderRowNum)->applyFromArray($styleArrayFontBold);	
	$objPHPExcel->getActiveSheet()->getStyle('R'.$iHeaderRowNum)->applyFromArray($styleArray);
	$objPHPExcel->getActiveSheet()->getStyle('R'.$iHeaderRowNum)->applyFromArray($styleArrayFontBold);	
	...
	$objPHPExcel->getActiveSheet()->getStyle('Q'.$iHeaderRowNum)->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'D9D9D9'))));
	$objPHPExcel->getActiveSheet()->getStyle('R'.$iHeaderRowNum)->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'D9D9D9'))));
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$iHeaderRowNum,"GP IN Qty");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,$iHeaderRowNum,"GP OUT Qty");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,$iHeaderRowNum,"Transfer IN Qty ");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12,$iHeaderRowNum,"Transfer OUT Qty");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13,$iHeaderRowNum,"Issued QTY");	
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14,$iHeaderRowNum,"Stock In Hand");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15,$iHeaderRowNum,"Stock In Hand/Recieved (%)");	
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(16,$iHeaderRowNum,"Value");
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(17,$iHeaderRowNum,"Comments");
	...
	while($rowItems = mysql_fetch_array($resItemDetails)){
		...
		#====== Get GP IN QTY ===================================
		$_dblGPINQty = GetGatePassIN($iStyleId,$_itemcode,$_color,$_size,$_buyerpono,$iStoresId);
		#=======================================================
		
		#====== Get GP OUT QTY ===================================
		$_dblGPOUTQty = GetGatePassOUT($iStyleId,$_itemcode,$_color,$_size,$_buyerpono,$iStoresId);
		#=======================================================
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$i,$_dblGPINQty);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,$i,$_dblGPOUTQty);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,$i,$_dblTRInQty);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12,$i,$_dblTROutQty);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13,$i,$_dblIssuedQty);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14,$i,$_dblStockInHand);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15,$i,number_format($_dblBalPercentage,0)."%");
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(16,$i,$_dblStockValue);
...
function GetGatePassIN($prmStyleId, $prmItemCode, $prmColor, $prmSize, $prmBuyerPONo, $prmMainStoresId){
	
	global $db;
	
	$_dblGPINQty = 0;
	
	$sqlGPIN  = " SELECT SUM(stocktransactions.dblQty) AS GPIN_QTY ".
			    " FROM   stocktransactions ".
				" WHERE  stocktransactions.strMainStoresID = '$prmMainStoresId' AND stocktransactions.intStyleId = '$prmStyleId' AND ".
				"        stocktransactions.intMatDetailId = '$prmItemCode' AND stocktransactions.strColor = '$prmColor' AND ".
				"        stocktransactions.strSize = '$prmSize' AND stocktransactions.strBuyerPoNo = '$prmBuyerPONo' AND ".
	...
	//echo $sqlReceivedQty;				  
	$resGPIN = $db->RunQuery($sqlGPIN);
	
	while($rowGPIN = mysql_fetch_array($resGPIN)){
		$_dblGPINQty = $rowGPIN['GPIN_QTY'];	
	}	
	return $_dblGPINQty;	
}
