...
while($rowStores=mysql_fetch_array($resStores)){
	...
	while($rowItems = mysql_fetch_array($resItemDetails)){
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7,$i,$_dblRcvPercentage."%");
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13,$i,$_dblBalPercentage."%");
