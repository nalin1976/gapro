...
function viewReport()
{
	...
	if(document.getElementById("rdoAll").checked)
		...
		x = 'bulk';	
	else if(document.getElementById("rbLiability").checked)
		x = 'liability';		
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                 <!-- <td width="20%" class="normalfnt">&nbsp;</td>-->
                  <td colspan="3"  align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="normalfnt">
                    <tr>
                      <td width="6%" align="center">
					  <?php 
					  	$y		= $_POST["A"];
					  ?></td>
                      <td width="4%" align="center"><input <?php
					  	if($y=='all' || $y=='')
							echo 'checked="checked"';
							
					   ?> name="A" type="radio" value="all" id="rdoAll" onchange="GetStyleAndSc(0)"/></td>
                      <td width="11%"> All</td>
                      <td width="4%"><input <?php
					  	if($y=='running')
							echo 'checked="checked"';
							
					   ?>name="A" type="radio" value="running" id="rdoRunning" onchange="GetStyleAndSc(11)"/></td>
                      <td width="17%">Running</td>
                      <td width="4%"><input <?php
					  	if($y=='leftOvers')
							echo 'checked="checked"';
							
					   ?> name="A" type="radio" value="leftOvers" id="rdoLeftOvers" onchange="GetStyleAndSc(13)"/></td>
                      <td width="19%">Left Overs </td>
                      <td width="4%"><input type="radio" name="A" id="rbBulk" value="Bulk" onchange="getReportType('bulk');" /></td>
                      <td width="12%">Bulk</td>
                      <td width="4%"><input type="radio" name="A" id="rbLiability" value="Liability" /></td>
