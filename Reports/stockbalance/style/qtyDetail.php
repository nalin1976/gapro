      ...
      <?php
        ...
        <td><table width="1050" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000">
          <tr bgcolor="#CCCCCC" class="normalfntMid">
            <th width="223"  height="23" >Document No </th>
            <th width="172" >Transaction Type</th>
            <th width="139" >Document Year</th>
            <th width="105" >In Qty</th>
            <th width="126" >Out Qty</th>
	...
	/*	if($fromVal == '120')
		...
		?>
          <tr bgcolor="#FFFFFF">
            ...
            <td class="normalfntRite"><?php $mm='';
			
			if($row_det['dblQty'] > 0) { 
			echo $row_det['dblQty']; } else { echo $mm;}?></td>
            <td class="normalfntMid"><?php if($row_det['dblQty'] < 0) {
				echo $row_det['dblQty']; } else{echo $mm;}; ?></td> 
...
//echo $sql;
		...
		?>
          ...
          <td class="normalfntMid" nowrap="nowrap">&nbsp;</td>
            <td class="normalfntMid" nowrap="nowrap" height="20">&nbsp;</td>
