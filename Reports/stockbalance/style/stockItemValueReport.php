...
function getPODetails($grnNo,$grnYear,$grnType,$styleId,$matDetailID,$color,$size)
{
	...
	if($grnType == 'S')
	{
		$sqlSup = "select s.strTitle,gd.dblInvoicePrice as grnPrice,c.strCurrency,gh.dblExRate as exRate,poh.intPONo as PONo, poh.intYear as POYear, gd.dblPoPrice as POprice,gh.strInvoiceNo,date(gh.dtmConfirmedDate) as ConfirmedDate
from grndetails gd 
...
where gd.intGrnNo='$grnNo' and gd.intGRNYear='$grnYear'  and gd.intMatDetailID='$matDetailID' and gd.strColor='$color' and  gd.strSize = '$size' and gd.intStyleId = '$styleId' ";
