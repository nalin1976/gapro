...
specificationdetails.dblUnitPrice
FROM
materialratio
...
INNER JOIN specificationdetails ON specification.intStyleId = specificationdetails.intStyleId AND stocktransactions.intMatDetailId = specificationdetails.strMatDetailID
WHERE
...
while($row = mysql_fetch_array($result))
{
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$i,$balance);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,$i,$row['dblUnitPrice']);
	$i++;
	}
}
