...
$preStyleId = '';
		...
		while($row = mysql_fetch_array($result))
		{
          ...
          <td class="normalfntRite"><strong><?php  echo ($totStyleStockValue == 0?'&nbsp;':number_format($totStyleStockValue,2));		 ?></strong></td>
     ...
     <td class='normalfnt' colspan="<?php echo $numRows; ?>">&nbsp;</td>	
		...
		$totStyleStockQty =0;
			...
			<?php echo ($stockValue == 0?'&nbsp;':number_format($stockValue,2));  ?>
			</td>
...
mainstores AS CC ";
		  ...
		  //echo $sqlCC;
			...
			//echo "  <th width='8%' >".$rowCC['strName']."</th>";
                        echo "<td class='normalfntRite'><a href='ageAnalysisRpt.php'>".$totMainQty."</a></td>";
			}
        ...
        <tr bgcolor="#EBEBEB">
         <td height="20" class="normalfnt" colspan="4" ><b>&nbsp;&nbsp;&nbsp;&nbsp;Grand Total</b></td>
          <td class="normalfntRite">&nbsp;<b><?php echo ($totStockQty == 0?'&nbsp;':number_format($totStockQty,2)); ?></b>&nbsp;</td>
           ...
           <td class="normalfntRite">&nbsp;<b><?php echo ($totStockValue == 0?'&nbsp;':number_format($totStockValue,2));  ?></b>&nbsp;</td>
