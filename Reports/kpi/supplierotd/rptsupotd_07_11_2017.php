...
$sql = " SELECT purchaseorderheader.intYear, purchaseorderheader.intPONo, suppliers.strTitle, purchaseorderheader.dtmDate, purchaseorderheader.dtmETA,
            ...
            specification.intSRNO, orders.strStyle, orders.strDescription, purchaseorderdetails.strUnit       
...
while($row = mysql_fetch_array($result)){
    ...
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,$rowNum,$poETADate);
