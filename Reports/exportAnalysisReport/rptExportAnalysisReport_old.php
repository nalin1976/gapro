...
$sql = "select date(cih.dtmInvoiceDate) as comInvoiceDate,cid.strInvoiceNo,b.strBuyerCode,cid.strBuyerPONo,c.strCompanyCode,
...
?>
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <td width="2%" class="normalfntRite"><?php echo ($row["Insurance"]==0?'':$row["Insurance"]); ?></td>
          ...
          <td width="3%" class="normalfntRite"><?php echo ($row["comInvInsurance"]==0?'':$row["comInvInsurance"]); ?></td>
...
while($rowS=mysql_fetch_array($result_s))
{
		...
		$TTLValue = $rowS["TTLValue"]+$rowS["Insurance"]+$rowS["freight"]+$rowS["dblDestCharge"];
      ...
      <tr bgcolor="#FFFFFF">
       ...
       <td class="normalfntRite"><?php  echo ($embTTL == ''?'':number_format($embTTL,2)); ?></td>
        ...
        <td>&nbsp;</td>
        <td class="normalfntRite"><?php  echo number_format($facTTL,2); ?></td>
        <td class="normalfntRite"><?php  echo number_format($TTLValue,0); ?></td>
	  ...
	  ?>
       ...
       <td class="normalfntRite"><b><?php  echo number_format($totEmbValue,0); ?></b></td>
         <td class="normalfntRite"><b><?php  echo number_format($totMarValue,0); ?></b></td>
         <td class="normalfntRite"><b><?php  echo number_format($totNauValue,0); ?></b></td>
        <td class="normalfntRite"><b><?php  echo number_format($totSW3Value,0); ?></b></td>
        <td>&nbsp;</td>
        <td class="normalfntRite"><b><?php echo number_format($totWetCost,2); ?></b></td>
        <td class="normalfntRite"><b><?php echo number_format($totDryCost,2); ?></b></td>
        <td class="normalfntRite"><b><?php  echo number_format($totfreight,2); ?></b></td>
