...
<title>GaPro | Export Sales</title>
...
function viewReport()
{
	...
	var reportName = "rptExportAnalysisReport.php";	
	var url  = reportName+"?txtDfrom="+txtDfrom+"&txtDto="+txtDto+"&companyId="+companyId;
	url	+= "ReportType=N";
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0" class="tableBorder">
          <tr>
            <td height="25" class="mainHeading">Export Sales</td>
          </tr>
          <tr>
                    ...
                    <tr>
                      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                        ...
                        <tr >
                            ...
                            <td colspan="3" style="display:none"><select name="cboCompany" class="txtbox" id="cboCompany" style="width:302px" >
                              <?php 	
	$SQL=" select intCompanyID,strName from companies where intManufacturing=1 -- order by strName ";	
