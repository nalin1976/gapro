...
function ViewReport(obj)
{
	...
	var disInvoice		= document.getElementById("chkDisInvoice").checked;
	var factory			= document.getElementById("cboFactory").value;
	var reportType		= obj;
	var reportName 		= "rptPaymentDiscrepancy.php";

	var url  = reportName+"?ReportType="+reportType+"&CheckDate="+checkDate+"&DateFrom="+dateFrom+"&DateTo="+dateTo+"&Supplier="+supplier+"&DisInvoice="+disInvoice+"&Factory="+factory;
    ...
    <td><table width="600" border="0" align="center">
      <tr>
        <td width="62%"><table width="100%" border="0" class="tableBorder">
          <tr>
            <td height="25" class="mainHeading">Style Payment Discrepancy</td>
          </tr>
          <tr>
                      ...
                      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          <tr>
                            ...
                            <legend class="legendHeader">&nbsp;Invoice Date&nbsp;</legend> 
                                ...
                                <tr>
                                  <td width="42" class="normalfntMid"><input name="checkDate" id="checkDate" type="checkbox" checked="checked" onclick="setDateChecked(this);"/></td>
                          ...
                          <tr>
                            ...
                            <td width="357" colspan="3"><select name="cboSupplier" class="txtbox" id="cboSupplier" style="width:302px">
 <?php 	
	$SQL = "SELECT strSupplierID,strTitle FROM suppliers s where intApproved='1' order by strTitle;";	
...
?>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td>Factory</td>
                            <td colspan="3"><select name="cboFactory" class="txtbox" id="cboFactory" style="width:302px">
                              <?php 	
	$SQL = "select C.intCompanyID,C.strName from companies C where C.intStatus=1 order by C.strName;";	
	$result =$db->RunQuery($SQL);	
		echo "<option value =\"".""."\">"."All"."</option>";
	while($row = mysql_fetch_array($result))
	{
...
?>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td class="normalfnt">Discrepancy Invoice Only </td>
                            <td colspan="3"><input type="checkbox" name="chkDisInvoice" value="checkbox" checked="checked" id="chkDisInvoice"/></td>
                          </tr>
                      </table></td>
                    </tr>
                </table></td>
                ...
                <td width="100%" bgcolor="#FFFFFF"><table width="100%" border="0">
                    <tr>
                      ...
                      <img src="../../../images/new.png" alt="new" onclick="ClearForm();"/>
						...
						<img src="../../../images/download.png"  border="0" onclick="ViewReport('E');" />
