...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="600" border="0" cellspacing="0" cellpadding="2" align="center" class="tableFooter">
      <tr>
        <td ><table width="600" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td  height="25" class="mainHeading">Inter Company Sales For The Month</td>
            </tr>
          <tr>
            ...
            <tr>
              ...
              <tr class="normalfnt">
                ...
                <td width="16%">Buyer</td>
                <td width="54%"><select name="cboBuyer" class="txtbox" id="cboBuyer" style="width:280px">
 <?php 	
...
?>
              ...
              <tr class="normalfnt">
                <td height="20">&nbsp;</td>
                <td>Factory</td>
                <td><select name="cboCutomer" id="cboCutomer" style="width:280px;">
                <?php 	
	$SQL=" select c.strCustomerID,concat(c.strName,' - ',c.strCompanyCode) as CompanyName from eshipping.customers c order by c.strName ";	
	$result =$db->RunQuery($SQL);	
		echo "<option value =\"".""."\">"."All"."</option>";
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"".$row["strCustomerID"]."\">".$row["CompanyName"]."</option>";
	}
?>
                </select>
                </td>
     ...
     <tr><td><table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableFooter">
       <tr>
         <td align="center"><img src="../../../images/new.png" width="96" height="24" onClick="ClearForm();"><img src="../../../images/report.png" width="108" height="24" onClick="viewReport();"><img src="../../../images/download.png" width="115" height="24" onClick="viewExcelReport();"><a href="../../../main.php"><img src="../../../images/close.png" width="97" height="24" border="0"></a></td>
       </tr>
     </table></td></tr>
    </table></td>
  </tr>
...
function viewReport()
{
	...
	var factory   = document.getElementById("cboCutomer").value;
		
	var url	 = "monthlySalesReport.php?";
		url	+= "ReportType=N";
	 	url += "&txtDfrom="+txtDfrom+"&txtDto="+txtDto;
		url += "&factory="+factory;
		url += "&buyer="+buyer;
		url += "&buyerName="+URLEncode($("#cboBuyer option:selected").text());
		url += "&factoryName="+URLEncode($("#cboCutomer option:selected").text());
				
	window.open(url,'monthlySalesReport.php');	
}
