...
<title>GaPro | BOI - Good Received Note</title>
...
function ViewReport(obj)
{
	...
	var iExporter   	= document.getElementById("cboIExporter").value;
	var fExporter		= document.getElementById("cboFExporter").value;
	var reportType		= obj;
	var reportName 		= "rptBOIGRN.php";

	var url  = reportName+"?ReportType="+reportType+"&CheckDate="+checkDate+"&DateFrom="+dateFrom+"&DateTo="+dateTo+"&IExporter="+iExporter+"&FExporter="+fExporter;
...
function Validate()
{
	if(document.getElementById("cboIExporter").value=="")
	{
		alert("Please select 'Indirect Exporter'.");
		document.getElementById("cboIExporter").focus();
		return false;
	}
	
	if(document.getElementById("cboFExporter").value=="")
	{
		alert("Please select 'Final Exporter'.");
		document.getElementById("cboFExporter").focus();
		return false;
	}
return true;
}
    ...
    <td><table width="600" border="0" align="center">
      <tr>
        <td width="62%"><table width="100%" border="0" class="tableBorder">
          <tr>
            <td height="25" class="mainHeading">BOI - Good Received Note</td>
          </tr>
          <tr>
                ...
                <td width="92%" class="normalfnt"><table width="100%" border="0" class="tableBorder">
                    <tr>
                      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          ...
                          <tr >
                            <td width="42">&nbsp;</td>
                            <td width="154">Indirect Exporter <span class="compulsoryRed">*</span></td>
                            <td width="357" colspan="3"><select name="cboIExporter" class="txtbox" id="cboIExporter" style="width:302px">
 <?php 	
...
?>
                          ...
                          <tr >
                            <td>&nbsp;</td>
                            <td class="normalfnt">Final Exporter <span class="compulsoryRed">*</span></td>
                            <td colspan="3"><select name="cboFExporter" class="txtbox" id="cboFExporter" style="width:302px">
                              <?php 	
	$SQL = "select intCompanyID,strName from companies order by intCompanyID;";	
	$result =$db->RunQuery($SQL);	
		echo "<option value =\"".""."\">"."All"."</option>";
                ...
                <td width="100%" bgcolor="#FFFFFF"><table width="100%" border="0">
                    <tr>
                      ...
                      <img src="../../../images/new.png" alt="new" onclick="ClearForm();"/>
                     	<img src="../../../images/report.png" alt="Report" name="Delete" border="0" class="mouseover" onclick="ViewReport('N');"/>
						<img src="../../../images/download.png"  border="0" onclick="ViewReport('E');" style="display:none" />
