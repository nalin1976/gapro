        	...
        	<tr><td width="25%">&nbsp;</td>
                ...
                <td width="40%">
                	<table width="100%" border="0" class="normalfnt">
                    	<tr><td width="20%" align="right">Buyers List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        	<td >
                ...
                <td width="10%">&nbsp;<span style="position:absolute; top:131px; right:180px;">Summary</span><input type="checkbox" id="chkSummary" name="chkSummary" /></td>
            </tr>
        </table>
    </td>
</tr>
    	...
    	<table border="0" width="100%">
        	<tr><td width="37%">&nbsp;</td>
                ...
                <td width="43%">
                	<table width="100%" border="0" class="normalfnt">
                    	 <tr>
                    <td width="30%" align="right" ><!--<input type="checkbox" id="frmDateCheck"   name="frmDateCheck" class="txtbox" tabindex="5" onchange="dateArrange();" />-->&nbsp;&nbsp; From</td>
                    <td width="33%" align="right"><input name="txtFrmDate" value="<?php echo $_POST['txtFrmDate'];?>" type="text" class="txtbox" id="txtFrmDate" style="width:148px"  onmousedown="DisableRightClickEvent();" tabindex="5" onmouseout="EnableRightClickEvent();" onfocus="return showCalendar(this.id, '%d/%m/%Y');" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input name="reset" type="reset"  class="txtbox" style="visibility:hidden;width:1px" onkeypress="return showCalendar(this.id, '%d/%m/%Y');"   onclick="return showCalendar(this.id, '%d/%m/%Y');"  value="" /></td>
                    <td width="5%" align="right"  >To</td>
                    <td width="32%" align="right"><input name="txtToDate" value="<?php echo $_POST['txtToDate'];?>" type="text"  class="txtbox" id="txtToDate" style="width:148px" tabindex="6"  onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onfocus="return showCalendar(this.id, '%d/%m/%Y');" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input name="reset2" type="reset"  class="txtbox" style="visibility:hidden;width:1px" onkeypress="return showCalendar(this.id, '%d/%m/%Y');"   onclick="return showCalendar(this.id, '%d/%m/%Y');"  value="" /></td>
