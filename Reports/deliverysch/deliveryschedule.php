...
<tr>
	<td>
    	<table border="0" width="100%">
        	<tr><td width="33%">&nbsp;</td>
                <td width="20%" class="normalfnt">Selection Criteria &nbsp;
                    <select id="cmbSelection">
                        <option value="1">FOB Date</option>
                        <option value="2">Ex. Factory Date</option>
                        <option value="3">Hand Over Date</option>
                    </select>
                </td>
