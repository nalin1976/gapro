...
$resBuyerList = GetBuyerList($dtFromDate, $dtToDate);
...
function GetBuyerList($prmFromDate, $prmToDate){
...
$strSql = " SELECT buyers.strName, buyers.intBuyerID ".
		  ...
		  " WHERE  deliveryschedule.dtDateofDelivery between '$prmFromDate' AND '$prmToDate' ".
