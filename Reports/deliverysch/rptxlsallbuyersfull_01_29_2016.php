...
function GetAODDate($prmSCNo, $prmBuyerPONo, $prmD2DConnt, $prmFromDate){
	...
	$strSql = "SELECT distinct
               ...
               WHERE d2d_Pack_Export_Header.scNumber = '$prmSCNo' AND d2d_Pack_Export_Header.bpo =  '$prmBuyerPONo' AND d2d_Pack_Export_Header.`status` =  'SEND' AND $repMonth < MONTH(d2d_Pack_Export_Header.`date`) AND (d2d_Pack_Export_Header.destination <> 20) ";
