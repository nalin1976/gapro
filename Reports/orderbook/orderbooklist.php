...
function ShowExcelReport()
{
	...
	var url  = reportName+"?Buyer="+buyer+"&delDfrom="+delDfrom+"&delDto="+delDto;
	window.open(url);
                      ...
                      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                         <tr>
                            <td colspan="5" align="center"><fieldset class="roundedCorners" ><legend class="legendHeader">&nbsp;Delivery Date&nbsp;</legend><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="56" class="normalfntMid">&nbsp;</td>
                                <td width="86">Date From </td>
                                <td width="147"><input type="text" name="txtDelDfrom" id="txtDelDfrom" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"  value="<?php echo ($txtDfrom=="" ? "":$txtDfrom);?>" /><input name="text32" type="text"  class="txtbox" style="visibility:hidden;width:1px"   onclick="return showCalendar(this.id, '%Y-%m-%d');" value="" /></td>
                                <td width="31">To</td>
                                <td width="239"><input type="text" name="txtDelDto" id="txtDelDto" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);" onclick="return showCalendar(this.id, '%d/%m/%Y');" value="<?php echo ($txtDto=="" ? "":$txtDto);?>" /><input name="text222" type="text"  class="txtbox" style="visibility:hidden;width:1px"   onclick="return showCalendar(this.id, '%Y-%m-%d');" value="" /></td>
                              </tr>
                            </table> </fieldset></td>
                            </tr>
...
?>
                          ...
                          <tr>
							...
							<select name="cboReportCategory" class="txtbox" id="cboReportCategory" style="width:302px">
								...
								<!--<option value="2">Order Book Summary Report</option>-->
                            </select></td>
                          </tr>
                      </table></td>
                    </tr>
