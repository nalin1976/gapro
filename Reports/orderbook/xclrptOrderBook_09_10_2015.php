...
distinct CASE Month(deliveryschedule.dtDateofDelivery) 
	WHEN 1 THEN 'JAN'
	WHEN 2 THEN 'FEB'
	WHEN 3 THEN 'MAR'
	WHEN 4 THEN 'APR'
	...
	WHEN 12 THEN 'DEC'	
	END  as deli_month,
year(deliveryschedule.dtDateofDelivery) AS deli_year,
Month(deliveryschedule.dtDateofDelivery) as delivery_month
FROM
deliveryschedule
WHERE
deliveryschedule.dtDateofDelivery BETWEEN  '$formatFromDate' AND '$formatToDate' AND deliveryschedule.strShippingMode <> '7'
ORDER BY Month(deliveryschedule.dtDateofDelivery)";
...
while ($rowMonth = mysql_fetch_array($rs_month))
{
	...
	$sql_summary 	= " SELECT Sum(deliveryschedule.dblQty) as DeliQty, buyers.strName, buyerdivisions.strDivision, buyers.intBuyerID, ".
					  ...
					  " WHERE  month(deliveryschedule.dtDateofDelivery) = '$delivery_month' AND ".
					  "        year(deliveryschedule.dtDateofDelivery) = '$delivery_year' AND deliveryschedule.strShippingMode <> '7' AND  ".
					  "        deliveryschedule.intDeliveryStatus = 1 ".
					  " GROUP BY  buyers.strName, buyerdivisions.strDivision ".
	...
	while($row_summary = mysql_fetch_array($rs_summary)){
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$detail_row,$row_summary["DeliQty"]);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$detail_row,$TotHrs);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$detail_row,$CMValue);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$detail_row,$TotalFOB);
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$detail_row,$SubDeliveryQty);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$detail_row,$SubTotHours);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$detail_row,$SubCMTot);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$detail_row,$SubTotFOB);
	...
	$sql_summary 	= " SELECT Sum(deliveryschedule.dblQty) as DeliQty, buyers.strName, buyerdivisions.strDivision, buyers.intBuyerID, ".
					  ...
					  " WHERE  month(deliveryschedule.dtDateofDelivery) = '$delivery_month' AND ".
					  "        year(deliveryschedule.dtDateofDelivery) = '$delivery_year' AND deliveryschedule.strShippingMode <> '7' AND  ".
					  "        deliveryschedule.intDeliveryStatus = 2 ".
					  " GROUP BY  buyers.strName, buyerdivisions.strDivision ".
					  " ORDER BY Month(deliveryschedule.dtDateofDelivery), buyers.strName ";
	...
	while($row_summary = mysql_fetch_array($rs_summary)){
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2,$detail_row,$row_summary["strName"]." - ".$row_summary["strDivision"]);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$detail_row,$row_summary["DeliQty"]);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$detail_row,$Tot_Hrs);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$detail_row,$CMValue);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$detail_row,$TotalFOB);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7,$detail_row,number_format($CMPerFOB,0)."%");
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8,$detail_row,number_format($CMPerMin,2));
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$detail_row,$MonthlyDeliQty);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$detail_row,$MonthlyTotHrs);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$detail_row,$MonthlyCM);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$detail_row,$MonthlyTotFOB);
...
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$detail_row,$SummaryGrandQty);
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$detail_row,$SummaryGrandHrs);
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$detail_row,$SummaryGrandCM);
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$detail_row,$SummaryGrandFOB);
