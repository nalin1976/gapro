...
<title>GaPro | Sample Non Invoice Approval List</title>
...
<body >
<form name="frmInvoiceCostingList" id="frmInvoiceCostingList" action="samplenoninvoice.php" method="post">
<tr>
...
<table width="1000" border="0" align="center" bgcolor="#FFFFFF" class="tableBorder">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="61%" height="31" bgcolor="#498CC2" class="mainHeading"><div align="center">Sample Non Invoice Approval List</div></td>      </tr>
		...
		<table width="100%" cellpadding="0" cellspacing="1" id="tblInvoiceCostingList" bgcolor="#C58B8Bd" class="bcgcolor">
          <thead>
            <tr class='mainHeading4'>
              ...
              <th width="8%" nowrap="nowrap">Approve</th>
...
?>
            <tr class='bcgcolor-tblrowWhite'>
              ...
              <?php if($row["intStatus"]=='0') {?>
              <img src="../../images/accept.png" alt="approve"  border="0"  class="mouseover" id="butApproved" onclick="ApproveInvoice(this);" />
              <?php }?></td>
...
?>
		<tr class='bcgcolor-tblrowWhite'>
              <td class="normalfnt" colspan="8" nowrap="nowrap">&nbsp;</td>
            </tr>
          </tbody>
        </table>
		<!--</div>--></td>
