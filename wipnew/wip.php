...
function viewReport()
{
	...
	var PONo        =  document.getElementById("cmbStyle").value;
	
	var reportName = "wipReport.php";	
	var url  = reportName+"?txtDfrom="+txtDfrom+"&txtDto="+txtDto+"&companyId="+companyId+"&checkDate="+checkDate+"&PONo="+PONo+"&ReportType="+ReportType;
