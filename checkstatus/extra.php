...
<?php
 $loop=0;
 $sql="select intFRollSerialNO,intFRollSerialYear,intPoYear,intPoNo,strSupplierBatchNo,strCompanyBatchNo from fabricrollheader 
...
<tr class="bcgcolor-tblrowWhite">
	<td class="normalfntMid" height="20"><?php echo ++$loop;?></td>
	<td class="normalfntMid" ><?php echo $pono;?></td>
	<td class="normalfntMid" ><?php echo $row["strSupplierBatchNo"];?></td>
	<td class="normalfntMid" ><?php echo $row["strCompanyBatchNo"];?></td>
