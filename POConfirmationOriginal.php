...
{
	window.open("poConfirmReport.php?pono=" + poNO + "&year=" + intYear,'frmcompletePO');
	//alert(reportname);
}
...
<form id="frmcompletePO" name="frmcompletePO" method="post" action="POConfirmation.php">
  <table width="100%" border="0" align="center" bgcolor="#FFFFFF">
	...
	?>
                  ...
                  <td width="193" ><select name="cboStyles" class="txtbox" style="width:170px" id="cboStyles" onchange="getScNo();getStyleOrderNo();resetCompanyBuyer();">
	...
	?>
                  ...
                  <td width="193" ><select name="cboOrderNo" id="cboOrderNo" style="width:170px;" onchange="getStyleSCNo();resetCompanyBuyer();">
                    <option value="" selected="selected">Select One</option>
                    <?php
          ...
          <td colspan="2"><div id="divData" style="width:1100px; height:400px; overflow: scroll; border-width:3px; border-style:solid;border-color:#FFD5AA;">
            <table width="1080" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF" class="bcgl1" id="tblPreOders" >
              <tr>
                ...
                <td width="5%" bgcolor="#804000" class="normaltxtmidb2">Second Approve By</td>
                <td width="5%" bgcolor="#804000" class="normaltxtmidb2">Second Approve Date</td>
                <?php if($allowSecondApprovalPO) 
				{
				?>
                <td width="5%" bgcolor="#804000" class="normaltxtmidb2">Second Approve</td>
                <?php 
				}
				?>
              </tr>
