...
<title>Gapro Web - Inter Job Transfer Authorization</title>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
	...
	$sql = "select distinct SP.intSRNO,SP.intStyleId from itemtransfer IT
Inner Join specification SP On IT.intStyleIdFrom=SP.intStyleId";

	$result = $db->RunQuery($sql);	
	while($row = mysql_fetch_array($result))
	{
		if($fromStyle == $row["intSRNO"])
			echo "<option selected=\"selected\"value=\"". $row["intSRNO"] ."\">" . $row["intStyleId"] ."</option>" ;
		else
...
$sql = "select distinct SP.intSRNO,SP.intStyleId from itemtransfer IT
Inner Join specification SP On IT.intStyleIdTo=SP.intStyleId";
...
Inner Join orders O On O.intStyleId = IT.intStyleIdTo where intTransferId <> 0 ";

if($fromStyle!="")
	$sql .= "AND IT.intStyleIdFrom='$fromSc' ";
if($toStyle!="")
	$sql .= "AND IT.intStyleIdTo='$toSc' ";
if($jobNo!="")
...
?>
              <tr class="<?php echo $class;?>">
                ...
                <td class="normalfntMid" ><?php echo $row["intStyleIdFrom"];?></td>
                <td class="normalfntMid" ><?php echo $row["fromScNo"];?></td>
                <td class="normalfntMid" ><?php echo $row["intStyleIdTo"];?></td>
