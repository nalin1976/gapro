...
include "../../Connector.php";
		...
		$SQL = "SELECT
				...
				{  
					...
					$styleFrom		= $row["strStyleFrom"];
					$styleTo		= $row["strStyleTo"];
...
$sqlfrom="SELECT
		...
		Inner Join specification ON O.strStyleID = specification.strStyleID
		WHERE
		O.strStyleID =  '$styleFrom'";
...
<?php 
	$sql_details="SELECT
		...
		LEFT Join materialratio MR ON MR.strStyleID=IT.strStyleFrom and MR.strBuyerPONO=ITD.strBuyerPoNo and 
