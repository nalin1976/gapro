...
<title>GaPro Web - Bill Of Material Reports</title>
...
<script type="text/javascript" src="javascript/bomreport.js"></script>
...
function viewXLSReport(prmstyleId){
    ...
    window.open("bomxlsreport.php?styleID=" + prmstyleId); 
}
...
<body>
<form id="frmcomplete" name="frmcomplete" method="post" action="bomreports.php">
    <tr>
  ...
  <table width="990" border="0" align="center" bgcolor="#FFFFFF"> 
    ...
    <tr>
      <td><table width="100%" border="0"  class="tableBorder">
        ...
        <tr>
          <td width="96%" height="25" class="mainHeading">BOM - Bill Of Material Reports </td>
        </tr>
        <tr>
          <td><table width="100%" border="0">
            ...
            <tr>
              <td width="50%" height="21"><table width="100%" border="0" class="tableBorder">
                ...
                <tr>
                  <td width="10%" class="normalfnt">&nbsp;Report Type</td>
                  <td width="20%" class="normalfnt">
                      <select name="cboOption" class="selectpicker textformat" data-live-search="true" style="width:150px" id="cboOption">
                        <option value="1" selected="selected">Summerised</option>
                        <option value="0">With Buyer PO</option>
                      </select></td>
                  <td width="8%">&nbsp;</td>
                  <td width="7%">&nbsp;</td>
            ...
            <table width="910" bgcolor="#CCCCFF" border="0" cellpadding="0" cellspacing="1" class=" table tableBorder" id="tblPreOders" >
                <thead>  
                    <tr >
                      ...
                      <td width="36%" bgcolor="#498CC2" class="normaltxtmidb2L">Description</td>
