...
<table width="100%" border="0" bgcolor="#FFFFFF">
			...
			<table width="100%"border="0" bgcolor="#0E4874">
                <tr class="mainHeading">
				 ...
				 onClick="closeWindow();" />				  </div></td>
                </tr>
              </table></td>
            </tr>
			<tr>
				<td title="<?php echo $matDetailId;?>" class="normalfnth2" id="tdMatDetailId">Item Description : <?php echo $itemDescription;?></td>
			</tr>
...
<div id="realtooltip1" style="display:inline"><table width="100%" border="0" class="bcgl1" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td align="left"><select name="cboManufactLeftCompany" id="cboManufactLeftCompany" style="width:220px;">
