...
$comID     = $companyId;// GetCompanyDetails($mainStoreID);
...
elseif($RequestType=="SaveHeader")
{
	...
	// ===========================================================
        ...
        */
        ...
        $sqlH="insert into commonstock_leftoverheader 
		(intTransferNo,	intTransferYear,intToStyleId,strToBuyerPoNo,intUserId,dtmDate,intCompanyId, intManufactCompanyId, merchantRemarks)
		values ('$no','$year','$toStyleId','$toBuyerPoNo','$userId',now(),'$companyId','$manufactCom', '$merchantRemarks');";
        //echo $sqlH;
...
$fromStoresId   = $_GET["storesId"];
$subStoreId     = $_GET["subId"];
$locationId     = $_GET["locationId"];
$binId          = $_GET["binID"];
$toStores       = $_GET["toStores"];
$toStyleId      = $_GET["toStyleId"];
$toBuyerPONo    = $_GET["toBuyerPoNo"];
	...
	$resD = $db->RunQuery($sql);	
        ...
        // Add On - 01/19/2017
        // Add For - Add minus (-) transaction to the left over transaction
        // ==========================================================
        $sql_left_st = " INSERT INTO stocktransactions_leftover(intYear, strMainStoresID, strSubStores, strLocation, strBin, intStyleId, strBuyerPoNo, intDocumentNo, intDocumentYear, intMatDetailId, strColor, strSize, strType, strUnit, dblQty, dtmDate, intUser, intGrnNo, intGrnYear, strGRNType)
                         VALUES ('$year','$fromStoresId','$subStoreId','$locationId','$binId','$fromStyleId','$buyerPoNo','$no','$year','$matDetailId','$color','$size','WROUT','$units','$outQty',now(),'$userId','$grnNo','$grnYear','$grnType') ";
        
        $resLeftStock = $db->RunQuery($sql_left_st);
        // ==========================================================
        
        // ==========================================================
        // Adding By - Nalin Jayakody
        // Add On - 01/19/2017
        // Add For - Add allocation qty from write-off to live stcktransaction.
        // ==========================================================
        $sql_stockin = " INSERT INTO stocktransactions(intYear, strMainStoresID, strSubStores,strLocation,strBin,intStyleId,strBuyerPoNo,intDocumentNo,intDocumentYear,intMatDetailId,strColor,strSize,strType,strUnit,dblQty,dtmDate,intUser,intGrnNo,intGrnYear,strGRNType)
                         VALUES ('$year','$fromStoresId', '$subStoreId','$locationId','$binId', '$toStyleId','$toBuyerPONo','$no','$year','$matDetailId','$color','$size','WRIN','$units','$qty',now(),'$userId','$grnNo','$grnYear','$grnType')";
        
        $resLiveStock = $db->RunQuery($sql_stockin);
        // ==========================================================
        
        // ==========================================================
        // Adding By - Nalin Jayakody
        // Add On - 01/30/2017
        // Add For - Reduce balance qty from material ratio.
        // ==========================================================
        $sql = "UPDATE materialratio SET dblBalQty = dblBalQty - $qty WHERE materialratio.intStyleId = '$toStyleId' AND materialratio.strMatDetailID = '$matDetailId' AND materialratio.strColor = '$color' AND materialratio.strSize = '$size' AND materialratio.strBuyerPONO = '$toBuyerPONo'";
        $resMatRatio = $db->ExecuteQuery($sql);
        // ==========================================================
