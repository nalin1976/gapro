...
INNER JOIN storesbins ON storesbins.strLocID = S.strLocation AND storesbins.strMainID = S.strMainStoresID AND storesbins.strSubID = S.strSubStores AND storesbins.strBinID = S.strBin
	...
	while($row_1=mysql_fetch_array($result_1))
	{
		...
		<td class=\"normalfntMid\"><input type=\"text\" id=\"txtTransferQty\" class=\"txtbox\" style=\"width:75%;text-align:right\" name=\"txtTransferQty\" onblur=\"ValidateQty(this);\"  onkeyup=\"\" onkeypress=\"return isNumberKey(event);\"/></td>
