...
<title>Due Date Revised Events Report</title>
...
<tr>
  ...
  <tr>
    <td colspan="4"><p class="head2BLCK"><br/>Event Schedule - Due Date Revised Events </p>
      <p class="head2BLCK"></p>
  ...
  <tr>
    <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablez" bgcolor="#FFFFFF">
        ...
        <td colspan="2" class="normalfntCenterTABNoBorder"><b>Revised Date</b></td>
			<td colspan="4" class="normalfntCenterTABNoBorder"><b>Reason</b></td>
        </tr>
        <tr>
			<td colspan="12"><hr></td>        
        </tr>
...
WHERE  eventscheduleheader.intStyleId IN ($styleList) AND NOT ISNULL((SELECT eventscheduledetail.intScheduleId FROM eventscheduledetail WHERE eventscheduledetail.intScheduleId = eventscheduleheader.intScheduleId AND NOT ISNULL(eventscheduledetail.dtChangeDate) LIMIT 1) );;";
        ...
        $isFirstRow = true;
        $sql = "SELECT eventscheduledetail.intEventId,  DATE_FORMAT(eventscheduledetail.dtmEstimateDate, '%Y %b %d') as EstimateDate, DATE_FORMAT(eventscheduledetail.dtChangeDate, '%Y %b %d') as changedDate, events.strDescription, eventscheduledetail.strChangedReason  
FROM eventscheduledetail INNER JOIN events ON  eventscheduledetail.intEventId = events.intEventID 
WHERE eventscheduledetail.intScheduleId = '$scheduleID' AND  NOT ISNULL(eventscheduledetail.dtChangeDate)";
     ...
     <tr>
        ...
        <td colspan="2" class="normalfntCenterTABNoBorder"><?php echo $rowevent["changedDate"]; ?></td>
			<td colspan="4" class="normalfntCenterTABNoBorder"><?php echo $rowevent["strChangedReason"]; ?></td>
        </tr>
        <?php
