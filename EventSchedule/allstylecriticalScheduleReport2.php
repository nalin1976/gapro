...
<?php 
			...
			$_SESSION["FactoryID"]	=	'1';
			$_SESSION["Server"] 	= 	"localhost";
			$_SESSION["UserName"] 	= 	"fgmeplan";
			$_SESSION["Password"] 	= 	"poison";
			$_SESSION["Database"] 	= 	"eplan";
...
include "../Connector.php";				
				...
				$styleList = "";
					...
					WHERE O.intCompanyID = '$companyID' and ESD.dtmEstimateDate < CURDATE() AND ISNULL(ESD.dtCompleteDate);";
        ...
        <td class="tophead"><table width="100%" cellpadding="0" cellspacing="0">
              <tr>
				...
				<td width="6%" class="normalfnt">&nbsp;</td>
					<td width="74%" class="tophead"><p class="topheadBLACK">&nbsp;</p>
					<p class="normalfnt">&nbsp;</p>
...
WHERE eventscheduledetail.intScheduleId = '$scheduleID' AND eventscheduledetail.dtmEstimateDate < CURDATE() AND ISNULL(eventscheduledetail.dtCompleteDate)";
        ...
        ?>
       	 	<tr>
        		<td height="25" colspan="9" class="normalfntLeftTABNoBorder"><br>Delayed Events<hr></td>
        	</tr>
        <?php
        $isFirstRow = false;
        }
