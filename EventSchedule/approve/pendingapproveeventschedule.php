...
$reportname = "EventSchedule/approve/approveschedulereport.php";
	...
	$SQL = "select intStyleId from eventscheduleheader where intStatus = 1 ;";
	...
	$SQL = "select SH.intSRNO from specification SH inner join eventscheduleheader EH on SH.intStyleId = EH.intStyleId AND EH.intStatus = 1 ;";
