...
?>
              ...
              <td><span class="normalfnt">
                <select name="cboSCNO" class="txtbox" id="cboSCNO" style="width:100px" onchange="getStyleNoFromSC('cboSCNO','cboStyleID');LoadBuyerPoNo(); loadStyleName();" >
                  <?PHP		
$SQL="SELECT DISTINCT ".
"ID.intStyleId, ".
...
<!--<div style="left:418px; top:142px; z-index:10; position:absolute; width: 261px; visibility:hidden; height: 61px;" id="NoSearch" >-->
  <table width="300" height="71" border="0" cellpadding="0" cellspacing="0" class="tablezRED">
          <tr>
            
            <td  colspan="8" class="mainHeading"><img src="../images/cross.png" alt="rep" align="right" onclick="closeFindReturnNo();" /></td>
          </tr>
          <tr>
           ...
           <!-- <td width="37" class="normalfnt">Year</td>-->
            <td width="55"><!--<select name="select4" class="txtbox" id="cboYear" style="width:55px; visibility:hidden;" onchange="LoadPopUpNo();">
	...
	?>
      ...
      <td width="55"><select name="cboYear" class="txtbox" id="cboYear" style="width:55px" onchange="LoadPopUpNo();">
          <?php
