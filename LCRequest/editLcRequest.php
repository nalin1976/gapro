...
<body onLoad="viewLCData(<?php $arrLc= explode('/',$_GET["lcNo"]);
echo $arrLc[0].','.$arrLc[1];
?>);">
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td><table width="850" border="0" cellspacing="0" cellpadding="2" align="center" class="tableBorder">
      ...
      <tr >
        <td class="normalfnt">LC Request No</td>
        <td><select name="cboLcReqNo" id="cboLcReqNo" style="width:150px;" onChange="viewLcRequestData();">
        <option value=""></option>
         <?php 
		$sql = "select intLCRequestNo,intRequestYear from lcrequest_pialloheader  ";
	...
	?>
        ...
        <td class="normalfnt">LC Name</td>
        <td><input type="text" name="txtLcName" id="txtLcName" readonly="readonly"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableFooter">
          <tr>
            <td align="center"><a href="editLcRequest.php"><img src="../images/new.png" width="96" height="24" border="0"></a><img src="../images/save.png" width="84" height="24" onClick="saveProdLineDateDetails();" id="butSave"><a href="../main.php"><img src="../images/close.png" width="97" height="24" border="0"></a></td>
          </tr>
        </table></td>
        </tr>
    </table></td>
