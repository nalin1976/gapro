...
if($_FILES["filepath2"]["name"] != '')
	{
        ...
        // require_once 'Excel/reader.php';
		 ...
		 values ('$fac','$orderNo','$piNo','$oritRef','$supPIno','$DDNno', '$shipMode','$itemCode','$color','$size','$qty', $amount,'$GW','$CM','$payment','$handleBy','$readyDate','$confirmDate','$handDate','$remarks','$supplier','$userId',now()) ";
