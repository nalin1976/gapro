...
<title>GaPro | Left Over - Gate Pass</title>
<script type="text/javascript" src="leftovergatepass.js"></script>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="bcgl1">
  <tr>
    <td height="26" class="mainHeading">Left Over - Gate Pass</td>
  </tr>
  <tr>
...
<td colspan="3"><select name="cboStyles" class="txtbox" id="cboStyles" style="width:325px" onchange="getStylewiseOrderNo(this.value);" >
<?PHP		
		/*$SQL="SELECT DISTINCT SP.intSRNO,SP.intStyleId,Sum(ST.dblQty) AS qty ".
		    ...
		    $SQL = "SELECT DISTINCT round(Sum(ST.dblQty),2) AS dblQty,O.strStyle
					 ...
					 WHERE MS.intCompanyId ='12' AND MS.intStatus=1
					 GROUP BY ST.intStyleId
					 having dblQty>0
					 order by O.strStyle";
...
?>
              ...
              <td colspan="3"><select name="cboBuyerPoNo" class="txtbox" id="cboBuyerPoNo" style="width:230px" >
              </select></td>
            </tr>
            <tr>
<?PHP
...
?>
              ...
              <td width="14%"><select name="cboOrderNo" class="txtbox" id="cboOrderNo" style="width:130px" onchange="SetSCNo(this);LoadBuyerPoNo(this);" >
                <?PHP		
		/*$SQL="SELECT DISTINCT SP.intSRNO,SP.intStyleId,Sum(ST.dblQty) AS qty ".
			 "FROM stocktransactions AS ST INNER JOIN ".
			 "specification AS SP ON ST.intStyleId=SP.intStyleId ".
			...
			$arrStatus  = explode(',',$headerPub_AllowOrderStatus);
			 ...
			 $SQL = "SELECT DISTINCT ST.intStyleId,round(Sum(ST.dblQty),2) AS dblQty,O.strOrderNo 
					 FROM stocktransactions_leftover AS ST INNER JOIN 
					 mainstores AS MS ON MS.strMainID = ST.strMainStoresID
					 INNER JOIN orders O ON O.intStyleId = ST.intStyleId
...
?>
              ...
              <td width="6%"><span class="normalfnt">SC No</span></td>
              <td width="25%"><select name="cboScNo" class="txtbox" id="cboScNo" style="width:120px" onchange="setOrderNo(this);LoadBuyerPoNo(this);" >
                <?PHP	
$arrStatus  = explode(',',$headerPub_AllowOrderStatus);	
...
?>
              ...
              <td colspan="3"><select name="cboMainStore" id="cboMainStore" style="width:230px;" onchange="getCommonBinDetails(0);">
                <?php 
...
?>
            ...
            <tr>
              ...
              <td width="9%"><input  type="text" name="txtNoOfPackages" class="txtbox" id="txtNoOfPackages" style="width:100px;text-align:right" onkeypress="return IsNumberWithoutDecimals(this.value,event);"/></td>
              <td width="3%">&nbsp;</td>
              <td width="22%">&nbsp;</td>
            </tr>
<tr>
        ...
        <td><div id="divGatePassMain" style="overflow:scroll; height:300px; width:950px;" class="tableBorder">
          <table id="tblGatePassMain"width="1000" border="0" cellpadding="0" cellspacing="1"  bgcolor="#CCCCFF" >
            <tr class="mainHeading4">
              ...
              <td width="5%">Size</td>
              <td width="4%">Unit</td>
              <td width="6%">Stock Bal</td>
              <td width="6%">GP Qty</td>
              <td width="3%">RTN</td>
              <td width="2%">Bin</td>		
			  <td width="4%">GRN<br/>
			    No</td>
  ...
  <tr >
    <td height="30"><table width="100%" border="0" class="bcgl1">
      <tr>	
        <td class="normalfnt" style="text-align:center"><a href="leftovergatepass.php">
        <img src="../../images/new.png" alt="new" border="0" id="cmdNew" width="96" height="24" />
        </a>        <img src="../../images/save.png" alt="Save" width="84" id="cmdSave" height="24" onclick="SaveValidation(0);" /><img src="../../images/conform.png" alt="confirm" id="cmdConfirm" width="115" height="24" style="visibility: visible" onclick="Confirm();"/><img src="../../images/report.png" alt="Report" border="0" width="108" height="24" onclick="ViewReport();" /><a href="../../main.php"><img src="../../images/close.png" alt="close" width="97" height="24" border="0" /></a></td>
