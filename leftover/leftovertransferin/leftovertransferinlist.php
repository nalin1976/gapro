...
<title>Left Over Gatepass - Transfer List</title>
...
<!--start -for calander-->
<link href="../../css/erpstyle.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="../../leftovertranferin/javascript/calendar/theme.css" />
...
<body>
<form name="frmLOTIListing" id="frmLOTIListing" action="leftovertransferinlist.php" method="post">
  <tr>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="bcgl1">
      ...
      <tr  height="25" class="mainHeading">
        <td>Left Over  Gate Pass TransferIn List</td>
        </tr>
    </table></td>
  <tr>
    <td colspan="2"><table width="100%" border="0" class="tableBorder">
      ...
      <tr>
        <td><div id="divTranferInDetails" style="overflow:scroll; height:400px; width:950px;">
          <table id="tblTranferInDetails" width="930" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF" >
            <tr class="mainHeading4">
			  ...
			  <?php
			  $SQL = "SELECT DISTINCT BTIH.intTINYear,BTIH.intTransferInNo, 
					date(BTIH.dtmDate) as dtmDate,concat(BTIH.intGPYear,'/',BTIH.intGatePassNo) as GatePassno,BTIH.intStatus 
					FROM leftover_gatepasstransferin_header AS BTIH 
					Inner Join leftover_gatepasstransferin_details AS BTID ON BTIH.intTransferInNo = BTID.intTransferInNo AND BTIH.intTINYear = BTID.intTINYear 	
		...
		?>
              ...
              <td width="7%" class="normalfntMid" ><?php echo $row["intTINYear"].'/'.$row["intTransferInNo"]?></td>
              <td width="7%" class="normalfntMid" ><?php echo $row["dtmDate"]; ?></td>
              <td width="8%" class="normalfntMid"><?php echo $row["GatePassno"]; ?></td>
              <td width="8%" class="normalfntMid" ><a href="leftovertransferinrpt.php?id=1&amp;TransferInNo=<?php echo $row["intTransferInNo"];?>&amp;TransferInYear=<?php echo $row["intTINYear"];?>" class="non-html pdf" target="_blank"><img border="0" src="../../images/view.png" alt="view" /></a></td>			  
              </tr>	
		 <?php
		 $No++;
		 }
  ...
  <tr >
    <td height="30" colspan="2"><table width="100%" border="0" class="tableBorder">
      <tr>
        <td class="normalfnt" style="text-align:center"><a href="../../main.php"><img src="../../images/close.png" alt="close" width="97" height="24" border="0" /></a></td>
        </tr>
    </table></td>
  </tr>
</table>
