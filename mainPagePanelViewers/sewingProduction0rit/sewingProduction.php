          ...
          <td valign="top"><table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              ...
              <table width="100%" height="200" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  ...
                  <td><input  name="txtSrchDatePD" type="text" class="txtbox" id="txtSrchDatePD" style="width:76px;"  
                  onclick="return showCalendar(this.id, '%Y-%m-%d');" value="<?php echo date("Y-m-d");?>"/><input type="text" value=""  
            ...
            <tr>
              ...
              <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><div id="mainGridDataDivPD" style="overflow:scroll; height:250px; width:930px;" onmousedown="scrollGridHead('mainGridHeadDivPD','mainGridDataDivPD');">
