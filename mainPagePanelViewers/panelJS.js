...
function viewPanel(panelName)
{
	...
	if(panelName=="Production"){
		...
		document.getElementById("subPanel3").style.display = "block";
	}else if(panelName=="SOReport"){
		document.getElementById("subPanel4").style.display = "block";		
...
function hideAllPanel()
{
	...
	document.getElementById("subPanel3").style.display = "none";
	document.getElementById("subPanel4").style.display = "none";
	//2014-03-11====================================================
	/// Add new panel ///	
}
...
function setupPanelData()
{
	if(document.getElementById("subPanel1").style.display == "block"){		
		...
		setPanelMRN();
	}else if(document.getElementById("subPanel3").style.display == "block"){
	}else if(document.getElementById("subPanel4").style.display == "block"){	
		//==========2014-03-11================================
		//setPanelPLAN();
	}else{
			}
