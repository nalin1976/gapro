...
plan_teams.strTeam LIKE 'LINE%' order by strTeam ASC";
                                        ...
                                        <td width="15%">	
                                        	<input name="txtFromDate" type="text" class="txtbox" id='txtFromDate<?php echo $r;?>'  value=""  style="width:80px;" />
                     </td>
                                        <td width="15%">
                                        	<input name="txtToDate" type="text" class="txtbox" id='txtToDate<?php echo $r;?>'  value=""  style="width:80px;" />
                                        </td>
                                     </tr>
							<?php
							$r++;
