...
{//alert("searchDataPD");
	...
	var url = "mainPagePanelViewers/sewingProduction/sewingProductionDB.php?RequestType=searchDataPD";
		...
		document.getElementById('lbTotTarQty').innerHTML = ": "+document.getElementById('hdTotTarQty').value;
		document.getElementById('lbTotActQty').innerHTML = ": "+document.getElementById('hdTotActQty').value;
		document.getElementById('lbOtherQty').innerHTML  = ": "+document.getElementById('hdTotOtherQty').value;
		document.getElementById('lbVariance').innerHTML  = ": "+(parseInt(document.getElementById('hdTotTarQty').value)-parseInt(document.getElementById('hdTotActQty').value));		
}

function resetTotalQtyField()
{
	document.getElementById('lbTotTarQty').innerHTML = ": 0";
	document.getElementById('lbTotActQty').innerHTML = ": 0";
	document.getElementById('lbOtherQty').innerHTML = ": 0";
	document.getElementById('lbVariance').innerHTML = ": 0";	
}
