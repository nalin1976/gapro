...
plan_teams.strTeam LIKE 'LINE%' order by strTeam ASC";
                                        ...
                                        <td width="15%">	
                                        	<input name="txtFromDate" type="text" class="txtbox" id='txtFromDate<?php echo $r;?>'  value="" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%Y-%m-%d');" style="width:80px;" /><input type="reset" value=""  class="txtbox" style="visibility:hidden; width:10px;"   onclick="return showCalendar(this.id, '%d/%m/%Y');">
                     </td>
                                        <td width="15%">
