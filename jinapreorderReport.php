      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td class="bcgl1txt1"><?php echo $oderDate; ?></td>          
          </tr>    
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="tablez">
          ...
          <tr>
           ...
           <tr>
			...
			//echo number_format(($CMVAL * $BuyingOfficeMargin / 100),4);
			echo number_format($costinglabourCost,4);
			?></td>
			 <td class="normalfntRiteTAB">
			<?php
			$CMTot = round($costinglabourCost *( $intQty + ($intQty * $reaExPercentage / 100) ),4);
			echo  number_format($CMTot,4);
			?></td>
          </tr>
          <tr>
			...
			// echo round($reaSMV*$reaSMVRate,4);
			//echo $TotaleDrectCost . "<br>";
			echo number_format(($CMVAL - $costinglabourCost ),4);
			?></td>
			 <td class="normalfntRiteTAB">
			<?php
			echo  number_format(($CMVAL - $costinglabourCost ) *( $intQty + ($intQty * $reaExPercentage / 100)),4);
			?></td>
          </tr>
           <?php
          ...
          <tr <?php echo $bgColor; ?>>
			...
			?></td>
			 <td class="normalfntRiteTAB">
			<?php
			echo  number_format(($CMVAL) *( $intQty + ($intQty * $reaExPercentage / 100)),4);
			?></td>
          </tr>
          <tr>
