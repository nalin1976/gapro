...
<table width="1000" border="1" align='center' CELLPADDING=1 CELLSPACING=1 rules="rows" >
      ...
      <td class='bcgl1txt1NB' align="left" width="76">SC No</td>
	  ...
	  <td class='bcgl1txt1NB' align="right" width="65">Dispose Qty</td>
      ...
      <td class='normalfnt' align="left" width="76"><?php echo $rowD['intSRNO'];?></td>
