...
<script src="javascript/buyerPO.js" type="text/javascript"></script>
...
<form id="form1" name="form1" method="post" action="">
  <table width="950" border="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td><table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="96%" class="head1">Buyer PO  </td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%" border="0">
            <tr>
              ...
              <td width="17%"><select name="cboFactory" onchange="GetCompanyPOList();" style="width:170px" id="cboFactory">
	...
	?>
              ...
              <td width="36%"><a href="#"><img src="images/view.png" alt="view" width="91" height="19" border="0" onclick="GetTargetPOs();" /></a></td>
            </tr>
          </table></td>
          </tr>
        <tr>
          <td colspan="2"><table id="tblPreOders" width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
            <tr>
              ...
              <td width="28%" bgcolor="#498CC2" class="normaltxtmidb2">Order Qty </td>
