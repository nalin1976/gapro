...
{	
	...
	var url='advancePaymentListDB.php?DBOprType=findAdvData&strPaymentType=' + strPaymentType + '&supID=' + supID + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo+'&poNo='+poNo+'&poYear='+poYear+'&cboUser='+cboUser;
...
function loadReport(){
	...
	window.open('advPayRep.php?strPaymentType=' + strPaymentType + '&supID=' + supID + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo+'&poNo='+poNo+'&poYear='+poYear+'&cboUser='+cboUser+'&strPaymentType='+strPaymentType,'frmBanks'); 
}