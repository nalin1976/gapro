...
<div class="main_bottom_center2">
	<div class="main_top2" onmousedown="grab(document.getElementById('fmGrnDetails'),event);" >
		...
		<div id="divcons2" style=" overflow:scroll;height:230px; width:650px;" class="tableBorder">
			<table width="630" cellspacing="1" id="tblGrnMain" class="table_grid_style">
				<thead>
				...
				advancepaymentpos.paidAmount
						...
						Inner Join advancepaymentpos ON advancepaymentpos.POno = grnheader.intPoNo
				...
				<tr>
					...
					<td class="<?php echo $cls;?>" style="text-align:center;"><input type="text" style="width:70px;text-align:right; " onkeypress="return CheckforValidDecimal(this.value,1,event);" onkeyup="setBalance(this),setGrnValue();"  <?php echo $disabled?>//></td>
		...
		<br />
		 ...
		 <div style="font-size:15px;color:#550000">
		 <table align="right">
		 <tr>
		 <td>
		 <input name="btnshowgl" type="button" style="background-color:#fdeec0;vertical-align:top;" id="btnshowgl" value="Show all GLs" onclick="ShowAllGLAccounts();" align="right"/> </td>
		 <td>
		 <input type="text" class="txtbox"  style="width:70px;text-align:right;" id="txtGLTotal" readonly="readonly">	
		 </td>
		 </tr>
		 </table>
		 </div>
		 <div id="divconsOfSelGLs" style="overflow:scroll; height:90px; width:650px;" class="tableBorder">
		...
		<table width="650" >
			<tr>
				...
				<td width="164" class="normalfntRite">Adv Paid</td>
				&nbsp;
			  <td width="169" class="normalfnt"><input type="text" class="txtbox" style="width:75px;text-align:right;" value="<?php echo $advance;?>" readonly="readonly" id="grnPoAmount"  /><input type="hidden" value="<?php echo $balance;?>" id="txtBalance"/></td>
				<td width="67" class="normalfntRite">GRN Value</td>
				&nbsp;
			  <td width="166" class="normalfnt"><input type="text" class="txtbox"  style="width:75px;text-align:right;" id="txtTotGrn" readonly="readonly"></td>
