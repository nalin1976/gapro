	...
	if(StylePOXmlHttp.readyState == 4) 
    {
	   if(StylePOXmlHttp.status == 200) 
        {  
			...
			strTable="<table width=\"860\" cellpadding=\"0\" cellspacing=\"0\" id=\"tblPOList\" class=\"normalfnt\">"+
					"<tr>"+
					...
					"<td width=\"13%\" bgcolor=\"#498CC2\" class=\"normaltxtmidb2\"><div align=\"right\">PO Amount</div></td>"+
