...
?>
            <tr class="backcolorGreen">
              ...
              <td class="<?php echo $cls;?>" ><a target="_blank"  href=<?php echo "grnReport.php?grnno=$grnNo&grnYear=$grnYear" ?>><img src="../images/view.png" alt="Report " name="butReport" border="0" id="butReport"/></a></td>
            </tr>
