...
if($RequestType == "updateGrnDetails"){
	 ...
	 $poYear = $_GET["poYear"];
	  ...
	  $sql_update_grnDetails = "update grndetails set dblAdvPayAmt = dblAdvPayAmt+'$payAmt',
							   ...
							   where intGrnNo='$grnNo' AND intGRNYear = '$grnYear' and intStyleId = '$styleId'";
...
$glAmt = $_GET["glAmt"];
 ...
 $sql = "insert into tblAdvancePaySettlementGlAllocation        (ID,paymentNo,intPoNo,glAccID,intCompany,intSupplier,dblAmt)values($dblAdvPaySetGlAccNo,$paymentNo,$txtPoNo,$glAccID,$companyId,$supplier,$glAmt)";
$result =$db->RunQuery($sql);	
echo $result;
}
