...
<!--				<td width="69" class="normalfnt">Select All</td>
			  <td width="411" align="left"><input type="checkbox" class="txtbox" id="chkAll" onclick="selectAllChk(this);" ></td>-->
				...
				<td align="right"><input name="btnshowgl" type="button" style="background-color:#fdeec0;vertical-align:top;" id="btnshowgl" value="Show all GLS" onclick="ShowAllGLAccounts();"/></td>
			</tr>
			<tr>
		...
		<div id="divcons2" style="overflow:scroll; height:250px; width:600px;" class="tableBorder">
			<table width="582" cellspacing="1" id="tblGrnMain" class="table_grid_style">
				<thead>
					<tr>
						<td class="grid_header"><input type="checkbox" class="txtbox" id="chkAll" onclick="selectAllChk(this);" ></td>
...
<?php
				...
				from grndetails inner join matitemlist on matitemlist.intItemSerial = grndetails.intMatDetailID inner join grnheader on grnheader.intGrnNo =                grndetails.intGrnNo Inner Join advancepaymentpos ON advancepaymentpos.POno = grnheader.intPoNo
				where grnheader.intPoNo='$poNo' AND intYear = '$poYear' 
				group by grndetails.intGrnNo,grndetails.intGRNYear,grndetails.intStyleId,grndetails.strBuyerPONO,grndetails.intMatDetailID";
                //echo $strSQL;		
