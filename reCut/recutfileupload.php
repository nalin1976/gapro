...
function RemoveFile(obj,url)
{
	...
	{		
		...
		var url = 'recutpreorderdb.php?RequestType=RemoveFile&url='+url;
...
<form action="uploader_file.php" method="post" enctype="multipart/form-data" name="formstyle" id="formstyle">
  <table width="429" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
    ...
    <tr>
     ...
     <tr>
      <td>&nbsp;</td>
      <td colspan="3" class="normalfnt"><input name="file" type="file" class="txtbox" id="file" size="50" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td width="74">&nbsp;</td>
...
<?php
$file = "";
$url = "../upload files/Recut/". $_SESSION["no"]."/";
