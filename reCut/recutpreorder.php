...
<title>GaPro : : Re-Cut Costing Sheet </title>
<style type="text/css">
...
<body onload="LoadSavedPreOrderDetails();">
<?php
	...
	if($_GET["recutNo"] != '')
		$recutNo = $_GET["recutYear"].'/'.$_GET["recutNo"];
	else
		$recutNo='';	
	?>
...
<tr>
  ...
  <table width="90%" align="center" cellpadding="1" cellspacing="1" class="bcgl1" id="tblMain">
      ...
      <td height="75" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="100%" height="44" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="92%" height="20" class="mainHeading">Recut Cost Sheet</td>
              ...
              <tr>
                <td height="18"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="214"><select name="cboStyles" class="txtbox" style="width:210px" id="cboRecutStyles" onchange="getStyleWiseRecutOrderData();" >
	...
	$SQL = "select distinct strStyle from orders where intUserID = " . $_SESSION["UserID"] . " AND intStatus  =11 order by strStyle";
	...
	?>
                      ...
                      <td width="109"><select name="cboRecutSR" class="txtbox" style="width:100px" id="cboRecutSR" onchange="getRecutOrderNo();" >
                        <option value="" selected="selected">Select One</option>
                        <?php
	
		$SQL = "select specification.intSRNO,orders.intStyleId from specification inner join orders on specification.intStyleId = orders.intStyleId AND orders.intStatus=11 and intUserID = " . $_SESSION["UserID"] . " ";
	...
	?>
                      ...
                      <td width="149"><select name="cboRecutOrderNo" id="cboRecutOrderNo" style="width:120px;" onchange="getRecutScNo();" >
                        <option value="" selected="selected">Select One</option>
                        <?php
	
	$SQL = "select intStyleId,strOrderNo from orders where intUserID = " . $_SESSION["UserID"] . " AND intStatus  =11 ";
	...
	?>
                      ...
                      <td width="319"><img src="../images/go.png" width="30" height="22" onclick="reloadPreOrderDetails();" /></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                     <td class="normalfnt">Recut No</td>
                      <td><input type="text" name="txtRecutNo" id="txtRecutNo" style="width:206px;" disabled="disabled" value="<?php echo $recutNo; ?>"/></td>
                       <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
          ...
          <tr>
            <td height="286"><table width="100%" class="bcgl1">
                <tr>
                  <td width="73%" height="253"><table width="108%">
                      <tr>
                        <td width="70" class="normalfnt">Factory<span class="compulsoryRed"> *</span></td>
                        <td width="217"><select name="cboFactory" class="txtbox" onchange="ChangeFactory();" style="width:210px" id="cboFactory" disabled="disabled">
	...
	?>
                        ...
                        <td width="80" class="normalfnt">Responsible Person</td>
                        <td width="196" class="normalfnt"><select name="cboResposiblePerson" id="cboResposiblePerson" style="width:170px;">
	...
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"". $row["intUserID"] ."\">" . $row["Name"]  ."</option>" ;
						...
						?>
                          ...
                          <input type="text" name="txtEPF" id="txtEPF" style="width:80px;" value="Enter EPF No" onclick="clearEPFTextbox();" maxlength="10"/> <span class="compulsoryRed">*</span>                       </td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Style No<span class="compulsoryRed"> *</span></td>
                        <td><input name="txtStyleNo" type="text" disabled="disabled" class="txtbox" id="txtStyleNo" style="width:40px" maxlength="27" onkeyup="AutoCompleteStyleNos(event);" />
                        ...
                        <td class="normalfnt"><input name="txtOrderNo" type="text" class="txtbox" id="txtOrderNo" style="width:168px;" maxlength="30" disabled="disabled"/>&nbsp;
                          <select name="cboOrderType" id="cboOrderType" style="width:80px;" disabled="disabled">
                            <option value="1">Bulk</option>
                            <option value="2">Sample Invoice</option>
                            <option value="3">Sample Non Invoice</option>
                            <option value="4">Seconds</option>
                            <option value="5">Assorted</option>
                          </select></td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Style Name<span class="compulsoryRed"> *</span></td>
                        <td><input name="txtStyleName" type="text" class="txtbox" id="txtStyleName" style="width:208px" maxlength="100" disabled="disabled" /></td>
                        <td class="normalfnt">Qty <span class="compulsoryRed">*</span></td>
                        <td class="normalfnt"><!-- onkeyup="ChangeOrderQuantity();"-->
                          <input name="txtQTY" type="text" class="txtbox" id="txtQTY"  onblur="DisplayEfficiencyLevel();checkForValues(this);ChangeOrderQuantity();"  onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();"  onkeypress="return isValidZipCode(this.value,event);" value="1" style="width:68px; text-align:right" maxlength="9" disabled="disabled"/>
                          <span class="normalfnt">&nbsp;&nbsp;&nbsp; Ex:Qty&nbsp;%</span>
                          <input name="txtEXQTY" type="text" class="txtbox" id="txtEXQTY" onblur="checkForValues(this);ChangeOrderQuantity();"  onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();"  onkeypress="return isValidZipCode(this.value,event);" value="0" style="width:20px; text-align:right" maxlength="3" disabled="disabled"/>
                      ...
                      <tr>
                        ...
                        <td><select name="cboCustomer" class="txtbox" onchange="getGetDivisions();GetBuyingOffices();" style="width:210px" id="cboCustomer" disabled="disabled">
                          <option value="Select One" selected="selected">Select One</option>
                          <?php
	...
	?>
                        ...
                        <td class="normalfnt">Recut Qty<span class="compulsoryRed">*</span></td>
                        <td><span class="normalfnt">
                          <input type="text" name="txtRecutQty" id="txtRecutQty" style="width:68px; text-align:right"  onblur="ChangeRecutOrderQuantity();" onkeypress="return isValidZipCode(this.value,event);"/> 
                          SMV <span class="compulsoryRed">*
                          <input name="txtSMV" type="text" <?php if ($SMVEnabled == "false") { ?> disabled="disabled" <?php } ?> class="txtbox" id="txtSMV" onblur="DisplayEfficiencyLevel();checkForValues(this);" onmousedown="DisableRightClickEvent();"  onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0" style="width:55px; text-align:right" maxlength="7" onkeyup="CalculateCMRate();CalculateESC();" readonly="readonly" />
                        </span></span></td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Buying Office</td>
                        <td><select name="cboBuyingOffice" class="txtbox" style="width:210px"  id="cboBuyingOffice" disabled="disabled">
                          <?php
                        ...
                        <td class="normalfnt">Merchandiser <span class="compulsoryRed">*</span></td>
                        <td><span class="normalfnt">
                          <select name="cboMerchandiser" class="txtbox" style="width:170px"  id="cboMerchandiser" disabled="disabled">
	...
	?>
                      ...
                      <tr>
                        ...
                        <td><select name="dboDivision" class="txtbox" style="width:210px"  id="dboDivision" disabled="disabled">
                          <?php
                        ...
                        <td><span class="normalfnt">Season</span></td>
                        <td><select name="dboSeason" class="txtbox" style="width:170px"  id="dboSeason" disabled="disabled">
                          <?php
	...
	?>
                      ...
                      <tr>
                        ...
                        <td><input name="txtRefNo" type="text" class="txtbox" id="txtRefNo" style="width:208px" maxlength="30" disabled="disabled"  /></td>
                        <td><span class="normalfnt">Schedule Method</span></td>
                        <td><select name="cboScheduleMethod" class="txtbox" id="cboScheduleMethod" style="width:170px" disabled="disabled">
                      ...
                      <tr>
                        ...
                        <td valign="bottom" class="normalfnt" ><input name="txtEffLevel" onblur="checkForValues(this);"  type="text" class="txtbox" id="txtEffLevel" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0" size="4" onkeyup="changeEffLevel();" maxlength="4" style="text-align:right" readonly="readonly" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ESC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="txtESC" type="text" disabled="disabled" class="txtbox" id="txtESC" onblur="checkForValues(this);" value="0"  style="text-align:right; width:52px;" maxlength="9" />                       </td>
                        <td  class="normalfnt">Order Unit </td>
                        <td ><select name="cboOrderUnit" class="txtbox" style="width:170px"  id="cboOrderUnit" disabled="disabled">
                          <?php
	...
	?>
                      ...
                      <tr>
                        ...
                        <td valign="bottom" ><select name="cboProductCategory" class="txtbox" style="width:210px"  id="cboProductCategory" disabled="disabled">
<?php	
...
?>
	...
	?>" style="width:68px; text-align:right" /></td>
                      ...
                      <tr>
                        <td height="23" class="normalfnt" >Recut Reason<span class="compulsoryRed">*</span></td>
                        <td valign="bottom" ><input type="text" name="txtRecutReason" id="txtRecutReason" style="width:208px;"  maxlength="100"/></td>
                        <td  class="normalfnt" >Total Fabric ConPc</td>
                        <td  ><input name="txtTotFabConPc" type="text" disabled="disabled" class="txtbox" id="txtTotFabConPc" value="<?php	
	...
	?>" style="width:68px; text-align:right" /></td>
                  ...
                  <td width="27%" rowspan="2" valign="top" style="display:none"><table width="100%" height="249" class="bcgl1">
                    <!--DWLayoutTable-->
                      <tr>
...
<div style="cursor: pointer;" class="div_horizontalscroll" onmouseover="this.style.cursor='pointer'">
    ...
    <tr>
      <td height="21" valign="top" style="visibility:hidden"><a href="#"><img src="images/view2.png" alt="save" width="62" height="21" border="0" onclick="ShowSubContractWindow();" />
                          <input name="txtSubContactQty" type="text" class="txtbox" id="txtSubContactQty" size="10" maxlength="30" onblur="checkForValues(this);" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();"  onkeypress="return isNumberKey(event);" />
                        </a></td>
    </tr>
     <tr>
      <td height="21" valign="top" style="visibility:hidden"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="23%" class="normalfnt">Labour Cost</td>
          <td width="6%"><input name="txtLabourCost" type="text" <?php if ($LabourCostEnabled == "false") { ?> disabled="disabled" <?php } ?> class="txtbox" id="txtLabourCost" onkeypress="return CheckforValidDecimal(this.value, 4,event);" onblur="checkForValues(this);" value="0" size="2" style="text-align:right" /></td>
          <td width="14%">No of Lines</td>
          <td width="19%"> <input name="txtNoLines" onblur="checkForValues(this);" type="text" class="txtbox"  id="txtNoLines"  onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();"  onkeypress="return isNumberKey(event);" value="1" size="15" /></td>
          <td width="38%"><label class="normalfnth2" id="lbldate"><?php echo date("Y-m-d") ?></label></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td height="99" valign="top" style="display:none"><table id="tblDelivery"  width="100%" cellpadding="0" cellspacing="1">
       <!-- <tr>
        ...
        <tr>
          <td width="10%" height="24" bgcolor="#804000" class="normaltxtmidb2">Edit</td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">Del</td>
          <td width="25%" bgcolor="#804000" class="normaltxtmidb2">Delivery Date</td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">Qty.</td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">With Ex. Qty</td>
          <td width="15%" bgcolor="#804000" class="normaltxtmidb2">Shipping Mode</td>
          <td width="20%" bgcolor="#804000" class="normaltxtmidb2">Remarks</td>
         <!-- <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">Lead Time </td>
          <td width="15%" bgcolor="#498CC2" class="normaltxtmidb2">Estimated Date</td>-->
        </tr>
      ...
      <td bgcolor="#FFD5AA"><table width="100%" align="center">
          <tr>
            <td class="normalfntMid">
              <img src="../images/new.png" alt="New" onclick="ClearReCutForm();" />
              <img src="../images/save.png" alt="save" onclick="saveRecutDetails(0);" />
              <img src="../images/send2app.png" alt="send to Approval" onclick="recutSendtoApp(<?php echo $styleNo; ?>);"  />
              <img src="../images/upload.jpg" id="butUpload" title="Click here to upload documents" onclick="UploadFile();"/>
              <img src="../images/report.png" onclick="showRecutReport();" />
...
<script src="recut.js" type="text/javascript"></script>
</html>
