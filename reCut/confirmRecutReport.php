...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2" class="bcgl1">
      <tr>
        <td align="center"><img src="../images/approve.png" width="113" height="24" onClick="confirmRecutOrder(<?php echo $recutNo; ?>,<?php echo $recutYear; ?>);"><img src="../images/reject.png" width="102" height="24" onClick="rejectRecut(<?php echo $recutNo; ?>,<?php echo $recutYear; ?>);"></td>
