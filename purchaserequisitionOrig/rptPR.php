...
?>
	<tr>
		<td height="24" align="left" class="normalfnBLD1">Factory</td>
		<td width="89%" class="normalfnt">: <?php echo $row["strName"]; ?> </td>
	</tr>
	<tr>
		<td height="24" align="left" class="normalfnt">PR No</td>
		<td class="normalfnt">: <?php echo $row["strPRNo"]; ?></td>
	</tr>
	<tr>
		<td height="24" align="left" class="normalft">PR Date</td>
		<td class="normalfnt">: <?php echo $row["dtmRequestDate"]; ?></td>
	</tr>
	<tr>
		<td height="24" align="left" class="normalfnt">Job No</td>
		<td class="normalfnt">: <?php echo $row["strJobNo"]; ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="normalfnt">: <?php echo $row["strAttension"]; ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="normalfnt">: <?php echo $currency; ?></td>
	</tr>
	</table></td>
	</tr>
<?php
...
<?php
$sql_detail =" select PD.intPRNo, PD.intPRYear, PD.intMatDetailId, GM.strItemDescription, PD.strUnit, PD.dblUnitPrice, PD.dblQty, PD.dblValue ,PD.intAssest, PD.dblDiscount, PD.dblFinalValue from purchaserequisition_details PD inner join genmatitemlist GM ON PD.intMatDetailId=GM.intItemSerial where PD.intPRNo='$PRNo' AND PD.intPRYear='$PRYear' order by PD.intMatDetailId ;";
...
?>
                  <tr class="bcgcolor-tblrowWhite">
                    ...
                    <td align="left" class="normalfnt"><?php echo $row_detail["strItemDescription"]; ?></td>
            ...
            <tr>
              <td><table width="100%" height="67" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td>Total</td>
                    <td>&nbsp;</td>
                    <td width="12%" class="normalfntRite"><b><?php echo number_format($totalValue,4); ?>&nbsp;</b></td>
                  </tr>
                  <tr>
                    <td height="20">&nbsp;</td>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td class="normalfntMid">Factory Account</td>
                    <td>&nbsp;</td>
                    <td class="normalfntMid">Final Approval</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="20">&nbsp;</td>
...
<?php if($status=='0' || $status=='1' || $status=='2') { ?>
	<div style="position:absolute;top:200px;left:300px;"><img src="../images/pending.png"></div>
