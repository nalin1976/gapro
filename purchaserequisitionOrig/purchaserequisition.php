...
?>
				...
				<tr>
				  <td width="4%" class="normalfnt">&nbsp;</td>
					...
					<td width="1%" class="normalfnt"></td>
					<td width="13%" class="normalfnt">Supplier <span class="compulsoryRed">*</span></td>
				  	<td width="38%" class="normalfnt">
						<select style="width: 250px;" class="txtbox" onchange="LoadSuppDetails(this);" id="cboSupplier">
<?php
...
?>
				...
				<tr>
				  <td width="4%" class="normalfnt">&nbsp;</td>
					...
					<td width="1%" class="normalfnt"></td>
					<td width="13%" class="normalfnt">Department <span class="compulsoryRed">*</span></td>
				  	<td width="38%" class="normalfnt">
...
?>
				  ...
				  <input type="text" class="txtbox" style="width:55px;text-align:right" id="txtExRate" disabled="disabled"/>				  </td>
					<td width="1%" class="normalfnt"></td>
				...
				<tr>
				  <td width="4%" class="normalfnt">&nbsp;</td>
					<td width="15%" class="normalfnt">Job No / Type</td>
		  	      <td width="29%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtJobNo" maxlength="20" />
