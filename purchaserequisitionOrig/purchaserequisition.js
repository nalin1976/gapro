	...
	if(obj.checked)
	{
		...
		{			
			...
			for(loop=0;loop<XMLItem.length;loop++)
			{
				...
				var XMLDisPercent	= 0;
				//pub_mainCat		= glId;
				CreateMainItemTbl(glId,XMLItemId,XMLItemDesc,XMLUnit,XMLUPrice,XMLFUPriceDate,XMLUPriceDate,XMLMainCat,XMLReorderLevel,XMLStockBal,XMLOrderQty,XMLDisPercent);
			}
		}
	}
	else
...
function CreateMainItemTbl(glId,XMLItemId,XMLItemDesc,XMLUnit,XMLUPrice,XMLFUPriceDate,XMLUPriceDate,XMLMainCat,XMLReorderLevel,XMLStockBal,XMLOrderQty,XMLDisPercent)
{
...
function LoadSaved_Details(year,no)
{
	...
	for(var loop=0;loop<XMLItem.length;loop++)
	{
		...
		CreateMainItemTbl(XMLGLAllowId,XMLItemId,XMLItemDesc,XMLUnit,XMLUPrice,XMLFUPriceDate,XMLUPriceDate,XMLMainCat,XMLReorderLevel,XMLStockBal,XMLOrderQty,XMLDisPercent);
		CalculateRowValue(++i);
	}
}
