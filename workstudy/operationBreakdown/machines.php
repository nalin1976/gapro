...
<div class="main_bottom">
	<div class="main_top">
		<div class="main_text">Machines<span class="vol">#</span></div>
	</div>
	<div class="main_body">
	<table align="center" border="0" cellspacing="1" width="600">
		<tr>
			<td class="normalfnt" width="112">&nbsp;</td>
			<td class="normalfnt" width="146">Search</td>
			<td width="324">
		...
		<tr>
			<td class="normalfnt" width="112">&nbsp;</td>
			<td class="normalfnt" width="146">Machine Code</td>
			<td width="324"><input style="width: 200px;" class="txtbox" type="text" maxlength="10"></td>              
			<td width="5"></td>
		</tr>
		<tr>
			<td class="normalfnt" width="112">&nbsp;</td>
			<td class="normalfnt" width="146">Machine</td>
			<td width="324"><input style="width:200px;" class="txtbox" type="text" maxlength="10"></td>              
		</tr>
		<tr>
			<td class="normalfnt" width="112">&nbsp;</td>
		...
		<tr>
			<td class="normalfnt" width="112">&nbsp;</td>
			<td class="normalfnt" width="146">Active</td>
			<td width="324"><input type="checkbox" checked="checked"  class="chkbox"></td>              
		</tr>
	</table>
	<br />
	<table width="600">
