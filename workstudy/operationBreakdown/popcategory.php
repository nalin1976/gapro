...
<table width="450" border="0" cellspacing="4" cellpadding="0" bgcolor="#FFFFFF" height="200" >
  <tr>
    <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="bcgl1 normalfnt">
      ...
      <tr>
        <td colspan="2" class="mainHeading" style="text-align:center"> Component Category</td>
        </tr>
      <tr>
        <td width="35%">&nbsp;</td>
        <td width="65%">&nbsp;</td>
      ...
      <tr>
        ...
        <td><input name="txtPopCatDscr" type="text" class="txtbox" id="txtPopCatDscr" style="width:230px;" tabindex="2" maxlength="100"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
