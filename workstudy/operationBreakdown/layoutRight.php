...
?> 
		...
		<?php 	$k =90; $n=1; 
				...
				if((90-$n) < $resCount){ break; }
							?>
							<tr id="<?php echo $k; ?>">
								<td><?php echo "R".$i;  $machineName = "machineR".$n; ?></td>
								<td align="center"><img src="../../images/aad.png" alt="add" border="0" onclick="addOperationToRightTableLayout(this.parentNode.parentNode.rowIndex);"/></td>
								<td>
				...
				<td style="display:none">right</td>
		...
		?>
			...
			<td><?php			
			 ...
			 echo $record['lineNo'];			
			$innerLoop--;			 			
			$machineName = "machineR".$n; ?></td>
			<td align="left"><img src="../../images/edit.png" height="19" width="19" alt="add" border="0" onClick="addOperationToRightTableLayout(this.parentNode.parentNode.rowIndex,20);"/>
