...
<div class="main_bottom">
	<div class="main_top">
		<div class="main_text">Tex<span id="banks_popup_close_button"></span></div>
	</div>
	<div class="main_body">
	...
	<td>
		<table width="32%" align="center" border="0"  class="bcgl1">
			...
			<td class="normalfnt">&nbsp;</td>
				...
				<?php
				$SQL="SELECT * FROM ws_tex ORDER BY strDescription ASC";		
			...
			<td class="normalfnt">&nbsp;</td>
			  ...
			  <td><input style="width: 201px;" class="txtbox" type="text" id="txtDescription" maxlength="10">
			  </td>
			  <td class="normalfnt">&nbsp;</td>
			  <tr>
				...
				<td colspan="4">
					<table >
						<tr>
							...
							<td><img src="../../images/save.png" alt="Save" name="Save" onclick="saveTex();" class="mouseover"></td>
							<td width="15%"><img src="../../images/delete.png" onclick="deleteTex();" class="mouseover"  name="Delete" height="24"></td>       
