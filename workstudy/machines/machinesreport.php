...
<thead style="height:25px">
  <tr>
      <td colspan="5" class="normalfnt2bldBLACKmid">Machines Report</td>
      </tr>
      <tr>
	  <td class='normalfntBtab' align="center"><font style='font-size:9px;'><b>ID</b></font></td>
	  <td class='normalfntBtab' align="center"><font style='font-size:9px;'><b>Machine Code</b></font></td>
	  ...
	  <?php        
		$SQL="SELECT * FROM ws_machinetypes WHERE intStatus !='10' ORDER BY strMachineCode ASC";			
        $result=$db->RunQuery($SQL);
	    $i=1;
		while($row = mysql_fetch_array($result))
	{		
		$MachineCode=$row["strMachineCode"];
		$Machine=$row["strMachineName"];
		$factor=$row["dblFactor"];
	  ...
	  echo"<td class='normalfnt'>$MachineCode</td>";
