...
$year = $_GET["intYear"];
	...
	# Description - Chnage the purchase order listing to PO raised user instead of confirmed user
	#=======================================================================================================
	...
	$sql ="select distinct PH.intYear,PH.intPONo from purchaseorderheader PH inner join purchaseorderdetails PD on PD.intPoNo=PH.intPoNo and PD.intYear=PH.intYear where PH.intStatus=10 and intUserID=$userId and PD.dblPending>0 and PH.intYear='$year';";
