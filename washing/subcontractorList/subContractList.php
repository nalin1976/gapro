...
<title>Gapro : Washing - Sub Contractor Send List</title>
...
function selectStyle(obj){
	var path="subContractList_xml.php?req=getStyle&po="+obj.value.trim();
	htmlobj=$.ajax({url:path,async:false});
	document.getElementById('cboStyle').value=htmlobj.responseText;
}

function selectPo(obj){
	var path="subContractList_xml.php?req=getPo&style="+obj.value.trim();
	htmlobj=$.ajax({url:path,async:false});
...
function showGP(obj){
	...
	window.open('../subcontract/rptSubContractorGP.php?req='+AOD,'new');
}
</script>
</head>
...
<form name="frmWRS" method="post" id="frmWRS">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	include("class.subContractList.php");
      ...
      <tr><td>&nbsp;</td></tr>
          ...
          <td><table width="800" border="0" cellspacing="0" cellpadding="3" align="center" class="tableFooter">
            <tr>
              <td width="800"><table width="800" border="0" cellspacing="0" cellpadding="0" class="normalfnt" align="center">
                <tr>
                  <td colspan="4" class="mainHeading" height="26">Sub Contract Send List</td>
                  </tr>
               
                <tr>
                  <td height="20" colspan="4"><table width="615" border="0" cellspacing="0" cellpadding="2" class="" align="center">

                    <tr class="normalfnt">
                      <td width="136">Sub Contractor</td>
                      <td colspan="3"><select name="cboFactory" id="cboFactory" style="width:377px;">
                        <option value=""></option>
                        <?php 
                    ...
                    <tr class="normalfnt">
                      <td>PO No</td>
                      <td width="162"><select name="cboOrderNo" id="cboOrderNo" style="width:122px;" onChange="selectStyle(this)">
                      ...
                      <td width="86">Style</td>
                      <td width="215"><select name="cboStyle" id="cboStyle" style="width:121px;" tabindex="2" onChange="selectPo(this)">
                                        <option value="" selected="selected">Select One</option>
                  <?php 
		...
		?>
                    ...
                    <tr class="normalfnt">
                      ...
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td align="right"><img src="../../images/search.png" width="80" height="24" onClick="searchFrom();"></td>
                    </tr>
                  </table></td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td colspan="4">
                  <table width="910" border="0" cellpadding="2" cellspacing="0" class="bcgl1">
                    <tr><td width="910">
                  <div id="divwash" style="overflow:scroll; width:910; height:300px;">
                    <table width="890" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                      	<td width="85" class="grid_header">AOD No</td>
                      	<td width="102" class="grid_header" height="20"> PO No</td>
                        <td width="114" class="grid_header" height="20">Style No</td>
                        <td width="246" class="grid_header">Style</td>
                        <td width="132" class="grid_header">Color</td>
                        <td width="67" class="grid_header">Order Qty</td>
                        <td width="62" class="grid_header"><strong>Sent Qty</strong></td>
                        <td width="82" class="grid_header"><strong>Gatepass</strong></td>
                      </tr>
                      <?php 
					...
					?>
                    <tr  height="20">
                    	<td width="85" class='<?php echo $cls;?>' style="text-align:left;"><?php echo $row['AOD'];?></td>
                        <td width="102" class='<?php echo $cls;?>' style="text-align:left;">&nbsp;<?php echo $row['strOrderNo'];?></td>
                        <td width="114" class='<?php echo $cls;?>' style="text-align:left;">&nbsp;<?php echo $row['strStyle'];?></td>
                        <td width="246" class='<?php echo $cls;?>' style="text-align:left;">&nbsp;<?php echo $row['strDescription'];?></td>
                        <td width="132" class='<?php echo $cls;?>' style="text-align:left;">&nbsp;<?php echo $row['strColor'];?></td>
                        <td width="67" class='<?php echo $cls;?>' style="text-align:right;"><?php echo $row['intQty'];?>&nbsp;</td>
                        <td width="62" class='<?php echo $cls;?>' style="text-align:right;"><?php echo $row['dblQty'];?>&nbsp;</td>
                        <td width="82" class='<?php echo $cls;?>' style="text-align:right;"><img src="../../images/report.png" onClick="showGP(this);" height="18" /></td>
