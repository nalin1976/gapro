      ...
      <tr>
      	<td colspan="3" width="100%">
            ...
            <tr  height="20">
                ...
                <td width="151" class='normalfntMid'><b>Color</b></td>
                <td width="83" class='normalfntMid'><b>Order Qty</b></td>
                <td width="99" class='normalfntMid'><b>Gatepass Qty</b></td>
                <td width="69" class='normalfntMid'><b>Cum.QTY</b></td>
                <td width="107" class='normalfntMid'><b>To be RCVD Qty</b></td>
            </tr>
            <?php 
            ...
            <tr  height="20">
                ...
                <td width="151" class='normalfnt'>&nbsp;<?php echo $row['strColor'];?></td>
                <td width="83" class='normalfntR'><?php echo $row['intQty'];?>&nbsp;</td>
                <td width="99" class='normalfntR'><?php echo $totGp=$wrsr->getGPQtyAndToBRcvd($_SESSION["FactoryID"],$row['GPNO'],$row['intStyleId']);?></td>
                <td width="69" class='normalfntR'><?php echo $rcvd=$row['CQty'];?>&nbsp;</td>
                <td width="107" class='normalfntR'><?php echo $totGp-$rcvd;?>&nbsp;</td>
