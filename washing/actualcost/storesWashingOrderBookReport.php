...
<table width="99%" border="1" align='center' cellpadding=1 cellspacing=1 rules="all" >
  ...
  <tr class="bcgcolor-tblrowWhite" onmouseover="this.style.background ='#D6E7F5';" onmouseout="this.style.background='';">
    ...
    <td class='normalfnt' ><a rel="1" id="poreport" target="_blank" href="../actualcost/chemicalCostSheet.php?q=<?php echo $rowM['intSerialNo'];?>&po_location=inhouse"><?php echo $rowM['strOrderNo']; $sId=$rowM['intStyleId'];?></a></td>
    ...
    <td class='normalfntRite' ><?php  echo number_format(($totCost),2);?></td>
  </tr>
  <?php }?>
</table>
</body>
