...
<table width="800" align='center' CELLPADDING=3 CELLSPACING=1 >
  	...
  	<tr>	<?php if($rowHeader['intStatus']==0){
 			...
 			<td class='normalfnt' align="left" style="width:400px;color:#F30;display:none;">&nbsp;</td>			
            <td>&nbsp;</td>
            <td class='normalfnt' align="left" style="width:100px;"><b>Cost Id <div style="float:right">:</div> </b></td>
            <td class='normalfnt' align="left" style="width:100px;"><?php echo $sNO; ?></td>
  </tr>
	  ...
	  <tr>	<?php if($rowHeader['intStatus']==0){
            ...
            <td>&nbsp;</td>
            <td class='normalfnt' align="left" style="width:100px;"><b>Machine Code <div style="float:right">:</div></b>            </td>
...
<!--            <td width="1%"></td>-->
          ...
          <tr  height="20">
            <td class='bcgl1txt1NB' align="left" width="17%" style="font-size:12px;">No of PCs</td>
           <!-- <td>:</td>-->
            <td class="normalfnt" style="font-size:12px;">&nbsp;<?php echo $rowHeader['dblQty']; ?></td>
          ...
          <tr  height="20">
            <td class='bcgl1txt1NB' align="left" width="17%" style="font-size:12px;"><span class="bcgl1txt1NB" style="font-size:12px;">Wash Type</span></td>
           <!-- <td>:</td>-->
            <td class="normalfnt" style="font-size:12px;" colspan="3">&nbsp;<?php echo $rowHeader['intWashType']; ?></td>
      ...
      <tr>
      	<td colspan="3" width="100%">
            ...
            <tr <?php if($pid==1){ ?>style="border-top:#000 solid 1px;" <?php }?>>
                ...
                <td class="normalfntRite" valign="top"><font  style='font-size: 13px;' ><?php if($pid==1){ echo number_format($rowP['dblLiqour']);}?>&nbsp;</font></td>
                <td class="normalfntRite" valign="top"><font  style='font-size: 13px;' ><?php if($pid==1){echo number_format($rowP['dblTemp']);}?></font>&nbsp;</td>
			...
			<tr <?php if($pid==1){ ?>style="border-top:#000 solid 1px;" <?php }?>> 
					...
					<td class='normalfntRite' valign="top"><font  style='font-size: 13px;' ><?php echo number_format($rowP['dblLiqour']);?>&nbsp;</font></td>
					<td class='normalfntRite' valign="top"><font  style='font-size: 13px;' ><?php if($rowP['dblTemp']==0){ echo "COOL";}else{ echo number_format($rowP['dblTemp']);}?>&nbsp;</font></td>
