...
<table width="800" border='1' align='center' CELLPADDING=3 CELLSPACING=1>
 ...
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Machine Name</font></td>
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Machine Type</font></td>
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Active</font></td>
  </tr>
	   <?php

		$SQL="SELECT was_machine.strMachineName,was_machinetype.strMachineType,was_machine.intStatus FROM was_machine 
		      INNER JOIN was_machinetype ON was_machine.intMachineType=was_machinetype.intMachineId
		where was_machine.intStatus AND was_machinetype.intStatus !='10' order by was_machine.strMachineName";
		...
		$strMachineType = $row["strMachineType"];
	...
	echo "<tr>";
	  ...
	  echo"<td class='normalfnt'>$strMachineType</td>";
