...
<title>GaPro | Out Side Company Details</title>
...
<div class="main_bottom">
	<div class="main_top">
		<div class="main_text">Out Side Company Details<span class="vol">(Ver 0.3)</span><span id="company_Details_popup_close_button"></span></div>
	</div>
<div class="main_body">
<table width="100%" border="0" align="center" bgcolor="#FFFFFF">
<!--  <tr>
            ...
            <td height="47" ><table width="100%" border="0" class="bcgl1">
			  <tr>
                ...
                <td colspan="3">
					...
					<?php
						$SQL="select intCompanyID,strName from was_outside_companies where intStatus <> 10 order by strName";
	...
	echo "<option value=\"". $row["intConID"] ."\" selected=\""."selected"."\">" . cdata($row["strCountry"]) ."</option>" ;
		...
		echo "<option value=\"". $row["intConID"] ."\">" . cdata($row["strCountry"]) ."</option>" ;
              ...
              <tr>
                ...
                <td><input name="txtBOINo" type="text" class="txtbox" id="txtBOINo" style="width:157px" maxlength="30" tabindex="16"/></td>
              </tr>
              <tr>
                <td class="normalfnt">TQB No </td>
                <td><input name="txtTqbNo" type="text" class="txtbox" id="txtTqbNo" style="width:140px" tabindex="17" maxlength="30"/></td>
                <td class="normalfnt">&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td class="normalfnt">Fac. Cost Per Min</td>
                <td><input name="txtFactroyCostPerMin" type="text" class="txtbox" id="txtFactroyCostPerMin" onkeypress="return CheckforValidDecimal(this.value, 4,event);" style="width:140px;text-align:right" maxlength="10" tabindex="18"/></td>
                <td colspan="2" class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="52%">Default Invoice to </td>
                      <td width="48%"><select onchange="checkDefaultInvoiceStatus(this)" name="cboDefaultInvoiceTo" class="txtbox" id="cboDefaultInvoiceTo" style="width:72px" tabindex="19">
              ...
              <tr>
                ...
                <td><input name="txtAccountNo" type="text" class="txtbox" id="txtAccountNo" style="width:140px" maxlength="10" tabindex="20"/></td>
                <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              <tr>
                ...
                <td><input type="checkbox" name="chkActive" id="chkActive" checked="checked" tabindex="22"/></td>
                <td class="normalfnt">&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
            </table></td>
            ...
            <td height="34"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
              <tr>
                <td width="100%" bgcolor=""><table width="50" border="0" align="center">
                    <tr>
                      <td width="20%"><img src="../../../images/new.png" alt="New" name="New" width="96" height="25" onclick="ClearCompanyForm();" class="mouseover" id="butNew" tabindex="26"/></td>
                      <td width="19%"><img src="../../../images/save.png" alt="Save" name="Save"width="84" height="25" onclick="butCommand1(this.name);" class="mouseover" id="butSave" tabindex="22"/></td>
                      <td width="22%"><img src="../../../images/delete.png" alt="Delete" name="Delete" width="100" height="25" onclick="ConfirmDeleteCompany(this.name);" class="mouseover" id="butDelete" tabindex="23"/></td>
					  					          <td width="12%" class="normalfnt"><img src="../../../images/report.png" alt="Report" width="108" height="25" border="0" class="mouseover" onclick="listORDetails();" id="butReport" tabindex="24" /></td>
                      <td width="17%"><a href="../../../main.php"><img src="../../../images/close.png" alt="Close" name="Close" width="97" height="25" border="0"  class="mouseover" id="butClose" tabindex="25"/></a></td>
                      </tr>
                </table></td>
              </tr>
            </table></td>
