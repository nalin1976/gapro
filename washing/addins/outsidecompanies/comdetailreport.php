...
<tr>
 <td height="10">
  ...
  <?php
		...
		$SQL="SELECT * FROM was_outside_companies where intCompanyID='$cbocompany' AND intStatus !='10'"; 
...
<tr>
 <td align="center" style="font-family: Arial;	font-size: 12pt;color: #000000;font-weight: bold;"><table style="width:900px;" border='0' align='center' cellpadding="3" cellspacing="0"  >
   <thead>
   <tr>
     <td colspan="2" align="center" class='border-Left-Top-right-fntsize12'><div class="normalfnt2bldBLACKmid">Out Side Company Detail Report</div></td>
     </tr></thead>
   <tr>
