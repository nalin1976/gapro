...
<title>GaPro | Chemical Requisition</title>
...
<script type="text/javascript" src="chemicalrequisition.js"></script>
...
<tr>
	<td class="mainHeading">Chemical Requisition</td>
</tr>
<tr>
    <td>
		<div  id="tabs" style="background-color:#FFFFFF">
		<ul>
			<li><a href="#tabs-1" class="normalfnt">Chemical Requisition Details </a></li>
			<li><a href="#tabs-2" class="normalfnt"  onclick="LoadList();">Chemical Requisition List </a></li>
		</ul>
				<div id="tabs-1">
              <form id="frmChemRequisitionMain" action="" name="frmChemRequisitionMain" method="post">
					<table width="100%" border="0">
						...
						<tr >
							<td width="11%" class="normalfnt" >Cost No </td>
					  	  <td width="19%" class="normalfnt" id="orderId" title=""><select name="txtCostNo" class="txtbox" style="width:152px;" id="txtCostNo" onchange="LoadCostDetails(this);" tabindex="1" />
						                                <?php 
							$sql="select concat(intYear,'/',intSerialNo)as costNo from was_actualcostheader where intStatus=1 order by intYear,intSerialNo DESC";
							$result =$db->RunQuery($sql); 
							echo "<option value=\"". "" ."\">" . "" ."</option>" ;
							while($row=mysql_fetch_array($result))
							{
								echo "<option value=\"". $row["costNo"] ."\">" . $row["costNo"] ."</option>" ;
							}
						?>
						 </select>						</td>
							<td width="18%" class="normalfnt">MRN No </td>
					      <td width="19%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtMrnNo" disabled="disabled" tabindex="2" /></td>
						  <td width="12%" class="normalfnt">Date </td>
						  <td width="21%" class="normalfnt"><input name="text" type="text" class="txtbox" id="text" style="width:150px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');" value="<?php echo date("d/m/Y");?>" tabindex="3" /><input type="text"  class="txtbox" style="visibility:hidden;width:2px"   onclick="return showCalendar(this.id, '%d/%m/%Y');"  /></td>
						</tr>
						<tr>
						...
						<tr>
						    ...
						    <td class="normalfnt"><input name="txtQty" type="text" class="txtbox" id="txtQty" style="width:150px;text-align:right" disabled="disabled" tabindex="9" /></td>
						</tr>
						<tr>
							<td width="11%" class="normalfnt">Wash Qty</td>
					  	  <td width="19%" class="normalfnt"><input name="txtWashQty" type="text" class="txtbox" id="txtWashQty" style="width:150px;text-align:right" tabindex="10" onkeypress="return IsNumberWithoutDecimals(this,event)" onkeyup="ValidateWithOrderQty(this);" maxlength="10"/></td>
...
<table style="width:100%"  border="0" cellspacing="1" bgcolor="#C58B8B" class="bcgcolor" >						
							...
							<thead>
								<tr  class="mainHeading4">
								  ...
								  <th width="34%">Item Description</th>
									<th width="9%">Unit</th>
									<th width="8%">Qty No Of PCS</th>
									<th width="8%">Req Qty </th>
								    <th width="7%">Bal To MRN Qty </th>
								    <th width="7%">MRN Raised </th>
								    <th width="7%">Issued Qty </th>
								    <th width="9%">Issue Balance</th>
				...
				<div id="tabs-2">
					...
					<table style="width:100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCFF" id="tblList" >
						<thead>	
							<tr class="mainHeading4">
								<th width="159" height="25">MRN No </th>
								<th width="148">Cost No </th>
								<th width="262">Date</th>	
								<th width="368">Requested By </th>	
							</tr>		
						</thead>
					</table>
					</div>
