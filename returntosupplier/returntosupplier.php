...
<title>Style Items :: Return To Suppliers</title>
<script type="text/javascript" src="returntosupplier.js"></script>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="bcgl1">
  <tr>
    <td height="26" class="mainHeading">Style Items - Return To Suppliers</td>
  </tr>
  <tr>
    <td><table width="100%" border="0">
      <tr>
        <td valign="top"><table width="100%" border="0" class="bcgl1">
            ...
            <td width="24%" class="normalfnt"><select name="cboStyles" class="txtbox" id="cboStyles" style="width:200px" onchange="getStylewiseOrderNoNew('ReturnToSupGetStylewiseOrderNo',this.value,'cboStyleID');getScNo('ReturnToSupgetStyleWiseSCNum','cboSCNO');">-->
<?php
...
?>
            <!--</select></td>-->
              ...
              <td width="24%"><select name="cboStyleID" class="txtbox" id="cboStyleID" style="width:200px" onchange="getSC('cboSCNO','cboStyleID');getStyleNoFromSC('cboSCNO','cboStyleID');LoadBuyerPoNo();LoadSupplier();" >
<?PHP		
	/*$SQL="SELECT DISTINCT SP.intSRNO,SP.intStyleId,O.strOrderNo,Sum(ST.dblQty) AS qty ".
		 "FROM stocktransactions AS ST INNER JOIN ".
		 "specification AS SP ON ST.intStyleId=SP.intStyleId ".
		 "inner join orders O on O.intStyleId=ST.intStyleId ".
		 "Inner Join mainstores AS MS ON MS.strMainID = ST.strMainStoresID ".
		 "WHERE MS.intCompanyId ='$companyId' ".
		 "GROUP BY SP.intStyleId order by O.strStyle";*/
...
?>
              ...
              <td width="9%" class="normalfnt">Sc No</td>
              <td width="25%">
                <select name="cboSCNO" class="txtbox" id="cboSCNO" style="width:200px" onchange="getStyleNoFromSC('cboSCNO','cboStyleID');LoadBuyerPoNo(); loadStyleName();LoadSupplier();" >
<?PHP		
...
?>
              ...
              <td width="0%" ><span class="normalfnt">Buyer PO No</span></td>
<td width="0%"><select name="cboBuyerPoNo" class="txtbox" id="cboBuyerPoNo" style="width:200px" onchange="LoadSupplier()" >
  ...
  ";
            ...
            <tr>
              ...
              <td width="24%"><input  type="text" name="txtReturnNo" class="txtbox" id="txtReturnNo" style="width:80px" readonly="" />
...
<td >&nbsp;</td>
            ...
            <tr>
			 <td class="normalfnt">Supplier</td>
              <td width="24%"><select name="cboSupplier" class="txtbox" id="cboSupplier" style="width:200px" >
                <?PHP		
	$SQL="select strSupplierID, ".
		 "strTitle ".
		 "from suppliers ".
...
?>
 ...
 <td >
                <select name="cboMainStores" class="txtbox" id="cboMainStores" style="width:200px" onchange="LoadSubStores();ValidatePopUpItems();">
<?php
...
?>
			...
			<tr>
              ...
              <td ><select name="cboSubStores" class="txtbox" id="cboSubStores" style="width:200px">
              </select></td>
             
			   <td class="normalfnt">Remarks</td>
              <td colspan="0"><input name="txtRemarks" type="text" class="txtbox" id="txtRemarks"  maxlength="100" style="text-transform:capitalize;width:200px;"/></td>
			  <td></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainHeading2">
          <tr>
            ...
            <td width="11%" ><img src="../images/add-new.png" width="109" id="cmdAddNew" height="18" onclick="ValidatePopUpItems();" /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><div id="divMain" style="overflow:scroll; height:300px; width:950px;">
          <table id="tblMain"width="940" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF">
            <tr class="mainHeading4">
              ...
              <td width="9%" >BuyerPONo</td>
              <td width="8%" >Color</td>
              <td width="7%" >Size</td>
              <td width="5%" >Unit</td>
              <td width="7%" >Stock</td>
              <td width="7%" >GRN </td>
			   <td width="6%" >Return Qty</td>
              <td width="8%" >Bin</td>
              </tr>
<!--          /*  <tr>
              <td class="normalfnt"><img src="../images/del.png" alt="del" width="15" height="15"/></td>
             <td class="normalfntSM">NA</td>
              ...
              <td class="normalfntRiteSML">0.20</td>
			  <td class="normalfntRiteSML">0.20</td>
              <td class="normalfntRiteSML"><input type="text" name="txtIssueQty" id="txtIssueQty" class="txtbox" size="8" style="text-align:right" onkeypress="return isNumberKey(event);" value="0" /></td>              
              <td class="normalfntMidSML"><img src="../images/location.png" alt="add" width="70" height="15" /></td>
              </tr>*/-->
          </table>
        </div></td>
      </tr>
  ...
  <tr >
    <td height="30" ><table width="100%" border="0" class="bcgl1" align="center">
      <tr>	
         <td width="100%" align="center"><a href="returntosupplier.php"><img src="../images/new.png" alt="new" border="0" id="cmdNew" width="96" height="24" /></a>
        <img src="../images/save-confirm.png" alt="Save" name="cmdSave" width="174" height="24" id="cmdSave" onclick="SaveValidation();" /><!--<img src="../images/cancel.jpg" alt="cancel" id="cmdCancel" name="cmdCancel" width="104" height="24" onclick="CancelValidation();" />--><img src="../images/report.png" alt="Report" border="0" width="108" height="24" onclick="ViewReport();" /><a href="../main.php"><img src="../images/close.png" alt="close" width="97" height="24" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table>
