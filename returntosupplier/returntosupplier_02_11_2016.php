...
?>
            <!--</select></td>-->
              ...
              <td width="24%"><select name="cboStyleID" class="txtbox" id="cboStyleID" style="width:200px" onchange="getSC('cboSCNO','cboStyleID');getStyleNoFromSC('cboSCNO','cboStyleID');LoadBuyerPoNo();" >
<?PHP		
...
?>
              ...
              <td width="25%">
                <select name="cboSCNO" class="txtbox" id="cboSCNO" style="width:200px" onchange="getStyleNoFromSC('cboSCNO','cboStyleID');LoadBuyerPoNo(); loadStyleName();" >
<?PHP		
...
<td width="0%"><select name="cboBuyerPoNo" class="txtbox" id="cboBuyerPoNo" style="width:200px" >
