...
<tr bgcolor="#FFFFFF">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="657" rowspan="2" id="companyName" style="color:#FF0000;text-decoration:blink;font-size:14px;text-align:center;font-family:Verdana, Arial, Helvetica, sans-serif" class="mouseover"><?php echo include "${backwardseperator}notificaton.php"?></td>
...
!</span></span></td>
	...
	<?php if ($addingMenu){?>
        ...
        <ul>
		<?php if($addStyleItems || $manageItemRequest || $manageItemRequestConfirmation || $materialDeletion || $canManageStyleSubCategories){?>
        ...
        <ul>
			...
			if($canManageStyleSubCategories)
			{
			?>	
...
<!--End - 28-02-2011 Account Addins   -->
		...
		<?php if ($preorderCosting) { ?>			
			...
			if($canValidatePOs)
				...
				<?php if($PP_AllowExcessPOSecondApproval) { ?>
			...
			?>
				...
				<ul>
					...
					<li><a class="style2" href="<?php echo $backwardseperator;?>invoiceCosting/Cost/invoiceCostList.php">Invoice Costing List</a></li>
					<?php }?>
				</ul>
				</li>
			<?php
			...
			<ul>
				...
				<?php if($manageWeeklyShipmentSchedule) { ?>
					<li><a class="style2" href="<?php echo $backwardseperator;?>finishing/schedule/week/weekShipSchedule.php">Weekly</a>
				<?php } ?>
			</ul></li>	
			<?php } ?>
...
?>
		...
		<li><a class="style2" href="#">Item Disposals</a>
		<ul>
			<li><a class="style2" href="<?php echo $backwardseperator;?>itemDispose_new/itemDispose.php">Details</a></li>
			<li><a class="style2" href="<?php echo $backwardseperator;?>itemDispose_new/itemDisposeListing.php">Listing</a></li>
		</ul>
		</li>
		<?php } ?>
...
<?php if($PP_allowItemWiseLeftOverForm) { ?>
	<li><a class="style2" href="<?php echo $backwardseperator;?>leftover_itemwise/frmItemWiseLeftOver.php?">Item Wise Left Over</a></li>
<?php } ?>
          </ul>
        </li>
		<?php
        ...
        <li><a href="#" class="style3">Payments</a>
		 ...
		 <?php
            ...
            <li><a class="style2"  href="#">Advance Payment</a>
              <ul>
                <li><a class="style2"  href="<?php echo $backwardseperator;?>Payments/AdvPaymentNew/advPayment.php">Advance Payments</a></li>
                <li><a class="style2"  href="<?php echo $backwardseperator;?>Payments/advancePayment/advancePaymentFinder.php">Payment Reports</a> </li>
				 <li><a class="style2"  href="<?php echo $backwardseperator;?>Payments/advance_payment_settlement.php">Payment Settlement</a> </li>
              </ul>
            </li>
			<?php
			}
...
<li><a class="style2" href="<?php echo $backwardseperator;?>washing/returnToFactory/retrunToFactory.php">Return To Factory</a></li>
<?php } ?>
...
<ul>
	<li><a class="style2" href="<?php echo $backwardseperator;?>workstudy/machines/machines.php">Machines</a></li>
	<li><a class="style2" href="<?php echo $backwardseperator;?>workstudy/operations/Operations.php">Operations</a></li>
	<li><a class="style2" href="<?php echo $backwardseperator;?>production/component/componenteditor.php">Components</a></li>
	...
	<li><a class="style2" href="<?php echo $backwardseperator;?>workstudy/opbdReport/opbdRpt1.php">peration Break Down Report</a></li>
...
<ul>
	...
	<?php if($PP_allowExportGatePass) { ?>
		<li><a href="<?php echo $backwardseperator;?>finishing/exportgatepass/exportgatepass.php" class="style2">Export GatePass</a></li>
	<?php } ?>
...
<li><a href="#" class="style3 MenuBarItemSubmenu">Sub Contract</a>
<ul>
	<li><a href="<?php echo $backwardseperator;?>SubContract/Details/SubContractNew.php" class="style2">Sub Contractor</a></li>
	
	<li><a href="#" class="style2">Advice Of Dispatch</a>
	<ul>
		<li><a href="<?php echo $backwardseperator;?>SubContract/AOD/AOD.php" class="style2">Advice Of Dispatch</a></li>
		<li><a href="<?php echo $backwardseperator;?>SubContract/aodListing/adviceOfDispatchListing.php" class="style2">Listing</a></li>
	</ul>
	</li>
	
	<li><a href="#" class="style2">Emblishment GRN</a>
	<ul>
		<li><a href="<?php echo $backwardseperator;?>SubContract/emblishment_grn/emblishmentGrn.php" class="style2">Emblishment GRN</a></li>
...
<ul>
<?php if($POGRNList) {?>
<li><a class="style2" href="<?php echo $backwardseperator;?>Reports/pogrnlist/style/POGrnList.php">Style</a></li>
<?php } ?>
...
{
?>
<li><a class="style2" href="<?php echo $backwardseperator;?>costestimatesheet/costestimate.php">Post Order Costing</a></li>
<?php
}
...
<?php if($manageInvoiceCostingList){?>
	<li><a class="style2" href="<?php echo $backwardseperator;?>invoiceCosting/Cost/invoiceCostList.php">Invoice Costing</a></li>
<?php }?>
...
<?php if($PP_AllowProduction){?>
	<li><a class="style2" href="<?php echo $backwardseperator;?>Reports/production/gatepassdiscrepancy/orderbooklist.php">Production</a></li>
<?php }?>
</ul>
</li>
