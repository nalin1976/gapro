...
<?php
	...
	if($checkDate==1)
		$sql .= "AND date(dtmDate) >='$dateFrom' and date(dtmDate) <='$dateTo' ";
		//echo $sql;
	/*if($invoNoFrom!="")
...
while($row = mysql_fetch_array($result))
{
	...
	$cdnDateArr=explode(" ",$row["dtmDate"]);
	$cdnSailDateArr = explode(" ",$row['dtmSailingDate']);
...
?>
	    <tr bgcolor="#FFFFFF" class="normalfnt">
    	<td  height="20" colspan="8"><b>Total</b></td>
