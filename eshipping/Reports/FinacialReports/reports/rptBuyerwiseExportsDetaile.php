...
if($checkDate==1)
	...
	if($checkDate==1)
		 $sql1 .= "and date(CIH.dtmInvoiceDate) >='$dateFrom' and date(CIH.dtmInvoiceDate) <='$dateTo' ";
...
<?php
	...
	$totNetAmount		+= round($row["netAmount"]-$discount,2);
		...
		$fulltotDisAmt+=$totDiscount;
		$fulltotNetAmt+=$totNetAmount;
	//echo $fulltotQuantity;
...
?>
    	    ...
    	    <tr bgcolor="#FFFFFF" class="normalfnt">
    	<td height="20" colspan="5">Grand Total</td>
        ...
        <td width="78" nowrap class="normalfntRite"><b><?php echo number_format($fulltotDisAmt,2);?></b></td> 
         <td width="78" nowrap class="normalfntRite"><b><?php echo number_format($fulltotNetAmt,2);?></b></td>       
	</tr>
