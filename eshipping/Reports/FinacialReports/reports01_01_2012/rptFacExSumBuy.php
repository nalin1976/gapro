...
<?php
	...
	if($locationId!="")
	 ...
	 if($checkDate==1)
	 $sql_factory .= " AND DATE(CIH.dtmInvoiceDate) >='$dateFrom' AND DATE(CIH.dtmInvoiceDate) <='$dateTo'";
	...
	while($row_fac=mysql_fetch_array($result_fac))
	{
			 ...
			 ORDER BY MB.strMainBuyerName,C.strMLocation";
				...
				{ 
					...
					?>
                        ...
                        <td class="normalfntRite"><b><?php echo number_format($grossAmt,2); ?></b></td>
	 ...
	 <tr bgcolor="#FFFFFF" class="normalfnt">
    	...
    	<td height="20">&nbsp;</td>
        <td height="20" class="normalfntRite"><b><?php echo number_format($totgrossAmt,2);?></b></td>
...
?>
    	...
    	<td height="20">&nbsp;</td>
        <td height="20" class="normalfntRite"><b><?php echo number_format($fulltotgrossAmt,2);?></b></td>
