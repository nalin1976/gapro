	...
	?> 
      <tr bgcolor="#FFFFFF" class="normalfnt">
		...
		if($row["intSerialNo"] !='')
		 ...
		 ?></td>
        <td class="normalfntRite"><?php echo $row['dtmReceiptDate']; ?></td>
        <td class="normalfntRite"><?php
		if($row["strRefNo"] !='')
				{
				echo "DIS".$row["strRefNo"];
		 		 ...
		 		 ?></td>
        <td class="normalfntRite"><?php echo $row['dtmDesDate']; ?></td>
      ...
      <tr bgcolor="#FFFFFF" class="normalfnt">
        ...
        <td class="normalfntRite"><b><?php echo number_format($totQuantity); ?></b></td>
        <td>&nbsp;</td>
        <td><span class="normalfntRite"><b><?php echo number_format($totGrossAmount,2); ?></b></span></td>
        <td><span class="normalfntRite"><b><?php echo number_format($totDiscount,2); ?></b></span></td>
        <td><span class="normalfntRite"><b><?php echo number_format($totNetAmount,2); ?></b></span></td>
