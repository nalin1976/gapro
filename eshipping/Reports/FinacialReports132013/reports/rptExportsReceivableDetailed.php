...
<?php
	$sql_buyer="SELECT buyers_main.strMainBuyerName
...
LEFT JOIN bankletter_header ON bankletter_detail.intSerialNo = bankletter_header.intSerialNo
				...
				WHERE commercial_invoice_header.strInvoiceNo 
					...
					AND buyers_main.strMainBuyerName='$buyer'
...
?>		 
    <tr bgcolor="#FFFFFF" class="normalfnt">
    	<td height="20"><?php if($mloc!=$row_buyer["strMainBuyerName"]){echo $row["strMainBuyerName"];}?></td>
        ...
        <?php
			...
			if($row['strDiscountType']=='value'){
					...
					$netReceivable+=$netAmt-$billDiscount;
...
$mloc=$row_buyer["strMainBuyerName"];
	 }
     ...
     ?>
        	 ...
        	 <tr bgcolor="#FFFFFF" class="normalfnt">
    	<td height="20" colspan="6"><b><?php echo $buyer; ?> Total</b></td>
        ...
        <td width="78" nowrap class="normalfntRite"><b><?php echo number_format($netReceivable,2);?></b></td>
        <td width="78" nowrap class="normalfntRite">&nbsp;</td>         
	</tr>
...
?>
        ...
        <td nowrap class="normalfntRite"><b><?php echo number_format($grandTotNetAmount,2);?></b></td>  
         <td nowrap class="normalfntRite"><b><?php echo number_format($grandTotbillDis,2);?></b></td>   
         <td nowrap class="normalfntRite"><b><?php echo number_format($grandTotNetAmount-$grandTotbillDis,2);?></b></td> 
         <td>&nbsp;</td>  
	</tr>
    </table></td>
  </tr>
