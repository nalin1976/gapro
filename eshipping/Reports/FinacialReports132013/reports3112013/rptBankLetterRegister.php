...
<table width="1000" border="0" cellspacing="0" cellpadding="2" align="center">
  ...
  <tr>
	...
	$bnkltNo=$intSerial_No;
		...
		<tr bgcolor="#FFFFFF" class="normalfnt">
    	<td height="20" colspan="6"><b><?php echo "BNK".$intSerial_No; ?> Total</b></td>
        ...
        <td width="78" nowrap class="normalfntRite"><b><?php echo number_format($totDiscount,2);?></b></td>  
...
?>
        ...
        <td nowrap class="normalfntRite"><b><?php echo number_format($fulltotDiscount,2);?></b></td> 
