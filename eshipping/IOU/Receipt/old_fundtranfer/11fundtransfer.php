...
<tr><td colspan="2"><table width="100%" cellpadding="0" cellspacing="0"><tr>
    <td height="25" bgcolor="#498CC2" align="center"><span class="TitleN2white">IOU Fund Transfer</span></td>
</tr>
     <tr>
...
<?php 
$strSerial="select dblFundTransferNo from syscontrol";
...
?>
    ...
    <tr>
        <td colspan="2"  height="14"><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt bcgl1">
          <tr>
      ...
      <tr>
        ...
        <tr>
          <td width="38%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt bcgl1" >
            <tr>
              <td width="44%" height="28"><dd>Wharf Clerk</td>
            ...
            <tr>
              <td  height="27"><dd>Name of Account</td>
           ...
           <td  width="2%"></td>
          <td width="60%" valign="top"><div id="divcons1"  style="overflow:scroll; height:140px; width:100%;" >
              <table width="100%" height="23" class="normalfnt " cellpadding="0" cellspacing="1"bgcolor="#ccccff" id="tblDetail">
                <tr bgcolor="#498CC2" >
                  ...
                  <td width="50%" height="20"  class="normaltxtmidb2">Name of Account</td>                  
                  <td width="20%"  class="normaltxtmidb2">Account Number</td>
                   <td width="20%" height="20"  class="normaltxtmidb2">Amount</td>
