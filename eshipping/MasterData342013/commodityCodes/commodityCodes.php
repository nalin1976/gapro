                ...
                <tr>
                  <td colspan="2" class="normalfnt"><table width="95%" border="0" bgcolor="#FFFFFF">
                    <tr>
                      ...
                      <td width="66%"><select name="cboCommodity" class="txtbox"  style="width:200px"  id="cboCommodity" onchange="setbydelivery(this.value)">
                        <?php
	
	$SQL = "SELECT strCommodityCode FROM commoditycodes GROUP BY strCommodityCode ORDER BY strCommodityCode";
	...
	?>
                    ...
                    <tr>
                      <td colspan="4" class="normalfnt"><table width="549" border="0" class="bcgl1">
                        <tr>
                          <td height="21" colspan="4" bgcolor="#D6E7F5" class="normalfntMid">Commodity Code Details </td>
                        </tr>
                        <tr>
                          <td width="134" class="normalfnt">Commodity Code </td>
                          <td width="208"><input name="txtCommodity" type="text" class="txtbox" id="txtCommodity" style="width:200px"  maxlength="20"  onkeypress="return CheckforValidDecimal(this.value, 4,event);"/></td>
                          <td colspan="2">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td width="59">Unit</td>
                          <td width="128"><select name="cboUnit" class="txtbox"   style="width:100px" id="cboUnit">
                            <?php
