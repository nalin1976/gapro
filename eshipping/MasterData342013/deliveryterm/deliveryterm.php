            ...
            <td height="34"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
              <tr>
                <td width="100%" bgcolor="#d6e7f5"><table width="100%" border="0">
                    <tr>
                      <td width="11%">&nbsp;</td>
                      <td width="20%"><img src="../../images/new.png" class="mouseover" alt="New" name="New" width="96" height="24" onclick="ClearForm();"/></td>
                      <td width="19%"><img src="../../images/save.png" class="mouseover" alt="Save" name="Save" width="84" height="24" onclick="SaveData();"/></td>
                      <td width="22%"><img src="../../images/delete.png" class="mouseover" alt="Delete" name="Delete" width="100" height="24" onclick="deleteData();"/></td>
