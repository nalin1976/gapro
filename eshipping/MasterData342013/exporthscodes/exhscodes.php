...
<table width="950" border="0" align="center" bgcolor="#FFFFFF">
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="60%"><table width="97%" border="0" cellspacing="0" >
          <tr>
            <td width="65%" height="30" bgcolor="#498CC2" class="TitleN2white"><div align="right">Commodity Codes </div>              <div align="left"></div></td>
                ...
                <tr>
                  <td colspan="2" class="normalfnt"><table width="95%" border="0" bgcolor="#FFFFFF">
                    <tr>
                      ...
                      <td width="23%">Search</td>
                      <td width="66%"><select name="cboComodity" class="txtbox"  style="width:200px"  id="cboComodity" onchange="setbydelivery(this.value)">
                        <?php
	
	$SQL = "SELECT strCommodityCode FROM excommoditycodes GROUP BY strCommodityCode ORDER BY strCommodityCode";
	...
	?>
                    ...
                    <tr>
                      <td colspan="4" class="normalfnt"><table width="549" border="0" class="bcgl1">
                        <tr>
                          <td height="21" colspan="3" bgcolor="#D6E7F5" class="normalfntMid">Commodity Code Details </td>
                        </tr>
                        <tr>
                          <td width="136" class="normalfnt">Commodity Code </td>
                          <td><input name="txtCommodity" type="text" class="txtbox" id="txtCommodity" style="width:200px"  maxlength="50"/></td>
                          <td width="151">&nbsp;</td>
                        </tr>
                        <tr>
                          <td class="normalfnt">Fabric</td>
                          <td><input name="txtFabric" type="text" class="txtbox" id="txtFabric" style="width:200px" maxlength="50"/></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td class="normalfnt">Description</td>
                          <td><input name="txtDescription" type="text" class="txtbox" id="txtDescription" style="width:200px" maxlength="50"/></td>
                          <td>&nbsp;</td>
                        </tr>
						<tr>
                          <td class="normalfnt">Category No</td>
                          <td>
						  <select style="width:200px" id="cboCatNo" name="cboCatNo" class="txtbox">
						  <option value="0"></option>
						  <?php
						  	$sql="SELECT DISTINCT strCatNo FROM quotacat
								  ORDER BY strCatNo";
							$result=$db->RunQuery($sql);
							while($row=mysql_fetch_array($result))
							{
						  ?>
						  <option value="<?php echo $row['strCatNo']; ?>"><?php echo $row['strCatNo']; ?></option>
						  <?php
						  	}
						  ?>
						  </select>&nbsp;<img src="../../images/add.png" onclick="showCatPopUp();" class="mouseover" /></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td class="normalfnt">Remarks</td>
                          <td><input name="txtRemarks" type="text" class="txtbox" id="txtRemarks" style="width:200px" maxlength="50"/></td>
                          <td>&nbsp;</td>
                        </tr>
                      </table></td>
                    </tr>
  ...
  <td    class="normaltxtmidb2"></td>
												...
												<td><table><tr><td height="30"><img src="../../images/uw.png" alt="up" width="19" height="18"  class="mouseover" onclick="moveup();"/>
												</td></tr>
												<tr><td  height="30">
												<img src="../../images/dw.png" alt="down" width="19" height="18"  class="mouseover" onclick="movedown();"  />
												</td></tr></table>												</td>                                    
                                    </tr></table></td>
                            </tr>
                                              </table></td>
              ...
              <tr>
                <td width="100%" bgcolor="#d6e7f5"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="98" rowspan="2"><img src="../../images/new.png" width="84" height="24" name="New"onclick="frmReload();" class="mouseover" id="check" alt="new"/></td>
                      <td width="87" rowspan="2"><img src="../../images/save.png" alt="Save" width="84" height="24" name="Save"  class="mouseover" onclick="savedata()"lass="mouseover" /></td>
                      <td width="85" rowspan="2"><img src="../../images/delete.png" alt="Delete" width="84" height="24"  class="mouseover" name="Delete"onclick="deletedata();" lass="mouseover" "/></td>
                      ...
                      <td width="43" rowspan="2"><img src="../../images/Tax.png" alt="tax" width="43" height="34"  class="mouseover" onclick="selecttax();" /></td>
...
<td colspan="8">
	...
	<tr  >
	 ...
	 <td colspan="4">
	   ...
	   <div align="left">
	     <select name="txtBase" class="txtbox"  style="width:90px"  id="txtBase" >
	       <option value=""></option>
...
<tr><td >&nbsp;</td><td  align="left" class="normalfnt"><input type="checkbox" name="CESS" value="Vat" id="CESS" />
&nbsp;CESS</td>
  <td  align="left"  class="normalfnt">&nbsp;&nbsp;<input type="checkbox" name="course" value="Vat" id="EIC"/>&nbsp;EIC</td><tr>
...
<tr><td >&nbsp;</td><td  align="left" class="normalfnt"><input type="checkbox" name="course" value="Vat" id="PAL"/>&nbsp;PAL</td><td  align="left"  class="normalfnt">&nbsp;&nbsp;<input type="checkbox" name="course" value="Vat" id="SLR"/>&nbsp;SLR</td><tr>
<tr><td >&nbsp;</td><td  align="left" class="normalfnt"><input type="checkbox" name="course" value="Vat" id="SUR"/>&nbsp;SUR</td><td  align="left"  class="normalfnt">&nbsp;&nbsp;<input type="checkbox" name="CID" value="Vat"id="CID"/>
&nbsp;CID</td>
<tr>
<tr><td >&nbsp;</td><td  align="left" class="normalfnt"><input type="checkbox" name="course" value="Vat" id="VAT"/>&nbsp;VAT</td><td>&nbsp</td></tr>
