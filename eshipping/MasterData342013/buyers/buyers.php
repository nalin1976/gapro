...
<table width="950" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0">
          <tr>
            <td height="30" bgcolor="#588DE7" class="TitleN2white">Consignee</td>
          </tr>
          <tr bgcolor="#D8E3FA">
            <td height="96">
	...
	?>
                    ...
                    <tr>
                      <td class="normalfnt">&nbsp;</td>
                      <td class="normalfnt">Main Buyer (Not for Packing Users)</td>
                      <td colspan="3"><select name="cboMainBuyer" class="txtbox" style="width:320px" id="cboMainBuyer">
                        <?php
	...
	?>
                    ...
                    <tr>
                      ...
                      <td colspan="3"><input name="txtBuyerID" type="text" autocompletetype="Disabled" autocomplete="off" class="txtbox" id="txtBuyerID"  size="50" maxlength="50"></td>
                    </tr>
                    <tr>
                      <td width="2%" class="normalfnt">&nbsp;</td>
                      <td width="23%" class="normalfnt">Name <span id="txtHint" style="color:#FF0000">*</span></td>
                    ...
                    <tr>
                      ...
                      <td width="24%"><input name="txtPhone" type="text" class="txtbox" id="txtPhone" style="width:129px" maxlength="40" /></td>
                      <td width="8%" >Fax</td>
                      <td width="43%" ><input name="txtFax" type="text" class="txtbox" id="txtFax" style="width:129px" maxlength="40" /></td>
                      </tr>
                    <tr>
                      <td class="normalfnt">&nbsp;</td>
