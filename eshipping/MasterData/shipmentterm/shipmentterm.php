		...
		<tr>
			<td>
			  <table width="500" border="0" class="bcgl1" align="center">
			    <tr>
			      <td height="30" bgcolor="#588DE7" class="TitleN2white" align="center">Shipment Term</td>
			      </tr>
			    <tr bgcolor="#FFFFFF">
			      <td ><table width="100%" border="0" cellpadding="2" cellspacing="10">
			          ...
			          <tr>
			            <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="2" class="bcgl1">
			              ...
			              <tr>
			                <td class="normalfnt">&nbsp;</td>
			                <td class="normalfnt">&nbsp;Shipment Term &nbsp;<span class="compulsory">*</span> </td>
			                <td width="44%" class="normalfnt">
							<input name="txtShipmentTerms" id="txtShipmentTerms" style="width:130px" class="txtbox" type="text" maxlength="50" />
			                  </td>
			                <td width="15%" class="normalfnt">&nbsp;</td>
			                </tr>
			              <tr>
			                <td width="9%" class="normalfnt">&nbsp;</td>
			                <td width="32%" class="normalfnt">&nbsp;Remarks &nbsp;</td>
			                <td class="normalfnt"><input name="txtRemarks" id="txtRemarks" style="width:130px" class="txtbox" type="text" maxlength="100" /></td>
			                <td class="normalfnt">&nbsp;</td>
			                </tr>
			        ...
			        <tr>
			          ...
			          <tr>
			            <td align="center"><div id="divcons" style="overflow:scroll; height:130px; width:600px;">
                                  <table width="100%" cellpadding="0" cellspacing="1" class='normalfnt'  id="tbl_shipmentTerm">
                                    <tr>
                                    ...
                                    <td width="29%" bgcolor="#498CC2" class="normaltxtmidb2" >Shipment Term </td>
									<td width="35%" bgcolor="#498CC2" class="normaltxtmidb2" >Remarks</td>  
									  
								    </tr>
									
									<?php
										$SQL="SELECT intShipmentTermId,strShipmentTerm,strRemarks	FROM shipmentterms WHERE intStatus=1;";
										$result = $db->RunQuery($SQL);
										$i=1;
										while($row = mysql_fetch_array($result))
									{
										$id=$row['intShipmentTermId'];
										$term=$row['strShipmentTerm'];
										$desc=$row['strRemarks'];
									?>
									<tr>
										...
										<td class="normalfntMid"><?php echo $row['intShipmentTermId']; ?></td>
										<td class="normalfntMid"><?php echo $row['strShipmentTerm']; ?>
										</td>
										<td class="normalfntMid"><?php echo $row['strRemarks']; ?>
										</td>
									</tr>
									<?php
									 $i++;   									
