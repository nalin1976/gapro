      ...
      <tr>
        ...
        <td width="48%"><form id="frmmaterial4" name="frmmaterial4" method="post" action="">
          <table width="100%" border="0">
            <tr>
              <td height="16" colspan="3" bgcolor="#498CC2" class="TitleN2white">Countries</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="38%"><select name="cboCountryList" class="txtbox" id="cboCountryList" style="width:160px" tabindex="4" onchange="getCountryDetails();">
 ...
 <?php
	...
	?>
            ...
            <tr>
              ...
              <td width="38%"><input name="txtCountryCode" type="text" class="txtbox" style="width:160px" id="txtCountryCode" size="25" onclick="checkvalue();"/></td>
              <td width="39%">&nbsp;</td>
            </tr>
            <tr>
              <td height="-1" class="normalfnt">Country Name</td>
              <td width="38%"><input name="txtCountry" type="text" class="txtbox" style="width:160px" id="txtCountry" size="25" /></td>
              <td width="39%">&nbsp;</td>
            </tr>
            <tr>
              <td height="3">&nbsp;</td>
