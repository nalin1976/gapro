...
//{
			...
			url=url+"?q="+strCommand;
				...
				{ 
					...
					url=url+"&strReference="+document.getElementById("txtReference").value;		
...
function ShowCountryDetails()
	{
		if(xmlHttp.readyState == 4) 
		{
			...
			{	
				...
				var XMLLoad = xmlHttp.responseXML.getElementsByTagName("Reference");
				document.getElementById('txtReference').value = XMLLoad[0].childNodes[0].nodeValue;	
