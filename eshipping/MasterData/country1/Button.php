<?php
    ...
    if($strButton=="New")
	{
	  ...
	  $strCountryCode=$_GET["strCountryCode"];
	  $strReference=$_GET["strReference"];
			...
			{$strCountryCode=$row_check["strCountryCode"];
			  ...
			  {
			  		$SQL_Update="UPDATE country SET strCountryCode='".$strCountryCode."',strCountry='".$strCountry."',intStatus=1,strReference='$strReference' where strCountryCode='".$strCountryCode."';"; 
		...
		echo "Saved SuccessFully";
		  ...
		  {
		  $SQL="insert into country (strCountryCode,strCountry,strReference) values ('".$strCountryCode."','".$strCountry."','$strReference')";
	...
	{
		$SQL_Update="UPDATE country SET strCountry='".$strCountry."',intStatus=1,strReference='$strReference' where strCountryCode='".$strCountryCode."';"; 
