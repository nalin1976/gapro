...
{ 
	if(xmlHttp[0].readyState == 4) 
    {
        ...
        {  
				...
				var regionId = xmlHttp[0].responseXML.getElementsByTagName("RegionId")[0].childNodes[0].nodeValue; 
				document.getElementById("cboRegion").value = regionId 
        }
    }
}
...
function doInsert(req)
{
		...
		var regionId=	document.getElementById("cboRegion").value;
		createNewXMLHttpRequest(0);
