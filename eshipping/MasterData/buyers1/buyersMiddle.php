...
{ 
	...
	$sql="SELECT strBuyerId,strBuyerCode, strName, strAddress1, strAddress2,strAddress3, strCountry, strPhone, strEMail, strFax,strRemarks,strTINNo,strContactPerson,intBuyerRegionId FROM buyers 
	...
	{ 
		...
		$XMLString .= "<RegionId><![CDATA[" . $row["intBuyerRegionId"]  . "]]></RegionId>\n";
