...
{		
	...
	$result = $db->RunQuery($sql);
		if ($result)
		{
		$sql_ms = "INSERT INTO buyers (strBuyerCode,strName,strAddress1, strAddress2,strAddress3, strCountry, strPhone, strFax, strEMail, strRemarks, strTINNo,strContactPerson)
