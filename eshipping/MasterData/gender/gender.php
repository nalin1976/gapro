      ...
      <tr>
        ...
        <td width="48%"><form id="frmmaterial4" name="frmmaterial4" method="post" action="">
          <table width="100%" border="0">
            <tr>
              <td height="16" colspan="3" bgcolor="#498CC2" class="TitleN2white">Gender</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="38%"><select name="cboGenderList" class="txtbox" id="cboGenderList" style="width:162px" tabindex="4" onchange="getCountryDetails();">
   
 <?php
	
	$SQL = "SELECT strGender,intId FROM gender WHERE intStatus=1";
	
	$result = $db->RunQuery($SQL);
	echo "<option value=\"". "" ."\">" . "" ."</option>" ;
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"". $row["intId"] ."\">" . $row["strGender"] ."</option>" ;
	}
	...
	?>
            ...
            <tr>
              <td height="0" class="normalfnt">Gender</td>
              <td width="38%"><input name="txtGenderCode" maxlength="30" type="text" class="txtbox" style="width:160px" id="txtGenderCode" size="25" onclick="checkvalue();"/></td>
              <td width="39%">&nbsp;</td>
            </tr>
