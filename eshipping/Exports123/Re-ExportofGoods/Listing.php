                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:230px; width:750px;">
                                  <table width="700" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="9%" height="14" bgcolor="#498CC2" class="normaltxtmidb2">&nbsp;</td>
									  <td width="13%" height="14" bgcolor="#498CC2" class="normaltxtmidb2">HS Code </td>
									  <td width="35%" height="14" bgcolor="#498CC2" class="normaltxtmidb2">Item </td>
									  <td width="14%" bgcolor="#498CC2" class="normaltxtmidb2">Entry No </td>
									  <td width="12%" bgcolor="#498CC2" class="normaltxtmidb2">Date</td>
									  <td width="17%" height="14" bgcolor="#498CC2" class="normaltxtmidb2">Qty</td>
									  <!--          </tr>
