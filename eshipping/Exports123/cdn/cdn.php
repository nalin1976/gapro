                    ...
                    <tr>
                      <td class="normalfnt"><table width="100%" border="0" cellpadding="1" cellspacing="1" class="bcgl1"><tr><td><table width="100%" border="0" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                          ...
                          <td nowrap="nowrap"><input name="txtCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtCDNInvNo" size="25" style="width:70px" onkeyup="changeCDNInvCombo(this,event);"/>&nbsp;<select name="cboCDNNo"  class="txtbox" id="cboCDNNo" style="width:150px" onchange="loadHeaderData(this.value);">
                              <option value=''></option>
                              <?php
              ...
              <tr bgcolor="#d6e7f5">
                <td width="100%"><table width="100%" border="0" cellspacing="0">
                    <tr bgcolor="#d6e7f5">
                      ...
                      <img src="../../images/do_copy.png" onclick="popAddCtn();" /></td>
                      </tr>
                </table></td>
              </tr>
            </table></td>
		  ...
		  <td colspan="6" ><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
		    ...
		    <tr>
              ...
              <tr>
                ...
                <td>CBM</td>
                <td><input name="txtCBM" tabindex="23" type="text" class="txtbox" id="txtCBM" onkeypress="return CheckforValidDecimal(this.value, 4,event);" size="15" maxlength="30" /></td>
		    ...
		    <tr>
		      <td height="25">Qty</td>
		      <td nowrap="nowrap"><input name="txtQty"  class="txtbox" id="txtQty" tabindex="7" onkeypress="return CheckforValidDecimal(this.value, 4,event);" style="width:100px;" maxlength="15" onblur="getItemVal();"/>
