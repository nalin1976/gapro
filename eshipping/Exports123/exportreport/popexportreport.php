...
function showDate()
{
	if(document.getElementById("checkbox1").checked==1)
	{
		...
		document.getElementById("txtInvoiceDate2").disabled =false;
		document.getElementById("txtInvoiceDate3").disabled =false;
		document.getElementById("txtInvoiceDate2").value ="<?php echo date('Y-m-d');?>";
		document.getElementById("txtInvoiceDate3").value ="<?php echo date('Y-m-d');?>";
	...
	else
	{
		...
		document.getElementById("txtInvoiceDate2").disabled =true;
		document.getElementById("txtInvoiceDate3").disabled =true;
		document.getElementById("txtInvoiceDate2").value ="";
		document.getElementById("txtInvoiceDate3").value ="";
...
<form id="form1" name="form1" method="POST" action="" >
  <table  border="0" cellspacing="0" width="647" height="293">
    <tr>
          ...
          <tr>
            <td colspan="2" class="normalfnt"><table width="100%" border="0" bgcolor="#FFFFFF" >
                <tr>
                  ...
                  <td width="5%">Date</td>
                  <td width="4%"><input type="checkbox" id="checkbox1" name="checkbox1" onclick="showDate()" checked="checked" /></td>
                  ...
                  <td colspan="9" class="normalfnt"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="162" colspan="2" class="normalfnt"><table width="642" height="163">
                            <tr>
                              <td width="634" height="149"><div id="divcons" style="overflow:scroll; height:170px; width:634px;">
    ...
    <tr>
      <td height="34" colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
          <tr>
            <td width="100%" bgcolor="#d6e7f5"><table width="616" border="0" >
                <tr>
                  <td width="207">&nbsp;</td>
                  <td width="91"><img src="../../images/ok.png" alt="Ok" name="Ok" width="84" height="24"  class="mouseover" id="Ok" onclick="sendData();" /></td>
