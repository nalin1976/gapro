...
<table width="960" border="0" cellspacing="2" cellpadding="0" bgcolor="#FFFFFF" align="center">
    ...
    <td class="bcgl1txt1NB">
      ...
      <form id="pl_header" >
		...
		?>
          ...
          <tr>
            ...
            <td nowrap="nowrap"><input name="txtCTNS" type="text" class="txtbox" id="txtCTNS" style="width:146px;display:none"  maxlength="50" tabindex="13" title="Separate using 'X'." />
              <input name="txt_l" type="text" class="txtbox" id="txt_l" style="width:45px;text-align:right" maxlength="50" tabindex="13" onkeypress="return CheckforValidDecimal(this.value, 2,event);" onblur="cal_cbm()"/>
              <input name="txt_h" type="text" class="txtbox" id="txt_h" style="width:45px;text-align:right" maxlength="50" tabindex="13" onkeypress="return CheckforValidDecimal(this.value, 2,event);" onblur="cal_cbm()"/>
              <input name="txt_w" type="text" class="txtbox" id="txt_w" style="width:45px;text-align:right" maxlength="50" tabindex="13" onkeypress="return CheckforValidDecimal(this.value, 2,event);" onblur="cal_cbm()"/></td>
            <td>Wash Code</td>
		...
		?>
          ...
          <tr>
            <td width="10%" height="25">Container #</td>
            <td width="15%"><input name="txtContainer" type="text"  class="txtbox" id="txtContainer" style="width:146px"  maxlength="50" tabindex="25" /></td>
            <td width="10%" nowrap="nowrap">Transport Mode</td>
            <td width="15%"><select name="cboTransMode" class="txtbox" id="cboTransMode"style="width:150px" tabindex="26">
              <option value=""></option>
				<?php 
				   ...
				   {?>
					 <option value="<?php  echo $row_lship_mode['strDescription'];?>"><?php  echo $row_lship_mode['strDescription'];?></option>                
             <?php }   ?>
              </select></td>
            <td width="10%">Destination</td>
            <td width="15%"><select name="cboDestination" class="txtbox" id="cboDestination"style="width:150px;" tabindex="27">
              <option value=""></option>
              <?php 
            ...
            <td width="10%">DC </td>
            <td width="15%"><input name="txtDC" type="text" maxlength="30"class="txtbox" id="txtDC"style="width:146px" tabindex="20"/></td>
          </tr>
  ...
  <tr>
      ...
      <tr bgcolor="#D6E7F5">
        ...
        <td width="12%" height="30"><div align="center"> <img tabindex="29" src="../images/new.png"  id='btnNew'/> </div></td>
        <td width="10%" ><div align="center"> <img class="mouseover" tabindex="30" src="../images/view.png"  id="btnView" /> </div></td>
        <td width="10%"><div align="center"> <img tabindex="31" src="../images/save.png"   class="mouseover" id='btnSave'/> </div></td>
        <td width="13%"><div align="center"> <img tabindex="32" src="../images/report.png "   class="mouseover"  id="btnPrint"/> </div></td>
        <td width="10%" valign="middle"><a href="styleratioplplugin.php"><img src="../images/back.png"  class="noborderforlink"/></a></td>
        <td width="10%"><a href="<?php echo $backwardseperator?>main.php"><img src="../images/close.png"  class="mouseover noborderforlink"  /></a></td>
        <td align="center"><img src="../images/do_copy.png" width="32" height="31" alt="c" class="mouseover" title="Save As New Packing List" id="btn_save_as"/></td>
      </tr>
    </table></td>
  </tr>
