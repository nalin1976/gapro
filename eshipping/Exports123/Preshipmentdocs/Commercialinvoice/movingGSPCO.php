...
<table style="width:800px;"border="0" cellspacing="1" cellpadding="0" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  class="dragableElement" style="z-index:25; position:absolute; left:97px; top:140px; width:305px; height:92px;" >
	...
	if($detail_data_set['strCountryCode']=='GB')
		$couCode = 'UK';
	?>
    <td><div  style="z-index:25; position:absolute; left:531px; top:104px; width:305px; height:22px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:97px; top:225px; width:305px; height:92px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
    ...
    <td><div  style="z-index:25; position:absolute; left:529px; top:241px; width:305px; height:92px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
     ...
     <td><div  style="z-index:25; position:absolute; left:296px; top:599px; width:235px; height:17PX;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="14"  class="paragraph"><span class="normalfnt">HS Code: <?php echo $detail_data_set['strHSCode']; ?></span></td>
          </tr>
        </table>
      </div>
    </div></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:528px; top:560px; width:64px; height:44px;" class="dragableElement" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:687px; top:549px; width:55px; height:44px;" class="dragableElement" >
      <table width="94" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="94" height="14" nowrap="nowrap" class="normalfnt" style="text-align:center">&nbsp;</td>
        </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:519px; top:991px; width:250px; height:17PX;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
        <tr>
        ...
        <tr>
          ...
          <tr>
            <td width="240" height="14"  class="normalfnt"><?php echo $detail_data_set['strCountry']; ?></td>
          </tr>
          <tr>
            <td width="240" height="14"  class="normalfnt">&nbsp;</td>
          </tr>
