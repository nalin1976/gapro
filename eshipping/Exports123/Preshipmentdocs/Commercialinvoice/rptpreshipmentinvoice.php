...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td class="normalfnt_size20" style="text-align:center" bgcolor="#CCCCCC"><?php echo $Company;?></td>
  </tr>
  <tr>
    <td bgcolor="#999999" class="normalfntMid"><?php echo $Address." ".$Country." Tel ".$phone." Fax ".$Fax;?></td>
  </tr>
  <tr>
    <td class="normalfntMid">&nbsp;</td>
  </tr>
  <tr>
    <td class="normalfnt2bldBLACKmid"><?PHP echo 'COMMERCIAL INVOICE NO. \t'.$dataholder['strInvoiceNo'];?> </td>
  </tr>
  <tr>
  ...
  <?php $str_summary="select 
strUnitID,sum(dblAmount) as totamt,sum(dblQuantity) as totqty
from invoicedetail
where strInvoiceNo ='$invoiceNo'
  ...
  <tr>
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="2" class="normalfnt">
      <tr>
        ...
        <td class="border-top-bottom-fntsize12" style="text-align:center"><span class="normalfnth2B">Amount</span></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="5" class="border-left-fntsize12"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="30%"><?php echo $row_summary["totqty"] ." PCS";?></td>
            <td width="40%"><?php echo ($row_summary["totqty"]/12)." DZS";?></td>
          </tr>
        </table></td>
        <td colspan="2" class="border-left-fntsize12" style="text-align:center"><span class="normalfnth2B">FOB SRILANKA </span></td>
      </tr>
      <tr>
        <td >&nbsp;</td>
        <td colspan="5" class="border-left-fntsize12">&nbsp;</td>
        <td class="border-left-fntsize12" style="text-align:center"><span class="normalfnth2B"><?php echo $dataholder['strCurrency']."/".$row_summary["strCurrency"];?></span></td>
      ...
      <tr>
        ...
        <td colspan="5" class="border-left-fntsize12" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
          ...
          <tr>
            ...
            <td colspan="4" rowspan="2" valign="top"><?php 
		...
		while($row_hs=mysql_fetch_array($result_hs)){echo $row_hs["strHScode"];}
	  ?></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="4" rowspan="2" valign="top">347 / 348 </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            </tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="4" rowspan="2" valign="top"><?php echo $dataholder['strGenDesc']; ?></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            </tr>
      ...
      <tr>
        ...
        <td width="10%" class="border-bottom-fntsize12" style="text-align:center"><span class="normalfnth2B">QTY/<?php echo $row_summary["strUnit"];?></span></td>
