		...
		<td>
			<table width="100%" border="0" cellspacing="0" align="center">
				...
				<table width="100%" border="0" cellspacing="0" align="center">
					...
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">&nbsp;<b>EXPORT ENTRY NO: R-24891</b></td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					...
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">We bring to your kind attention the NO OF PKGS of above numbered Export Entry </td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">Cage no: 6&amp;31 should read as <b>14 CTNS </b> and not <b>10 CTNS </b>which are an error.</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
