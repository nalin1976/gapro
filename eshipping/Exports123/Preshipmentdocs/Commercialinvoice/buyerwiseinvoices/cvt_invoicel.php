...
<table width="985" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    <td colspan="4" class="border-All-fntsize10"><table width="100%" height="423" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="17%" class="normalfnt_size10">&nbsp;<strong>12 Marks and Nos.of Pkgs</strong></td>
	  ...
	  {
	 	   	$qty=$row_desc["dblQuantity"];
		    $tot+=$row_desc["dblAmount"]+$tot_ch*$$qty;
			$totqty+=$row_desc["dblQuantity"];
			$totctns+=$row_desc["intNoOfCTns"];
			$price_dtl=$row_desc["dblUnitPrice"]+$tot_ch;
			$amt_dtl=$row_desc["dblAmount"]+$tot_ch*$qty;
			$hts_code=$row_desc["strHSCode"];
			$count++;
	  ?>
      <tr>
        <td class="border-left-fntsize10"  style="text-align:center"><?php echo $row_desc["strBuyerPONo"]; ?>&nbsp;</td>
        <td  style="text-align:center" class="normalfnt_size10"><?php echo $row_desc["strStyleID"]; ?></td>
        <td style="text-align:center" class="normalfnt_size10"><?php echo $row_desc["strDescOfGoods"];?></td>
        <td style="text-align:center" class="normalfnt_size10" ><?php echo $row_desc["strColor"];?>&nbsp;</td>
        ...
        <td colspan="2" style="text-align:right" class="border-left-fntsize10"><?php echo ($amt_dtl==0?"":$u_price=number_format(($price_dtl/100*107),2)) ; ?> &nbsp;</td>
        <td class="border-left-fntsize10" style="text-align:right"><?php echo($amt_dtl==0?"":number_format($qty*$u_price,2));$wo_discount_tot+=number_format($qty*$u_price,2);?>&nbsp;</td>
      </tr>
		<?php
		}
		?>
        ...
        <tr>
          <td colspan="4" class="border-left-fntsize10">&nbsp;</td>
          <td colspan="2" class="border-left-fntsize10"> LESS: 7% TRADE DISCOUNT:</td>
          <td colspan="2" class="border-left-fntsize10">&nbsp;</td>
          <td class="border-left-fntsize10"><?php echo $wo_discount_tot-$tot;?></td>
        </tr>
        <tr>
          <td colspan="4" class="border-left-fntsize10">&nbsp;</td>
          <td class="border-left-fntsize10">&nbsp;</td>
      ...
      <tr>
        <td height="49" class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
        <td colspan="2" class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
      </tr>
