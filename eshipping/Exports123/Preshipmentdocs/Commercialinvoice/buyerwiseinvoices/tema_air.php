...
<table width="985" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    <td class="border-left-fntsize10">&nbsp;</td>
    <td class="border-left-fntsize10">&nbsp;HWAB # : </td>
    <td colspan="2" class="border-right-fntsize10">&nbsp;<?php echo $com_inv_dataholder['strHAWB'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" class="border-right-fntsize10">&nbsp;<?php echo $com_inv_dataholder['strMAWB'];?></td>
  </tr>
  <tr>
