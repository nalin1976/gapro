		...
		<td>
			<table width="100%" border="0" cellspacing="0" align="center">
				...
				<table width="100%" border="0" cellspacing="0" align="center">
					...
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">10.09.2011</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">The Manager</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">CVT,</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">Orugodawatta</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
				...
				<table width="100%" border="0" cellspacing="0" align="center">
					...
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">&nbsp;<b>EXPORT ENTRY NO: R-68536</b></td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					...
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">We bring to your kind attention the PO NO of above numbered Export Entry </td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
					  <td class="normalfnt" style="font-size:12px">Cage no: 31 should read as <b>LF5AZ-5A</b> and not<b> LF7AZ-5A</b> which is an error.</td>
					  <td></td>
				  </tr>
					<tr>
					  <td>&nbsp;</td>
