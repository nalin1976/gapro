...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    <td colspan="5" class="border-top-left-fntsize10">&nbsp;<strong>CONSIGNEE /BILL TO :</strong></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<strong>1ST NOTITY PARTY </strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo ($dataholder['buyerphone']!=""?"Tel : ".$dataholder['buyerphone']:"");?> <?php echo ($dataholder['notify2Fax']!=""?"Fax : ".$dataholder['notify2Fax']:"");?></td>
  ...
  <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo ($dataholder['notify2Mail']!=""?"E-Mail : ".$dataholder['notify2Mail']:"");?></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<strong>Ship To:</strong></td>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <?php 
		...
		$tot+=$row_desc["dblAmount"]+$tot_ch*$row_desc["dblQuantity"]*0;
		$totqty+=$row_desc["dblQuantity"];
		$totctns+=$row_desc["intNoOfCTns"];
		$price_dtl=$row_desc["dblUnitPrice"]+$tot_ch*0;
		$amt_dtl=$row_desc["dblAmount"]+$tot_ch*$row_desc["dblQuantity"]*0;
      ...
      <tr>
        <td colspan="6">COUNTERY OF ORIGIN : MADE IN SRI LANKA</td>
        <td width="6%">&nbsp;</td>
        <td width="8%">&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td colspan="5" rowspan="4" ><?php if($tot_ch>0){?><table width="100%" border="0" cellpadding="2" cellspacing="0">
          
          <tr>
            <td colspan="3" class="border-top-left-fntsize10">TOTAL CFR COST</td>
          ...
          <tr>
            <td colspan="3" class="border-left-fntsize10"><?php echo ($freight_ch!=0?"LESS FREIGHT CHARGES":"")?></td>
