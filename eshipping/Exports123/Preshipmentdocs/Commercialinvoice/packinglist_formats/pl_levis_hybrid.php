...
<body><table width="1000" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt" style="font-weight:500;line-height:12px;font-size:10px;">
      ...
      <tr>
        <td>DO #</td>
        <td><?php echo $holder_header['strDO'];?></td>
      </tr>
      <tr>
        <td>WASH CODE </td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      <tr  class="tbl-h-fnt">
        ...
        <td width="5%" class="border-top-right-fntsize9 tbl-h-fnt" v="v">STYLE #</td>
      ...
      <tr class="tbl-h-fnt">
        ...
        <td width="5%" class="border-right-fntsize9 tbl-h-fnt" v="v">&nbsp;</td>
