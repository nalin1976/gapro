  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      <tr  class="tbl-h-fnt">
        ...
        <td width="2%" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">TAG #</td>
        <td width="3%" class="border-top-right-fntsize9 tbl-h-fnt">SH</td>
...
<?php $count++;}?>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td colspan="<?php echo $col_dyn+2;?>" rowspan="3" ><div  style=" width:100%; " class="normalfnt" >
            <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
              <tr></tr>
              <tr>
                <td nowrap="nowrap" class="normalfnt2bldBLACK" >ORIT TRADING LANKA (PVT) LTD</td>
                </tr>
              <tr>
                <td nowrap="nowrap" >&nbsp;</td>
                </tr>
              ...
              <tr>
                <td nowrap="nowrap" class="normalfnth2B" >Commercial Manager</td>
                </tr>
              </table>
          </div></td>
          <td colspan="2" >&nbsp;</td>
