            ...
            <td height="96">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="23%" class="normalfnt">Invoice No </td>
                  <td><select name="cboBankName"  onchange="getBankDetails();" class="txtbox" id="cboBankName"style="width:320px">
                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:130px; width:750px;">
                                  <table width="800" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="5%" height="33" bgcolor="#498CC2" class="normaltxtmidb2">&nbsp;</td>
                                      <td width="13%" bgcolor="#498CC2" class="normaltxtmidb2">Invoice No </td>
                                      <td width="11%" bgcolor="#498CC2" class="normaltxtmidb2">Cusdec No </td>
                                      <td width="13%" bgcolor="#498CC2" class="normaltxtmidb2">Item No </td>
                                      <td width="21%" bgcolor="#498CC2" class="normaltxtmidb2">Cat No </td>
