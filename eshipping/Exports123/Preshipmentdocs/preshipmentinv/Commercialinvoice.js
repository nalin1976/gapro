...
{	if(document.getElementById('cboInvoiceNo').value!=""){
	...
	var vessel=document.getElementById('txtCarrier').value;
	var VoyageNo=document.getElementById('txtVoyageeNo').value;
	var voyagedate=document.getElementById('txtSailing').value;
	var portdischaarge=document.getElementById('cboDestination').value;
	...
	var ShippingLine=document.getElementById('cboTransMode').value;
