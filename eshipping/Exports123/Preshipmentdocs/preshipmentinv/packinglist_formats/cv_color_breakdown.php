...
<body><table width="1000" border="0" cellspacing="0" cellpadding="3">
  ...
  <?php 
  $str_color_row="select strColor, sum(dblNoofCTNS) as colorwise_cartoons from shipmentpldetail where strPLNo='$plno' group by strColor order by intRowNo";
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      ...
      <tr  >
        ...
        <td colspan="2"  nowrap="nowrap" ><?php echo $holder_header['strSortingType'];?></td>
        <td colspan="<?php echo $col_dyn;?>" class=" tbl-h-fnt">&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
      ...
      <tr  >
        ...
        <td colspan="2"  nowrap="nowrap" ><?php echo $row_clors["colorwise_cartoons"];?></td>
        <td colspan="<?php echo $col_dyn;?>" class=" tbl-h-fnt">&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
        <td nowrap="nowrap" >&nbsp;</td>
