...
<body><table width="1000" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt" style="font-weight:bold">
      ...
      <tr>
        <td>DC #</td>
        <td><?php echo $holder_header['strDc'];?></td>
      </tr>
      <tr>
        <td>WASH CODE </td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      <tr  class="tbl-h-fnt">
        <td  nowrap="nowrap" colspan="2" width="3%" class="border-Left-Top-right-fntsize9 tbl-h-fnt">CTN NO</td>
...
<?php $count++;}?>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td colspan="<?php echo $col_dyn;?>"style="font-size:14px"><i>SUMMARY</i> </td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <td width="<?php echo $col_width.'%';?>" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $row_dyn['strSize'];?></td><?php }?>
          <td  class="border-top-right-fntsize9 tbl-h-fnt">TTL</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td class="border-Left-Top-right-fntsize9 tbl-h-fnt">QTY PCS</td>
          <?php $result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td width="<?php echo $col_width.'%';?>" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $pcs=size_wise_total($row_dyn['intColumnNo']); $tot_pcz+=$pcs;?></td><?php }?>
          <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $tot_pcz;?> </td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td class="border-Left-Top-right-fntsize9 tbl-h-fnt">QTY DOZ</td>
          <?php $result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td width="<?php echo $col_width.'%';?>" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">							<?php echo $doz=round(size_wise_total($row_dyn['intColumnNo'])/12,2);$tot_doz+=$doz;?></td><?php }?>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo ($plunit=="KG"?number_format(($tot_TotGross/0.4536),2):$tot_TotGross);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo ($plunit=="KG"?number_format(($tot_TotNet/0.4536),2):$tot_TotNet);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo ($plunit=="KG"?number_format(($tot_TotNetNet/0.4536),2):$tot_TotNetNet);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo($plunit=="lbs"?number_format(($tot_TotGross*0.4536),2):$tot_TotGross);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo ($plunit=="lbs"?number_format(($tot_TotNet*0.4536),2):$tot_TotNet);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt" style="text-align:left">
          ...
          <td ><?php echo ($plunit=="lbs"?number_format(($tot_TotNetNet*0.4536),2):$tot_TotNetNet);?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
