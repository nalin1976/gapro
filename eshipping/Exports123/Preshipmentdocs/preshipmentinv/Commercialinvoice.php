		  ...
		  <table width="100%"  id="tblGen">
		    <tr>
              ...
              <tr>
		         ...
		         <td width="21%"><input name="txtInvoicePoNo" tabindex="2"  type="text" class="txtbox" id="txtInvoicePoNo"  style="width:170px" maxlength="30" onkeyup="changePrePoInvCombo(this,event);" /></td>
		         <td width="12%">&nbsp;</td>
		         <td width="20%">&nbsp;</td>
		         </tr>
		       <tr>
		    ...
		    <tr>
		      <td height="65"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
		        <tr>
		          ...
		          <td>Consignee</td>
		          <td><select name="cboConsignee" tabindex="6"  class="txtbox"  id="cboConsignee" style="width:160px">
		            <option value=""></option>
		            <?php 
...
?>
		        ...
		        <tr>
		          ...
		          <td width="21%"><input name="txtCarrier" tabindex="16"  type="text" class="txtbox" id="txtCarrier"  style="width:158px" maxlength="50" /></td>
...
?>
      ...
      <tr>
        ...
        <td width="74"></td>
        <td width="98"><img src="../../../images/new.png" alt="new"  name="butNew" width="96" height="24" class="mouseover"  id="butNew" onclick="pageReload(); "/></td>
        <td width="104"><img src="../../../images/cancel.jpg" width="104" height="24" class="mouseover" onclick ="rowupdater();" /></td>
        <td width="84"><img src="../../../images/save.png" alt="save" name="butSave" width="84" height="24" class="mouseover" id="butSave" onclick="saveData();" /></td>
        ...
        <td width="109"><a href="../../../main.php"><img src="../../../images/close.png" width="97" height="24" border="0" class="mouseover"  /></a></td>
       
        
       <td width="52"><img src="../../../images/go.png"alt="go"  name="butgo" width="37" height="26" class="mouseover"  id="butgo" 	onclick="Loadshippingnote(); "/>
      </td>
        <td width="106"><img src="../../../images/print.png" alt="Print" width="100" height="24" onclick="printReport();"/></td>
        
        
        
		<td width="89"><img src="../../../images/do_copy.png" width="32" height="31" alt="c" onclick="copy_invoice()" class="mouseover" title="Copy Invoice"/></td>
      </tr>
    </table></td>
		</tr>
