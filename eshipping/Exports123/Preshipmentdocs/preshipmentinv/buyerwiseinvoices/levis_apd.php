  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td colspan="3" class="invoicefntbold"><strong><?php  echo $r_summary->summary_string($invoiceNo,'strDescOfGoods');?></strong></td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="3" class="invoicefntbold"><strong><?php echo $com_inv_dataholder['strGender'];?></strong></td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td colspan="2" nowrap="nowrap">Net Net Weight</td>
