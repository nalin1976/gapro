...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo "TEL ".$dataholder['Brokerphone'];?></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
     ...
     <td colspan="6" class="border-left-right-fntsize10"><strong>&nbsp;</strong></td>
   </tr>
  <tr>
    <td colspan="2" class="border-left-fntsize10">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize10">&nbsp;</td>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td colspan="2" style="text-align:left"><span >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_desc["strDescOfGoods"];?></span></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2">SHIPPING MARKS</td>
    <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">BRAZIL, CSC</td>
    <td colspan="4"> 1-UP</td>
    <td class="border-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
    <td class="border-left-fntsize10">&nbsp;B/L #</td>
    <td colspan="3"><?php echo $com_inv_dataholder['strBL'];?></td>
    <td colspan="2">C/NO:</td>
    <td colspan="4">NET WEIGHT</td>
    <td class="border-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
    <td class="border-left-fntsize10">&nbsp;</td>
    <td colspan="3">&nbsp;</td>
    <td colspan="2">MADE IN SRI LANKA </td>
    <td colspan="3">SIZE</td>
    <td>&nbsp;</td>
    <td class="border-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;TARIFF  NUMBER(HTS CODE) : <?php echo $hts_code;?></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="4">MEASUREMENT:<?php echo $com_inv_dataholder['strCTNSize'];?></td>
    <td class="border-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="7" class="border-left-fntsize10"><strong>&nbsp;&quot;I DECLARE  THAT I  HAVE  SEEN  SUFFICIENT INFORMATION DUCUMENTS AND PROOF  TO</strong></td>
    <td >&nbsp;</td>
    <td >&nbsp;</td>
    <td>&nbsp;</td>
    <td class="border-right-fntsize10">&nbsp;</td>
