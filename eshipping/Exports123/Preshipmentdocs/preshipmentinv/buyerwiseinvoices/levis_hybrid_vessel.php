...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;VESSEL <?php echo $dataholder['strCarrier'];?></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo $dataholder['CustomerCountry'];?></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;VESSEL ETD <?php echo $dateInvoice ;?></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<strong>MID NO :<?php echo $dataholder['strMIDCode'];?></strong></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;CARRIER <?php echo $dataholder['strVoyegeNo'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo ($dataholder['Brokerphone']!=""?"Tel : ".$dataholder['Brokerphone']:"");?> <?php echo ($dataholder['BrokerFax']!=""?"Fax : ".$dataholder['BrokerFax']:"");?></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo $BrokerContactPerson;?></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo $BrokerRemarks;?></td>
