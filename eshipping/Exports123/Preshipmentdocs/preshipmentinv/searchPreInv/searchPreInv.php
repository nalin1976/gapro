...
<title>Search Pre Invoice</title>
<style type="text/css"> 
body {
...
<script src="searchPreInv.js" type="text/javascript"></script>
...
<table  width="950" border="0" cellspacing="0" cellpadding="2" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td bgcolor="#316895"  height="25" class="TitleN2white" >Pre Invoice Search</td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
     
      <tr>
        <td width="10%" height="25">Inv No#</td>
        <td width="20%"><select name="cmbInv" class="txtbox" id="cmbInv" style="width:150px" tabindex="3">
          <option value=""></option>
          <?php 
			$buyerstr="SELECT strInvoiceNo FROM invoiceheader ORDER BY strInvoiceNo desc";
			...
			{
		?>
          <option value="<?php echo $buyerrow['strInvoiceNo'];?>"><?php echo $buyerrow['strInvoiceNo'];?></option>
          <?php } ?>
        </select></td>
        ...
        <td width="20%"><input name="txtStyleNo"  type="text" class="txtbox" id="txtStyleNo" tabindex="1" style="width:150px" /></td>
      </tr>
       <tr>
