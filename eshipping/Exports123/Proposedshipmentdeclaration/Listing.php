    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0">
          <tr>
            <td height="19" bgcolor="#588DE7" class="TitleN2white">Details</td>
          </tr>
          <tr>
            <td height="96">
                      ...
                      <td colspan="3" class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><table width="100%" height="223" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:430px; width:750px;">
                                  <table width="800" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="12%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Item No </td>
									  <td width="17%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Item Description </td>
									  <td width="14%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">HS Code </td>
									  <td width="28%" bgcolor="#498CC2" class="normaltxtmidb2">Quantity</td>
									  <td width="29%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Unit</td>
									  <!--          </tr>
