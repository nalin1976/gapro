    	...
    	<td>
			<table align="center" width="822" style="margin-top:15px;"  class="normalfnt">
				...
				<tr>
				  ...
				  <td width="170"><input type="text" class="txtbox" style="width:168px" id="txtAmount" name="txtAmount" onkeypress="return CheckforValidDecimal(this.value,2,event);" /></td>
				</tr>
				<tr>
			      ...
			      <td width="170"><input type="text" class="txtbox" style="width:150px; background-color:#CCCCCC" id="txtChequeNo" name="txtChequeNo" disabled="disabled" /></td>
					<td width="96" class="normalfnt">Paid Amount </td>
					<td width="170"><input type="text" class="txtbox" style="width:168px; background-color:#CCCCCC" id="txtPaidAmt" name="txtPaidAmt" disabled="disabled" onkeypress="return CheckforValidDecimal(this.value,2,event);" /></td>
				</tr>
		  </table>
		</td>
	</tr>
	...
	<tr>
    	<td>
          ...
          <tr>
            ...
            <td width="10%" bgcolor="#D6E7F5"><img src="../../images/close.png" alt="new" name="butNew" width="97" height="24" class="mouseover"  id="butNew" onclick="closeWindow();"/></td>
