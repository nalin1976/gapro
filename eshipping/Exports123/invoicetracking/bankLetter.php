  	...
  	<tr>
    	<td>
			<table align="center" width="494" style="margin-top:15px;">
				<tr>
					<td width="92" class="normalfnt">Serial No</td>
					<td colspan="3">
						<select name="#" style="width:330px" id="#" class="txtbox" onchange="#">
							<option></option>
							<option></option>
							<option></option>
						</select>
				...
				<tr>
					<td width="92" class="normalfnt">Buyer</td>
					<td colspan="3">
						<select name="#" style="width:330px" id="#" class="txtbox" onchange="#">
							<option></option>
							<option></option>
				...
				<tr>
			  	  ...
			  	  <td width="134"><input type="text" style="width:125px" id="#" class="txtbox"/></td>
					<td width="60" class="normalfnt">Date To</td>
	  	  	  	  <td width="188"><input type="text" style="width:125px" id="#" class="txtbox"/></td>
				</tr>
	 	  </table>
		  	<div align="center">
