    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0">
          <tr>
            <td height="19" bgcolor="#588DE7" class="TitleN2white">Final Instruction Listing </td>
          </tr>
          <tr>
            <td height="96">
                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:130px; width:750px;">
                                  <table width="800" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="17%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Section No </td>
									  <td width="37%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Container No</td>
									  <td width="26%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Measurement</td>
									  <td width="20%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Seal No </td>
									  <!--          </tr>
              ...
              <tr bgcolor="#d6e7f5">
                <td width="100%"><table width="100%" border="0" cellspacing="0">
                    <tr bgcolor="#d6e7f5">
                      ...
                      <td width="21"><a href="../../main.php"><img src="../../images/close.png" alt="Close" name="Close" width="97" height="24" border="0"/></a></td>
                      <td width="18%">&nbsp;</td>
                      <td width="21%">&nbsp;</td>
                    </tr>
                </table></td>
