    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="62%"><table width="100%" border="0">
          <tr>
            <td height="19" bgcolor="#588DE7" class="TitleN2white">Certificate Of Origin Listing </td>
          </tr>
          <tr>
            <td height="96">
                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:130px; width:750px;">
                                  <table width="800" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="7%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Position</td>
									  <td width="10%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Style No </td>
									  <td width="13%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Description</td>
									  <td width="22%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">PCS</td>
									  <td width="6%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">SETS</td>
									   <td width="7%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">FOB Value </td>
									    <td width="11%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Cat No </td>
										 <td width="9%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Gross</td>
										  <td width="9%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Net</td>
									  <td width="6%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">CBM</td>
                                      <!--          </tr>
