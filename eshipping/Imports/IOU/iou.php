    ...
    <td><table width="100%" border="0">
      ...
      <tr>
        ...
        <td class="normalfnt"><table width="100%" readonly="readonly" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="41%"><input name="txtMerchandiser" type="text" readonly="readonly" class="txtbox" id="txtMerchandiser" size="15" /></td>
            <td width="12%">LC # </td>
      ...
      <tr>
        ...
        <td class="normalfnt"><input name="txtReason" readonly="readonly" type="text" class="txtbox" id="txtReason" size="39" /></td>
