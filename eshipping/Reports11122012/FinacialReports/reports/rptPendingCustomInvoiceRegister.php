...
where CIH.strInvoiceNo NOT IN (SELECT commercial_invoice_header.strPreInvoiceNo FROM commercial_invoice_header) AND B.intMainBuyerId <> '' AND CIH.strInvoiceNo NOT IN (SELECT strInvoiceNo FROM cdn_header)
					 ";
	if($buyerId!="")
