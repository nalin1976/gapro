...
/*$SQLDetail = "Select * From orderspec Where intOrderId=$orderId";
    ...
    <td class="bcgl1txt1NB">
      ...
      <form id="pl_header" >
		...
		?>
          ...
          <tr>
            ...
            <td><select name="cboFactory"  class="txtbox" style="width:150px" id="cboFactory"  tabindex="23" >
              <option value=""></option>
              <?php 
			$strtofactory="select strCustomerID,strName, strAddress1 from customers  order by strName";
			...
			{
		?>
              <option value="<?php echo $factrow['strCustomerID'];?>"><?php echo $factrow['strName'];?>--><?php echo $factrow['strAddress1']; ?></option>
              <?php } ?>
            </select></td>
            <td>WT Unit </td>
		...
		?>
            ...
            <td width="16%"><input name="txtInvNo" type="text" class="txtbox" id="txtInvNo" style="width:146px" maxlength="50" tabindex="20"/></td>
          </tr>
          <tr>
            <td height="25">Multi Yes</td>
            <td><input type="checkbox" name="mul_yes" id="mul_yes"></td>
            <td nowrap="nowrap">&nbsp;</td>
            <td>Ex. Poly Wt</td>
            <td><input name="txtPolyWt" type="text" class="txtbox" id="txtPolyWt" style="width:146px" maxlength="50" tabindex="22" onkeypress="return CheckforValidDecimal(this.value, 4,event);"/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
        </table>
...
<?php }?>
<script>load_pl_grid(<?php echo $orderId; ?>);</script>
</html>