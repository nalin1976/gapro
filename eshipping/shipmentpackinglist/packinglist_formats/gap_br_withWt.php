    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="25%" rowspan="2" valign="top"><table width="420">
          ...
          <tr>
            <td class="normalfntMid" height="20" style="text-align:left"><?php echo $holder_header['strMLocation']." ".$holder_header['strAddress2'];?><br />
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
     ...
     <tr  class="tbl-h-fnt" style="border-top:1px dotted;">
      ...
      <tr  class="tbl-h-fnt" bgcolor="#CCCCCC">
        <td  nowrap="nowrap" colspan="2" class="border-Left-Top-right-fntsize9 tbl-h-fnt">CTN NO</td>
        <td width="26" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">PRE PACK</td>
        <td width="27" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">EDI NO</td>
        <td width="28" class="border-top-right-fntsize9 tbl-h-fnt">COLOR</td>
        <td colspan="<?php echo $col_dyn;?>" width="38" class="border-top-right-fntsize9 tbl-h-fnt">RATIO</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">NO OF</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">NO OF</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">QTY</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">QTY</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">Gross Wt</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">Net Wt</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">CARTONE</td>
        </tr>
	  
      <tr class="tbl-h-fnt" bgcolor="#CCCCCC">
        <td colspan="2" class="border-left-right-fntsize9 tbl-h-fnt" >&nbsp;</td>
        <td class="border-right-fntsize9 tbl-h-fnt">NO'S</td>
        <td class="border-right-fntsize9 tbl-h-fnt">&nbsp;</td>
        <td class="border-right-fntsize9 tbl-h-fnt">&nbsp;</td>
        <?php 
		$result_dyn		=$db->RunQuery($str_dyn);
		while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td width="38" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $row_dyn['strSize'];?></td><?php }?>
        ...
        <td class="border-right-fntsize9 tbl-h-fnt">per CTN</td>
        <td class="border-right-fntsize9 tbl-h-fnt">per CTN</td>
        <td class="border-right-fntsize9 tbl-h-fnt">D/M/Inches</td>
        </tr>
        <?php /*$str_row_data="select 	strPLNo, 
								...
								where strPLNo='$plno'and
								srtPack='$prepack' order by dblPLNoFrom ";*/
		...
		$str_row_data="SELECT
		 ...
		 {$row_index=$row_row_data['intRowNo']?>
            ...
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['strPrePack']; ?></td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['strTagNo'];?></td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['strColor'];?> - <?php echo $row_color_code['strColorCode']; ?></td>
            <?php 		
...
<?php $count++;}?>
            ...
            <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data["strCartoon"];?></td>
            </tr>
      ...
      <tr  class="tbl-h-fnt" bgcolor="#CCCCCC">
        <td  nowrap="nowrap" colspan="2" class="border-Left-Top-right-fntsize9 tbl-h-fnt">CTN NO</td>
        <td width="26" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">PRE PACK</td>
        <td width="27" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">&nbsp;</td>
        <td width="28" class="border-top-right-fntsize9 tbl-h-fnt">COLOR</td>
        <td colspan="<?php echo $col_dyn;?>" width="38" class="border-top-right-fntsize9 tbl-h-fnt">RATIO</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">QTY</td>
	...
	$str_row_data="SELECT
		 ...
		 {		
            ...
            <td class="border-Left-Top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['dblPLNoFrom'];?></td>
            <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['dblPlNoTo'];?></td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt">&nbsp;</td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt">&nbsp;</td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['strColor'];?> - <?php echo $row_color_code['strColorCode']; ?></td>
        <?php 		
		...
		{?>
	<td class="border-top-right-fntsize9 tbl-h-fnt" style="width:25px;" nowrap="nowrap"><?php echo  $col_atrray_sum[$prepack][$row_row_data['strColor']][$row_dyn['intColumnNo']];$ratioQty+=$col_atrray_sum[$prepack][$row_row_data['strColor']][$row_dyn['intColumnNo']];
		?></td>
<?php $count++;}?>
            <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $ratioQty;$fullRatioQty+=$ratioQty?></td>
            <td width="71" bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
        ...
        <tr class="tbl-h-fnt">
              <td colspan="5" class="border-top">&nbsp;</td>
              <?php for($i=0;$i<$col_dyn;$i++){?>
              <td class="<?php if($i==$col_dyn-1) echo 'border-top-right-fntsize9';else echo 'border-top';?>" ><input type="text" style="width: 40px; visibility:hidden" class="txtbox" /></td><?php }?>
              <td class="border-top-bottom-right-fntsize9 tbl-h-fnt"><?php echo $fullRatioQty;?></td>
              <td width="71" bgcolor="#FFFFFF"></td>
              <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
              <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
              <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
      ...
      <tr  class="tbl-h-fnt" bgcolor="#CCCCCC">
        ...
        <td width="26" class="border-Left-Top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">COLOR NO</td>
        <td width="27" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap">COLOR</td>
        <td width="28" class="border-top-right-fntsize9 tbl-h-fnt">&nbsp;</td>
        <td colspan="<?php echo $col_dyn;?>" width="38" class="border-top-right-fntsize9 tbl-h-fnt">RATIO</td>
        <td nowrap="nowrap" width="71" class="border-top-right-fntsize9 tbl-h-fnt">QTY</td>
        <td width="71" bgcolor="#FFFFFF"></td>
        <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
      ...
      <tr class="tbl-h-fnt">
            <td colspan="2" bgcolor="#FFFFFF"></td>
            <td nowrap="nowrap"  class="border-Left-Top-right-fntsize9 tbl-h-fnt"><?php echo $color_row['strColorCode'] ?></td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $color;?></td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt">ORDER QTY</td>
        <?php 		
		$sql_column = "SELECT
						SPSI.intColumnNo
						FROM
		...
		{	
		 $str_order="SELECT sum(OSD.dblPcs) AS dblPcs,intColumnNo,OSD.strSize,OSD.strColor FROM orderspecdetails OSD
					LEFT JOIN orderspec OS ON OS.intOrderId=OSD.intOrderId
					LEFT JOIN shipmentplheader SPH ON SPH.strStyle=OS.strOrder_No
					LEFT JOIN shipmentplsizeindex SPSI ON SPSI.strPLNo= SPH.strPLNo
					WHERE SPH.strPLNo=$plno AND OSD.strColor='$color' AND intColumnNo =".$row_column['intColumnNo']." GROUP by intColumnNo,strSize";		
		$result_order		=$db->RunQuery($str_order);
		$row_order=mysql_fetch_array($result_order);	
		
		?>
	<td class="border-top-right-fntsize9 tbl-h-fnt" style="width:25px;" nowrap="nowrap"><?php 
...
<?php $count++;
       ...
       <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $color_ord_tot;?></td>
      <td width="71" bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            ...
            <td colspan="2" rowspan="2" class="border-Left-Top-right-fntsize9 tbl-h-fnt">&nbsp;</td>
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt">SHIP QTY</td>
        <?php 		
		...
		{?>
	<td class="border-top-right-fntsize9 tbl-h-fnt" style="width:25px;" nowrap="nowrap"><?php echo  $col_array_sum[$row_row_data['strColor']][$row_dyn['intColumnNo']];
		?></td>
<?php $count++;}?>
            <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $tot_shipped=$row_row_data['dblQtyPcs'];?></td>
            <td width="71" bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            ...
            <tr class="tbl-h-fnt">
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt">SHORT/OVER SHIP %</td>
        <?php 		
		...
		
		{
			...
			?>
	<td class="border-top-right-fntsize9 tbl-h-fnt" style="width:25px;" nowrap="nowrap">
...
<?php $count++;}}?>
            <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo round((abs(($tot_shipped)/$color_ord_tot*100)),2)."%";?></td>
            <td width="71" bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
            <td width="71" nowrap="nowrap"  bgcolor="#FFFFFF"></td>
		...
		$result_dyn		=$db->RunQuery($str_dyn);
		while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td width="38" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap" bgcolor="#CCCCCC"><?php echo $row_dyn['strSize'];?></td><?php }?>
          <td class="border-top-right-fntsize9 tbl-h-fnt" bgcolor="#CCCCCC">TTL</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td >&nbsp;</td>         
          <td colspan="3" class="border-Left-Top-right-fntsize9 tbl-h-fnt">TTL SHIPPED</td>
          <?php $result_dyn		=$db->RunQuery($str_dyn);
		while($row_dyn=mysql_fetch_array($result_dyn)){?>	
          <td  class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $summary_size=$col_atrray_tot[$row_dyn['intColumnNo']]; $summary_tot+=$summary_size?></td>
         <?php }?>
          <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $summary_tot;?></td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td >&nbsp;</td>
        ...
        <tr  class="tbl-h-fnt">
          <td >&nbsp;</td>
          <td >&nbsp;</td>
          <td colspan="3" class="border-Left-Top-right-fntsize9 tbl-h-fnt">GARMENT WEIGHT</td>
          <?php 
		 ...
		 {
		 ?>		  
          <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_weight_summary["dblWeight"];?></td>
          <?php
		 }?>
