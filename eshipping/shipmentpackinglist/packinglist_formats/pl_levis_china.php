  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      ...
      <tr class="tbl-h-fnt">
        ...
        <td class="border-right-fntsize9 tbl-h-fnt">WT-<?php echo $holder_header['strUnit'];?></td>
        <td class="border-right-fntsize9 tbl-h-fnt">(CM)</td>
      </tr>
...
{
	$row_gross_wt+=$row_row_data['dblTotGross'];
	$row_net_wt  +=$row_row_data['dblNoofCTNS'];
	$col_atrray[$row_cell_data['intColumnNo']]= $row_cell_data['dblPcs'];?>
        ...
        <?php $count++;}
$ctn_netwt=$row_row_data['dblTotNet'];
?>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['dblNoofPCZ'];$tot_QtyPcs+=$row_row_data['dblQtyPcs'];?></td>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format($row_row_data['dblTotGross'],2);$tot_TotGross+=$row_row_data['dblTotGross'];
		$lenth_nt_wt_array[$row_row_data['strLength']]	 +=$row_row_data['dblTotNet'];
		$lenth_gross_wt_array[$row_row_data['strLength']]+=$row_row_data['dblTotGross'];
		?></td>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format($row_row_data['dblTotNet'],2);$tot_TotNet+=$row_row_data['dblTotNet'];?></td>
      ...
      <tr class="tbl-h-fnt">
        ...
        <td class="<?php if($i==$col_dyn-1) echo 'border-top-right-fntsize9';else echo 'border-top';?>" ><input type="text" style="width: 25px; visibility:hidden" class="txtbox" /></td>
        <?php }?>
        <td class="border-top-bottom-right-fntsize9 tbl-h-fnt"><strong><?php echo $tot_QtyPcs;?></strong></td>
        <td class="border-top-bottom-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($tot_TotGross,2),2);?></td>
        <td class="border-top-bottom-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($tot_TotNet,2),2);?></td>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
        ...
        <td rowspan="2" class="border-top-right-fntsize9 tbl-h-fnt">TOTAL GROSS</td>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){
			    ?>
        <td  class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $tot_pcs=size_wise_total($row_dyn['intColumnNo'],$row_len['strLength']);$length_tot+=$tot_pcs;?></td>
        <?php }?>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $length_tot;?></td>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($lenth_gross_wt_array[$row_len['strLength']],2),2);//echo round($tot_TotGross,2);?></td>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($lenth_nt_wt_array[$row_len['strLength']],2),2);?></td>
        <td >&nbsp;</td>
      </tr>
      <?php }?>
      <tr  class="tbl-h-fnt" style="text-align:left">
        ...
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($tot_TotGross,2),2);?></td>
        <td class="border-top-right-fntsize9 tbl-h-fnt"><?php echo number_format(round($tot_TotNet,2),2);?></td>
        <td >&nbsp;</td>
      </tr>
      <tr  class="tbl-h-fnt" style="text-align:left">
        <td >&nbsp;</td>
