...
<body><table width="1050" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
  	$sql_array="SELECT DISTINCT
					...
					LEFT JOIN orderspecdetails ON orderspecdetails.intOrderId = orderspec.intOrderId AND orderspecdetails.strColor = shipmentpldetail.strColor AND orderspecdetails.strSize = ssi.strSize
