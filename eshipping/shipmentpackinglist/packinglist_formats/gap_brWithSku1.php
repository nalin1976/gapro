     ...
     <tr  class="tbl-h-fnt" style="border-top:1px dotted;">
      ...
      <tr class="tbl-h-fnt" bgcolor="#CCCCCC">
		...
		$str_row_data="SELECT
		 ...
		 {
			if($preColor!=$row_row_data['strColor']) 
			{ 
				$nowColor = $row_row_data['strColor'];
			?>
				<tr class="tbl-h-fnt" bgcolor="#CCCCCC">
        <td colspan="2" class="border-left-right-fntsize12 tbl-h-fnt" >&nbsp;</td>
        <td class="border-right-fntsize12 tbl-h-fnt">&nbsp;</td>
		...
		while($row_dyn=mysql_fetch_array($result_dyn))
		{
			$skuSize=$row_dyn['strSize'];
			$skuOrderNo = $holder_header['strStyle'];
			
			$skuOrderNoSql = "SELECT
							...
							WHERE orderspec.strOrder_No='$skuOrderNo' AND orderspecdetails.strSize='$skuSize' AND orderspecdetails.strColor = '$nowColor'
							";
			$result_Sku	= $db->RunQuery($skuOrderNoSql);
			$row_sku = mysql_fetch_array($result_Sku);
			$newstring = substr($row_sku['strSKU'], 0, -4);
			?>
        <td width="38" class="border-top-right-fntsize12 tbl-h-fnt" nowrap="nowrap"><?php echo $newstring ;?></td><?php }?>
        <td class="border-right-fntsize12 tbl-h-fnt">&nbsp;</td>
        <td class="border-right-fntsize12 tbl-h-fnt">&nbsp;</td>
        <td class="border-right-fntsize12 tbl-h-fnt">&nbsp;</td>
        <td class="border-right-fntsize12 tbl-h-fnt">&nbsp;</td>
        ...
        <?php
            ...
            <td nowrap="nowrap" class="border-top-right-fntsize12 tbl-h-fnt"><?php echo $row_row_data['strColor'];?></td>
            <?php 		
...
<?php $count++;}?>
		...
		<?php 
			$preColor=$row_row_data['strColor'];
			$colorCount=1;
		}?> 
        <tr class="tbl-h-fnt">
