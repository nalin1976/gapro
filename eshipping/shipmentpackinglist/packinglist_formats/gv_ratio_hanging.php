  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt" style="font-weight:bold">
      ...
      <tr>
        ...
        <td><?php echo $holder_header['strTrnsportMode'];?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
      ...
      <tr class="tbl-h-fnt">
        ...
        <?php $str_row_data="select 	strPLNo, 
		 ...
		 {$row_index=$row_row_data['intRowNo']?>
            ...
            <td nowrap="nowrap" class="border-top-right-fntsize9 tbl-h-fnt"><?php echo $row_row_data['strShade'];?></td><?php 		
...
<?php $count++;}?>
            ...
            <td class="border-top-right-fntsize9 tbl-h-fnt">&nbsp;<?php $tot_NoofCTNS+=$row_row_data['dblNoofCTNS'];?></td>
