...
<?php $count++;}?>		
            ...
            <td class="border-top-right-fntsize12 tbl-h-fnt"><?php echo $packs_ctn/$ttl_ctns;?></td>
        ...
        <tr class="tbl-h-fnt">
              ...
              <td class="border-top-bottom-right-fntsize12 tbl-h-fnt"><?php echo $tot_QtyPcs+=$row_row_data['dblQtyPcs'];?></td>
