...
$str_header		="SELECT
					...
					LEFT JOIN orderspec ON shipmentplheader.strStyle = orderspec.strOrder_No
					LEFT JOIN customers ON customers.strCustomerID = shipmentplheader.strFactory
					LEFT JOIN buyers ON buyers.strBuyerID = shipmentplheader.strShipTo
					where
...
<title>Packing List-Lands End</title>
...
<body><table width="1050" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="5" style="text-align:center" class="normalfnBLD1">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1" style="text-align:right"><u>SHIP TO:</u></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="5" rowspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td style="text-align:center"><img src="../../images/landsend_logo.png" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1" nowrap="nowrap">ORDER QTY:</td>
    <td colspan="2" class="normalfnBLD1" style="text-align:center"><?php echo round($holder_header['ordpcs'],0);?></td>
    <td></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1">SHIP QTY:</td>
    <td colspan="2" class="normalfnBLD1" style="text-align:center"><?php echo $holder_header['dblQtyPcs']; ?></td>
    <td></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1">&nbsp;</td>
    <td colspan="2" class="normalfnBLD1" style="text-align:center"><?php echo round((($holder_header['dblQtyPcs']*100)/$holder_header['ordpcs']),2) ;?>%</td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td class="normalfnBLD1" style="text-align:center">&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1">MODE:</td>
    <?php $mode=explode(" ", $holder_header['strTrnsportMode']); ?>
    <td colspan="2" class="normalfnBLD1" style="text-align:center" nowrap="nowrap"><?php echo $mode[0]; ?></td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1" style="text-align:center">PO NO:</td>
    <td width="148" class="normalfnBLD1" style="text-align:center"><?php echo $holder_header['strStyle'];?></td>
    <td>&nbsp;</td>
    <td class="normalfnBLD1" style="text-align:center">STYLE NO:</td>
    <td class="normalfnBLD1" style="text-align:center"><?php echo $holder_header['strProductCode'];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" class="normalfnBLD1">DATE:</td>
    <?php $sailingDate= explode(" ", $holder_header['strSailingDate']); ?>
    <td colspan="2" class="normalfnBLD1" style="text-align:center"><?php echo $sailingDate[0]; ?></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td class="normalfnBLD1">&nbsp;</td>
    <td class="normalfnBLD1" nowrap="nowrap">&nbsp;</td>
    <td>&nbsp;</td>
    <td class="normalfnBLD1" nowrap="nowrap">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" style="text-align:center"><span class="normalfnBLD1">CTNS</span></td>
    <td style="text-align:center" class="border-All"><span class="normalfnBLD1"><?php echo $holder_header['dblNoofCTNS'];?></span></td>
    <td style="text-align:center"></td>
    <td class="normalfnBLD1" style="text-align:center">Pieces</td>
    <td class="border-All" style="text-align:center"><span class="normalfnBLD1"><?php echo $holder_header['dblQtyPcs'];?></span></td>
    <td></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="4" class="normalfnBLD1">Style Description :</td>
    <td colspan="3" class="normalfnBLD1"><?php echo $holder_header['strLable']; ?></td>
  ...
  <tr>
    ...
    <td width="39">&nbsp;</td>
    <td width="49">&nbsp;</td>
    <td colspan="10" class="normalfnBLD1" valign="top">&nbsp;</td>
    <td width="4">&nbsp;</td>
  </tr>
    <tr>
    <td>&nbsp;</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	 <tr>
         <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">Vendor Name</span></td>
         <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center" nowrap="nowrap"><span class="normalfnBLD1">Order No</span></td>
    ...
    <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">NO OF CTN</span></td>
    <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">SKU #</span></td>
    ...
    <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">CTN M.MENT</span></td>
    <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">NET. WGHT. PER CTN</span></td>
    <td class="border-top-left" bgcolor="#CCCCCC" style="text-align:center"><span class="normalfnBLD1">GROSS. WGHT PER CTN</span></td>
    <td width="" bgcolor="#CCCCCC" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">CBM</span></td>
    <td width="" bgcolor="#CCCCCC" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">TTL CBM</span></td>
    <td width="" bgcolor="#CCCCCC" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">WEIGHT</span></td>
    <td width="" bgcolor="#CCCCCC" class="border-Left-Top-right" style="text-align:center"><span class="normalfnBLD1">TTL WEGHT</span></td>
    </tr>
  <?php
  $sql_array="SELECT DISTINCT
					...
					LEFT JOIN shipmentpldetail ON shipmentpldetail.intRowNo = ssd.intRowNo AND shipmentpldetail.strPLNo = ssd.strPLNo
...
";
  ...
  <tr>
  	<td class="border-top-left" nowrap="nowrap" style="text-align:center">EAM MALIBAN</td>
    <td class="border-top-left"  style="text-align:center"><?php echo $holder_header['strStyle'];?></td>
    <td colspan="2" class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo $row_row_data['dblPLNoFrom']; ?></span></td>
    <td class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo $row_row_data['dblPlNoTo']; ?></span></td>
	<?php
    ...
    <td class="border-top-left" style="text-align:center; width:20%"><span class="normalfnt"><?php if($preSku!=$row_row_data['strSKU'])echo $row_row_data['strSKU']; else echo '""'; ?></span></td>
    <td class="border-top-left" style="text-align:center; width:20%" nowrap="nowrap"><span class="normalfnt"><?php if($pre_row_color!=$row_row_data['strColor']) echo $row_row_data['strColor']."(".$row_row_data['strColorCode'].")";  else echo '""';?></span></td>
    ...
    <td class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo $row_row_data["dblGorss"]; ?></span></td>
    <td class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo round(($row_row_data["intWidth"]*$row_row_data["intHeight"]*$row_row_data["intLength"]*.0000164),2); ?></span></td>
    <td class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo round(($row_row_data["intWidth"]*$row_row_data["intHeight"]*$row_row_data["intLength"]*$row_row_data["dblNoofCTNS"]*.0000164),2);$totCBM+=round(($row_row_data["intWidth"]*$row_row_data["intHeight"]*$row_row_data["intLength"]*$row_row_data["dblNoofCTNS"]*.0000164),2); ?></span></td>
    <td class="border-top-left" style="text-align:center; width:5%"><span class="normalfnt"><?php echo $row_row_data["dblTotGross"]; ?></span></td>
  ...
  <tr>
    ...
    <td colspan="7" rowspan="2"><table width="500" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
      <td width="56" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">Order No #</span></td>
      <td width="56" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">PLI No #</span></td>
        <td width="56" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">SKU #</span></td>
        ...
        <td width="47" class="border-top-left" style="text-align:center"><span class="normalfnBLD1">Per Pce wt.</span></td>
        <td width="44" class="border-Left-Top-right" style="text-align:center"><span class="normalfnBLD1">Net Wt</span></td>
      </tr>
	  <?php
	  $sql_size="SELECT DISTINCT
				...
				INNER JOIN shipmentpldetail ON shipmentpldetail.intRowNo = ssd.intRowNo AND shipmentpldetail.strPLNo = ssd.strPLNo 
				INNER JOIN shipmentplheader ON shipmentplheader.strPLNo = ssd.strPLNo 
				LEFT JOIN orderspec ON orderspec.strOrder_No = shipmentplheader.strStyle 
				INNER JOIN orderspecdetails ON orderspecdetails.intOrderId = orderspec.intOrderId AND
						orderspecdetails.strColor = shipmentpldetail.strColor 
				INNER JOIN finishing_garment_weight ON shipmentplheader.strStyle = finishing_garment_weight.strOrderId 
				where ssi.strPLNo='$plno' AND ssd.dblPcs!=''
				GROUP BY strSKU
	...
	while($row_size=mysql_fetch_array($result_size))
	{
	  ...
	  ?>
	  <tr>
      <td class="border-top-left" style="text-align:center; width:20%"><span class="normalfnt"><?php echo $holder_header['strStyle']; ?></span></td>
      <td class="border-top-left" style="text-align:center; width:20%"><span class="normalfnt"><?php echo $row_size['strPliNo']; ?></span></td>
	    <td class="border-top-left" style="text-align:center; width:20%"><span class="normalfnt"><?php echo $row_size['strSKU']; ?></span></td>
	    <td class="border-top-left" style="text-align:center; width:20%" nowrap="nowrap"><span class="normalfnt"><?php if($preColor!=$row_size['strColor']) echo $row_size['strColor']."(".$row_size['strColorCode'].")"; else echo '""'; ?></span></td>
	    ...
	    <td class="border-Left-Top-right" style="text-align:center; width:8%"><span class="normalfnt"><?php echo $net_w_summary[$row_size['strColor']][$row_size['strSize']][$row_size['strSKU']];$totNet+=$net_w_summary[$row_size['strColor']][$row_size['strSize']][$row_size['strSKU']]; ?></span></td>
	    </tr>
		<?php
	    ...
	    <td class="border-All" style="text-align:center"><span class="normalfnBLD1"><?php echo $totNet; ?></span></td>
  ...
  <tr>
    ...
    <td width="71%" class="normalfnBLD1">&nbsp;</td>
  </tr>
  <tr>
    <td class="normalfnBLD1">&nbsp;</td>
    <td rowspan="4" valign="top" class="normalfnBLD1">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    </tr>
  ...
  <tr>
    ...
    <td class="border-top" style="text-align:center"><span class="normalfnBLD1"><?php echo number_format($tot_cbm,2);?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
