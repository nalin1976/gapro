  	...
  	<tr>
    	<td>
			<table align="center" width="507" style="margin-top:15px;">
				...
				<tr>
					<td width="60" class="normalfnt">FCR #</td>
					<td width="219"><input type="text" style="width:170px" id="#" class="txtbox"/></td>
					<td width="97" class="normalfnt">Rec. Date</td>
			  	  <td width="204"><input type="text" style="width:170px" id="#" class="txtbox"/></td>
				</tr>
	 	  </table>
		  	<div align="center">
