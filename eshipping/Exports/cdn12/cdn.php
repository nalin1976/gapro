              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="116" class="normalfnt" >Pre Invoice No</td>
                    ...
                    <td><input type="checkbox" name="Pending_Cdn" class="txtbox" id="Pending_Cdn" onchange="Pen_cdn();" /></td>
                  </tr>
                </table></fieldset>
                ...
                <?php
                          ...
                          <td><select name="cboInvoiceNo" class="txtbox" id="cboInvoiceNo" style="width:150px" onchange="loadInvoiceData(this.value);">
                            <option value=''></option>
                            <?php
                   			$str_sql = "SELECT strInvoiceNo FROM invoiceheader 
									WHERE intCancelInv=0 
									ORDER BY strInvoiceNo DESC";
                  			$exec=$db->RunQuery($str_sql);
									while($row=mysql_fetch_array($exec)) 
						 			{?>
...
" type="text" maxlength="100" class="txtbox" id="txtContainerL" size="25" onkeypress="return CheckforValidDecimal(this.value, 4,event);" style="width:67px"/></td>
                        ...
                        <td height="2">&nbsp;&nbsp;Status</td>
                          ...
                          <td  height="2">Print CO</td>
                          <td><input type="checkbox" name="Print_Co" class="txtbox" id="Print_Co" value="1" <?php echo ($checkBoxco==1)?'checked="checked"':""; ?>/></td>
