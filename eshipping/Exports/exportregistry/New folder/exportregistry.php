...
<table  width="950" border="0" cellspacing="0" cellpadding="2" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      ...
      <tr>
        <td width="11%" height="40">Registry</td>
        <td width="21%"><select name="cboInvoiceType"  class="txtbox" tabindex="7" id="cboInvoiceType" style="width:160px">
          <option value="F" >Final</option>
            <option value="P" >Proforma</option>
        </select></td>
        <td width="8%" valign="middle">Date <input type="checkbox" id="cbxSetDate" name="cbxSetDate"  checked="checked"/></td>
        <td width="30%">From
        ...
        <td width="9%"><img src="../../images/search.png" width="80" height="24" id="btnSearch" class="mouseover"/></td>
        <td width="21%"><img src="../../images/save_small.jpg" width="20" height="20" align="middle" class="mouseover" onclick="export_to_excel()" title="Save as Excel format"/></td>
      </tr>
  ...
  <tr>
                  ...
                  <tr>
                    <td width="3" class="normalfntMid">&nbsp;</td>
                    <td width="112" class="normalfnt">Invoice No</td>
                    <td width="169"><input name="txtCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtCDNInvNo" size="25" style="width:130px" onkeyup="changeCDNInvCombo(this,event);" onload="abc();"/></td>
                    <td width="142" class="normalfnt">PO No</td>
                    <td width="170"><input name="txtCDNBuyerPO" type="text" maxlength="100" class="txtbox" id="txtCDNBuyerPO" size="25" style="width:130px" onkeyup="changeCDNPoCombo(this,event);" onload="abc();"/></td>
                  
                  <td width="140" class="normalfnt">Style No</td>
                   <td width="146"><input name="txtStyleNo" type="text" maxlength="100" class="txtbox" id="txtStyleNo" size="25" style="width:130px" onkeyup="changeStyleNoCombo(this,event);" onload="abc();"/></td>
                  
                   <td width="140" class="normalfnt">Buyer</td>
                   <td width="146"><input name="txtbuyer" type="text" maxlength="100" class="txtbox" id="txtbuyer" size="25" style="width:130px" onkeyup="changetxtbuyerCombo(this,event);" onload="abc();"/></td>
