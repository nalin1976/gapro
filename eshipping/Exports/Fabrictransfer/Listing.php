                            ...
                            <tr>
                              <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:130px; width:750px;">
                                  <table width="800" cellpadding="0" cellspacing="0" id="tblMainGrn">
                                    <tr>
                                      <td width="12%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">HS Code </td>
									  <td width="10%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Item</td>
									  <td width="16%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">NFE/FE</td>
									  <td width="14%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Ratio</td>
									  <td width="6%" height="25" bgcolor="#498CC2" class="normaltxtmidb2">Qty</td>
									   <!--          </tr>
            ...
            <td height="34"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
              <tr bgcolor="#d6e7f5">
                <td width="100%"><table width="100%" border="0" cellspacing="0">
                    <tr bgcolor="#d6e7f5">
                      <td width="190">&nbsp;</td>
                      <td width="100"><img src="../../images/new.png" alt="New" width="100" height="24" name="New"onclick="ClearForm();"/></td>
                      <td width="88"><img src="../../images/save.png" alt="Save" width="84" height="24" name="Save" onclick="butCommand(this.name)"/></td>
                      <td width="125"><a href="../../main.php"><img src="../../images/close.png" alt="Close" name="Close" width="97" height="24" border="0"/></a></td>
                      <td width="85">&nbsp;</td>
                      <td width="156">&nbsp;</td>
                    </tr>
                </table></td>
