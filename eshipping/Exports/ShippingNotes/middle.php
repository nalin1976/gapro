...
//$row_sdp["strName"]='';	
while($row_sdp = mysql_fetch_array($result_sdp))

{
//if ($row_sdp["strName"]!="")
//{
$ResponseXML .="<strShippingLineName><![CDATA[".$row_sdp["strName"]."]]></strShippingLineName>\n";
//}
}
...
{	
	...
	//$ResponseXML .="<strShippingLineName><![CDATA[".$row["strName"]."]]></strShippingLineName>\n";
