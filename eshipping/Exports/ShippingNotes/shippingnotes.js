...
function LoadDetails(){
	...
	document.getElementById('txtShippingLine').value=''
	...
	function LoadDetailsRequest(){
		if(xmlHttp[1].readyState==4 && xmlHttp[1].status==200){
			...
			var strShippingLineName=xmlHttp[1].responseXML.getElementsByTagName("strShippingLineName")[0].childNodes[0].nodeValue;
			...
			document.getElementById('txtShippingLine').value =strShippingLineName;
