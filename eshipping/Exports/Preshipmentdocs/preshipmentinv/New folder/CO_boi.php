...
<table width="799" height="1035"border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" style="width:800px;">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:484px; top:260px; width:114px; height:24px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
              <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:672px; top:494px; width:68px; height:24px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
    ...
    <td><div  style="z-index:25; position:absolute; left:644px; top:253px; width:130px; height:27px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
              <tr>
...
'];?></td>
      ...
      <div  style="z-index:25; position:absolute; left:572px; top:554px; width:168px; height:22px;"  >
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
                <tr>
    ...
    <td><div  style="z-index:25; position:absolute; left:573px; top:525px; width:168px; height:22px;"  >
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
                <tr>
