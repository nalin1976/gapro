...
$row=mysql_fetch_array($result);			
	 ...
	 $sql_sdp="SELECT
			...
			forwaders.strName,
			invoiceheader.strInvFormat,
			invoiceheader.strInvoiceNo
			FROM
			commercialinvformat
			INNER JOIN forwaders ON commercialinvformat.strForwader = forwaders.intForwaderID
			INNER JOIN invoiceheader ON commercialinvformat.intCommercialInvId = invoiceheader.strInvFormat
			WHERE invoiceheader.strInvoiceNo='$invoiceno'
			";
$result_sdp=$db->RunQuery($sql_sdp);
$row_sdp=mysql_fetch_array($result_sdp);										
//echo $row_sdp["strName"];
?>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 ?>
  <tr>
    <td height="21" colspan="11" class="border-top-left-fntsize12" >&nbsp;&nbsp;1.Shipper (Name and Address)</td>
  ...
  <tr>
    <td colspan="11" height="17" class="border-left-fntsize12">&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <tr>
    <td colspan="11" height="36" class="border-left-fntsize12">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="12" class="border-left-right-fntsize12 normalfnth2B">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_sdp["strName"]; ; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="11" height="31" class="border-left-fntsize12">&nbsp;</td>
  ...
  <tr>
    <td height="25" colspan="11" class="border-top-left-fntsize12">&nbsp;&nbsp;3. Notify Address 3180/1 </td>
...
?>
  ...
  <tr>
    <td height="28" colspan="11" class="border-left-fntsize12 normalfnth2B">&nbsp;&nbsp;&nbsp;&nbsp;<?php if($row["consigneeid"]!=$row["NotifyID"]){ echo $r1["strCountry"];  } ?></td>
    <td colspan="12"class="border-left-right-fntsize12">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="32" colspan="5" class="border-left-fntsize12" nowrap="nowrap">&nbsp;&nbsp;<strong><?php echo $VoyageNo." " ; ?></strong></td>
...
?>
  ...
  <tr>
    <td height="32" colspan="5" class="border-left-fntsize12">&nbsp;&nbsp;<strong><?php echo $Carrier ; ?></strong></td>
...
The Company Preparing this note declares that, to the best of belief, the goods have been accurately described their quantities, weights and mesures are correct and at the same time of dispatch they were in good condition and at the same time of dispatch they were in good order and condition.
  ...
  <tr>
    <td height="22" colspan="5" class="border-top-left-fntsize12">&nbsp;&nbsp;8. Port of Discharge 3414/5 </td>
...
?>
    <td height="37" colspan="5" class="border-left-fntsize12">&nbsp;&nbsp;<strong><?php echo $rowNEW["strPortOfLoading"]; ?></strong></td>
  ...
  <tr>
    <td height="30" colspan="5" class="border-top-left-fntsize12"><div class="normalfnt">&nbsp;&nbsp;15. Marks &amp; Nos. 7102 </div></td>
  ...
  <tr>
    <td height="26" colspan="5" class="border-left-fntsize12" ><div  class="normalfntMid">Container Numbers. </div></td>
  ...
  <tr>
    <td colspan="14" rowspan="16" valign="" class="border-left-fntsize12"><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
	  ...
	  ?>       
      <tr>
        <td width="39%" height="228"  style="text-align:left;"><span style="text-align:right">
  ...
  <tr>
    <td height="19" colspan="3" class="border-left-fntsize12"><div class="normalfnt"><span >(Kg.)</span></div></td>
    <td colspan="3" class="border-left-right-fntsize12">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize12">&nbsp;</td>
  ...
  <tr>
    <td height="19" colspan="5" class="border-left-fntsize12"><span style="text-align:left; vertical-align:text-top">Container Type :&nbsp;
        <?php
  ...
  <tr>
    <td height="27" colspan="9" class="border-left-right-fntsize12">&nbsp;</td>
  </tr>
  <tr>
    <td height="19" colspan="3" class="border-left-fntsize12"><div align="center" class="normalfntMid">Date</div></td>
    <td colspan="3" >&nbsp;</td>
  ...
  <tr>
    <td height="40" colspan="5" class="border-left-fntsize12">&nbsp;</td>
  ...
  <tr>
    <td height="36" colspan="5" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize12"><div  class="normalfnt">&nbsp;&nbsp;&nbsp;Date</div></td>
    <td colspan="3" >&nbsp;</td>
    <td colspan="3" class="border-right-fntsize12"><div  class="normalfntMid">Signature</div></td>
    </tr>
  ...
  <tr>
    <td height="40" class="border-left-fntsize12"><div  class="normalfntMid">Date</div></td>
    <td colspan="2" >&nbsp;</td>
    <td colspan="2" ><div  class="normalfntMid">Signature</div></td>
    </tr>
  <tr>
    ...
    <td colspan="3" rowspan="2" class="border-top-left-fntsize12">&nbsp;</td>
    <td colspan="3" rowspan="2" class="border-top-left-fntsize12">&nbsp;</td>
    <td height="19" colspan="5" class="border-top-left-fntsize12"><div class="normalfnt">25.(a)Status of Container8130/1 </div></td>
  ...
  <tr>
    <td height="39" class="border-All" >&nbsp;</td>
  ...
  <tr>
    <td height="37" colspan="3" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize12">&nbsp;</td>
  ...
  <tr>
    <td height="40" colspan="9" class="border-left-right-fntsize12"><dd>
	<?php 
$SQLNO1 =  "SELECT
			wharfclerks.strName,
...
?>
  ...
  <tr>
    <td height="35" colspan="3" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize12">&nbsp;</td>
  ...
  <tr>
    <td height="36" colspan="3" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="5" class="border-left-fntsize12">&nbsp;</td>
    <td colspan="9" class="border-left-right-fntsize12">&nbsp;</td>
  </tr>
