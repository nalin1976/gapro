...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
      ...
      <?php 
  		$str_summary="select 
		strUnitID,strDescOfGoods,strFabrication,strPriceUnitID,sum(dblAmount) as totamt,sum(dblQuantity) as totqty
		from invoicedetail
		where strInvoiceNo ='$invoiceNo'
		...
		$str_CTNS = "Select SUM(intNoOfCTns) As CTNSUM, SUM(intCBM) AS CBMSum, SUM(dblGrossMass) AS SumGross, SUM(dblNetMass) AS SumNet From invoicedetail Where strInvoiceNo='$invoiceNo' group by strInvoiceNo";
        ...
        <td colspan="6" class="border-left">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
	  	...
	  	$str_desc="select
					...
					invoicedetail					
					where 
					strInvoiceNo='$invoiceNo' GROUP BY dblUnitPrice
 order by intItemNo
";
					//die($str_desc);
