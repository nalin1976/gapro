...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td class="normalfnt2bldBLACKmid"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="20%">&nbsp;</td>
        <td width="60%" style="text-align:center"><?PHP echo 'COMMERCIAL INVOICE NO : ';?><?PHP echo $dataholder['strInvoiceNo'];?></td>
        <td width="20%"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      ...
      <tr>
        <td class="normalfnth2B">Shipped From </td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td colspan="2"><?php echo $dataholder['soldtoAName'];?></td>
        </tr>
        ...
        <td>&nbsp;</td>
        <td colspan="2"></td>
        <td><strong>Consignee</strong>:<?php echo $dataholder['BuyerAName']?></td>
        <td colspan="2"></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>&nbsp;</td>
        <td colspan="2"><?php echo $dataholder['soldtoAddress1'];?></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"></td>
        <td><strong>Notify party</strong>:<?php echo $dataholder['strBuyerCode']?></td>
        <td colspan="2"></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>&nbsp;</td>
        <td colspan="2"><?php echo $dataholder['soldtoCountry'];?></td>
        </tr>
