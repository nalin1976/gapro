		    ...
		    <tr>
		      <td><table width="100%" height="175" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
		        <tr>
		          ...
		          <td> Vessel Name</td>
		          <td><input name="txtVesselName" tabindex="15" type="text" class="txtbox" id="txtVesselName"  style="width:158px" maxlength="25" /></td>
...
?>
      ...
      <tr>
		...
		<table width="100%"  >
		  <tr>
		    <td width="70" height="15">Invoice No </td>
		    <td width="167"><input name="txtInvoiceDetail" type="text" class="txtbox" id="txtInvoiceDetail"  size="25" maxlength="10" disabled="disabled" /></td>
		    <td width="114" ><img src="../../../images/addsmall.png" title="Add PL" style="cursor:pointer;" onclick="viewPOPUPDetail();"/></td>
		    <td width="85" >Add Detail</td>
		    <td width="118" ><img src="../../../images/add.png" width="28" height="28" class="mouseover" onclick="showCatPopUp();" /></td>
		    <td width="328" >SC No &nbsp;<input name="txtScNo" type="text" class="txtbox" id="txtScNo"  size="25" maxlength="10" disabled="disabled" /></td>
            <td width="84" >&nbsp;</td>
			</tr>
		<tr>
		<td height="80" colspan="6" ><div style="overflow: scroll; height: 250px; width: 900px;" id="selectitem"><table width="1200" cellspacing="1" cellpadding="0" class="bcgl1" id="tblDescription">
          ...
          <tr>
            ...
            <td width="5%" bgcolor="#498CC2" class="normaltxtmidb2">SC# </td>
		    ...
		    <tr>
              ...
              <tr>
                ...
                <td><img src="../../../images/addsmall.png" alt="add" width="70" height="24" class="mouseover"  onclick="addToGrid();" /><img src="../../../images/new.png" alt="new" name="butNew" width="70" height="24" class="mouseover"  id="butNew2" onclick=" newDettail();setGenDesc();"/> <img src="../../../images/addmark.png" alt="addDetails" name="addDetails" width="40" height="25" class="mouseover" onclick="addDetailsToGrid();"/></td>
                            ...
                            <tr>
                <td height="25">GSP Approvel</td>
                <td><input type="checkbox" name="GSP_app" class="txtbox" id="GSP_app"  /></td>
                <td></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
