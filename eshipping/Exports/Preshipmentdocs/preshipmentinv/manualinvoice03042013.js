...
{
newDettail();
document.getElementById('txtStyle').value=this.cells[1].childNodes[0].nodeValue;
...
document.getElementById('txtareaDisc').value=this.cells[4].childNodes[0].nodeValue;
document.getElementById('txtUnit').value=this.cells[10].childNodes[0].nodeValue;
...
document.getElementById('txtBuyerPO').value=this.cells[2].childNodes[0].nodeValue;
...
document.getElementById('txtCBM').value=this.cells[20].childNodes[0].nodeValue;
document.getElementById('txtFabric').value=empty_handle_str(this.cells[5].childNodes[0].nodeValue);
document.getElementById('txtColor').value=this.cells[6].childNodes[0].nodeValue;
document.getElementById('txtPL').value=this.cells[3].childNodes[0].nodeValue;
