...
<table width="985" border="0" cellspacing="0" cellpadding="1" align="center">
    ...
    <tr>
	  <td colspan="2" class="normalfnt_size10" style="height:20"><b>&nbsp;UPS Supply Chain Solutions <sup>SM</sup></b></td>
    </tr>
    <tr>
        <td width="893" height="100" class="normalfnt_size10" style="text-align:center"><span style="font-size:16px"><b>Air Freight Shipper's Letter of Instruction</b></span><br />
  ...
  <tr>
    ...
    <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $Company; ?>.</td>
    <td class="normalfnt_size10">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="20" class="border-left-fntsize10">&nbsp;</td>
    <td colspan="2" class="normalfnt_size10">&nbsp;</td>
    <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $Address; ?>,<?php echo $City; ?>.</td>
    <td class="normalfnt_size10">&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3" class="border-left-right-fntsize10">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="3" rowspan="10" class="border-Left-Top-right-fntsize10"><table width="100%" border="0" cellspacing="3" cellpadding="0">
      ...
      <tr>
        <td style="border-bottom:dotted" class="normalfnth2B">&nbsp;<?php echo $row['strBuyerPONo']; ?></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="28" colspan="3" class="border-left-fntsize10">&nbsp;</td>
    <td class="normalfnt_size10" >&nbsp;</td>
   ...
   <tr>
    ...
    <td colspan="4" class="border-top-fntsize10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BuyerName']; ?>.
   ...
   <tr>
     ...
     <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BuyerAddress1']; ?></td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     </tr>
   <tr>
     <td height="20" class="border-left-fntsize10">&nbsp;</td>
     <td colspan="2" class="normalfnt_size10">&nbsp;</td>
     <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BuyerAddress2']; ?>,<?php echo $row['BuyerCountry']; ?>.</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     </tr>
   <tr>
   ...
   <tr>
     <td height="20" colspan="3" class="border-left-fntsize10" style="text-align:right">&nbsp;TELEPHONE :&nbsp;</td>
     <td class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BuyerPhone'];?></td>
     <td class="normalfnt_size10" style="text-align:right">&nbsp;&nbsp;FAX :</td>
     <td class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BuyerFax'];?></td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     </tr>
   <tr>
     <td height="28" class="border-left-fntsize10">&nbsp;</td>
     <td colspan="2" class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
   ...
   <tr>
     ...
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td colspan="3" class="border-left-right-fntsize10 normalfnth2B">&nbsp;<?php echo $SailingDateArray[0]; ?>-<?php echo $SailingDateArray[1]; ?>-<?php echo $SailingDateArray[2]; ?></td>
   </tr>
   <tr>
     <td height="20" class="border-left-fntsize10">&nbsp;</td>
   ...
   <tr>
     ...
     <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BrokerName']; ?></td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
   ...
   <tr>
     <td height="20" class="border-left-fntsize10">&nbsp;</td>
     <td colspan="2" class="normalfnt_size10" style="text-align:right">&nbsp;ADDRESS :&nbsp;</td>
     <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BrokerAddress1']; ?></td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
   ...
   <tr>
     ...
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td colspan="4" class="normalfnt_size10 normalfnth2B" style="border-bottom:dotted">&nbsp;<?php echo $row['BrokerAddress2']; ?><?php echo $row['BrokerCountry']; ?></td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
   ...
   <tr>
     <td height="30" class="border-left-fntsize10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
     <td class="normalfnt_size10">&nbsp;</td>
   ...
   <tr>
     <td height="20" class="border-top-left-fntsize10">&nbsp;</td>
     <td height="20" colspan="3" class="border-top-fntsize10">ORIGIN AIRPORT :&nbsp;<b><?php echo $row['strPortOfLoading']; ?></b></td>
     <td class="border-top-fntsize10">&nbsp;</td>
   ...
   <tr>
     ...
     <td colspan="3" class="border-top-fntsize10">DESTINATION AIRPORT : &nbsp;<b><?php echo $row['port']; ?></b></td>
     <td class="border-top-fntsize10">&nbsp;</td>
     <td colspan="7" class="border-Left-Top-right-fntsize10"><table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr>
    <td>&nbsp;</td>
   ...
   <tr>
     <td colspan="12" class="border-Left-Top-right-fntsize10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         <td width="77" height="196" class="border-top-fntsize10">&nbsp;</td>
         <td width="65" class="border-top-left-fntsize9" style="vertical-align:text-top; text-align:center"><p>PLTS<br /><b><?php echo $row['dblQuantity']; ?><br />
           (<?php echo $r_summary->summary_string($invoiceNo,'strUnitID'); ?>)</b></p>
           <p>&nbsp;</p></td>
         <td width="90" class="border-top-left-fntsize9" style="vertical-align:text-top; text-align:center">PLTS<br /><b><?php echo $row['dblQuantity']; ?><br />
           (<?php echo $r_summary->summary_string($invoiceNo,'strUnitID'); ?>)</b></td>
         <td width="62" class="border-top-left-fntsize9">&nbsp;</td>
         <td  class="border-top-left-fntsize9" style="text-align:center; vertical-align:text-top"><b><br /><?php  echo $row['dblGrossMass'];?></b></td>
         <td  class="border-top-left-fntsize9" style="text-align:center; vertical-align:text-top"><b><br /><?php  echo $row['intCBM'];?></b></td>
         <td  class="border-top-left-fntsize9"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
       
              <tr>
                <td>
                  <p><b><br />&nbsp;&nbsp;<?php echo $row['strDescOfGoods']; ?><br />&nbsp;&nbsp;<?php echo $row['strFabrication']; ?>
                    <br /><br />
                    &nbsp;&nbsp;PO NO :&nbsp;<?php echo $row['strBuyerPONo']; ?><br />
                    &nbsp;&nbsp;STYLE :&nbsp;<?php echo $row['strStyleID']; ?>
                    <br /><br />
                    &nbsp;&nbsp;CARGO READY DATE:&nbsp;&nbsp;<?php echo $SailingDateArray[0]; ?>-<?php echo $SailingDateArray[1]; ?>-<?php echo $SailingDateArray[2]; ?>
                    <br /><br />
                    &nbsp;&nbsp;FREIGHT&nbsp;&nbsp;<?php echo $row['strCollect']; ?></b></p>
                  <p class="normalfnBLD1" style="text-align:center; font-size:8px" >FOR ADDITIONAL ITEMS, PLEASE ATTACH RIDE</p>
                  </td>
              </tr>
