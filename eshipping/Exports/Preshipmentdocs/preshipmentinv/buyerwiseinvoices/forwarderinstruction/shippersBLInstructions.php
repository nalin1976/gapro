...
<td>
	...
	<tr>
		<td width="30%" class="border-top-left">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr><td class=""><b>VESSAL : </b>&nbsp;&nbsp;<?php echo $row['strCarrier']; ?></td></tr>
			</table>
		</td>
		...
		<td width="47%" class="border-Left-Top-right">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr>
					...
					<td width="24%" class="normalfnt" style="text-align:center"><?php  echo $row['dblGrossMass'];?></td>
				</tr>
			</table>
	  </td>
	</tr>
	...
	<tr>
		<td width="30%" class="border-top-left">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr><td class=""><b>PORT OF LOADING : </b>&nbsp;&nbsp;<?php echo $row['strPortOfLoading']; ?></td></tr>
			</table>
		</td>
		<td width="23%" class="border-top-left">
			<table cellspacing="0" align="center" border="0" width="100%">
		...
		<td width="47%" class="border-Left-Top-right">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr>
					...
					<td width="24%" class="normalfnt" style="text-align:center"><?php  echo $row['dblNetMass'];?></td>
				</tr>
			</table>
	  </td>
	</tr>
	...
	<tr>
		<td width="30%" class="border-top-left">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr>
				  <td class=""><b>PORT OF DISCHARGE :</b> &nbsp;<?php echo $row['port']; ?></td></tr>
			</table>
		</td>
		<td width="23%" class="border-top-left">
			<table cellspacing="0" align="center" border="0" width="100%">
				<tr><td class=""><b>FINAL DESTINATION :</b>&nbsp;<?php echo $row['port']; ?></td></tr>
			</table>
		</td>
	  ...
	  <tr>
		...
		<td width="23%" class="border-top-bottom-left" height="100" valign="top">
			<table cellspacing="0" border="0" width="100%" style="vertical-align:top">
				<tr><td class="" style="text-align:center; vertical-align:text-top"><br /><?php  echo $row['intNoOfCTns'];?>&nbsp;CTN</td></tr>
			</table>
		</td>
		...
		<td width="47%" class="border-All" height="100" valign="top">
			<table cellspacing="0" align="center" border="0" width="100%">
                ...
                <br />
                &nbsp;
                <?php echo $row['dblQuantity']; ?>&nbsp;<?php echo $r_summary->summary_string($invoiceNo,'strUnitID'); ?>&nbsp;OF&nbsp;<?php echo $row['strDescOfGoods']; ?>&nbsp;IN&nbsp;<?php echo $row['strFabrication']; ?>
                <br /><br />
                PO NO :&nbsp;<?php echo $row['strBuyerPONo']; ?><br /><br />
