...
<table width="920" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo $BuyerRemarks;?></td>
  </tr>
  <tr>
    <td colspan="5" class="border-top-left-fntsize10">&nbsp;<strong>CONSIGNEE/ IMPORTER : </strong></td>
    <td colspan="6" class="border-Left-Top-right-fntsize10">&nbsp;<strong> SHIP TO /NOTIFY PARTY :</strong></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;</td>
  ...
  <tr>
   ...
   <tr>
     ...
     <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo $dataholder['bankaddress1']." ".$dataholder['bankaddress2']." ".$dataholder['bankcountery'];?></td>
   </tr>
  <tr>
    <td colspan="2" class="border-left-fntsize10">&nbsp;</td>
    <td colspan="3" class="border-left-fntsize10">&nbsp;</td>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="border-left-fntsize10" style="text-align:center"><?php echo "FOB";?> UNIT</td>
        <td class="border-left-fntsize10" style="text-align:center"><?php echo  $dataholder['strCurrency'];?></td>
      </tr>
      <tr>
        <td>BRAND </td>
        ...
        <td class="border-left-fntsize10" style="text-align:center;font-size:9px"><?php echo "FOB SRI LANKA";?></td>
      </tr>
      <tr>
        <td>QUALITY STD </td>
      ...
      <tr>
        ...
        <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">CTNS</span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">LOT # </span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">PO#</span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">DC</span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">DO# </span></td>
          <td class="border-left-fntsize10">&nbsp;</td>
          <td class="border-left-fntsize10">&nbsp;</td>
          <td class="border-left-fntsize10">&nbsp;</td>
        </tr>
      ...
      <?php 
		...
		$price_dtl=$row_desc["dblUnitPrice"];
		$amt_dtl=$row_desc["dblAmount"];
	  ?>
      ...
      <tr>
        ...
        <td style="text-align:center"><?php echo $row_desc["intNoOfCTns"];?></td>
          ...
          <td style="text-align:center"><span style="text-align:center"><?php echo $row_desc["strDc"];?></span></td>
          <td style="text-align:center"><span style="text-align:center"><?php echo $row_desc["strISDno"];?></span></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="7" rowspan="8" valign="top" class="border-right-fntsize10"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt_size10">
      <tr>
        <td width="50%"><strong>
          <?php  echo $mainmark1;?>
        </strong></td>
  ...
  <tr>
    <td colspan="3" class="border-left-fntsize10">&nbsp;GPA NUMBER : </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" class="border-left-fntsize10">&nbsp;<?php echo "PS NO.(#) :".$com_inv_dataholder['strPSno'];?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="border-left-fntsize10">&nbsp;CARTON SIZE </td>
    <td><?php echo $com_inv_dataholder['strCTNSize'];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="border-left-fntsize10">&nbsp;CARTON TYPE </td>
    <td><?php echo $com_inv_dataholder['strCTNSType'];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="border-left-fntsize10">&nbsp;MAWB #</td>
    <td ><?php echo $com_inv_dataholder['strMAWB'];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5" class="border-left-fntsize10">&quot;SEE ANNEXURE FOR NET NET WEIGHT     PER PRODUCT CODE / PER SIZES&quot;</td>
    <td colspan="2" >&nbsp;</td>
  ...
  <tr>
    <td colspan="5" rowspan="2" class="border-left-fntsize10 cusdec-normalfnt2bldBLACK" ><?php echo ($com_inv_dataholder['strFreightPC']!=""? "FREIGHT ".$com_inv_dataholder['strFreightPC']:"");?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="border-left-fntsize10">&nbsp;</td>
    <td >&nbsp;</td>
