...
<table style="width:800px;" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="text-align:center;font-family:'Times New Roman';font-weight:bold;font-size:12px" height="20" bgcolor="#999999"><?php echo $Address;?></span>,<?php echo $City;?>. Tel: <?php echo $phone;?> Fax: <?php echo $Fax;?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt"  style="font-weight:bold;font-size:10px;line-height:14px;">
      ...
      <tr>
        ...
        <td>ISD # </td>
        <td><?php echo ($data_header['strISDno']!='n/a'?$data_header['strISDno']:"");?></td>
      </tr>
      <tr>
        <td>SAILING DATE:</td>
