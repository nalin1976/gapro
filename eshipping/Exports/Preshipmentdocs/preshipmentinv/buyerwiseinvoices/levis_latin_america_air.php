...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    ...
    <td colspan="6" class="border-Left-Top-right-fntsize10" >&nbsp;<?php echo $dataholder['banklckname'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td  style="text-align:center"><u><strong>PO #</strong></u></td>
      ...
      <tr>
        ...
        <td style="font-size:9px;">&nbsp;&nbsp;&nbsp;<?php echo $row_desc["strDescOfGoods"];?></td>
