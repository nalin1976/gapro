  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="border-left-fntsize10" style="text-align:center"><?php echo $dataholder['strCurrency']." ". $inco_terms;?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td class="border-left-fntsize10" style="text-align:center;"><?php echo ($inco_terms=="FOB"?$dataholder['strPortOfLoading'].", SRI LANKA":$dataholder['tolocation']);?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td colspan="5" rowspan="4" valign="bottom"><?php if($tot_ch>0){?>
