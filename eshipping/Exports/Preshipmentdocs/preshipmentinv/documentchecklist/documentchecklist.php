...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" class=" border-Left-Top-right" style="text-align:center;font-family:'Times New Roman';font-weight:bold;font-size:60px" height="56" ><img src="../../../../images/maersk-logistics.gif" width="769" height="83" /></td>
  </tr>
    ...
    <td width="92%"><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt">
      ...
      <tr>
        ...
        <?php    			$sql_EntryNo = "SELECT
							...
							$result=$db->RunQuery($sql_EntryNo);
							$row=mysql_fetch_array($result);
							echo $row['strCustomesEntry'];
		?>
        &nbsp;</td>
        <td>&nbsp;</td>
      </tr>
