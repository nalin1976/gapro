			          ...
			          <tr>
			            <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="2" class="bcgl1">
			              ...
			              <tr>
			                ...
			                <td width="44%" class="normalfnt"><input name="txtDocNo" id="txtDocNo" style="width:140px" class="txtbox" type="text" tabindex="1" /></td>
			              ...
			              <tr>
			                ...
			                <td class="normalfnt"><input name="txtCDNNo" id="txtCDNNo" style="width:140px" class="txtbox" type="text" tabindex="1" /></td>
			                <td class="normalfnt">&nbsp;</td>
			                </tr>
			              <tr>
			                <td class="normalfnt">&nbsp;</td>
			              ...
			              <tr>
                            ...
                            <tr>
			                <td class="normalfnt">&nbsp;</td>
			                <td class="normalfnt">Hellmann</td>
			                <td class="normalfnt"><input type="checkbox" id="chk_hell" /></td>
			                <td class="normalfnt">&nbsp;</td>
			                </tr>
