...
{
	if(document.getElementById('chk_ups').checked==false && document.getElementById('chk_expeditors').checked==false && document.getElementById('chk_bax').checked==false && document.getElementById('chk_hell').checked==false)
...
function printDoc()
{
	if(document.getElementById('txtDocNo').value!='')
	{
		...
		if(document.getElementById('chk_hell').checked)
			window.open("hell_report.php?type=doc&docNo="+document.getElementById('txtDocNo').value);
	}
	else
	{
		if(document.getElementById('chk_ups').checked)
		...
		if(document.getElementById('chk_hell').checked)
			window.open("hell_report.php?type=doc&docNo="+document.getElementById('txtCDNNo').value);
	}
}