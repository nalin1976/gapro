...
$sql_page="SELECT 	strHSCode FROM 	invoicedetail WHERE  strInvoiceNo='$invoiceNo' group by strHSCode;";
...
?>
            ...
            <tr>
              <td height="19" colspan="2" class="border-left-right-fntsize12">&nbsp;<?php echo $exporterName1."ORIT TRADING LANKA (PVT) LTD";?></td>
            </tr>
            <tr>
        ...
        <td width="53%" colspan="4"><table width="100%" height="102" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="26" class="border-right"><div align="center">2</div></td>
...
{	
	...
	$noOfPackages_1			= $row_details["intNoOfCTns"];
	...
	$unit_1					= $row_details["strPriceUnitID"];
	...
	$Fabrication_1	= $row_details["strFabrication"];
...
' class="normalfnt_size12"><?php echo $itemDescription_1."\n\n".$commodityCode_1."\n".$Fabrication_1;?></textarea></td>
            ...
            <tr>
              ...
              <td class="border-right"><?php echo ($noOfPackages_1!=""?$noOfPackages_1." CTNS":'');?></td>
      ...
      <tr>
        ...
        <td colspan="5" height="10"><table width="100%" border="0" height="20" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="border-bottom-right" style="text-align:center"><?php echo ($umoqty1_3=="" ? "":round($umoqty1_3))." ".$umoqtyuint1_3;?></td>
              <td colspan="2" class="border-bottom" style="text-align:center"><?php echo ($itmValue_1=="" ? "":number_format($itmValue_1*$exRate,0))?></td>
            </tr>
        </table></td>
      </tr>
      <tr>
...
while($row_details=mysql_fetch_array($result_details))
{
	...
	$noOfPackages_2			= $row_details["intNoOfCTns"];
	...
	$unit_2					= $row_details["strPriceUnitID"];
	...
	$Fabrication_2	= $row_details["strFabrication"];
...
' class="normalfnt_size12"><?php echo $itemDescription_2."\n\n".$commodityCode_2."\n".$Fabrication_2;?></textarea></td>
            ...
            <tr>
              <td height="31" class="normalfnt_size10">&nbsp;</td>
              <td class="border-right"><?php echo ($noOfPackages_2!=""?$noOfPackages_2." CTNS":'');?></td>
              <td colspan="2" class="border-right-fntsize10">&nbsp;<strong>37. Procedure Code</strong></td>
            ...
            <tr>
              ...
              <td class="border-bottom-right" style="text-align:center"><?php echo ($itmValue_2=="" ? "":$currency." ".number_format($itmValue_2,2));?></td>
              <td class="border-bottom">&nbsp;</td>
            </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td colspan="7" height="10" class="normalfnt_size10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="border-bottom">&nbsp;</td>
              <td colspan="2" class="border-bottom-right-fntsize10">&nbsp;</td>
              <td class="border-bottom-right" style="text-align:center"><?php echo ($umoqty2_3=="" ? "":round($umoqty2_3))." ".$umoqtyuint2_3;?></td>
              <td colspan="2" class="border-bottom" style="text-align:center"><span class="border-bottom" style="text-align:center"><?php echo ($itmValue_2=="" ? "":number_format($itmValue_2*$exRate,0))?></span></td>
            </tr>
        </table></td>
      </tr>
      <tr>
...
while($row_details=mysql_fetch_array($result_details))
{
	...
	$noOfPackages_3			= $row_details["intNoOfCTns"];
	...
	$unit_3					= $row_details["strPriceUnitID"];
	...
	$Fabrication_3	= $row_details["strFabrication"];
}
?>
...
' class="normalfnt_size12"><?php echo $itemDescription_3."\n\n".$commodityCode_3."\n".$commodityCode_3;?></textarea></td>
            ...
            <tr>
              <td height="31" class="normalfnt_size10">&nbsp;</td>
              <td class="border-right"><?php echo ($noOfPackages_3!=""?$noOfPackages_3." CTNS":'');?></td>
              <td colspan="2" class="border-right-fntsize10">&nbsp;<strong>37. Procedure Code</strong></td>
              <td width="18%" class="normalfnt_size10">&nbsp;<strong>38. Net Mass (Kg)</strong></td>
              <td width="13%" class="normalfnt_size10">&nbsp;<strong>39. Quota</strong></td>
            </tr>
            ...
            <tr>
              ...
              <td class="border-bottom-right" style="text-align:center"><?php echo ($itmValue_3=="" ? "":$currency." ".number_format($itmValue_3,2));?></td>
              <td class="border-bottom">&nbsp;</td>
            </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td colspan="7"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="border-bottom">&nbsp;</td>
              <td colspan="2" class="border-bottom-right-fntsize10">&nbsp;</td>
              <td class="border-bottom-right" style="text-align:center"><span style="text-align:center"><?php echo ($umoqty3_3=="" ? "":round($umoqty3_3))." ".$umoqtyuint3_3 ;?></span></td>
              <td colspan="2" class="border-bottom" style="text-align:center"><span class="border-bottom" style="text-align:center"><?php echo ($itmValue_3=="" ? "":number_format($itmValue_3*$exRate,0))?></span></td>
            </tr>
        </table></td>
      </tr>
      <tr>
