...
document.getElementById("txtBookingNo").value=xmlHttp[0].responseXML.getElementsByTagName("BookingNo")[0].childNodes[0].nodeValue;
document.getElementById("txtNSLInvNo").value=xmlHttp[0].responseXML.getElementsByTagName("NSLInvoiceNo")[0].childNodes[0].nodeValue;
...
if(document.getElementById("txtBookingNo").value=="")
{
alert("Please Enter a Booking No.")
document.getElementById("txtBookingNo").focus();
return false;
}

//if(document.getElementById("txtNSLInvNo").value=="")
//{
//alert("Please Enter a NSL Invoice No.")
//document.getElementById("txtNSLInvNo").focus();
//return false;
//}
...
/*------------------------ dhanushka 3-27-2013 --------------- */
var bookingNo			=document.getElementById("txtBookingNo").value;
var nslInvoiceNo			=document.getElementById("txtNSLInvNo").value;
	 ...
	 + '&bank=' +bank+ '&loading=' +loading+ '&carrier=' +carrier+ '&destination=' +destination+'&voyageeno=' +voyageeno+
	  '&currency=' +currency+ '&edit=' +edit+ '&sailing=' +sailing+'&exchangerate=' +exchangerate+ '&TransMode=' +TransMode+
	   '&manufactdate=' +manufactdate+ '&incoterm=' +URLEncode(incoterm)+ '&inveta=' +inveta+ '&preinvno=' +URLEncode(preinvno)+
		...
		+buyerBank+ '&bookingNo='+ bookingNo + '&nslInvoiceNo='+ nslInvoiceNo +'&proInvNo=' +URLEncode(proInvNo),true);
	xmlHttp[1].send(null);
}
}
...
{
	//location.reload();
	var chkVal=$('#Pending_comm').is(':checked');
	  ...
	  if(chkVal)
		...
		if(chkCom==1)
		{
			...
			//document.getElementById('cboInvoiceNo').value="";
			//$( "#cboInvoiceNo" ).remove;
			var url7	='commercialinvoiceDB.php?REQUEST=loadpending';
		...
		//alert(pub_pending_arr);
			document.getElementById('txtLoadPreInvoiceNo').innerHTML=pub_xml_http_obj7.responseText;
			$( "#txtLoadPreInvoiceNo" ).autocomplete({
