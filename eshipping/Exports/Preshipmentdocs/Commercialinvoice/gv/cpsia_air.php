...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><?php echo $data_header['strHAWB'];?></td>
  </tr>
  <tr>
  ...
  $str_desc="select
		...
		while($row_desc=mysql_fetch_array($result_desc) or $no<=13)
		
		{$no++;?>
  <tr>
    <td class="border-bottom-left-fntsize10"><?php echo "(".($no-1).")";?></td>
    <td class="border-bottom-fntsize10"><?php echo $row_desc["strBuyerPONo"];?></td>
    <td class="border-bottom-fntsize10"><?php echo $row_desc["strStyleID"];?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
		...
		while($row_desc=mysql_fetch_array($result_desc))
				{
					...
					?>
				var no='<?php echo $no;?>';
				var HAWB='<?php echo $data_header['strHAWB'];?>';
				var style='<?php echo $row_desc["strStyleID"];?>';
				var po='<?php echo $row_desc["strBuyerPONo"];?>';
				if(no!=1)
				window.open("cpsia_air_ii.php?HAWB="+HAWB+'&style='+style+'&po='+po,no)
<?php }?>
</script>
</body>
</html>