...
$invoicNumber=$detail_data_set['strInvoiceNo'];
$str_headerNew="SELECT
strCatNo
FROM
invoicedetail
WHERE invoicedetail.strInvoiceNo='$invoicNumber'";

$result_detail2=$db->RunQuery($str_headerNew);
$row_detail2 = mysql_fetch_array($result_detail2);
...
<table style="width:800px;"border="0" cellspacing="1" cellpadding="0" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  class="dragableElement" style="z-index:25; position:absolute; left:68px; top:109px; width:305px; height:92px;" >
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:595px; top:57px; width:305px; height:22px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
            ...
            <tr>
              <td style="height:12px" class="normalfnt"><span class="normalfnt" style="height:12px"><?php echo $Country;?></span></td>
            </tr>
			<tr>
              <td width="340" style="height:12px" class="doctext2">&nbsp;</td>
            </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:71px; top:299px; width:305px; height:92px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:157px; top:564px; width:188px; height:70px;" class="dragableElement" >
  ...
  <tr bgcolor="#FFFFFF">
    <td height="25">&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:66px; top:436px; width:305px; height:22px;" class="dragableElement" >
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="14" nowrap="nowrap" class="paragraph"><table cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
     <td><div  style="z-index:25; position:absolute; left:299px; top:566px; width:150px; height:181px;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="3" width="340" style="height:12px;" class="doctext2"><span class="normalfnt" style="height:12px;"><?php  echo $detail_data_set['intNoOfCTns'];?>Cartons</span></td>
          </tr>
		  <tr>
            <td height="14"  class="paragraph">&nbsp;</td>
          </tr>
		  <tr>
            <td colspan="3" width="240" height="14"  class="paragraph"><span class="normalfnt"><?php echo $detail_data_set['dblQuantity'];?>&nbsp;&nbsp;Pcs of<br/><?php echo $detail_data_set['strDescOfGoods'];?></span></td>
          </tr>
		  <tr>
            <td height="14"  class="paragraph">&nbsp;</td>
          </tr>
		  <tr>
		  <td colspan="3" width="240" height="14"  class="paragraph"><span class="normalfnt">Category No:<?php echo $row_detail2['strCatNo'];?></span></td>
		  </tr>
		  <tr>
            <td height="14"  class="paragraph">&nbsp;</td>
          </tr>
		  <tr>
            <td width="120" height="14"  class="paragraph"><span class="normalfnt"><u>Style No</u><br/><?php echo $detail_data_set['strStyleID'];?></span></td>
			 <td width="240" height="14"  class="paragraph"><span class="normalfnt"><u>PO No</u><br/><?php echo $detail_data_set['strBuyerPONo'];?></span></td>
			 <td height="14"  class="paragraph">&nbsp;</td>
          </tr>
          ...
          <tr>
             <td colspan="2" width="240" height="14"  class="paragraph"><span class="normalfnt">FOB VALUE:<?php echo $detail_data_set['dblAmount'];?></span></td>
          </tr>
        </table>
      </div>
    </div></td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:479px; top:520px; width:64px; height:44px;" class="dragableElement" >
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:587px; top:548px; width:55px; height:44px;" class="dragableElement" >
      <table width="94" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="94" height="14" nowrap="nowrap" class="normalfnt" style="text-align:center">&nbsp;</td>
        </tr>
        <tr>
          <td height="14" nowrap="nowrap" class="normalfnt" style="text-align:center"><u>Gross Wt</u><br/><?php echo $detail_data_set['dblGrossMass']; ?>kgs</td>
        </tr>
        <tr>
          <td height="14" nowrap="nowrap" class="normalfnt" style="text-align:center">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td height="14" nowrap="nowrap" class="normalfnt" style="text-align:center"><u>Net Wt</u><br/><?php echo $detail_data_set['dblNetMass']; ?>kgs</td>
        </tr>
        <tr>
          <td height="14" nowrap="nowrap" class="normalfnt" style="text-align:center">&nbsp;</td>
        </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:695px; top:532px; width:55px; height:44px;" class="dragableElement" >
      <table width="94" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="94" height="14" nowrap="nowrap" class="normalfnt" style="text-align:center">&nbsp;</td>
        </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:111px; top:966px; width:250px; height:17PX;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
          <tr>
    ...
    <td>
	<td><div  style="z-index:25; position:absolute; left:84px; top:1067px; width:122px; height:15px;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="240" height="14"  class="normalfnt" style="text-align:center"><span class="normalfnt" style="text-align:center"><?php echo $detail_data_set['buyerCountry'];?></span></td>
          </tr>
        </table>
      </div>
    </div></td>
    ...
    <td><div  style="z-index:25; position:absolute; left:44px; top:1118px; width:122px; height:15px;" class="dragableElement"  >
      <div style="width:300px;">
        <table  border="0" cellpadding="0" cellspacing="0">
          <tr>
		  	<td width="240" height="14"  class="normalfnt" style="text-align:center">COLOMBO</td>
            <td width="240" height="14"  class="normalfnt" style="text-align:center"><?php echo $gspDate; ?></td>
          </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div style="z-index:24; position:absolute; left:54px; top:879px; width:283px; height:250px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div   style="z-index:24; position:absolute; left:305px; top:518px; width:170px; height:315px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div></td><td><div   style="z-index:24; position:absolute; left:123px; top:518px; width:174px; height:316px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:482px; top:518px; width:80px; height:223px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:582px; top:521px; width:80px; height:220px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:669px; top:521px; width:85px; height:220px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:508px; top:96px; width:306px; height:150px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:58px; top:518px; width:55px; height:180px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:57px; top:426px; width:315px; height:42px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:54px; top:94px; width:315px; height:108px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:55px; top:296px; width:315px; height:106px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
    <div   style="z-index:24; position:absolute; left:425px; top:296px; width:351px; height:103px; border-style:dotted; border:dashed" class="hideWhilePrinting" ></div>
