...
<body><table width="1000" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt" style="font-weight:bold;font-size:10px;line-height:12px;">
      <tr>
...
while(($row_cell_data=mysql_fetch_array($result_cell_data))|| ($count<$col_dyn))
{
	$col_atrray[$row_cell_data['intColumnNo']]= $row_cell_data['dblPcs']*$row_row_data['dblNoofCTNS'];?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td width="<?php echo $col_width.'%';?>" class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $row_dyn['dblPcs'];?></td>
        <?php }?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td  class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $tot_pcs=size_wise_total($row_dyn['intColumnNo'],"0");?></td>
        <?php }?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td  class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $tot_pcs=size_wise_total($row_dyn['intColumnNo'],"1");?></td>
        <?php }?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td  class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $tot_pcs=size_wise_total($row_dyn['intColumnNo'],"2");?></td>
        <?php }?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
		...
		$result_dyn=$db->RunQuery($str_dyn);
		  while($row_dyn=mysql_fetch_array($result_dyn)){?>
        <td  class="border-top-right-fntsize9 tbl-h-fnt" nowrap="nowrap"><?php echo $tot_pcs=size_wise_total($row_dyn['intColumnNo'],'');?></td>
        <?php }?>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
        <td >&nbsp;</td>
        <td colspan="4" class="normalfnt2bldBLACK" >ORIT TRADING LANKA (PVT) LTD</td>
        <td >&nbsp;</td>
        <td >&nbsp;</td>
        <td >&nbsp;</td>
        <td colspan="<?php echo $col_dyn;?>">&nbsp;</td>
      ...
      <tr  class="tbl-h-fnt" style="text-align:left">
        <td >&nbsp;</td>
        <td colspan="4" class="normalfnth2B" >Commercial Manager</td>
        <td >&nbsp;</td>
        <td >&nbsp;</td>
        <td >&nbsp;</td>
        <td colspan="<?php echo $col_dyn;?>">&nbsp;</td>
