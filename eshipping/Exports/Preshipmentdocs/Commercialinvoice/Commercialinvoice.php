        ...
        <td height="280" colspan="2" class="normalfnt"><div id="div"  style=" width:100%;">
          <table width="100%"  id="tblGen">
            ...
            <tr>
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bcgl1">
                  <tr>
                     <td><input type="checkbox" name="Pending_Cdn" class="txtbox" id="Pending_comm" onchange="Pen_comm();" /></td>
                    <td>Pre Invoice </td>
                    <td height="25">
...
?>
            ...
            <tr>
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bcgl1">
                ...
                <td height="25">&nbsp;</td>
                <td>Discount</td>
                <td colspan="0"><input name="txtDiscount" type="text" value="0" class="txtbox" id="txtDiscount" style="width:50px; text-align:right"  maxlength="10" onkeypress="return CheckforValidDecimal(this.value, 4,event);" />
                <select name="cboPrecentageValue" type="text"  id="cboPrecentageValue" class="txtbox" style="width:50px" >
                    ...
                    <td>Booking No</td>
                    <td><input name="txtBookingNo" tabindex="15" type="text" class="txtbox" id="txtBookingNo"  style="width:158px" maxlength="40" /></td>
                    <td>NSL Invoice No</td>
                    <td><input name="txtNSLInvNo" tabindex="15" type="text" class="txtbox" id="txtNSLInvNo"  style="width:158px" maxlength="40" /></td>
                </tr>
                </table></td>
            </tr>
		...
		<td colspan="2"><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#D6E7F5">
		  <tr>
		    ...
		    <td width="62"><img src="../../../images/report.png" alt="butReportList" name="butReportList" width="108" height="24" class="mouseover" id="butReport2" onclick="prit_straight();"/></td>
		...
		<tr>
		  <td colspan="6" ><table width="100%" border="0" cellpadding="3" cellspacing="0" class="normalfnt bcgl1">
		    ...
		    <tr>
              ...
              <tr>
                <td height="25">HS Code(for GSP Report)</td>
                <td ><input name="txtHsCode" type="text" class="txtbox" id="txtHsCode" style="width:100px;" maxlength="30" tabindex="10"/></td>
                <td><input name="txtColor" tabindex="23" type="text" class="txtbox" id="txtColor" size="15" maxlength="30" value="" style="visibility:hidden"/></td>
                <td valign="top">&nbsp;</td>
