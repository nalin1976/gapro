  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt"  style="font-weight:bold;font-size:10px;line-height:14px;">
      ...
      <tr>
        ...
        <td colspan="2">LEVI STRAUSS SA (PTY) LTD</td>
        </tr>
      <tr>
        <td>CONTAINER#</td>
        <td><?php echo $data_header['strContainer'];?></td>
        <td colspan="2">2, GUNNERS CIRCLE</td>
        </tr>
      <tr>
        <td>MAWB #</td>
        <td><?php echo $data_header['strMAWB'];?></td>
        <td colspan="2">EPPING INDUSTRIAL PARK</td>
        </tr>
      <tr>
        <td>MAWB #</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2">CARTON DIMENSION :</td>
      </tr>
      <tr>
        <td width="20%">&nbsp;</td>
        <td width="30%">&nbsp;</td>
