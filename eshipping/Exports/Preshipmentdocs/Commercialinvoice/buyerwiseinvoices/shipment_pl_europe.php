...
<body class="body_bound"><table style="width:800px;" border="0" cellspacing="0" cellpadding="0">
  <thead>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="1" class="normalfnt"  style="font-weight:bold;font-size:10px;line-height:14px;">
      <tr>
        ...
        <td>DATE:</td>
        <td><?php $date_array=explode("-",$data_header['dtmInvoiceDate']);$date_inv=$date_array[2]."/".$date_array[1]."/".$date_array[0];echo $date_inv;?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>DC#</td>
        <td><?php echo $data_header['strDc'];?></td>
      ...
      <tr>
        <td width="20%">&nbsp;</td>
        <td width="30%">&nbsp;</td>
        <td width="20%"><?php echo $sidemark6;?></td>
        <td width="30%">&nbsp;</td>
      </tr>
       <tr>
        <td width="20%">&nbsp;</td>
