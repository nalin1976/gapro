...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  <tr>
    <td colspan="11" class="cusdec-normalfnt2bldBLACK" style="text-align:center"><span class="cusdec-normalfnt2bldBLACK" style="text-align:center"><?php echo ($proforma==""?"COMMERCIAL":$proforma);?></span> INVOICE</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="6" class="border-Left-Top-right-fntsize10">&nbsp;<strong>SHIP TO AND NOTIFY PARTY: </strong></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;PAYMENT BY T.T (60 DAYS FROM THE B/L DATE)</td>
  </tr>
   <tr>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="border-left-fntsize10" style="text-align:center;font-size:7px"><?php echo ($dataholder['strIncoterms']=="FOB"?"SRI LANKA":$dataholder['city']);?></td>
      </tr>
      <tr>
        <td>QUALITY STD </td>
      ...
      <tr>
        ...
        <td colspan="2" class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">MATERIAL</span></td>
        <td class="border-top-bottom-left-fntsize10" style="text-align:center" nowrap="nowrap"><span class="invoicefntbold">ORDER NO</span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center" nowrap="nowrap"><span class="invoicefntbold">PRODUCT CODE</span></td>
          <td class="border-top-bottom-left-fntsize10" style="text-align:center"><span class="invoicefntbold">MRP/PCE</span></td>
		 ...
		 <tr>
        <td>&nbsp;</td>
        <td><strong><u>ISD NO</u></strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><span style="text-align:center"><?php echo $row_desc["strISDno"];?></span></td>
        <td colspan="2" style="text-align:center"><?php echo $row_desc["strFabric"];?></td>
        <td style="text-align:center" nowrap="nowrap"><?php echo $row_desc["strBuyerPONo"];?></td>
          <td style="text-align:center"><?php echo $row_desc["strStyleID"];?></td>
          <td style="text-align:center"><?php echo $row_desc["strMRP"];?></td>
          <td style="text-align:center"><?php echo $row_desc["intNoOfCTns"];?></td>
          <td class="border-left-fntsize10" style="text-align:right"><span class="normalfnt"><?php echo $row_desc["dblQuantity"];?></span></td>
      ...
      <tr>
        <td colspan="2">CARTON NOS:<strong><?php echo $totctns;?></strong></td>
        <td>&nbsp;</td>
        <td colspan="3" class="border-top-left-fntsize10"><strong>FOB BREAKDOWN</strong></td>
      ...
      <tr>
        <td colspan="3" nowrap="nowrap">COUNTERY OF MANUFACTURER: SRI LANKA</td>
      ...
      <tr>
        <td nowrap="nowrap">Net Net Weight</td>
  ...
  <tr>
    <td class="border-left-fntsize10">&nbsp;<?php echo ($com_inv_dataholder['strPSno']!=""?"PS NO.(#) :".$com_inv_dataholder['strPSno']:"");?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
