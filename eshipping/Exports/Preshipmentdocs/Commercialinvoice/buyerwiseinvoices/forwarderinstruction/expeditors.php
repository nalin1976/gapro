...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td class=""><table width="103%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      <tr>
        <td colspan="6" class="border-top-left">
          <table width="639">
            <tr>
              <td width="320" rowspan="2"> <img src="../../../../../images/expeditors.png" /></td>
              <td width="307" height="30"><br /><br /></td>
              
              </tr>
            <tr>
              <td class="normalfntMid" height="20" style="text-align:center"><p><br />
      ...
      <tr>
        ...
        &nbsp;<?php echo $BuyerCountry; ?><br /></td>
        <td colspan="3" class="normalfnth2B border-Left-Top-right">DESTINATION AIR PORT</td>
        <td width="13%" class="border-top-right"><?php echo $Destinationport; ?></td>
        <td width="13%" class="normalfnth2B border-top-right">PLACE OF DELIVERY</td>
        <td width="13%" class="border-top-right"><?php echo $Destinationcity; ?></td>
      </tr>
      <tr>
  ...
  <tr>
    <td class="border-left-right-fntsize12">
    	<table width="100%" border="0" cellspacing="0" cellpadding="2" class="normalfnt">
    		<thead>
   		  <td height="20" colspan="4" style="text-align:left" class=""><strong>SPECIAL INSTRUCTION (E.G.LETTER OF CREDIT/CONSULAR REQUIREMENTS)</strong></td>
          		<td width="4%" class="border-left" style="text-align:center">&nbsp;</td>
          		<td width="2%" class="" style="text-align:center">
    		</thead>
    
      <tr>
          <td width="12%" height="38" class="normalfnth2B border-top" style="text-align:center">NO OF PACKAGES</td>
        <td width="13%" height="38" class="border-top border-left" style="text-align:center"><span class="normalfnth2B">METHOD OF PACKING</span></td>
        <td width="29%" height="38" class="border-top border-left" style="text-align:center"><span class="normalfnth2B">NATURE AND QUANTITY OF GOODS</span></td>
       ...
       <tr height="">
          <td width="12%" height="" class="border-top" style="text-align:center; vertical-align:text-top"><?php  echo $r_summary->summary_sum($invoiceNo,'intNoOfCTns');?></td>
        ...
        <?php echo $r_summary->summary_sum($invoiceNo,'intNoOfCTns'); ?>&nbsp;<b>Cartons Containing</b><br />
        <?php echo $r_summary->summary_sum($invoiceNo,'dblQuantity'); ?>&nbsp;<?php echo $r_summary->summary_string($invoiceNo,'strUnitID'); ?>&nbsp;<b>of&nbsp;<?php echo $r_summary->summary_string($invoiceNo,'strDescOfGoods'); ?></b><br /><br /><b><?php echo $r_summary->summary_string($invoiceNo,'strFabric'); ?></b>
        </td>
        ...
        <td width="22%" colspan="-1" class="border-top border-left" style="text-align:center; vertical-align:text-top"><?php  echo $r_summary->summary_sum($invoiceNo,'dblCBM');?></td>
        <td width="11%" class="border-top border-left" style="text-align:center"><p class="" style="text-align:left">Gross :<br /><?php  echo $r_summary->summary_sum($invoiceNo,'dblGrossMass');?><br /><br />Net :<br /><?php  echo $r_summary->summary_sum($invoiceNo,'dblNetMass');?><br /><br />Net Net :<br /><?php  echo $r_summary->summary_sum($invoiceNo,'dblNetNet');?></p></td>
      </tr>
        <tr height="">
      ...
      <tr height="">
       ...
       <tr height="">
          <td width="12%" height="" class="normalfnth2B border-top " style="text-align:center">UPDATED :</td>
        <td width="13%" height="" class="border-top" style="text-align:center">&nbsp;</td>
        <td width="29%" height="" class="border-top" style="text-align:center">&nbsp;</td>
