...
<tr>
  ...
  <tr>
    <td class="normalfnt2bldBLACKmid"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="20%">&nbsp;</td>
        <td width="60%" style="text-align:center"><?PHP echo 'COMMERCIAL INVOICE';?></td>
        <td width="20%"></td>
      </tr>
    </table></td>
  </tr>
  ...
  ?>
      <tr>
		...
		$row_HS_summary=mysql_fetch_array($result_summary);		
			...
			echo $row_HS_summary['intNoOfCTns'];
			
				
	  ?>&nbsp;<?php if($dataholder['intPackingMthd']=='1'){echo "Cartoons";} else if($dataholder['intPackingMthd']=='2') {echo "GOH";} ?> CONTAINING..,</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td class="border-right-fntsize12">&nbsp;</td>
      </tr>
