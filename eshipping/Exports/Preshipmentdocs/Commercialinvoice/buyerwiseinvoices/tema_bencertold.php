...
<table width="850" border="0" cellspacing="0" cellpadding="2" style="font-family:Book Antiqua;font-size:14px;">
  ...
  <tr>
    <td colspan="5" style="font-family:Book Antiqua;font-size:16px;"><strong><u>BENEFICIARY'S CERTIFICATE</u></strong></td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="5">WE HEREBY CERTIFY THAT THE  SHIPPING DOCUMENTS (COMMERCIAL INVOICE,  </td>
  </tr>
  <tr>
    <td colspan="5">PACKING AND WEIGHT LIST, B/L, CERTIFICATE OF ORIGIN FORM A HAVE BEEN SENT </td>
  </tr>
  <tr>
    <td colspan="5">TO APPLICANT'S BY E-MAIL TO REZZAN.ARMUTCU(AT)LCWAIKIKI.COM WITHIN 05 DAYS</td>
  </tr>
  <tr>
    <td colspan="5">AFTER SHIPMENT DATE.</td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;</td>
  </tr>
