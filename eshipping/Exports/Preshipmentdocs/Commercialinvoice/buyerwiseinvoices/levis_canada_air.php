...
<table width="900" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  ...
  <tr>
    <td height="23" colspan="5" class="border-left-fntsize10">&nbsp;<?php echo $Address;?></td>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="border-left-fntsize10" style="text-align:center;font-size:10px"><?php echo ($dataholder['strIncoterms']=="FOB"?"Sri Lanka Int'l Air Port":"ONTARIO, CANADA ");?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="3" ><span ><strong><?php  echo $r_summary->summary_string($invoiceNo,'strISDno');?></strong></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6" class="border-left-fntsize10">&nbsp;TARIFF NUMBER (HTS CODE) :  <?php echo $r_summary->summary_string($invoiceNo,'strHSCode');?></td>
    <td>&nbsp;</td>
