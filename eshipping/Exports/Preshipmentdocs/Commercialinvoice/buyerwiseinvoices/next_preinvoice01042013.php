...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      <tr>
        ...
        <td class="border-All"><div align="center">GSP</div></td>
         <td class="border-top-bottom-right"><div align="center">NO</div></td>
        <td>&nbsp;</td>
        </tr>
          <tr>
        <td>&nbsp;</td>
      ...
      <tr>
       ...
       <tr>
        ...
        <td width="27%">NEXT SOURCING (LTD) </td>
        <td width="10%">&nbsp;</td>
        <td width="16%"><span class="normalfnth2B">INVOICE NO</span></td>
        <td width="15%" >: <?PHP echo $dataholder['strInvoiceNo'];?></td>
        <td width="17%">&nbsp;</td>
      </tr>
      
      <tr>
        <td width="14%" height="0">&nbsp;</td>
       <td width="27%">14/F, CITY PLAZA ONE,</td>
        <td width="10%">&nbsp;</td>
        <td width="16%">INVOICE DATE </td>
        <td width="15%">: <?PHP echo $dataholder['dtmInvoiceDate'];?></td>
        <td width="17%">&nbsp;</td>
      </tr>
      <tr>
        <td width="14%" >&nbsp;</td>
        <td width="27%">1111,KING'S ROAD,</td>
        <td width="10%">&nbsp;</td>
       ...
       <tr>
        <td width="14%" >&nbsp;</td>
        <td width="27%">TAIKOO SHING, HONG KONG.</td>
        <td width="10%">&nbsp;</td>
        <td width="16%">TO </td>
        <td width="15%">: <?php echo $dataholder['city'];?></td>
        <td width="17%">&nbsp;</td>
      </tr>
  ...
  ?>
       <tr>
        ...
        <td align="center"><?php echo $row_HS_summary['dblUnitPrice'];?></td>
        <td align="center"><?php echo $row_HS_summary['dblAmount'];?></td>
      </tr>
      <?php }?>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td align="center"><strong><?php echo $row_HS_summary['totqty'];?></strong></td>
        <td align="center"></td>
        <td align="center"><strong><?php echo $row_HS_summary['totamt'];?></strong></td>
      </tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2"><strong>LESS LAB TEST 0.015 USD * <?php echo $row_HS_summary['totqty'];?> PCS<strong></td>
        <?php $totqty=$row_HS_summary['totqty'];
			  $usd= $totqty * 0.015;
		?>
        <td align="center"><?php echo $usd;?></td>
      </tr>
       <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
       ...
       <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <?php  $totamt= $row_HS_summary['totamt'];
				$val = $totamt- $usd;
		?>
        <td align="center"><strong><?php echo $val;?></strong>
...
WHERE
commercial_invoice_header.strInvoiceNo = 'PRE/OTL/155/03/13'
";
