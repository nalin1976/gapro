...
<table style="width:800px;"border="0" cellspacing="1" cellpadding="0" bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><div  style="z-index:25; position:absolute; left:92px; top:194px; width:350px; height:44px;"  >
      ...
      <div  style="z-index:25; position:absolute; left:1px; top:397px; width:88px; height:24px;"  >
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
              <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:508px; top:567px; width:99px; height:22px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:227px; top:566px; width:68px; height:24px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
      ...
      <div  style="z-index:25; position:absolute; left:316px; top:566px; width:187px; height:24px;"  >
        <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td  nowrap="nowrap" class="normalfnt_size12"><?php echo $detail_data_set['dblQuantity']." ".$detail_data_set['strUnitID']; ?> ONLY</td>
          </tr>
        </table>
    </div></td>
    <td>&nbsp;</td>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:227px; top:593px; width:187px; height:32px;"  >
      <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td  nowrap="nowrap" class="normalfnt_size12"><?php echo $strDescOfGoods;?> </td>
            </tr>
          </table>
    </div></td>
    <td>&nbsp;</td>
    ...
    <td><div  style="z-index:25; position:absolute; left:93px; top:360px; width:233px; height:41px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td nowrap="nowrap" class="normalfnt_size10">FROM : <?php echo strtoupper($dataholder['strPortOfLoading']);?>, SRI LANKA</td>
            </tr>
            <tr>
              <td nowrap="nowrap" class="normalfnt_size10">TO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo strtoupper($dataholder['city']);?></td>
            </tr>
            <tr>
              <td width="308" nowrap="nowrap" class="normalfnt_size10">BY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo strtoupper($dataholder['strTransportMode']);?> FREIGHT</td>
            </tr>
          </table></td>
        </tr>
      </table>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:181px; top:712px; width:373px; height:28px;"  >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="normalfnt_size12">
        <tr>
          ...
          <td width="30%" style="text-align:center" nowrap="nowrap"><u><strong>STYLE</strong></u></td>
          <td width="30%" style="text-align:center" nowrap="nowrap"><u><strong>QTY (PCS)</strong></u></td>
        </tr>
        <?php $str_hs_dtl="select strBuyerPONo,strStyleID,dblQuantity from commercial_invoice_detail
where strInvoiceNo='$invoiceNo' and strHSCode='$hs'";
		 ...
		 ?>
        <tr>
          <td style="text-align:center"><?php echo $row_hs_dtl['strBuyerPONo'];?></td>
          <td style="text-align:center"><?php echo $row_hs_dtl['strStyleID'];?></td>
