...
$str_detail="SELECT
			...
			commercial_invoice_detail.dblNetNet,
			commercial_invoice_detail.strSD,
			commercial_invoice_detail.strConstType,
			commercial_invoice_detail.strSpecDesc,
			commercial_invoice_detail.strMRP,
			invoicedetail.strSC_No,
			shipmentforecast_detail.intGSP_status
			FROM
			commercial_invoice_detail
			INNER JOIN invoicedetail ON commercial_invoice_detail.strInvoiceNo = invoicedetail.strInvoiceNo
			INNER JOIN shipmentforecast_detail ON invoicedetail.strSC_No = shipmentforecast_detail.strSC_No
			WHERE
			commercial_invoice_detail.strInvoiceNo = '$invoiceNo' AND
			shipmentforecast_detail.intGSP_status = 'Y'
			group by strHSCode
...
//echo $detail_data_set['intGSP_status'];
...
<table style="width:800px;"border="0" cellspacing="1" cellpadding="0" bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><div  style="z-index:25; position:absolute; left:92px; top:194px; width:350px; height:44px;"  >
      ...
      <div  style="z-index:25; position:absolute; left:410px; top:320px; width:88px; height:24px;"  >
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
              <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:507px; top:617px; width:99px; height:22px; visibility:hidden"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:328px; top:563px; width:177px; height:24px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="308" nowrap="nowrap" class="normalfnt_size12"><?php echo $detail_data_set['intNoOfCTns'];?> CTNS CONTAINING</td>
            </tr>
          </table></td>
        </tr>
      </table>
    </div>
      <div  style="z-index:25; position:absolute; left:331px; top:598px; width:40px; height:24px;"  >
        <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
          <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:322px; top:648px; width:490px; height:32px;"  >
      <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
      
     <?php
if($detail_data_set['intGSP_status']='Y')
{
	  $str_des="select 	strInvoiceNo, 
	strStyleID, 
	intItemNo, 
	strBuyerPONo, 
	strDescOfGoods, 
	...
	group by strDescOfGoods order by strBuyerPONo";
	
	//die($str_detail);
$result_detail=$db->RunQuery($str_des);
while($row_summary=mysql_fetch_array($result_detail))
		{ ?>
		 <tr>
              <td  nowrap="nowrap" class="normalfnt_size12"><?php echo $row_summary['strDescOfGoods'];?> </td>
              
              
              <td  nowrap="nowrap" class="normalfnt_size12"><?php echo $row_summary['strHSCode'];?> </td>
            </tr>
...
<?php }} ?> 
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:620px; top:603px; width:108px; height:22px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
    ...
    <td><div  style="z-index:25; position:absolute; left:736px; top:612px; width:99px; height:22px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td nowrap="nowrap" class="normalfnt_size10"><?php echo strtoupper($dataholder['strTransportMode']);?> FREIGHT </td>
            </tr>
            <tr>&nbsp;</tr>
            <tr>&nbsp;</tr>
            <tr>
              <td nowrap="nowrap" class="normalfnt_size10">FROM TO SRI LANKA <?php echo strtoupper($dataholder['city']);?></td>
            </tr>
    ...
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:318px; top:860px; width:212px; height:22px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td nowrap="nowrap" class="normalfnt_size12">NET WEIGHT <?php echo $detail_data_set['dblNetMass'];;?> KGS</td>
            </tr>
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:291px; top:799px; width:241px; height:43px;"  >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="normalfnt_size12">
        <tr>
          <td width="30%" style="text-align:center" nowrap="nowrap"><u><strong>P.O.NO.</strong></u></td>
...
where strInvoiceNo='$invoiceNo' and strHSCode='$hs'";
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:621px; top:699px; width:108px; height:22px; visibility:hidden" >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="25">&nbsp;</td>
    <td>&nbsp;</td>
    <td><div  style="z-index:25; position:absolute; left:311px; top:718px; width:179px; height:24px;"  >
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="87%"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
