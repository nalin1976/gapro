...
<title>|M&S|Commercial Invoice Final|</title>
</head>
  ...
  ?>
	...
	$goh=mysql_fetch_array($result_goh);	
	   ?>
        ...
        <tr>      
        <td style="font-family:'Times New Roman', Times, serif; font-size:11px">TOTAL QTY</td>
        <td colspan="3">: <?php 
...
?>
        ...
        <tr>
        <td style="font-family:'Times New Roman', Times, serif; font-size:11px">TOTAL FOB USD</td>
        <td colspan="4">: <?php 
