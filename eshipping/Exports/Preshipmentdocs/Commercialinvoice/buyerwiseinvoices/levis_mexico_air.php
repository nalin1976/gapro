...
<table width="950" border="0" cellspacing="0" cellpadding="1" class="normalfnt_size10">
  <tr>
  ...
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<strong>MID NO :</strong><?php echo $dataholder['strMIDCode'];?></td>
  ...
  <tr>
    ...
    <td colspan="6" class="border-Left-Top-right-fntsize10">&nbsp;<strong>SHIP TO / DELIVERY ADDRESS : </strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo ($dataholder['dtophone']!=""?"Tel : ".$dataholder['dtophone']:"");?> </td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo ($dataholder['BuyerFax']!=""?"Fax # ".$dataholder['BuyerFax']:"");?></td>
    <td colspan="6" class="border-left-right-fntsize10">&nbsp;<?php echo ($dataholder['dtoFax']!=""?"Fax : ".$dataholder['dtoFax']:"");?></td>
  </tr>
  <tr>
    <td colspan="5" class="border-left-fntsize10">&nbsp;<?php echo $BuyerTINNo;?></td>
  ...
  <tr>
    <td colspan="11" class="border-Left-Top-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="border-left-fntsize10" style="text-align:center;"><?php echo ($dataholder['strIncoterms']=="FOB"?$dataholder['strPortOfLoading']:$dataholder['tolocation']);?>
		</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10"><?php echo ($dataholder['strIncoterms']=="FOB"?"SRI LANKA":"");?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>BRAND</td>
        <td colspan="5">:<?php echo ucwords($com_inv_dataholder['strBrand']);?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
      ...
      <tr>
       ...
       <tr>
        ...
        <td  style="text-align:center"><u><strong>ITEM</strong></u></td>
        ...
        <td  style="text-align:center"><u><strong>CONTRACT#</strong></u></td>
      ...
      <?php 
		...
		$bool_rec_fst=1;
		while(($row_desc=mysql_fetch_array($result_desc))||($cnt<=10)){
			$cnt++;
      ...
      <tr>
        ...
        <td style="text-align:center"><span style="font-size:9px;"><?php echo $row_desc["strDescOfGoods"];?></span></td>
        ...
        <td style="text-align:center"><?php echo $row_desc["strBuyerPONo"];$f_isd=$row_desc["strISDno"];?></td>
          <td style="text-align:center"><?php echo $row_desc["strWashCode"];?></td>
      ...
      <tr>
        <td colspan="6">CARTON NOS:<?php echo $totctns;?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
        <td class="border-left-fntsize10">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="7" rowspan="8"  class="border-right-fntsize10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt_size10">
      <tr>
        <td width="50%"><strong>
          <?php  echo $mainmark1;?>
        </strong></td>
  ...
  <tr>
    ...
    <td colspan="2" ><?php echo $com_inv_dataholder['strPSno'];?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" class="border-left-fntsize10">&nbsp;<strong><?php echo ($com_inv_dataholder['strFreightPC']!="" ? "FREIGHT ".$com_inv_dataholder['strFreightPC']:"");?></strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
