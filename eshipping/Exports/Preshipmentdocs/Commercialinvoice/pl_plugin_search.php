...
<table  width="955" border="1" style="border-color:#30C" cellspacing="0" cellpadding="2" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td bgcolor="#316895"  height="25" class="TitleN2white" >Shipment Packing List Search<div style="float:right"><img src="../../../images/cross.png" title="Close" onclick="closeCross();"/></div></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      ...
      <tr>
        ...
        <td width="10%">PO #</td>
        <td width="20%"><input name="txtPONo" value="<?php echo $po; ?>" type="text" class="txtbox" id="txtPONo" tabindex="1" style="width:150px" onkeyup="loadCBO();"/></td>
       ...
       <tr>
         ...
         <td><select name="cmbISD" class="txtbox" id="cmbISD" style="width:150px" tabindex="3">
           <option value=""></option>
           <?php 
			$buyerstr="select distinct strISDno from shipmentplheader order by strISDno";
		...
		?>
         ...
         <td><select name="cmbDO" class="txtbox" id="cmbDO" style="width:150px" tabindex="3">
           <option value=""></option>
           <?php 
			$buyerstr="select distinct strDO from shipmentplheader order by strDO";
