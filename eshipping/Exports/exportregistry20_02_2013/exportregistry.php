...
<table  width="950" border="0" cellspacing="0" cellpadding="2" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
                  ...
                  <tr>
                    ...
                    <td width="354" class="normalfnt">Invoice No</td>
                    <td width="531"><input name="txtCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtCDNInvNo" size="25" style="width:130px" onkeyup="changeCDNInvCombo(this,event);" onload="abc();"/></td>
                    <td width="447" class="normalfnt">PO No</td>
                    <td width="534"><input name="txtCDNBuyerPO" type="text" maxlength="100" class="txtbox" id="txtCDNBuyerPO" size="25" style="width:130px" onkeyup="changeCDNPoCombo(this,event);" onload="abc();"/></td>
                  
                  <td width="441" class="normalfnt">Style No</td>
                   <td width="641"><input name="txtStyleNo" type="text" maxlength="100" class="txtbox" id="txtStyleNo" size="25" style="width:130px" onkeyup="changeStyleNoCombo(this,event);" onload="abc();"/></td>
                  
                   <td width="260" class="normalfnt">Buyer</td>
                   <td width="465"><input name="txtbuyer" type="text" maxlength="100" class="txtbox" id="txtbuyer" size="25" style="width:130px" onkeyup="changetxtbuyerCombo(this,event);" onload="abc();"/></td>
