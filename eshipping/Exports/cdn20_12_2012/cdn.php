                    ...
                    <tr>
                      <td class="normalfnt"><table width="100%" border="0" cellpadding="1" cellspacing="1" class="bcgl1"><tr><td><table width="100%" border="0" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                          ...
                          <td nowrap="nowrap"><input name="txtCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtCDNInvNo" size="25" style="width:70px" onkeyup="changeCDNInvCombo(this,event);" onload="abc();"/>&nbsp;<select name="cboCDNNo"  class="txtbox" id="cboCDNNo" style="width:150px" onchange="loadHeaderData(this.value);">
                              <option value=''></option>
                              <?php
