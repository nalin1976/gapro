...
document.getElementById('txtProcedureCode').value=this.cells[5].id;
document.getElementById('txtareaDisc').value=this.cells[5].childNodes[0].nodeValue;
document.getElementById('txtUnit').value=this.cells[8].childNodes[0].nodeValue;
document.getElementById('txtUnitPrice').value=this.cells[7].childNodes[0].nodeValue;
document.getElementById('txtGross').value=this.cells[12].childNodes[0].nodeValue;
document.getElementById('txtCtns').value=this.cells[15].childNodes[0].nodeValue;
...
document.getElementById('txtHS').value=this.cells[14].childNodes[0].nodeValue;
document.getElementById('txtQty').value=this.cells[9].childNodes[0].nodeValue;
document.getElementById('txtQtyUnit').value=this.cells[10].childNodes[0].nodeValue;
document.getElementById('txtCM').value=0;
document.getElementById('txtValue').value=this.cells[11].childNodes[0].nodeValue;
document.getElementById('cboCategory').value=this.cells[2].id;
document.getElementById('txtUmoQty1').value=this.cells[16].childNodes[0].nodeValue;
document.getElementById('txtUmoQty2').value=this.cells[17].childNodes[0].nodeValue;
document.getElementById('txtUmoQty3').value=this.cells[18].childNodes[0].nodeValue;
document.getElementById('cboUmoQty1').value=this.cells[16].id;
document.getElementById('cboUmoQty2').value=this.cells[17].id;
document.getElementById('cboUmoQty3').value=this.cells[18].id;
document.getElementById('txtISDNo').value=this.cells[19].childNodes[0].nodeValue;
...
function addToGrid()
{
	...
	if(inputvalidation())
	{
		...
		if (position!=0)
			...
			editgrid.rows[verprepos].cells[5].childNodes[0].nodeValue=document.getElementById('txtareaDisc').value;
			editgrid.rows[verprepos].cells[2].childNodes[0].nodeValue=document.getElementById('txtStyle').value;
			if(editgrid.rows[verprepos].cells[4].innerHTML!="")
			{
				editgrid.rows[verprepos].cells[4].childNodes[0].nodeValue=document.getElementById('txtPLno').value;
			}
			
			editgrid.rows[verprepos].cells[2].id=category;
			editgrid.rows[verprepos].cells[11].childNodes[0].nodeValue=value;
			editgrid.rows[verprepos].cells[7].childNodes[0].nodeValue=document.getElementById('txtUnit').value;
			editgrid.rows[verprepos].cells[6].childNodes[0].nodeValue=document.getElementById('txtUnitPrice').value;
			editgrid.rows[verprepos].cells[12].childNodes[0].nodeValue=document.getElementById('txtGross').value;
			editgrid.rows[verprepos].cells[15].childNodes[0].nodeValue=document.getElementById('txtCtns').value;
			editgrid.rows[verprepos].cells[13].childNodes[0].nodeValue=document.getElementById('txtNet').value;
			editgrid.rows[verprepos].cells[1].id=document.getElementById('txtBuyerPO').value;
			editgrid.rows[verprepos].cells[10].childNodes[0].nodeValue=document.getElementById('txtQtyUnit').value;
			editgrid.rows[verprepos].cells[8].childNodes[0].nodeValue=document.getElementById('txtCM').value;
			editgrid.rows[verprepos].cells[9].childNodes[0].nodeValue=document.getElementById('txtQty').value;
			editgrid.rows[verprepos].cells[14].childNodes[0].nodeValue=document.getElementById('txtHS').value;
			editgrid.rows[verprepos].cells[5].id=procedurecode;
			editgrid.rows[verprepos].cells[15].id=prevpos;
						position=0;
			verpos=0;
