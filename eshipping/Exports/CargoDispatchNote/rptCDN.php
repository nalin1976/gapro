...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  ?>
        ...
        <td height="34" colspan="2" class="border-top-left-fntsize12">&nbsp;&nbsp;7. Lorry Trailer No </td>
  ...
  ?>
        ...
        <td height="16"colspan="2" class="border-top-left-fntsize12">&nbsp;&nbsp;11. Seal No. 9308 </td>
        <td height="16"colspan="2" class="border-Left-Top-right-fntsize12">&nbsp;&nbsp;11 B Customer Entry </td>
      </tr>
      <tr>
        ...
        <td height="24"colspan="2" class="border-left-right-fntsize12">&nbsp;&nbsp;<strong><?php echo $CustomerEntry; ?></strong></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="114" rowspan="6" class="border-top-left-fntsize12" valign="top"><div  class="normalfnt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; R </div></td>
        <td width="114" rowspan="6" class="border-top-left-fntsize12" valign="top"><div  class="normalfnt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; S </div></td>
      ...
      <tr>
        <td colspan="2" rowspan="12" class="border-left-fntsize12" valign="top"><table width="222" height="228" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="17">&nbsp;</td>
            <td width="205" valign="top"><textarea name="textarea" readonly='readonly'  style='border:0px; height:250px; width:180px;overflow:hidden;
' class="latter"><?php echo $marks ; ?></textarea></td>
          </tr>
        </table></td>
        <td colspan="4" rowspan="13" valign="top"><table width="442" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="22">&nbsp;</td>
              <td width="404" rowspan="12" valign="top"><textarea name="textarea2" readonly='readonly' style='border:0px; height:250px; width:300px;overflow:hidden;
' class="normalfnt_size12"><?php echo$gendesc ?></textarea></td>
              <td width="16" rowspan="12" valign="top">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
      ...
      <tr>
        ...
        <td colspan="2" class="border-left-fntsize12" >&nbsp;</td>
        <td colspan="3" class="border-left-right-fntsize12" ><dd><strong><?php echo $exportername ; ?></strong></td>
      </tr>
      <tr>
        <td height="3" colspan="3" class="border-left-fntsize12">&nbsp;</td>
        <td colspan="2" class="border-left-fntsize12" >&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="3" class="border-left-right-fntsize12" ><div align="center"><strong><?php echo $exportername1."ORIT TRADING LANKA (PVT) LTD" ; ?></strong></div></td>
      </tr>
