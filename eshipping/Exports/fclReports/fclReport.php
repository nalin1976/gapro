...
<script src="fclReport.js"></script>
</head>
<body>
<?php
			      ...
			      <td ><table width="100%" border="0" cellpadding="2" cellspacing="10">
			          ...
			          <tr>
			            <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="2" class="bcgl1">
			              ...
			              <tr>
			                <td class="normalfnt">&nbsp;</td>
			                <td class="normalfnt">Vessal Name</td>
			                <td width="44%" class="normalfnt"><input name="txtVessalName" id="txtVessalName" style="width:130px" class="txtbox" type="text" tabindex="1" /></td>
			                <td width="15%" class="normalfnt">&nbsp;</td>
			                </tr>
			              <tr>
			                <td class="normalfnt">&nbsp;</td>
			                <td class="normalfnt">CDN Doc No</td>
			                <td class="normalfnt"><input name="txtCDNNo" id="txtCDNNo" style="width:130px" class="txtbox" type="text" tabindex="1" /></td>
			                <td class="normalfnt">&nbsp;</td>
			                </tr>
		                </table></td>
		              </tr>
