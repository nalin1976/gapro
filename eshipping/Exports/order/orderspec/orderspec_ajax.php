...
if($request=='loadDataGrid')
{
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$XMLString .= "<PackUpc><![CDATA[" . $row["strPackUpc"]  . "]]></PackUpc>\n";
...
{	
	...
	if($mrp=="")
	{
	    ...
	    $sql2 = "Insert Into orderspecdetails (intOrderId,strSize,strColor,strColorCode,dblPcs,dblPrice,strDescription,intStatus,dblMRP,strSKU,strFabric,strPliNo,strPrePackNo,strPrePackType,strPackUpc)
				 Values ('$orderID','$size','$colour','$color_code',$pcs,$net,'$desc','1',$mrp,'$sku','$fab','$plino','$prepackno','$prepacktype','$pack_upc')";
