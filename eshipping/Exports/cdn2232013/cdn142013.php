            ...
            <td height="96">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <tr>
                    <td width="72" class="normalfntMid">&nbsp;</td>
                    <td width="164" class="normalfnt">CDN Invoice No</td>
                    <td width="207"><input name="txtCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtCDNInvNo" size="25" style="width:130px" onkeyup="changeCDNInvCombo(this,event);" onload="abc();"/></td>
                    <td width="154" class="normalfnt">Buyer PO No</td>
                    <td width="293"><input name="txtCDNBuyerPO" type="text" maxlength="100" class="txtbox" id="txtCDNBuyerPO" size="25" style="width:130px" onkeyup="changeCDNPoCombo(this,event);" onload="abc();"/></td>
                  </tr>
                </table></fieldset>
