...
<body <?php if($id==1){?> onload="loadHeaderData(<?php echo $invoiceNo;?>)" <?php }?> ><!-- "loadHeaderData(this.value);" setDefaultDate-->
									...
									while($row=mysql_fetch_array($exec)) 
						 			{
										...
										{
										?>
                              <option value="<?php echo $row['intCDNNo'];?>" selected="selected"><?php echo $row['strInvoiceNo'];?></option>
                              <?php }
							  			else
											  {
												  ?>
