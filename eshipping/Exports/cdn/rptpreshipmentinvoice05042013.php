    ...
    <td ><table width="100%" border="0" cellspacing="0" cellpadding="2" class="normalfnt">
      ...
      <tr>
        ...
        <td colspan="5" class="border-left-fntsize12"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="30%"><?php echo $dataholder['intNoOfCTns']; ?> <?php if($dataholder['intPackingMthd']=='1'){echo "Cartoons";} else if($dataholder['intPackingMthd']=='2') {echo "GOH";} ?></td>
...
?>	
        ...
        <td style="text-align:center"><div align="center"><?php echo $dataholder['intNoOfCartons']; ?></div></td>
        <td style="text-align:center"><?php echo $dataholder['dblQuantity'];?></td>
        </tr>
        <tr>
        ...
        <td style="text-align:center"><div align="center"><?php echo ($qty11['qtyOFcarton']-$dataholder['intNoOfCartons']);?></div></td>
        <td style="text-align:center"><?php echo ($qty11['quantity']-$dataholder['dblQuantity']);?></td>
        </tr>
