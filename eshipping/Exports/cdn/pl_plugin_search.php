    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3" class="normalfnt">
      ...
      <tr>
        ...
        <td width="20%"><select name="cmbPL" class="txtbox" id="cmbPL" style="width:150px" tabindex="3">
          <option value=""></option>
          <?php 
			$buyerstr="select distinct strPLNo from shipmentplheader 
						WHERE intCDNStatus=0 AND strStyle='$po' 
						order by strPLNo desc";
        ...
        <td width="20%"><select name="cmbStyle" class="txtbox" id="cmbStyle" style="width:180px" tabindex="3">
          <option value=""></option>
          <?php 
			$buyerstr="select distinct strProductCode from shipmentplheader WHERE intCDNStatus=0 order by strProductCode";
       ...
       <tr>
         ...
         <td><select name="cmbISD" class="txtbox" id="cmbISD" style="width:150px" tabindex="3">
           <option value=""></option>
           <?php 
			$buyerstr="select distinct strISDno from shipmentplheader WHERE intCDNStatus=0 order by strISDno";
		...
		?>
         ...
         <td><select name="cmbDO" class="txtbox" id="cmbDO" style="width:150px" tabindex="3">
           <option value=""></option>
           <?php 
			$buyerstr="select distinct strDO from shipmentplheader WHERE intCDNStatus=0 order by strDO";
