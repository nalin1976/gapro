              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <tr>
                    ...
                    <td width="112" class="normalfnt">CDN Invoice No</td>
                    ...
                    <td width="142" class="normalfnt">Buyer PO No</td>
                  ...
                  <td width="140" class="normalfnt">Pre Invoice No</td>
                    <td width="146"><input name="txtpendingCDNInvNo" type="text" maxlength="100" class="txtbox" id="txtpendingCDNInvNo" size="25" style="width:130px" onkeyup="changependingCDNvCombo(this,event);" onload="abc();"/></td>
                  </tr>
                </table></fieldset>
                          ...
                          <td><select name="cboInvoiceNo" class="txtbox" id="cboInvoiceNo" style="width:150px" onchange="loadInvoiceData(this.value);">
                            ...
                            <?php
                   			$str = "SELECT strInvoiceNo FROM invoiceheader 
									WHERE intCancelInv=0 && strInvoiceNo not in (SELECT strInvoiceNo FROM cdn_header WHERE intCancel=0)
