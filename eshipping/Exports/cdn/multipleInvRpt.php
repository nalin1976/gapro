...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        <td colspan="6" rowspan="12" class="border-left-fntsize12" valign="top">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="13%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">Entry No</span></td>
                    <td width="12%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">FTY</span></td>
                    <td width="13%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">Style</span></td>
                    <td width="12%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">PO</span></td>
                    <td width="13%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">CTN</span></td>
                    <td width="12%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">QTY</span></td>
                    <td width="11%" class="border-top-bottom-left" style="text-align:center"><span class="normalfnt">Item</span></td>
                    <td width="14%" class="border-All" style="text-align:center"><span class="normalfnt">Gross Wt</span></td>
                  </tr>
				  <?php
				  	$sqlMultiple="SELECT
...
shippingnote.strEntryNo,
cdn_detail.dblGrossMass,
customers.strMLocation
FROM
cdn_detail
INNER JOIN shippingnote ON shippingnote.strInvoiceNo = cdn_detail.strInvoiceNo
INNER JOIN cdn_header ON cdn_header.intCDNNo = cdn_detail.intCDNNo
INNER JOIN customers ON cdn_header.intShipper = customers.strCustomerID
WHERE cdn_detail.intCDNNo=$CDNNo";
				$resultMultiple=$db->RunQuery($sqlMultiple);
				while($rowMultiple=mysql_fetch_array($resultMultiple))
				{
				  ?>
                  <tr>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['strEntryNo']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['strMLocation']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['strStyleID']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['strBuyerPONo']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['intNoOfCTns']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['dblQuantity']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo $rowMultiple['intItemNo']; ?></td>
                    <td style="text-align:center; font-size:9px"><?php echo round($rowMultiple['dblGrossMass'],2); ?></td>
                  </tr>
				  <?php
				  }
				  ?>
      ...
      <tr>
        <td colspan="4" valign="top" class="border-left">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td height="10" colspan="3" class="border-left-fntsize12">&nbsp;</td>
        <td colspan="2" class="border-left-fntsize12">&nbsp;</td>
        <td colspan="3" class="border-left-right-fntsize12" ><dd><strong><?php echo $PhoneNo;  ?></strong></td>
      </tr>
      <tr>
...
?>
        ...
        <td height="10" ><?php echo $location ?></td>
      </tr>
    </table></td>
  </tr>
</table>
