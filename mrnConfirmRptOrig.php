...
?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablez">
        ...
        <tr> 
          <td colspan="8" class="normalfnt2BITAB"><?php echo  $row["strDescription"]; ?></td>
        </tr>
		<?php
...
matrequisitiondetails.strColor, matrequisitiondetails.strSize, specificationdetails.strUnit ,matrequisitiondetails.dblQty,orders.strStyle,orders.strOrderNo 
