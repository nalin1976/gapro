...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><table width="600" align="center" cellpadding="1" cellspacing="3" bgcolor="#FFFFFF" class="tableBorder">
      
      <tr>
        <td bgcolor="#316895" class="mainHeading">Component Editor</td>
      </tr>
      <tr>
        <td ></td>
      </tr>
      <tr>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="normalfnt">
                  ...
                  <tr class="mainHeading2">
                    <td height="25" style="text-align:left"><dd>Component Category
                      </td>
		...
		?>
                    ...
                    <td id="btnCategory" ><img src="../../images/add-new.png" alt="n" width="109" height="18" class="mouseover" onclick="edit_category();" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td height="25"><dd>Component <span class="compulsoryRed"> *</span></dd></td>
                  ...
                  <tr>
                    ...
                    <td><div align="center"><input type="image" src="../../images/addsmall.png" alt="a"   class="mouseover" onclick="saveComponent();" tabindex="4"/></div></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
