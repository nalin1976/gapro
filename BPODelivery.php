...
<form name="frmstylewise" id="frmstylewise">	
  <table width="1090" border="0" align="left" bgcolor="" >
    <tr>
      <td><table width="1090" border="0">
          <tr>
                        ...
                        <td align="left">
                          <select name="cboPreviousBPO" id="cboPreviousBPO" class="txtbox" style="width:150px">
                            ...
                            <?php
                                ...
                                $sql = " SELECT DISTINCT deliveryschedule.intBPO FROM deliveryschedule WHERE
                                          deliveryschedule.intStyleId =  '".$_GET["styleID"]."'";
                                $resBPO = $db->RunQuery($sql); 
                                while($row = mysql_fetch_array($resBPO))
                                {
                                    echo "<option value=\"". $row["intBPO"] ."\">" . $row["intBPO"] ."</option>" ;
                                }         
                            ?>
                          </select>
                        </td>
  ...
  ?>
    ...
    <tr>
                        ...
                        <td align="left"><select name="cmbProductionLocation" class="txtbox" id="cmbProductionLocation" style="width:300px">
                          <option value="-1"></option>
                          <?php
                        ...
                        <td class="normalfnt">RM IN Date</td>
                        <td align="left"><input name="dtmPcd" type="text" class="txtbox" id="dtmPcd"  style="width:150px" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');"></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left"><textarea name="txtremarks" cols="70" style="width:350px" rows="2" class="txtbox" id="txtremarks"></textarea>
                        &nbsp;&nbsp;
                ...
                <tr>
                  <td colspan="2"><table width="100%" border="0" class="bcgl1" height="200">
                   ...
                   <div id="divcons" style="table-layout:fixed; height:260px; width:1070px; margin:1; padding: 1; border-collapse:collapse; overflow:hidden; border:1px solid #000;">
                            <table id="BuyerPO1"  style="width:960px; margin:1; padding:1; border-collapse:collapse; table-layout:fixed;" cellpadding="0" cellspacing="1" bgcolor="">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="" bgcolor="#498CC2" class="normaltxtmidb2L" style="width:78px; border: 1px solid #CCC;">RM IN Date</td>
                             ...
                             <div id="divcons" style=" overflow-y:auto; height:220px; width:1072px; border-collapse:collapse; margin:0; padding:2;">
...
$sql = " SELECT bpodelschedule.intStyleId, DATE_FORMAT(bpodelschedule.dtDateofDelivery,'%d/%m/%Y') AS dtDateofDelivery,
                ...
                deliveryschedule.prvBPO, events.strDescription as LeadTime, deliveryschedule.shortShipId,DATE_FORMAT(deliveryschedule.dtmPCDDate,'%d/%m/%Y') AS dtmPCDDate
          ...
          $prvBPO = $row["prvBPO"];
				...
				$dblShippedPer = CalShippedPercentage($row["intQty"], $intShippedQty);
                      ...
                      <?php      
                       ...
                       <td style="width:75px; word-wrap:break-word; border: 1px solid #CCC;" class="normalfnt"><?php echo $row["dtmPCDDate"];  ?></td>
