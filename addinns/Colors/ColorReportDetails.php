...
<table width="800" border='1' align='center' CELLPADDING=3 CELLSPACING=1>
 ...
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Color</font></td>
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Description</font></td>
  </tr>
	   <?php
	   $cboBuyer    = $_GET["cboBuyer"];
       $cboDivision = $_GET["cboDivision"];

		$SQL="SELECT * FROM colors WHERE intCustomerId='$cboBuyer' AND intDivisionID='$cboDivision' AND intStatus = '1'  ORDER BY         strColor"; 
