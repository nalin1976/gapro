...
<tr>
 <td align="center" style="font-family: Arial;	font-size: 12pt;color: #000000;font-weight: bold;"><table style="width:900px;" border='0' align='center' cellpadding="3" cellspacing="0"  >
   ...
   <tr>
     <td align="center" class='border-top-left-fntsize12'><strong>Sequence No Start</strong></td>
     <td class='border-Left-Top-right-fntsize12'><?php echo $intFacNoSeq_Start;?></td>
   </tr>
   <tr>
     <td align="center" class='border-top-left-fntsize12'><strong>Sequence No End</strong></td>
     <td class='border-Left-Top-right-fntsize12'><?php echo $dblFacNoSeq_End;?></td>
   </tr>
   <tr>
