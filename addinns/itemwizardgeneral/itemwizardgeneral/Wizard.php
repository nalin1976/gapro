...
<title>GaPro | General Item Material Wizard</title>
  ...
  <table width="500" class="tableBorder" align="center">
    <tr>
      <td width="486" height="24" class="mainHeading"><table width="100%" border="0">
          <tr>
            <td width="88%" >General Item Material Wizard</td>
    ...
    <tr>
      <td><table width="100%" border="0">
          <tr>
            ...
            <td ><select name="itemwizard_cboMainCategories" class="txtbox" onchange="LoadSubCategory(this.value);" tabindex="1" id="itemwizard_cboMainCategories"style="width:150px">
              <?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		{
			if ($_SESSION["intCatNo"] == $row["intID"] )
	...
	?>
              ...
              &nbsp;<img src="../../images/add.png" alt="add" class="mouseover" id="imgP" onclick="ShowMainCategorryForm();" /></td>
          </tr>
          <tr>
            <td width="22%">&nbsp;</td>
	...
	$SQL = "SELECT intSubCatNo,StrCatName FROM genmatsubcategory WHERE intStatus = 1 AND intCatNo= ".$_GET["intCatNo"]." ORDER BY StrCatName;";
	...
	?>
              ...
              &nbsp;<img src="../../images/add.png" class="mouseover" onclick="getSubCatID();" id="imgP" /> </td>
          </tr>
      </table></td>
    </tr>
    <tr>
	...
	$SQL = "SELECT intPropertyId,strPropertyName FROM genmatproperties WHERE intStatus = 1  ORDER BY strPropertyName;";
          ...
          <tr>
            <td height="11" ><table width="100%" border="0" class="tableBorder">
                <tr>
				  ...
				  <td height="21" class="mainHeading2"><img src="../../images/edit.png" style="vertical-align:bottom;" alt="Add" class="mouseover" onclick="showPropertyModifyForm();"/>&nbsp;</td>
                </tr>
                <tr>
                  <td width="75%"><input name="itemwizard_txtassign" type="text"  class="txtbox" id="itemwizard_txtassign" size="20" tabindex="4" maxlength="20" onclick="closeList();" onkeydown="ItemListKeyEventHandler(event);" onkeyup="GetAutoComplete(event,this.value,'../../autofill.php?RequestType=generalItemProperty&',this.id);" /></td>
