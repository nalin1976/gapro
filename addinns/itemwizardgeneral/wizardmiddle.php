...
$reorderLevel	= $_GET["ReorderLevel"];
	...
	$cboProductPostInGroup = $_GET["cboProductPostInGroup"];
	$cboInventPostInGroup = $_GET["cboInventPostInGroup"];
	
	// sumith harshan 2011-05-30
	$cboCurrency  = $_GET["cboCurrency"];
	$navisionCode = $_GET["navisionCode"];
...
/*31/05/2011 hem		$sql = "insert into genmatitemlist  (strItemCode,strItemDescription,intMainCatID,intSubCatID,strUnit,sngWastage,intStatus,strUserId,dtmDate,intProductPostInGroup,intInventPostInGroup,strCurrency,strNavisionCode) values ('$ItemCode','$ItemName',$MainCatID,$subCatID,'$unitID',$Wastage,1,'$useID',now(),'$cboProductPostInGroup','$cboInventPostInGroup','$cboCurrency','$navisionCode')";
*/
		$sql = "insert into genmatitemlist (strItemCode,strItemDescription,intMainCatID,intSubCatID,strUnit,sngWastage,intStatus,strUserId,dtmDate,dblReorderLevel,intProductPostInGroup,intInventPostInGroup,strCurrency,dblLastPrice) values ('$navisionCode','$ItemName',$MainCatID,$subCatID,'$unitID',$Wastage,1,'$useID',now(),'$reorderLevel','$cboProductPostInGroup','$cboInventPostInGroup','$cboCurrency','$unitPrice')";
...
else if(strcmp($RequestType,"GetCurrency")==0)
{
	$ResponseXML="";
	$sql="SELECT currencytypes.intCurID,currencytypes.strCurrency FROM currencytypes WHERE currencytypes.intStatus =  '1'";
	$result=$db->RunQuery($sql);
	...
	$ResponseXML.="<currencyTypes><![CDATA[" .$str. "]]></currencyTypes>\n";	
	$ResponseXML.="</currency>";
	echo $ResponseXML;	
