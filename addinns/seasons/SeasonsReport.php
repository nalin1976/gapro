...
<tr>
 <td ><table width="100%" border='0' align='center' cellpadding="3" cellspacing="0">
   <thead>
   <tr >
     <td colspan="5" class='border-Left-Top-right-fntsize12'><div align="center"><span class="normalfnt2bldBLACKmid">Seasons Report</span></div></td>
     </tr>
   	 <tr bgcolor="#efefef">
   ...
   <?php
		...
		{		
		$strSeasonCode = cdata($row["strSeasonCode"]);
		$strSeason     = cdata($row["strSeason"]);
	...
	<tr>
			...
			<td class='border-top-left-fntsize12'><div class="normalfnt"><?php echo $strSeasonCode;?></div></td>
	  		<td class='border-top-left-fntsize12'><div class="normalfnt"><?php echo $strSeason;?></div></td>
