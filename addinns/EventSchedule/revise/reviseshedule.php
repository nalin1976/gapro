...
$reportname = $xml->PreOrder->ReportName;
	...
	$SQL = "select strStyleId from eventscheduleheader where intStatus=2;";
	...
	$SQL = "select specification.intSRNO from specification inner join eventscheduleheader on specification.intStyleId = eventscheduleheader.strStyleId AND eventscheduleheader.intStatus = 2 order by intSRNO desc;";
