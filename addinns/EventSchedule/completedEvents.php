...
companies.strAddress2, companies.strStreet, companies.strCity, companies.strState,country.strCountry, companies.strZipCode,companies.strRegNo, 
...
<tr>
    ...
    </table></td><td><?php echo $styleID; ?></td>
  </tr>
  <tr>
...
WHERE  eventscheduleheader.strStyleId IN ($styleList) AND NOT ISNULL((SELECT eventscheduledetail.intScheduleId FROM eventscheduledetail WHERE eventscheduledetail.intScheduleId = eventscheduleheader.intScheduleId AND NOT ISNULL(eventscheduledetail.dtCompleteDate) LIMIT 1) );";
        $result = $db->RunQuery($sql);
			while($row = mysql_fetch_array($result ))
			{
        ?>
