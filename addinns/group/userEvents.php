...
<script src="userEvents-js.js"></script>
	...
	<td><table width="66%" align="center" class="bcgl1">
	  <tr>
	    <td class="normalfnt" ><table width="101%" align="center" class="bcgl1">
	      ...
	      <tr>
	        <td colspan="3" bgcolor="#498CC2" class="TitleN2white">User Event Visibility</td>
	        </tr>
	      <tr>
	      ...
	      <tr>
	        <td class="normalfnt" width="149" style="padding-left:80px; padding-right:10px;"> Users </td>
	        <td width="454"><select name="cboUser" class="txtbox"  id="cboUser" style="width:203px;" onchange="loadExEventsForUsers()">
	          <?php
		$SQL="SELECT intUserID,Name FROM useraccounts ORDER BY Name ASC";		
