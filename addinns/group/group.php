	...
	<td><table width="66%" align="center" class="bcgl1">
	  <tr>
	    <td class="normalfnt" ><table width="101%" align="center" class="bcgl1">
	      ...
	      <tr>
	        <td colspan="3" bgcolor="#498CC2" class="mainHeading">Groups</td>
	        </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td width="454"><select name="cboGroup" class="txtbox"  id="cboGroup" style="width:203px;" onchange="loadExUsersForGroups()">
	          <?php
		...
		while($row = mysql_fetch_array($result))
		{
			echo "<option value=\"". $row["intGroupId"] ."\">" . $row["strGroupName"] ."</option>" ;
			 ...
			 ?>
	          ...
	          &nbsp;<img src="../../images/add.png" onclick="prompter()" />
			  &nbsp;<img src="../../images/addnew2.png" onclick="loadUsersPopUp()"/></td>
