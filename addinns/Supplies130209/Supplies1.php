...
?>
<form id="frmSupplies" name="frmSupplies" method="post" action="">
  ...
  <tr>
	...
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"". $row["strSupplierID"] ."\">" . $row["strTitle"] ."</option>" ;
                        ...
                        <td class="normalfnt" align="right"><img  src="../../images/refresh.png" size="1" onclick="getRefresh(cbocurrency.value)" /></td>
                        </tr>
                      <tr>
                        <td class="normalfnt">VAT reg. no</td>
                        <td><input name="txtvatrn" type="text" class="txtbox" id="txtvatrn" size="21" /></td>
                        <td><div align="right">Code</div></td>
                        <td colspan="1"><input name="txtSupplierCode" type="text" class="txtbox" id="txtSupplierCode" size="21" /></td>
						<td></td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Company Name</td>
                        <td colspan="3"><input name="txtcompany" type="text" class="txtbox" id="txtcompany" style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Address</td>
                        <td colspan="3"><input name="txtaddress1" type="text" class="txtbox" id="txtaddress1" style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
			          </tr>
                      <tr>
                        <td class="normalfnt">&nbsp;</td>
                        <td colspan="3"><input name="txtaddress2" type="text" class="txtbox" id="txtaddress2" style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
					  <tr>
                        <td class="normalfnt">Option 1</td>
                        <td colspan="3"><input name="txtOption1" type="text" class="txtbox" id="txtOption1"  style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
					  <tr>
                        <td class="normalfnt">Option 2</td>
                        <td colspan="3"><input name="txtOption2" type="text" class="txtbox" id="txtOption2"  style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
					  <tr>
                        <td class="normalfnt">Option 3</td>
                        <td colspan="3"><input name="txtOption3" type="text" class="txtbox" id="txtOption3"  style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
					  <tr>
                        <td class="normalfnt">Contact Person</td>
                        <td colspan="3"><input name="txtContactPerson" type="text" class="txtbox" id="txtContactPerson"  style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Street</td>
                        <td colspan="3"><input name="txtstreet" type="text" class="txtbox" id="txtstreet"  style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                        </tr>
                      <tr>
                        <td class="normalfnt">City</td>
                        <td class="normalfnt"><input name="txtCity" type="text" class="txtbox" id="txtCity" size="21" /></td>
                        <td align="right">State</td>
                        <td><input name="txtState" type="text" class="txtbox" id="txtState" size="21" /></td>
                        <td>&nbsp;</td>
                        </tr>
                      <tr>
                        <td class="normalfnt">Country</td>
                        <td class="normalfnt"><input name="txtCountry" type="text" class="txtbox" id="txtCountry" size="21" /></td>
                        <td align="right">Zip Code</td>
                        <td><input name="txtZipCode" type="text" class="txtbox" id="txtZipCode" size="21" /></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Phone</td>
                        <td class="normalfnt"><input name="txtPhone" type="text" class="txtbox" id="txtPhone" size="21" /></td>
                        <td align="right">Fax</td>
                        <td><input name="txtFax" type="text" class="txtbox" id="txtFax" size="21" /></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td class="normalfnt">e-Mail</td>
                        <td colspan="3"><input name="txtemail" type="text" class="txtbox" id="txtemail" style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Website</td>
                        <td colspan="3"><input name="txtweb" type="text" class="txtbox" id="txtweb" style="width:377px" /></td>
                        <td class="normalfnt">&nbsp;</td>
					  </tr>
                      <tr>
	...
	?>
                        </select>  <img  src="../../images/addmark.png" size="1" onclick="openr('shipment')" /> </td>
                        <td align="right">Shipment Term</td>
                        <td colspan="1"><select name="cboshipmentTerm" class="txtbox" id="cboshipmentTerm" style="width:100px">
                          <option value="0" selected="selected">Select One</option>
                          <?php
	...
	?>
                        </select>  <img  src="../../images/addmark.png" size="1" onclick="openr('shipmentTerms')" /></td>
                        <td class="normalfnt">&nbsp;</td>
                        </tr>
                      <tr>
	...
	?>
                        </select> <img  src="../../images/addmark.png" size="1" onclick="openr('payMode')" /></td>
                        <td align="right">Pay Terms</td>
                        <td colspan="1"><select name="cbopayterms" class="txtbox" id="cbopayterms" style="width:100px">
                          <?php
	...
	?>
                        </select> <img  src="../../images/addmark.png" size="1" onclick="openr('payTerms')" /></td>
                        <td class="normalfnt">&nbsp;</td>
                        </tr>
                      <tr>
                        <td class="normalfnt">&nbsp;</td>
                ...
                <tr>
                  <td class="normalfnt"><table width="100%" border="0" class="bcgl1">
                    <tr>
                      ...
                      <td width="81%"><input name="txtremarks" type="text" class="txtbox" id="txtremarks"  style="width:377px"/></td>
                    </tr>
                    <tr>
                      <td valign="top">Key Items</td>
                      <td><input name="txtkeyitms" type="text" class="txtbox" id="txtkeyitms" size="61" style="height:50px"/></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td class="normalfnt"><table width="100%" border="0" class="bcgl1">
                    ...
                    <tr>
                      <td>Tax Enabled</td>
                      <td><input type="checkbox" name="chktax" id="chktax" /></td>
                      <td align="right">Tax Types</td>
                      <td><select name="cbotax" class="txtbox" id="cbotax" style="width:100px">
                      <?php
					  ...
					  ?>
                              </select> <img  src="../../images/addmark.png" size="1" onclick="openr('taxType')" /></td>
                    </tr>
                    <tr>
                      <td>Credit Allowed</td>
                      <td><input type="checkbox" name="chkcredit" id="chkcredit" /></td>
                      <td align="right">Credit Period</td>
                      <td><select name="cbocredit" class="txtbox" id="cbocredit" style="width:100px">
                                            <?php
					  ...
					  ?>
                              </select> <img  src="../../images/addmark.png" size="1" onclick="openr('creditPeriod')" /></td>
                    </tr>
                    <tr>
                      <td>VAT Suspended</td>
                      <td><input type="checkbox" name="chkvat" id="chkvat" /></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
                ...
                <tr>
                  <td class="normalfnt"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="5%" align="left"><input name="txtsupplier" type="text"  id="txtsupplier" size="3"  value="1" onkeyup="Blacklistreason();"/></td>
					...
					<tr style="display:none" id="reasonBlacklistreason">
                      ...
                      <td class="normalfnt"><input type="text" name="txtReason" id="txtReason" /></td>
                    </tr></table>
					<table width="100%" border="0" >
                      <tr>
                        <td width="16%">Supplier Approved</td>
                        <td width="8%" align="left"><input type="checkbox" name="chksupplier" id="chksupplier" onclick="supplierApproved();"/>
                            </td>
                        <?php
					...
					//hem*  }
                      ...
                      <tr>
                        <td colspan="4"><table id="ss" style="display:none" width="100%">
                            <tr>
                              <td>Upload File</td>
                              <td align="left" colspan="2"><input type="file" size="" id="" name="" /> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>Comments</td>
                              <td colspan="2"><input type="text" name="txtApprComments" class="txtbox"
							   id="txtApprComments"  style="width:377px" value="" /></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
