...
else if (strcmp($RequestType,"SaveMaterial") == 0) 
{
	...
	$propIDlist = $_GET["propIDlist"];
        ...
        $fabricTypeCode = $_GET["fabtypecode"];
	...
	if (!$itemExists)
	{
		...
		$sql = "insert into matitemlist (strItemCode,strItemDescription,intMainCatID,intSubCatID,strUnit,sngWastage,intStatus,strUserId,dtmDate,strPurchaseUnit,dblUnitPrice,intFabricType) values ('$ItemCode','$ItemName',$MainCatID,$subCatID,'$unitID',$Wastage,1,'$useID',now(),'$purchaseUnit','$unitPrice','$fabricTypeCode')";
