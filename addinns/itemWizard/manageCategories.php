          ...
          <div class="tableBorder2" id="divData" style="width:930px; height:400px; overflow: scroll;">
            <table width="910" bgcolor="#CCCCFF" border="0" cellpadding="0" cellspacing="1"  id="tblPreOders" >
              <tr>
                ...
                <td bgcolor="#498CC2" class="mainHeading2">Active</td>
              </tr>
              <?php
			...
			$sql = "SELECT intSubCatNo,intCatNo,StrCatName,intDisplay,intInspection,intAdditionalAllowed,intStatus FROM matsubcategory WHERE intCatNo = $catgory order by StrCatName;" ;
			  ...
			  if ($pos % 2 == 0)
			   ...
			   ?>">
                ...
                <?php } ?>
                 ...
                 <td class="normalfntMid">              
                <?php if ($row["intStatus"]==1){ ?>
                	<input  id="<?php echo  $row["intSubCatNo"]; ?>" onChange="changeStatus(this);" checked="checked" type="checkbox" />
                <?php } else { ?>
                <input  id="<?php echo  $row["intSubCatNo"]; ?>" onChange="changeStatus(this);" type="checkbox" />
                <?php } ?>
                </td>
				</tr>
              <?php
