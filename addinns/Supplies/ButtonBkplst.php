...
//echo "$Button";supplierCode
 ...
 // {
   $SQL_update="update suppliers set strTitle='".$ComName."',strAddress1='".$Address1."',strAddress2='".$Address2."',strOption1='".$Option1."',
...
$messageBd="Updated the supplier".$SupplierID.";

$strEmail = "http://softknowedge.com/email.php?message=";
$strEmail .= $messageBd;
$strEmail .= "&senderName=$sender&reciever=";
$strEmail .= "hemanthi.bu@gmail.com";
$strEmail .="&subject=";
$strEmail .= $subject;

$file  = fopen($strEmail, "rb");
//--------------------------------------------------------------
...
if($Button=="New")
	{
	 ...
	 if($row_supp = mysql_fetch_array($result_checksupp))
	 {
		 ...
		 {
		  $SQL_newupdate="update suppliers set strTitle='".$ComName."',strAddress1='".$Address1."',strAddress2='".$Address2."',
...
$messageBd="Saved the supplier".$strSupplierID.$ComName.";
