...
<thead style="height:25px">
  <tr>
      <td colspan="4" class="normalfnt2bldBLACKmid">Product Category Report</td>
      </tr>
      <tr>
	  <td class='normalfntBtab' align="center"><b>No</b></td>
	  <td class='normalfntBtab' align="center"><b>Product Name</b></td>
	  <td class='normalfntBtab' align="center"><b>Remarks </b></td>
      <td class='normalfntBtab' align="center"><b>Active</b></td>
	  </tr>
	  </thead>
	  <?php        
		$SQL="SELECT * FROM productcategory where intStatus !='10' order by intCatId asc";			
        $result=$db->RunQuery($SQL);
	    $i=1;
		while($row = mysql_fetch_array($result))
	{		
		$GProdID=$row["intCatId"];
		$ProductName=$row["strCatName"];
		$Descrtiption=$row["strRemarks"];
	  ...
	  echo"<td class='normalfnt'>$ProductName</td>";
