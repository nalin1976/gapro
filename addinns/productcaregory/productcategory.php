...
<div class="main_bottom">
	<div class="main_top"><div class="main_text">Product Category</div></div>
<div class="main_body">
<table width="100%" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
          ...
          <tr>
            <td height="96">
              <table width="100%" border="0">
				...
				$SQL="select intCatId,strCatName from productcategory order by strCatName;";
		...
		echo "<option value=\"". $row["intCatId"] ."\">" . $row["strCatName"] ."</option>" ;
				...
				?>	  
				  ...
				  <tr>
				    ...
				    <td><textarea name="txtaRemarks" cols="40" rows="1" id="txtaRemarks"></textarea>
				      </td>
				    </tr>
