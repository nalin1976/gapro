	...
	echo "<option value=\"". $row["intConID"] ."\" selected=\""."selected"."\">" . cdata($row["strCountry"]) ."</option>" ;
		...
		echo "<option value=\"". $row["intConID"] ."\">" . cdata($row["strCountry"]) ."</option>" ;
              ...
              <tr>
                ...
                <td><input type="checkbox" name="chkActive" id="chkActive" checked="checked" tabindex="24"/></td>
                <td colspan="2"></td>
                </tr>
            </table></td>
          </tr>
            ...
            <td height="34"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
              <tr>
                <td width="100%" bgcolor=""><table width="50" border="0" align="center">
                    <tr>
                      <td width="20%"><img src="../../images/new.png" alt="New" name="New" width="96" height="24" onclick="ClearCompanyForm();" class="mouseover" id="butNew" tabindex="28"/></td>
                      <td width="19%"><img src="../../images/save.png" alt="Save" name="Save"width="84" height="24" onclick="butCommand1(this.name);" class="mouseover" id="butSave" tabindex="24"/></td>
                      <td width="22%"><img src="../../images/delete.png" alt="Delete" name="Delete" width="100" height="24" onclick="ConfirmDeleteCompany(this.name);" class="mouseover" id="butDelete" tabindex="25"/></td>
					  					          <td width="12%" class="normalfnt"><img src="../../images/report.png" alt="Report" width="108" height="25" border="0" class="mouseover" onclick="listORDetails();" id="butReport" tabindex="26" /></td>
                      <td width="17%"><a href="../../main.php"><img src="../../images/close.png" alt="Close" name="Close" width="97" height="25" border="0"  class="mouseover" id="butClose" tabindex="27"/></a></td>
                      </tr>
                </table></td>
              </tr>
            </table></td>
