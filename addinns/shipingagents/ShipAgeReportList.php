...
<table width="800" border='1' align='center' CELLPADDING=3 CELLSPACING=1>
	  ...
	  <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b>Active</font></td>
	   ...
	   <?php
		...
		$SQL="SELECT * FROM shipping_agents where intStatus != '10'"; 
	...
	echo "<tr>";
	  ...
	  echo"<td class='normalfnt'>$strAddress1  $strAddress2</td>";
	  echo"<td class='normalfnt'>$strPhone</td>";
	  echo"<td class='normalfnt'>$strEMail </td>";
	  echo"<td class='normalfnt'>$strWeb</td>";
