...
<table width="800" border='1' align='center' CELLPADDING=3 CELLSPACING=1>
 ...
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> From</font></td>
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> To</font></td>
 <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Percentage</font></td>
  </tr>
	   <?php

		$SQL="SELECT * FROM grnexcessqty where intStatus !='10'"; 
	...
	echo "<tr>";
	  ...
	  echo"<td class='normalfntMid'>$intFrom</td>";
	  echo"<td class='normalfntMid'>$strTo</td>";
	  echo"<td class='normalfntMid'>$dblPercentage</td>";
    echo"</tr>";	
    $i++;	
   }
