...
$reportname = "oritpreorderReport.php";
	...
	$SQL = "select specification.intStyleId,specification.intSRNO from specification inner join orders on specification.intStyleId = orders.intStyleId AND (orders.intStatus = 10 OR orders.intStatus = 5) ;";
	...
	?>
        ...
        <tr>
          <td colspan="2"><div id="divData" style="width:950px; height:400px; overflow: scroll;">
			...
			$sql = "SELECT O.strOrderNo,O.intStyleId,O.strDescription,C.strComCode,B.strName,O.intQty,O.dtmDate,O.intFirstApprovedBy, specification.intSRNO, O.reaSMVRate FROM orders O INNER JOIN companies C ON O.intCompanyID = C.intCompanyID INNER JOIN buyers B ON O.intBuyerID = B.intBuyerID Left Outer Join specification ON O.intStyleId = specification.intStyleId WHERE (O.intStatus = 10 OR O.intStatus = 5) " ;
    ...
    <tr class="tableBorder">
      ...
      <td width="890" class="normalfnt"> First Approved Orders </td>
    </tr>
  </table>
</form>
</body>
