  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0"><tr><td class="tophead"><table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="74%" class="tophead"><p class="topheadBLACK">
 		<?php		
...
WHERE (((orders.intStyleId)='".$strStyleID."'));";
		...
		{			
			...
			echo $row["strAddress1"]." ".$row["strAddress2"]." ".$row["strStreet"]." ".$row["strCity"]." ".$row["strCountry"].". <br>"." Tel: ".$row["strPhone"]." Fax: ".$row["strFax"]." <br>E-Mail: ".$row["strEMail"]." Web: ".$row["strWeb"] ;
			echo "</p>";
		}
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			?>            </td>
            <td width="6%">&nbsp;</td>
            <td width="19%" class="bcgl1txt1NB">MERCHANDISER<br>&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td class="bcgl1txt1"><?php echo $intQty;$mobileOdrQty = $intQty;?></td>
          ...
          <tr>
            ...
            <td bgcolor="#BED6E9" class="bcgl1txt1B">Foreign Component  </td>
          ...
          <tr>
            ...
            <td class="bcgl1txt1"><?php echo $reaSMV; $mobileSMV = $reaSMV; ?></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="tablez">
          ...
          <tr>
			...
			$mobileCorpCost = number_format($reaFOB * 0.05,4);
			?></td>
            <td class="normalfntRiteTAB"><?php
          ...
          <tr>
			...
			$mobileFOB = number_format($reaFOB,4);
			?></td>
            <td class="normalfntRiteTAB"><?php
          ...
          <tr>
			...
			$mobileCOstOfSale = number_format($costOfSale ,4);
          ...
          <tr>
            ...
            <td class="normalfntRiteTAB"><?php echo number_format(($costOfSale + $coporatecost) ,4); $mobileTotCost = number_format(($costOfSale + $coporatecost) ,4); ?></td>
    ...
    <td><table width="100%" border="0" cellpadding="0">
      ...
      <tr>
        <td width="60%"><table width="100%" border="0" cellpadding="0">
            ...
            <tr>
              <td ><table width="400px" border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
*/
//echo "$cmVal" . "-" . "$labsuboverheadcost)". "/". "$reaFOB";
