...
function ShowReport()
{
	...
	var intSupplier		= document.getElementById('cboSupplier').value;	 
	var intCompany 		= document.getElementById('cboBulkStyleCompany').value;	 
	...
	newwindow=window.open(reportName+'&intMeterial='+intMeterial+'&intCategory='+intCategory+'&intDescription='+intDescription+'&intSupplier='+intSupplier+'&dtmDateFrom='+dtmDateFrom+'&dtmDateTo='+dtmDateTo+'&status='+stateID+'&intCompany='+intCompany+ '&noFrom=' +noFrom+ '&noTo=' +noTo+ '&RequestType='+requestType, 'report');	
...
function ShowExcelReport()
{
	...
	{
		var reportName	= "reportxcel/rptxcelgrn.php?";
	}
	else if(ReportId == 'radOpenPO')
	{		
		//var reportName	= "reportxcel/rptxcelBulkPurchaseordersOpen.php?";
		var reportName	= "reportxcel/rptxcelpurchaseorders.php?";	
		requestType = "radOpenPO";
	}
	else if(ReportId == 'radCompPo')
	{		
		//var reportName	= "reportxcel/rptxcelBulkPurchaseordersComplete.php?";
		var reportName	= "reportxcel/rptxcelpurchaseorders.php?";	
		requestType = "radCompPo";
	}	
...
function loadSubCategory()
{
	...
	xmlHttpreq[3].onreadystatechange = HandleCategory; //&styleID='+URLEncode(styleID)+'
	var url='reportMiddleTire.php?RequestType=getCategory&materialNo='+materialNo;
	xmlHttpreq[3].open("GET",url, true);	
...
//	var styleID	= document.getElementById('cboScNo').value;
	...
	xmlHttpreq[4].onreadystatechange = HandleItemDetails; //&styleID='+URLEncode(styleID)+'
	var url='reportMiddleTire.php?RequestType=getItemDetails&materialNo='+materialNo+'&categoryNo='+categoryNo;
	xmlHttpreq[4].open("GET",url, true);	
