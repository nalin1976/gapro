...
while($row = mysql_fetch_array($resDeliList)){
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$rowId,$strAuthoUser);
	...
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,$rowId,$row["ProdLocation"]);
