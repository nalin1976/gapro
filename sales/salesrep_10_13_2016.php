...
while($row = mysql_fetch_array($resDeliList)){
	...
	//$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$rowId,$dtAuthoTime);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,$rowId,$strFactoryUser);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,$rowId,$strAuthoUser);
	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12,$rowId,$strConfirmUser);

	

	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13,$rowId,$row["ProdLocation"]);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14,$rowId,$strRemarks);
