...
function ViewPO()
{
	...
	window.open("reportpurchase.php?pono=" + PONo + "&year=" + year,'report');
}
			...
			?>
			  ...
			  if ($pos % 2 == 0)
			   ...
			   ?>">
                ...
                <td class="normalfnt"><div align="center"><img onclick="viewReport(<?php echo  $row["intPONo"]; ?>,<?php echo  $row["intYear"]; ?>);" src="images/view2.png" border="0" class="noborderforlink" /></div></td>
