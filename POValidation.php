...
<body>
<form id="frmcomplete" name="frmcomplete" method="post" action="POValidation.php">
  <table width="100%" border="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td><table width="950" border="0" align="center" class="bcgl1">
        ...
        <tr>
          ...
          <td width="96%" class="head1">Purchase Orders (Pending Approval) - Validation </td>
        </tr>
        <tr>
	...
	?>
                  ...
                  <td width="72" ><select name="cboStyles" class="txtbox" style="width:170px" id="cboStyles" onchange="resetCompanyBuyer();getScNo();getStyleOrderNolist();">
                    <option value="" selected="selected">Select One</option>
                    <?php
...
purchaseorderheader.strSupplierID = suppliers.strSupplierID and purchaseorderheader.intStatus=$status  " ;
			...
			?>
			  ...
			  if ($pos % 2 == 0)
			   ...
			   ?>">
                ...
                <td class="normalfnt"><div align="center"><a href="<?php echo $reportname; ?>?pono=<?php echo  $row["intPONo"]; ?>&year=<?php echo  $row["intYear"]; ?>" target="_blank"><img src="images/view2.png" border="0" class="noborderforlink" /></a></div></td>
              </tr>
              <?php
			  $pos ++;
			}
		...
		<a href="main.php" target="_self"><img src="images/close.png" border="0" /></a></td>
		</tr>
      </table></td>
    </tr>
    <tr>
