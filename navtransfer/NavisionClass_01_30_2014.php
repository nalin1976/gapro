...
class classNavision{
	...
	#               	
	#============================================================================================	
	function UpdateFinshGoods($prmFOB, $prmEstCost, $prmSMV, $prmCMPc, $prmLabor, $prmJobNo, $prmNoParts){
		...
		$strSql = ' UPDATE [dbHela].[dbo].[HELA CLOTHING (PVT) LTD$Item Transfer] '.
				  ...
				  '     EstimatedLabourOHPiece = '.$prmLabor.', PCS_Pack = '. $prmNoParts. 
	...
	#               	
	#============================================================================================	
	function InsertFinishGoods($prmJobNo, $prmStyleId, $prmDivision, $prmSeason, $prmFOB, $prmSMV, $prmEstCost, $prmCMPc, $prmLabor, $prmStyleDesc, $prmNoParts){
		...
		$strSql = ' INSERT INTO [dbHela].[dbo].[HELA CLOTHING (PVT) LTD$Item Transfer] ([Item No_], StyleNo, BuyerDivision, GarmentType, Season, '.
                  ...
                  '              Description, BaseUnitofMeasure, SalesUOM, PurchaseUOM, GenProdPostingGroup, Transfer, PCS_Pack) '.
