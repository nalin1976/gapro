...
function GetUserName(obj){
	//var str_user_id = document.getElementById(obj.id).options[document.getElementById(obj.id).selectedIndex].text;
	var int_user_id = document.getElementById(obj.id).value;
	
	//document.getElementById('txtemailaddress').value = str_user_id;
	LoadUserDetails(int_user_id);
                ...
                <tr class="bcgl1">
                  <td><table width="100%" border="0" class="tableBorder">
                    <tr>
					  ...
					  <?php if(!$canEditAnyUserAccount){ ?> disabled="disabled"  <?php  } ?> class="txtbox" onchange="GetUserName(this);">
        <?php
             if(!$canEditAnyUserAccount){   
