    ...
    <tr>
        <td width="100%">
            ...
            <div class="col-md-6 div-board">
                ...
                <div class="col-md-7 div-pad">&nbsp;</div>
                <div class="col-md-3 div-pad">Requested Delivery Date</div>
                <div class="col-md-2 div-pad"><input type="text" id="dtDeliveryDate" class="form-control text-md" readonly></input></div>
                <div class="col-md-7 div-pad">&nbsp;</div>
                <div class="col-md-3 div-pad">ETD (PI Date)</div>
                <div class="col-md-2 div-pad"><input type="text" id="dtETDDate" class="form-control text-md" readonly onchange="setClearedDate()"></input></div>
                <div class="col-md-7 div-pad">&nbsp;</div>
                <div class="col-md-3 div-pad">ETA</div>
                <div class="col-md-2 div-pad"><input type="text" id="dtETADate" class="form-control text-md" readonly></input></div>
                <div class="col-md-7 div-pad">&nbsp;</div>
                <div class="col-md-3 div-pad">Actual Delivery Date From Supplier End</div>
                <div class="col-md-2 div-pad"><input type="text" id="dtADDate" class="form-control text-md" readonly></input></div>
                <div class="col-md-7 div-pad">&nbsp;</div>
                <div class="col-md-3 div-pad">Actual Cleared Date</div>
                <div class="col-md-2 div-pad"><input type="text" id="dtACDate" class="form-control text-md" readonly></input></div>
