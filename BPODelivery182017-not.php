...
<form name="frmstylewise" id="frmstylewise">	
  <table width="1075" border="0" align="left" bgcolor="" >
    <tr>
	...
	?>
                      ...
                      <tr>
                        ...
                        <td align="left"><select name="cboShortShipReason" id="cboShortShipReason" class="txtbox" style="width:150px">
                          ...
                          <tr>
                      	<td height="30">&nbsp;</td>
                        <td class="normalfnt">PCD Date</td>
                      ...
                      <tr>
                        <td colspan="3" valign="top">
                            ...
                            <table id="BuyerPO1"  style="width:960px; margin:1; padding:1; border-collapse:collapse; table-layout:fixed;" cellpadding="0" cellspacing="1" bgcolor="">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td width="" bgcolor="#498CC2" class="normaltxtmidb2L" style="width:60px; border: 1px solid #CCC;">Previous BPO</td>
                                     <td width="" bgcolor="#498CC2" class="normaltxtmidb2L" style="width:60px; border: 1px solid #CCC;">PCD Date</td>
                             ...
                             <div id="divcons" style=" overflow-y:auto; height:220px; width:1090px; border-collapse:collapse; margin:0; padding:2;">
                             <table id="BuyerPO" cellpadding="0" cellspacing="2" bgcolor="" style="margin: 0; padding: 2; border-collapse: collapse; width:1090px; table-layout:fixed;">
                             	<colgroup>
                                  <col width="20px" />
                                  <col width="95px" />
                                  <col width="57px" />
