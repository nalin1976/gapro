...
<div id="divPart" style="overflow:hidden; height:300px; width:450px;">
<table id="tblMain" width="450" border="0" align="" bgcolor="#FFFFFF">
  <tr>
    <td> <table width="100%" height="237" border="0" class="bcgl1">
            ...
            <tr>
              <td height="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><div id="divPartDetails" style="overflow:scroll; height:130px; width:437px;">
                      <table  id="tblPartDetails" width="420" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="12%" bgcolor="#498CC2" class="normaltxtmidb2">Sewing SMV</td>
                          <td width="12%" bgcolor="#498CC2" class="normaltxtmidb2">Pack SMV</td>
                          <td width="13%" bgcolor="#498CC2" class="normaltxtmidb2">EFF%</td>
                        </tr>
<?php
