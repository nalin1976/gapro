        ...
        <tr>
          <td colspan="2"><div id="divData" style="width:950px; height:400px; overflow: scroll;">
			...
			# Description - List pending process and pending 3rd approval orders
                        # =====================================================================
			$sql = "SELECT O.strOrderNo,O.intStyleId,O.strDescription,C.strComCode,B.strName,O.intQty,O.dtmDate,O.intFirstApprovedBy, specification.intSRNO, O.reaSMVRate FROM orders O INNER JOIN companies C ON O.intCompanyID = C.intCompanyID INNER JOIN buyers B ON O.intBuyerID = B.intBuyerID Left Outer Join specification ON O.intStyleId = specification.intStyleId WHERE (O.intStatus = 10 OR O.intStatus = 5 OR O.intStatus = 20 OR O.intStatus = 25) " ;
