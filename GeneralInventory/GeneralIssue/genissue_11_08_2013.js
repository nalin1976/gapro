...
{	
	...
	var itemDisI =htmlobj.responseXML.getElementsByTagName("ItemDescription")
		for ( var loop = 0; loop < itemDisI.length; loop ++)
		{
			...
			craeteGrid(itemDis,XMLMatDetailID,XMLunit,XMLBalQty,XMLMatMainID,XMLStockQty,XMLGRNNo,XMLDept,XMLcostCenterId,XMLcostCenterDes,XMLMainCatDes/*,XMLGLCode,XMLGLAllowId*/); 
		}
	hidePleaseWait();		 
 ...
 function craeteGrid(itemDis,XMLMatDetailID,XMLunit,XMLBalQty,XMLMatMainID,XMLStockQty,XMLGRNNo,XMLDept,XMLcostCenterId,XMLcostCenterDes,XMLMainCatDes/*,XMLGLCode,XMLGLAllowId*/)
 {
