...
?>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" class="bcgl1">
      <tr>
        <td height="29" style="text-align:center"><img src="../../images/new.png" alt="new" width="96" height="24" onclick="ClearForm();" /> <img src="../../images/save.png" alt="save" width="84" height="24" id="Save" onclick="getIssueNo();" /><img src="../../images/report.png" width="108" height="24" onclick="showReport();" /><a href="../../main.php"><img src="../../images/close.png" width="97" height="24" border="0" /></a></td>
   		</tr>
    </table></td>
  </tr>
</table>
