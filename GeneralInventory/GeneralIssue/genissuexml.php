...
genstocktransactions.intMatDetailId =  '$intMatDetailId' ";
	...
	$SQL = " SELECT
genstocktransactions.intGRNYear,
genstocktransactions.intGRNNo,
Sum(genstocktransactions.dblQty) AS BalQty,
genstocktransactions.strUnit
FROM
genstocktransactions
...
genstocktransactions.intMatDetailId =  '$intMatDetailId' ";
	...
	$SQL .= " GROUP BY genstocktransactions.intGRNYear, genstocktransactions.intGRNNo, genstocktransactions.strUnit ";
	$SQL .= " HAVING Sum(genstocktransactions.dblQty) > 0 "; // Add below
...
}else if ($RequestType=="SaveGenStockTransaction"){
