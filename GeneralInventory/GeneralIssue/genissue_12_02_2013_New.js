...
{	
	...
	var itemDisI =htmlobj.responseXML.getElementsByTagName("ItemDescription")
		for ( var loop = 0; loop < itemDisI.length; loop ++)
		{
			...
			craeteGrid(itemDis,XMLMatDetailID,XMLunit,XMLBalQty,XMLMatMainID,XMLStockQty,XMLGRNNo,XMLDept,XMLcostCenterId,XMLcostCenterDes,XMLMainCatDes/*,XMLGLCode,XMLGLAllowId*/, loop); 
		}
	hidePleaseWait();		 
 ...
 function craeteGrid(itemDis,XMLMatDetailID,XMLunit,XMLBalQty,XMLMatMainID,XMLStockQty,XMLGRNNo,XMLDept,XMLcostCenterId,XMLcostCenterDes,XMLMainCatDes/*,XMLGLCode,XMLGLAllowId*/, LineId)
 {
...
function OpenItemPopUp()
{
	...
	htmlobj=$.ajax({url:url,async:false});
	drawPopupBox(805,388,'frmPopItem',1);
