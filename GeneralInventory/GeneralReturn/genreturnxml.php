...
{		
	...
	$ResponseXML .= "<loadMrnDetailsToGrid>";
		//=========================================================================
		// Comment On - 2015-06-10
		// Description - Add GRN number to the issue itemlist for raise return to
		//               supplier.
		// Done - Nalin Jayakody
		//=========================================================================					
		/* $SQL = "SELECT genmatitemlist.strItemDescription,
				...
				WHERE
				genissuesdetails.dblBalanceQty >0 "; */
		//=========================================================================	
...
genissuesdetails.intMatDetailID,
genissuesdetails.dblBalanceQty,
concat(genstocktransactions.intGRNYear,'/',genstocktransactions.intGRNNo) AS GRNNo,
genmatmaincategory.strDescription,
genissuesdetails.intCostCenterId,
genissuesdetails.intGLAllowId
...
Inner Join genissuesdetails ON genmatitemlist.intItemSerial = genissuesdetails.intMatDetailID
Inner Join genmatmaincategory ON genmatitemlist.intMainCatID = genmatmaincategory.intID
Inner Join genstocktransactions ON genissuesdetails.intIssueNo = genstocktransactions.intDocumentNo AND genissuesdetails.intIssueYear = genstocktransactions.intDocumentYear AND genissuesdetails.intMatDetailID = genstocktransactions.intMatDetailId
WHERE
				genissuesdetails.dblBalanceQty >0 AND genstocktransactions.strType = 'ISSUE' ";
				
				if($MatId != ""){
					
					$SQL .= " AND genmatitemlist.intMainCatID =  '" . $MatId . "' ";
				}
...
function getGenReturnDetailsData($GPNo,$GPyear)
{
	...
	//==============================================================
	// Comment On  - 2015-06-10
	// Description - To display items in the return to stores for 
	//				 confirm
	// Done        - Nalin Jayakody
	//==============================================================
	...
	/*$sql = "select 	GRD.intReturnId, 
			...
			and GID.intGrnNo=GRD.intGRNNo and GID.intGrnYear=GRD.intGRNYear AND gmil.intItemSerial = GID.intMatDetailID
	...
	$sql = " select 	GRD.intReturnId, 
			...
			inner join genmatitemlist gmil on GRD.intMatDetailID = gmil.intItemSerial
			inner join genissuesdetails GID on GID.intIssueNo=GRD.intIssueNo and GID.intIssueYear=GRD.intIssYear 
			 AND gmil.intItemSerial = GID.intMatDetailID
			where intReturnId='$GPNo' and intRetYear='$GPyear'";
