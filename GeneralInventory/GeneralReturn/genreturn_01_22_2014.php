    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" class="bcgl1">
      <tr>
        ...
        <!--    <td width="9%" height="24" class="normalfnt">Mat. Req No</td>
            ...
            <td width="12%" class="normalfnt"><input name="txtreturnNo" type="text" class="txtbox" id="txtreturnNo" size="15" readonly="readonly" /></td>
            ...
            <td width="9%" class="normalfnt">Returned By</td>
