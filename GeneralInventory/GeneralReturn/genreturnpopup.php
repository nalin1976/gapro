...
<table width="850" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="tableFooter" align="center">
  ...
  <tr>
	...
	<td>
      ...
      <tr>
        <td width="147">Main Category</td>
        <td width="217"><select name="cboMainCategory" id="cboMainCategory" style="width:150px;" onChange="loadMrnDetailsToGrid();">
        <?php 
        ...
        <td width="129">Issue No Like</td>
        <td width="203"><input name="txtIssueNo" id="txtIssueNo" type="text"></td>
        <td width="122" style="text-align:center"><img src="../../images/search.png" alt="" width="80" height="24" onClick="loadMrnDetailsToGrid();"></td>
      </tr>
    </table>
	</td>
	</tr>
