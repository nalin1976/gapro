...
$report_companyId  =$_SESSION["FactoryID"];
		...
		(SELECT useraccounts.Name FROM useraccounts WHERE genreturnheader.intConfirmedBy = useraccounts.intUserID)AS Confirmedby
  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" border="0">
	  ...
	  <td width="5%">&nbsp;</td>
		...
		<td width="20%">&nbsp;</td>       
        <td width="25%"  class="bcgl1txt1"><?php echo $confirmBy; ?></td>
         <td width="5%">&nbsp;</td>
      </tr>
      <tr>
	   <td >&nbsp;</td>
