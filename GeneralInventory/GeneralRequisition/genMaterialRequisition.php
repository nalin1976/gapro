  ...
  <td><table width="100%" border="0" class="bcgl1">
   <tr>
      ...
      <tr>
        ...
        <td width="18%" class="normalfnt"><label id="txtStyleNo">
        ...
        <td width="24%" class="normalfnt"><input name="txtrequestedby" type="text" class="txtbox" id="txtrequestedby" size="20" value="<?php 		
        ...
        <td width="24%" class="normalfnt"><label id="txtBuyerPo">
      ...
      <tr>
       <!-- <td class="normalfnt">Cost Center </td>
        ...
        <td class="normalfnt" align="right">
        	<select name="cboStores" class="txtbox" id="cboStores" style="width:200px">
          	<option value="" selected="selected">Select One</option>
        	<?php 
				 //include "../../Connector.php";
				$SQL = " SELECT DISTINCT companies.strName, companies.intCompanyID FROM mainstores Inner Join companies ON mainstores.intCompanyId = companies.intCompanyID
WHERE
