...
function saveMrnHeader($mrnNo,$mrnYear,$departmentCode,$requestBy,$status,$userID,$companyID)
{
	global $db;
	$sql="INSERT INTO 
	...
	VALUES('$mrnNo','$mrnYear',NOW(),'$departmentCode','$requestBy','$status','$userID','$companyID','0');";	
