...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="1" cellspacing="0" class="tablez">
        <tr> 
          <td width="447" class="normalfntBtab" height="25">Item Description</td>
          <td width="278" class="normalfntBtab">Note</td>
          <td width="61" class="normalfntBtab">Req Qty</td>
        </tr>
		<?php
		$sum = 0;
		...
		$sql = "select 
				...
				genmatitemlist GMIL 
				where GMRD.intMatRequisitionNo = $matreqno AND GMRD.strMatDetailID = GMIL.intItemSerial AND GMIL.intMainCatID = $CatID";
        ...
        <tr> 
		  ...
		  <td class="normalfntRiteTAB"><b><?php echo number_format($sum,2);?></b></td>
        </tr>
      </table>
