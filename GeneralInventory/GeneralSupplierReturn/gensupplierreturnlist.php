...
$mainStoresId = GetMainStoresID($_SESSION["FactoryID"]);
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
	   ...
	   #================================================================================================
	   # Comment On - 02/28/2014
	   # Description - To change filtering option of a company to stores
	   #================================================================================================
	  ...
	  #=================================================================================================
	   ...
	   $SQL = "SELECT concat(GSH.intRetYear,'/',GSH.strReturnID) as intIssueNo , GSH.dtmRetDate ,GSH.intStatus, SUP.strTitle FROM  gensupreturnheader GSH Inner Join suppliers SUP ON GSH.intSupplierID = SUP.strSupplierID WHERE GSH.intStatus = 1 AND GSH.intCompanyID='$mainStoresId' ";
