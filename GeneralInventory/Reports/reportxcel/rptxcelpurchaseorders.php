			...
			//echo $detailSql;
				 ...
				 $i=5;
				   xlsWriteLabel(2,5,"GENERAL PURCHASE ORDER REGISTER"); 
					...
					xlsWriteLabel(4,4,"Supplier Code");
					xlsWriteLabel(4,5,"Location");
					xlsWriteLabel(4,6,"Main Category");
					//materialRatioID
					xlsWriteLabel(4,7,"Item Code");
					xlsWriteLabel(4,8,"Item Description");
					xlsWriteLabel(4,9,"Unit");
					xlsWriteLabel(4,10,"Qty");
					xlsWriteLabel(4,11,"Unit Price");
					xlsWriteLabel(4,12,"Amount");
				 ...
				 {			 	
					...
					xlsWriteLabel($i,4,$row["strSupplierCode"]);
					xlsWriteLabel($i,5,$row["strName"]);
					xlsWriteLabel($i,6,(substr($row["strDescription"],0,3))); 
					xlsWriteLabel($i,7,$row["strItemCode"]); 
					xlsWriteLabel($i,8,$row["strItemDescription"]); 
					xlsWriteLabel($i,9,$row["strUnit"]);
					xlsWriteNumber($i,10,round($row["dblQty"],2));
					xlsWriteNumber($i,11,$row["dblUnitPrice"]);
					xlsWriteNumber($i,12,$row["amount"]);
					$totalQty += $row["dblQty"];
