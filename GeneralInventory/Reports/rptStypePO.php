  ...
  <tr>
	...
	<tr>
    	<td width="86" bgcolor="#C4DBFD" class="normalfnth2B" >PO Number</td>
  	    <td width="296"  bgcolor="#C4DBFD" class="normalfnth2B" ><?php echo $rowdata["intPoNo"]; ?></td>
  	    <td width="610" >&nbsp;</td>
  	</tr> 
    <tr>	
    	<td colspan="3">
		...
		<table width="965" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
          ...
          <tr height="25" >
            ...
            <td class="normalfnt"><?php echo($strStyleNo	); ?></td>
