...
(select useraccounts.Name from useraccounts where useraccounts.intUserID = gengrnheader.intUserId) as preparedperson,generalpurchaseorderheader.intCompId, suppliers.strSupplierCode
    ...
    <td class="normalfnt2bldBLACKmid"><table width="100%" border="0" cellspacing="0" cellpadding="0"> 
      <tr>
        <td width="52%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="24%" align="left" valign="top"  class="normalfnth2B">Supplier Code : </td>
              <td width="76%" class="normalfnt"><?php echo $strSupplierCode;?></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
        </table></td>
