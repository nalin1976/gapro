...
gpd.strUnit,gpd.dblUnitPrice,gpd.dblPending,gpd.intMatDetailID,gpd.intGenPONo,gpd.intYear, gmil.strItemCode
...
where gpd.intGenPoNo='$poNo' and gpd.intYear='$year' and gpd.intMatDetailID = '$matDetailId' ";
	...
	//echo $SQL;
		...
		while($row = mysql_fetch_array($result))
		{
			 ...
			 $ResponseXML .= "<strItemCode><![CDATA[" . $row["strItemCode"]  . "]]></strItemCode>\n";
