		  ...
		  <tr>
			<td width="100%" class="normalfnt"><div id="divItem" style="overflow:scroll; height:320px; width:600px;">
			  <table width="100%" cellpadding="0" cellspacing="1" id="tblItem"  bgcolor="#CCCCFF">
                ...
                <?php 
				$sql = "select strItemDescription as Description,gpd.strUnit as strUnit, dblPending as Qty,intGenPONo ,intMatDetailID, strItemCode
 from generalpurchaseorderdetails gpd inner join genmatitemlist gmil on gpd.intMatDetailID = gmil.intitemserial 
where  intGenPONo= '$arrGenPO[1]' AND intYear=$arrGenPO[0] ";
			...
			while($row = mysql_fetch_array($result))
			{
              ...
              <tr class="<?php echo $strColor; ?>">
                                    ...
                                    <td id="<?php echo $row["intMatDetailID"]; ?>">&nbsp;<?php echo $row["strItemCode"]; ?></td>
