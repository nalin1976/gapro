...
where genmatitemlist.intItemSerial = gengrndetails.intMatDetailID) as Description FROM genmatitemlist Inner Join gengrndetails ON genmatitemlist.intItemSerial = gengrndetails.intMatDetailID
