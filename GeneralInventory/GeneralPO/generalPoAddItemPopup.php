...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr >
		...
		<tr>
			...
			<td width="35%" class="normalfnt"><select name="cboMainCategory" class="txtbox" id="cboMainCategory" style="width:257px" onChange="loadSubCategory(); loadNavisionCode();"></select></td>
			<td width="21%">&nbsp;</td>
		</tr>
		<tr>
			<td >&nbsp;</td>
			<td class="normalfnt">Sub Category</td>
			<td class="normalfnt"><select name="cboSubCategory" class="txtbox" id="cboSubCategory" onChange="loadNavisionCode();" style="width:257px" ></select></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td >&nbsp;</td>
			<td class="normalfnt">Navision Code</td>
			<td class="normalfnt"><!--<select name="cboNavitionCode" class="txtbox" id="cboNavitionCode" style="width:257px" ></select>-->
            	<input name="txtNAVCode" type="text"  id="txtNAVCode" style="width:255px" onKeyPress="enableEnterSubmitLoadDetails(event)" />
            </td>
			<td>&nbsp;</td>
		</tr>
        <tr>
