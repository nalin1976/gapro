...
/*if($status == '0'){
 "	WHERE (GH.intStatus = '0' OR GH.intStatus = '2' )  ";		
}else{
 "  WHERE GH.intStatus = '$status' ";
}
*/
...
?>
            <tr class="bcgcolor-tblrowWhite">
              ...
              <td class="normalfntMid"><a target="_blank"  href="<?php echo $reportUrl; ?>"><img src="../../images/view2.png" id="butReport"  class="mouseover"  border="0" /></a></td>
            </tr>
<?php
}
?>
