...
<script language="javascript" src="generalPoList-java.js"></script>
		...
		<td colspan="4"></td>		
			...
			<tr bgcolor="#d6e7f5" align="center">
                ...
                <?php 
					...
					if($intStatus!=1){
					?>
                        <td width="15%" class="normalfntLeftTABNoBorder"><img src="../../images/reject.png" alt="reject" class="mouseover" onclick="RejectGenPO()" /></td>
                   <?php 		
					}
				 ?>
...
function RejectGenPO(){
    
    var genpono =<?php echo $_GET["bulkPoNo"];?>;
    var genyear =<?php echo $_GET["intYear"];?>;

    var url = 'generalPo-db.php?id=cancelBulkPo&intGenPONo=' +genpono+ '&intYear=' +genyear
    var xml_http_obj=$.ajax({url:url,async:false});
