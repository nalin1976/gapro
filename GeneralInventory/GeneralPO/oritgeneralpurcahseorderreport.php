...
<style type="text/css">
	...
	.borderBtmRight{ border-bottom:#000000 thin solid; border-right:#000 thin solid;}
	.borderBtm{ border-bottom:#000000 thin solid;}
	.borderBtmRightDetail{ border-bottom:#000000 thin solid; border-right:#000 thin solid; font-family:Verdana; font-size:11px;}
	.borderBtmRightDetailCenter{ border-bottom:#000000 thin solid; border-right:#000 thin solid; font-family:Verdana; font-size:11px; text-align:center}
	.borderBtmRightDetailRight{ border-bottom:#000000 thin solid; border-right:#000 thin solid; font-family:Verdana; font-size:11px; text-align:right}
	.borderBtmDetail{ border-bottom:#000000 thin solid; font-family:Verdana; font-size:11px; text-align:right}
	.borderBtmDetailCenter{ border-bottom:#000000 thin solid; font-family:Verdana; font-size:11px; text-align:center}
        .borderRight{border-right:#000 thin solid;}
        
        @media print{
            .donotprint{display:none;}
        }
</style>
<script src="gpo.js" type="text/javascript">
...
suppliers.strAddress1 as supstrAddress1, suppliers.strAddress2 as supstrAddress2, suppliers.strStreet as supstrStreet, suppliers.strCity as supstrCity, suppliers.strState as supstrState,(select strCountry from country C where C.intConID=suppliers.strCountry) as supstrCountry,
 ...
 GPOH.intPrintStatus, GPOH.intCheckedBy, GPOH.dtmCheckedDate, suppliers.strSupplierCode, GPOH.strSundrySupplier
...
{		
	...
	$CheckedId		    = $row["intCheckedBy"];
	$checkedDate 		= $row["dtmCheckedDate"];
	...
	$SDetails .= ($row["strSundrySupplier"]==""? "":$row["strSundrySupplier"]."<br/>"."&nbsp;");
...
?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="36" colspan="6" class="head2">PO NO - G-<?php echo "$intYear/$bulkPoNo "?></td>
      </tr>
      <tr>
       ...
       <tr>
        <td height="25" align="left" valign="top" class="normalfnth2B">Supplier Code </td>
        <td class="normalfnth2B" valign="top">:</td>
        <td class="normalfnt" valign="top">&nbsp;<?php echo $strSupplierCode; ?></td>
        <td width="10%" class="normalfnth2B" valign="top">&nbsp;</td>
        <td width="1%" class="normalfnth2B" align="left" valign="top">&nbsp;</td>
        <td width="34%" valign="top" class="normalfnt">&nbsp;</td>
      </tr>
      
      
      <tr>
        <td width="15%" class="normalfnth2B">PO Date </td>
        <td width="1%" class="normalfnth2B">:</td>
        <td width="39%" class="normalfnt"><?php echo substr("$dtmDate",0,10) ?></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="1" cellspacing="0"  style="border:#000000 thin solid;">
      <tr bgcolor="#CCCCCC" class="normalfntMid">
        <th width="10%" height="25" rowspan="2" class="borderBtmRight">ITEM CODE </th>
        <th width="30%" rowspan="2" class="borderBtmRight" >DESCRIPTION</th>
        <th width="8%" rowspan="2" class="borderBtmRight" >UNIT</th>
        <th width="11%" rowspan="2" class="borderBtmRight" >RATE<br/>(<?php echo $currencyName;?>)</th>
        <th width="8%" rowspan="2" class="borderBtmRight" >QTY</th>
        <!--<th colspan="2" >DISCOUNT</th>-->
      <th width="15%" rowspan="2" class="borderBtmRight" >TOTAL AMOUNT<br/>(<?php echo $currencyName;?>)</th>
      <?php if($intStatus==2){ ?>
        <th width="3%" rowspan="2" class="borderBtm donotprint" >&nbsp;<br/></th>
      <?php } ?>
      </tr>
      <tr bgcolor="#CCCCCC" class="normalfntMid">
        <!--<th width="7%" >%</th>
	  ...
	  <?php 
	  	$strSQL = "SELECT
					...
					group  by genmatitemlist.strItemDescription,generalpurchaseorderdetails.strUnit, genmatitemlist.strItemCode";
		...
		while($row = mysql_fetch_array($result))
		{
				...
				$strNavisionCode    =$row["strItemCode"];
	  ...
	  <tr class="bcgcolor-tblrowWhite">
        <td height="20" class="borderBtmRightDetail">&nbsp;<?php echo $strNavisionCode;?></td>
        <td class="borderBtmRightDetail">&nbsp;<?php echo $strDescription."-".$strRemarks; ?></td>
        <td class="borderBtmRightDetailCenter">&nbsp;<?php echo $strUnit  ?></td>
        <td class="borderBtmRightDetailRight"><?php echo number_format($dblUnitPrice,4,".",",");?>&nbsp;</td>
        <td class="borderBtmRightDetailRight"><?php echo $dblQty;?>&nbsp;</td>
        <!--<td class="normalfntRite"><?php echo $discount;?>&nbsp;</td>
        <td class="normalfntRite"><?php echo number_format($value,4,".",",");?>&nbsp;</td>-->
        <td class="borderBtmRightDetailRight"><?php $dblTotal =  ($dblUnitPrice * $dblQty)-$value ;echo number_format($dblTotal,2,".",",");	$dblGrandTotal +=$dblTotal; ?>&nbsp;</td>
        <?php if($intStatus==2){ ?>
        <!-- <td class="borderBtmDetailCenter donotprint"><img src="../../images/information-icon_30x30.png" id="<?php echo $MatDetailID; ?>" onmouseover="viewItemHistory(this,event)" onmouseout="HideDiv()" /></td> -->
        <td class="borderBtmDetailCenter donotprint"><img src="../../images/information-icon_30x30.png" id="<?php echo $MatDetailID; ?>" onclick="window.open('viewitemhistory.php?itemcode=<?php echo $MatDetailID; ?>','_blank') ;" /></td>
        <?php } ?>
        </tr>
		<?php		
		}		
      ...
      <tr bgcolor="#CCCCCC">
			...
			<td class="normalfntRite borderRight" ><b>
			<?php
				if ($strCurrency != "")
				{
...
?></b></td>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0">
      <tr>
        <td width="78" class="normalfnt2bldBLACKmid">&nbsp;</td>
        <td width="209" class="normalfntTAB2">
<?php
...
?></td>
		<td width="78" class="normalfnt2bldBLACKmid">&nbsp;</td>
        <td width="201" class="normalfntTAB2">
<?php

	$sql_checked = "SELECT UA.Name, UA.intUserID FROM useraccounts UA WHERE UA.intUserID ='$CheckedId'"; 
	$result_checked = $db->RunQuery($sql_checked);
	
	if($row_chekuser = mysql_fetch_array($result_checked))
	{
		echo $row_chekuser["Name"];
	}
...
?>        
        ...
        <td width="78" class="normalfnt2bldBLACKmid">&nbsp;</td>
        <td width="215" valign="top" class="normalfntTAB2">
<?php          
...
?>         </td>        
      ...
      <tr>
        ...
        <td width="78" class="normalfnt2bldBLACKmid">&nbsp;</td>
        <td width="201" class="normalfntMid">&nbsp;Checked By</td>
        <td width="78" class="normalfnt2bldBLACKmid">&nbsp;</td>
      ...
      <tr>
        ...
        <td class="normalfnt2bldBLACKmid">&nbsp;</td>
        <td class="normalfntMid"><?php echo $checkedDate; ?></td>
        <td class="normalfnt2bldBLACKmid">&nbsp;</td>
  ...
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td colspan="2"><?php  include "genaralpoconfirmation.php"; ?></td>
  </tr>
</table>
<div id="divPopUp" class="donotprint">
    <table id="tbItemHistory" width="100%" border="0">
	<thead>
            <th class="thformat">PO#</th>
            <th class="thformat">Supplier Name</th>
            <th class="thformat">UOM</th>
            <th class="thformat">Unit Price</th>
            <th class="thformat">Order Qty</th>
            <th class="thformat">Delivery Location</th>
        </thead>
	<tbody id="tbodyItemView" class="tbBody"></tbody>
    </table>
</div>
<?php
