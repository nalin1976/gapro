...
?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="1" cellspacing="0"  style="border:#000000 thin solid;">
      ...
      <th width="15%" rowspan="2" class="borderBtm" >TOTAL AMOUNT<br/>(<?php echo $currencyName;?>)</th>
      </tr>
      <tr bgcolor="#CCCCCC" class="normalfntMid">
        <!--<th width="7%" >%</th>
	  ...
	  <tr class="bcgcolor-tblrowWhite">
        ...
        <td class="borderBtmDetail"><?php $dblTotal =  ($dblUnitPrice * $dblQty)-$value ;echo number_format($dblTotal,2,".",",");	$dblGrandTotal +=$dblTotal; ?>&nbsp;</td>
        </tr>
		<?php		
		}		
		?>
