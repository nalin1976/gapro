...
<title>General Gatepass - Transfer List</title>
...
<body>
<form name="tranferList" id="tranferList">
  <tr>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="tableBorder">
      ...
      <tr  height="25" class="mainHeading">
        <td width="27%">&nbsp;</td>
        <td width="22%">General Gate Pass TransferIn</td>
        <td width="17%"><select name="cbocategory" class="txtbox" id="cbocategory" style="width:150px" onchange="LoadSavedDetails();">		
          	<option value="1">Processed TranferIn</option>
			<option value="10">Cancel TranferIn</option>
		  	<!--<option value="10">Cancel Details</option>-->
            </select></td>
        <td width="34%" class="normaltxtmidb2L">List</td>
      </tr>
    </table></td>
     <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="13%" class="normalfnt"><select name="TrasnferNoFrom" class="txtbox" id="TrasnferNoFrom" style="width:100px">
          <?php

 	$SQL ="select concat(intTransferInYear,'/', intTransferInNo)as tranferNo from gengatepasstransferinheader ; ";
	...
	{
		echo "<option value=\"".""."\">". $row["tranferNo"] ."</option>";
	}
 ?>
        </select></td>
        <td width="3%" class="normalfnt">To</td>
        <td width="13%" class="normalfnt"><select name="TrasnferNoTo" class="txtbox" id="TrasnferNoTo" style="width:100px">
          <?php
    ...
    <td>
      ...
      <tr>
        <td><div id="divTranferInDetails" style="overflow:scroll; height:400px; width:950px;">
          <table id="tblTranferInDetails" width="933" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF" >
