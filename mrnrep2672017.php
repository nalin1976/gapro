...
?>
    ...
    <td><table width="135%" border="0">
      <tr>
        <td width="42%" ><table width="100%" border="0">
              <tr> 
                <td width="37%" class="normalfnt2bldBLACK">Mat. Requisition No </td>
                <td width="63%" class="normalfnt">: <?php echo $MatRequisitionNo;?></td>
              </tr>
            </table></td>
        <td width="58%" ><table width="100%" border="0">
              <tr> 
                <td width="26%" class="normalfnt2bldBLACK">Requested Date </td>
                <td width="74%" class="normalfnt">: <?php echo $MatRequisitionDateNewDate."/".$MatRequisitionDateNewmonth."/".$MatRequisitionDateNewYear;?></td>
              </tr>
            </table></td>
      </tr>
      <tr>
        <td width="42%" ><table width="100%" border="0">
              <tr> 
                <td width="37%" class="normalfnt2bldBLACK">To </td>
                <td width="63%" class="normalfnt">: <?php echo $to;?></td>
              </tr>
              
            </table></td>
        <td width="58%" ><table width="100%" border="0">
              <tr> 
                <td width="26%" class="normalfnt2bldBLACK">Department (From)</td>
                <td width="74%" class="normalfnt">: <?php echo $department;?></td>
              </tr>
            </table></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablez">
        <tr> 
          <td width="7%" height="24" class="normalfntBtab">Style No</td>
          <td width="4%" height="24" class="normalfntBtab">SC No</td>
          <!--<td width="6%" class="normalfntBtab">Order No</td>-->
          <td width="14%" class="normalfntBtab">Item</td>
          <td width="9%" class="normalfntBtab">Remarks</td>
          <!--<td width="9%" class="normalfntBtab">Wash Color </td>-->
          ...
          <td width="10%" class="normalfntBtab">Item Code</td>
          <td width="16%" class="normalfntBtab">Note</td>
        </tr>
        ...
        <tr> 
          <td colspan="11" class="normalfnt2BITAB"><?php echo  $row["strDescription"]; ?></td>
        </tr>
		<?php
		
		$CatID = $row["intID"];
		//echo $CatID;
		$sql = "SELECT matitemlist.strItemDescription, matrequisitiondetails.intStyleId, specification.intSRNO, matrequisitiondetails.strBuyerPONO,matrequisitiondetails.strNotes,
matrequisitiondetails.strColor, matrequisitiondetails.strSize, specificationdetails.strUnit ,round(matrequisitiondetails.dblQty,2)as dblQty,orders.strStyle, orders.strOrderNo, matitemlist.intItemSerial
...
#==========================================================================================
# Comment on 2013/10/14 by Nalin Jayakody
#==========================================================================================

#==========================================================================================
# Un Comment on 2013/10/22 by Nalin Jayakody
#==========================================================================================
	/*$sql = "SELECT
matitemlist.strItemDescription,
matrequisitiondetails.intStyleId,
specification.intSRNO,
matrequisitiondetails.strBuyerPONO,
matrequisitiondetails.strNotes,
matrequisitiondetails.strColor,
matrequisitiondetails.strSize,
round(matrequisitiondetails.dblQty,2) AS dblQty,
orders.strStyle,
orders.strOrderNo,
purchaseorderdetails.strRemarks,
purchaseorderdetails.strUnit,
matrequisitiondetails.strMatDetailID
FROM matrequisitiondetails 
INNER JOIN matitemlist ON matrequisitiondetails.strMatDetailID = matitemlist.intItemSerial 
INNER JOIN specification ON matrequisitiondetails.intStyleId = specification.intStyleId
INNER JOIN orders ON orders.intStyleId = specification.intStyleId 
INNER JOIN purchaseorderdetails ON purchaseorderdetails.intMatDetailID = matrequisitiondetails.strMatDetailID 
AND purchaseorderdetails.strBuyerPONO = matrequisitiondetails.strBuyerPONO 
AND purchaseorderdetails.strColor = matrequisitiondetails.strColor AND purchaseorderdetails.strSize = matrequisitiondetails.strSize 
AND purchaseorderdetails.intStyleId = orders.intStyleId 
INNER JOIN grnheader ON grnheader.intGrnNo = matrequisitiondetails.intGrnNo AND grnheader.intPoNo = purchaseorderdetails.intPoNo
WHERE matrequisitiondetails.intMatRequisitionNo = '$matreqno' 
AND matrequisitiondetails.intYear='$year' AND matitemlist.intMainCatID = '$CatID'";*/

#==========================================================================================

#==========================================================================================
# Comment on 2013/10/23 by Nalin Jayakody
#==========================================================================================
...
Inner Join specification ON matrequisitiondetails.intStyleId = specification.intStyleId
Inner Join orders ON orders.intStyleId = specification.intStyleId
Left Join purchaseorderdetails ON purchaseorderdetails.intMatDetailID = matrequisitiondetails.strMatDetailID AND purchaseorderdetails.strBuyerPONO = matrequisitiondetails.strBuyerPONO AND purchaseorderdetails.strColor = matrequisitiondetails.strColor AND purchaseorderdetails.strSize = matrequisitiondetails.strSize AND purchaseorderdetails.intStyleId = orders.intStyleId
Left Join grnheader ON grnheader.intGrnNo = matrequisitiondetails.intGrnNo AND grnheader.intPoNo = purchaseorderdetails.intPoNo
WHERE matrequisitiondetails.intMatRequisitionNo = '$matreqno' 
AND matrequisitiondetails.intYear='$year' AND matitemlist.intMainCatID = '$CatID'";*/
#==========================================================================================
...
orders.strOrderNo,
matrequisitiondetails.strMatDetailID,
itemtransferdetails.strUnit
FROM
matrequisitiondetails
Inner Join matitemlist ON matrequisitiondetails.strMatDetailID = matitemlist.intItemSerial
Inner Join specification ON matrequisitiondetails.intStyleId = specification.intStyleId
Inner Join orders ON orders.intStyleId = specification.intStyleId
Inner Join itemtransferdetails ON matrequisitiondetails.strBuyerPONO = itemtransferdetails.strBuyerPoNo AND matrequisitiondetails.strMatDetailID = itemtransferdetails.intMatDetailId AND matrequisitiondetails.strColor = itemtransferdetails.strColor AND matrequisitiondetails.strSize = itemtransferdetails.strSize
Inner Join itemtransfer ON itemtransfer.intTransferId = itemtransferdetails.intTransferId AND itemtransfer.intTransferYear = itemtransferdetails.intTransferYear AND matrequisitiondetails.intStyleId = itemtransfer.intStyleIdTo
WHERE matrequisitiondetails.intMatRequisitionNo = '$matreqno' 
AND matrequisitiondetails.intYear='$year' AND matitemlist.intMainCatID = '$CatID'";*/
        ...
        <tr> 
          ...
          <td class="normalfntTAB"><?php echo   ""; //$row["strRemarks"]; ?></td>
          <!--<td class="normalfntMidTAB"><?php echo GetWashColor($StyleID);?></td>-->
          <td class="normalfntMidTAB"><?php echo $row["strBuyerPONO"];?></td>
          ...
          <td class="normalfntRiteTAB"><?php echo  GetItemCode($StyleID,$row['intItemSerial'],$row["strColor"],$row["strSize"],$buyerPOid ); ?></td>
        ...
        <tr> 
          <td colspan="7" style="text-align:center" ><strong class="normalfnth2Bm">TOTAL</strong></td>
...
function GetItemCode($prmStyleID, $prmMatItemCode, $prmColor, $prmSize, $prmBuyerPONo){
	
	global $db;
	
	$strSql = " select materialRatioID from materialratio where intStyleId = $prmStyleID and strMatDetailID = $prmMatItemCode and strColor = '$prmColor' and strSize = '$prmSize' and strBuyerPONO = '$prmBuyerPONo' ";
	
	$result = $db->RunQuery($strSql);
	
	while($rowItemCode = mysql_fetch_array($result)){
		return $rowItemCode['materialRatioID'];
	}
