...
else if (strcmp($RequestType,"UnLockUser") == 0)
{
	...
	$sql = "UPDATE useraccounts SET STATUS ='1',strRemarks=null WHERE intUserID ='$userID'";
	$db->executeQuery($sql);
}
...
$UserId = $_GET["userId"];
	...
	$sql="select UserName,UA.Name,intExPercentage from useraccounts UA where UA.intUserID=$UserId";
