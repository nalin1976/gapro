...
function Continue()
{
	window.opener.document.getElementById('imgStyle').src = "styles/<?php echo $_SESSION["currentStyle"]; ?>.jpg";
...
if ($_FILES["file"]["error"] > 0)
  ...
  move_uploaded_file($_FILES["file"]["tmp_name"],"styles/" . $_SESSION["currentStyle"] . ".jpg");
  }
