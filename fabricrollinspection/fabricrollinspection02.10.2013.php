...
?>
                      ...
                      <tr>
                        ...
                        <input type="text" name="txtponoLike" id="txtponoLike" onkeypress="autocomplete_item();"/><span><img src="../images/go.png" class="mouseover" onclick="DisplaySelectedItem(); LoadSupplier(); LoadStyle();LoadSc();LoadBuyerPoNo(); LoadDescription(); LoadColor();" />
                        <select name="cboPoNo" class="txtbox" style="width:100px" id="cboPoNo" onchange="LoadSupplier(); LoadStyle(); LoadSc();LoadBuyerPoNo(); LoadDescription(); LoadColor();"  >
                        </select>
                        </span></td>
                      ...
                      <tr>
                        ...
                        onkeyup="validateSpecialCharacters(this.id);" disabled="disabled" /></td>
                      </tr>
                      <tr>
                        <td class="normalfnt">Style No </td>
                        <td width="170">
                        	<select name="cboStyleId" class="txtbox" style="width:170px" id="cboStyleId" onchange="LoadColor();">
                            	<option value="0" selected="selected">Select One</option>
                        	</select>
                        </td>
                        <td width="36" class="normalfnt" align="right">Sc No </td>
                        <td width="170">
                        	<select name="cboScNo" class="txtbox" style="width:100px" id="cboScNo">
                        ...
                        <td colspan="3" rowspan="5" class="normalfnt"><table id="tblSub" width="438" border="0" class="bcgl1" bgcolor="#fbf8b3">
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td><input name="txtSuppWith" type="text" class="txtbox" id="txtSuppWith" size="9" style="text-align:right" onkeypress="return CheckforValidDecimal(this.value, 4,event);" onkeyup="nextCompWidthTextBox(event); "  /></td>
	...
	?>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td><input name="txtSuppLength" type="text" class="txtbox" id="txtSuppLength" size="9" style="text-align:right" onkeypress="return CheckforValidDecimal(this.value, 4,event);"  onkeyup="nextCompLengthTextBox(event);"/></td>
	...
	?>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td><input name="txtSuppWeight" type="text" class="txtbox" id="txtSuppWeight" size="9" style="text-align:right" onkeypress="return CheckforValidDecimal(this.value, 4,event);"  onkeyup="nextCompWeigthTextBox(event);" /></td>
