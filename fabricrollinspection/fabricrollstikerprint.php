...
while ($row=mysql_fetch_array($result))
{
	...
	$srNo				= $row["intSRNO"];
	$supplierBatchNo	= $row["strSupplierBatchNo"];
	$companyBatchNo		= $row["strCompanyBatchNo"];
	$color				= $row["strColor"];
...
<div style="border-width:1px;border:#ffffff;border-style:solid;overflow:hidden;">
 ...
 <?php 
$sqlcomp="select dblCompLength as compLength,strLengthUOM,dblCompWidth as compWidth,strWidthUOM,dblCompWeight as compWeight,strWeightUOM from fabricrolldetails 
...
while($row_comp=mysql_fetch_array($result_comp))
{
	...
	$compLengthUOM	=$row_comp["strLengthUOM"];
	$compWidthUOM	=$row_comp["strWidthUOM"];
	$compWeightUOM	=$row_comp["strWeightUOM"];
}
?>
  <tr>
    <td colspan="5" align="center"><span class="paragraph"><span class="fontColor11">Company -Len-</span><span class="fontColor11"><?php echo $compLength;?></span><span class="fontColor11"> </span><span class="fontColor11"><?php echo $compLengthUOM;?></span><span class="fontColor11"> / Wdt - </span><span class="fontColor11"><?php echo $compWidth;?></span><span class="fontColor11"> </span><span class="fontColor11"><?php echo $compWidthUOM;?></span><span class="fontColor11"> / Wgt - </span><span class="fontColor11"><?php echo $compWeight;?></span><span class="fontColor11"> </span><span class="fontColor11" ><?php echo $compWeightUOM;?></span></span></td>
  </tr>
  <tr>
...
?>
  <tr>
    <td height="19" colspan="5" align="center"><sup><span class="fontColor11"> -Len-</span><span class="fontColor11"><?php echo number_format($suppLength,2);?></span><span class="fontColor11"> </span><span class="fontColor11"><?php echo $compLengthUOM;?></span><span class="fontColor11"> / Wdt-</span><span class="fontColor11"><?php echo number_format($suppWidth,2);?></span><span class="fontColor11"><?php echo $compWidthUOM;?></span><span class="fontColor11"> /Wgt-</span><span class="fontColor11"><?php echo number_format($suppweight,2);?></span><span class="fontColor11"> </span><span class="fontColor11"><?php echo $compWeightUOM;?></span></sup></td>
  </tr>
