...
?>		
<table width="39%"  border="1" cellpadding="0" cellspacing="0" style="height:100px">
  <tr>
    <td height="204">&nbsp;


<DIV  style="z-index:25; position:relative; left:72PX; top:-12px; width:320PX; height:46PX; " class="adornment10"  ALIGN="CENTER">
...
<DIV  style="z-index:25; position:relative;left:64PX; top:-65PX; width:336PX; height:28PX; " class="adornment10"  ALIGN="CENTER">
<?php 
...
<DIV  style="z-index:25; position:relative; left:72PX; top:-55px; width:152PX; height:18PX; " class="adornment10" >
...
?>
<DIV  style="z-index:25; position:relative; left:232PX; top:-65px; width:168PX; height:16PX; " class="adornment10" >
...
<DIV  style="z-index:25; position:relative; left:72PX; top:-70PX; width:65PX; height:15PX; " class="adornment10" >
<table width="65PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor14" ><?PHP echo $supplierName;?></td></tr></table>
</DIV>
<div  style="z-index:25; position:relative; left:126px; top:-75px; width:288PX; height:26PX; " class="adornment10" >
  <table width="283PX" border=0 cellpadding="0" cellspacing="0">
    <tr>
      <td nowrap class="paragraph"><span class="fontColor11"> -Len-</span><span class="fontColor11"><?php echo number_format($suppLength,2);?></span><span class="fontColor11"> </span><span class="fontColor11">YRD</span><span class="fontColor11"> / Wdt-</span><span class="fontColor11"><?php echo number_format($suppWidth,2);?></span><span class="fontColor11">INCH</span><span class="fontColor11"> /Wgt-</span><span class="fontColor11"><?php echo number_format($suppweight,2);?></span><span class="fontColor11"> </span><span class="fontColor11">KGS</span></td>
    </tr>
  </table>
</div></td>
  </tr>
