...
<title>Style Items :: Saved Issues List</title>
...
<table width="950" border="0" align="center" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablezRED">
          <tr>
            ...
            <td width="10%" class="normalfnt"><select name="cboissuenofrom" class="txtbox" id="cboissuenofrom" style="width:80px">
 <?php

 	$SQL ="select concat(intIssueYear,'/', intIssueNo)as issueNo from issues ; ";
 ...
 ?>
            ...
            <td width="8%" class="normalfnt">Issue No To</td>
            
			<td width="10%" class="normalfnt"><select name="cboissuenoto" class="txtbox" id="cboissuenoto" style="width:80px">
 <?php
 ...
 ?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="18" bgcolor="#9BBFDD" class="normalfnth2"><div align="center">Saved Style Issue List</div></td>
        </tr>
      <tr>
        <td class="normalfnt"><div id="divtblIssueDetails" style="overflow:scroll; height:400px; width:950px;">
          <table id="tblIssueDetails" width="932" cellpadding="0" cellspacing="0">
            <tr>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#D6E7F5">
      <tr>
        ...
        <td width="13%"><img src="../images/new.png" alt="new" width="96" height="24" onclick="ClearForm();" /></td>        
