              ...
              <table width="100%" height="165" border="0" cellpadding="0" cellspacing="0">
                <tr class="bcgl1">
                  <td width="100%"><table width="93%" border="0" class="bcgl1">
                    <tr>
                      <td colspan="3"><div id="divBinItems" style="overflow:scroll; height:230px; width:500px;">
          <table id="tblBinItems" width="500" cellpadding="0" cellspacing="0" onclick="validateBinQty(this);">
            <tr>
                ...
                <tr class="bcgl1">
                  <td bgcolor="#D6E7F5"><table width="100%" border="0">
                    <tr>
                      ...
                      <td width="30%" class="normalfntp2"><img src="../images/close.png" alt="close" width="97" height="24"/></td>
                      <td width="20%">&nbsp;</td>
                    </tr>
                  </table></td>
                </tr>
