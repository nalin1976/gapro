...
{
	//alert(styleNo);
	if(document.getElementById("buyerPOfile").value=="")
	{
		alert("Please Select a document.");
		document.getElementById("buyerPOfile").focus();
		return false;
	}
	//alert(styleNo);
	var url = 'BuyerPO/uploader_buyerPO_file.php?styleNo=' + styleNo;
...
<form action="uploader_buyerPO_file.php?var=<?php echo $styleNo;?>&Qty=<?php echo $Qty; ?>" method="post"  enctype="multipart/form-data" name="formstyle" id="formstyle">
  <table width="429" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
    ...
    <tr>
      ...
      <td colspan="2"><input name="buyerPOfile" type="file" class="txtbox" id="buyerPOfile" size="40" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
