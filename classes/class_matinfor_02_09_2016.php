...
class MaterialCostInfo{
	...
	function GetStyleIdList($deliMonth, $deliYear, $deliStatus, $buyerId, $divisionId){
		...
		$sql = " SELECT orders.intStyleId, deliveryschedule.dblQty, buyers.intBuyerID, buyerdivisions.intDivisionId ".
               ...
               " WHERE month(deliveryschedule.dtDateofDelivery) = $deliMonth AND year(deliveryschedule.dtDateofDelivery) = $deliYear AND ".
			   "       deliveryschedule.strShippingMode <> '7' AND deliveryschedule.intDeliveryStatus = 1 and orders.intBuyerID = $buyerId and ";
		...
		$sql .= " ORDER BY Month(deliveryschedule.dtDateofDelivery), buyers.strName	 ";
