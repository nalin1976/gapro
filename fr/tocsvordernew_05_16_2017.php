	...
	if($_intStylePartCount>1){
		...
		while($rowOrder = mysql_fetch_array($_rsOrder)){
			...
			while($rowDeliveries = mysql_fetch_array($_rsDeliveries)){
				...
				$_arrOrderDetails[16] = $rowOrder['reaEfficiencyLevel'];				
				$_arrOrderDetails[17] = $rowOrder['reaLabourCost'];
                                $_arrOrderDetails[18] = $rowOrder['reaCostPerMinute'];
                                $_arrOrderDetails[19] = "END";
