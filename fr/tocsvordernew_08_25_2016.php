...
$_arrOrderHeader = array("O.CODE","O.PROD","O.DESCRIP", "O.CUST", "O.TIME", "O.STATUS", "O^DD:1", "O.CONTRACT_QTY", "O^DQ:1");
	
/*$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"O.CUST"); #6 */

$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"O.SPRICE"); #9

$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"O.SCOST"); #10
...
$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"O.UDLabour Cost"); #16

$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"O.UDGMT CM"); #17

$_iCount = count($_arrOrderHeader);
array_splice($_arrOrderHeader,$_iCount,0,"END"); #18
	...
	if($_intStylePartCount>1){
		...
		while($rowOrder = mysql_fetch_array($_rsOrder)){
			...
			while($rowDeliveries = mysql_fetch_array($_rsDeliveries)){
				...
				$_arrOrderDetails[4] = $rowDeliveries['strDescription'];
                                if(preg_match('/TBA/', $rowDeliveries['intBPO'])){                                  
				...
				$_arrOrderDetails[9] = $rowOrder['reaFOB'];			
				$_arrOrderDetails[10] = 0;	
				$_arrOrderDetails[11] = $rowOrder['reaEfficiencyLevel'];	
				$_arrOrderDetails[12] = $rowOrder['dblsmv'];
				$_arrOrderDetails[13] = $rowOrder['reaFOB']; 
				$_arrOrderDetails[14] = $rowOrder['reaSMVRate'];
				$_arrOrderDetails[15] = $rowOrder['reaEfficiencyLevel'];				
				$_arrOrderDetails[16] = $rowOrder['reaLabourCost'];
                                $_arrOrderDetails[17] = $rowOrder['reaCostPerMinute'];
                                $_arrOrderDetails[18] = "END";
