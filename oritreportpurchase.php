...
WHERE (((companies.intCompanyID)=".$intInvCompID."));";
  ...
  <tr>
    ...
    <thead>
	 ...
	 <?php 
         if($poStatus == 5 || $poStatus ==2)
         {
         ?>
         <td bgcolor="#CCCCCC" class="bcgl1txt1B">Max Rate
         (USD)</td>
         <?php 
         }
         ?>
...
$SL_PODATA = "SELECT
	 ...
	 ?>
      ...
      <tr <?php if ($poStatus == 1 && round($costingPrice,5) < round($purchasedPrice,4) && $HighLightOverCostPO == "true") {?> bgcolor="#FF6633" <?php } ?>>
        <td class="normalfntTAB9"><?php echo $buyerPoName; ?></td>
       
<!--	   <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr>-->
			<td colspan="2" class="normalfntTAB9"><?php echo $strDescription  ;  ?></td>
			<td class="normalfntTAB9"><?php echo $row_podata["strOrderNo"]."/".$row_podata["strStyle"]; ?><table width="100%" border="0" cellpadding="0"><tr>
			...
			<td class="normalfntTAB9"><?php echo $row_podata["strColor"]; ?></td>
			<td class="normalfntMidTAB9"><?php echo $row_podata["strUnit"]; ?></td>
			<td class="normalfntMidTAB9"><div align="right"><?php
			if ($poStatus == 1 && round($costingPrice,5) < round($purchasedPrice,4)  && $HighLightOverCostPO == "true")
			{
			 ...
			 {
			 ?>
             <td class="normalfntMidTAB9" style="text-align:right"><?php echo number_format($row_podata["MaxUSDRate"],4); ?></td>
             <?php 
			 }
			 ?>
			...
			?>			</td>
			<td class="normalfntMidTAB9"><div align="right"><?php echo number_format((round($row_podata["dblUnitPrice"],4)*($row_podata["dblQty"] + $row_podata["dblAdditionalQty"])),2);?></div></td>
		  <!--	
