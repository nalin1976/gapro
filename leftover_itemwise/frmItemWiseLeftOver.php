...
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="tableBorder">
  <tr>
    <td height="26" class="mainHeading">Style Items - Item Wise LeftOver </td>
  </tr>
  <tr>
...
?>
                ...
                <td><select name="cboMainStore" class="txtbox" id="cboMainStore" style="width:285px" onchange="LoadSubStore(this);" tabindex="4">
                  <?PHP		
