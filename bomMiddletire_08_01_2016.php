...
else if(strcmp($RequestType,"SaveMatRatio") == 0)
{
	...
	SaveMaterialRatio($styleNo,$buyerPONo,$item,$color,$size,$qty,$balQty,$userID,$dblFreightBal,$matcde,$recutQty,$sizeserial);
}
...
else if (strcmp($RequestType,"GetMatRatio") == 0)
{
	...
	else
	{
	 ...
	 if($isBuyerPOInMR > 0){$_isRowExist = 0;}
	 
	 //if(mysql_num_rows($result) == 0){
	 if(($_isRowExist == 1) || (mysql_num_rows($result) == 0)){
...
function SaveMaterialRatio($styleNo,$buyerPONo,$item,$color,$size,$qty,$balQty,$userID,$dblFreightBal,$materialRatioID,$recutQty,$sizeserial)
{
