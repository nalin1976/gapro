...
<script src="notifyparty.js"></script>
...
<form id="notifyParty" name="notifyParty" >
  ...
  <tr>
    ...
    <tr>
      <td height="25"class="mainHeading"> Notify Party </td>
	</tr>
	<tr>
    ...
    <td><table width="100%" border="0" align="center" class="bcgl1">
      ...
      <tr>
        ...
        <td colspan="3"><select name="cboSearch" style="width:380px" id="cboSearch" tabindex="1" onchange="setData(this.value);">
             <?php
		$SQL =" select intNotifyId,strNotifyName from finishing_buyer_notifyparty order by strNotifyName  ";	
		
		$result = $db->RunQuery($SQL);
		echo "<option value=\"". "" ."\">" . "" ."</option>" ;
	while($row = mysql_fetch_array($result))
	{
		echo "<option value=\"". $row["intNotifyId"] ."\">" . $row["strNotifyName"] ."</option>" ;
	}		  
		 ?>
        </select></td>
      </tr>
      ...
      <tr>
        <td class="normalfnt">&nbsp;</td>
        <td class="normalfnt">Notify Name&nbsp;<span class="compulsoryRed">*</span></td>
        <td colspan="3"><input name="txtNotifyName" type="text" class="txtbox" id="txtNotifyName"  style="width:380px" maxlength="20" tabindex="2"/>        </td>
      </tr>
      <tr>
        <td width="2" class="normalfnt">&nbsp;</td>
        <td width="163" class="normalfnt">Branch Network &nbsp;<span class="compulsoryRed">*</span></td>
        <td colspan="3"><select name="cboBranch"  style="width:380px" id="cboBranch" tabindex="3">
          <?php
