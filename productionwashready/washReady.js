...
function HandleLoadGrid(xmlHttp)
{
	...
	var tableText = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"1\" id=\"tblevents\" border=\"0\">"+
					"<tr>"+
						"<td width=\"11%\" height=\"18\" class=\"grid_header\">Cut No</td>"+
						"<td width=\"10%\" class=\"grid_header\">Size</td>"+
						"<td width=\"10%\" class=\"grid_header\">Bundle No</td>"+
						"<td width=\"10%\" class=\"grid_header\">Range</td>"+
						"<td width=\"10%\" class=\"grid_header\">Shade</td>"+
						"<td width=\"10%\" class=\"grid_header\">Bal Qty</td>"+
						"<td width=\"10%\" class=\"grid_header\">Wash Qty</td>"+
						"<td width=\"10%\" class=\"grid_header\"><input name=\"checkbox\" type=\"checkbox\" id=\"chkCheckAll\" onclick=\"checkAll(this);\" checked=\"checked\"  /></td>"+
