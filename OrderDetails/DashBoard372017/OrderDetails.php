          ...
          <td align="center" colspan="2"><div align="center" id="divData" style="width:1100px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#99CCFF;">
            <table width="1090" border="0" cellpadding="0" cellspacing="1" class="bcgl1" id="tblBomDetails" >
              <tr>
                ...
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">BPO Fob Unit</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Total FOB</td>
                
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Factory CM</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Total CM</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">RMC per pc</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Total RMC</td>
                 <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">RMC %</td>
                 <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Front End cost</td>
                 <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Projected NP</td>
                 <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Shipped Qty</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Order to shipped %</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">FOB shipped</td>
