...
<tr><td>
  <table width="1100" border="0" align="center" bgcolor="#FFFFFF">
          ...
          <td colspan="2"><table width="100%" border="0">
            ...
            <tr>
              <td width="50%" height="21"><table width="1100" border="0" class="bcgl1">
                <tr>
                  <td width="117"  class="normalfnt">SC No</td>
                  <td width="171" ><select name="cboSR" class="txtbox" style="width:170px" id="cboSR" >
	...
	?>
                  ...
                  <td width="93"  class="normalfnt">Buyer</td>
                  <td width="183">
                  <select name="cboBuyer" class="txtbox" id="cboBuyer" style="width:170px">
                    <option value="Select One" selected="selected">Select One</option>
                    <?php
                  ...
                  <td width="77"  class="normalfnt">From Date</td>
                  <td width="181" ><input name="dateFrom" type="text"  class="txtbox" id="dateFrom" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');" /></td>
                  <td width="98"  class="normalfnt">To Date</td>
                  <td colspan="2" ><input name="dateTo" type="text"  class="txtbox" id="dateTo" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');" /></td>
                  </tr>
				  

				  
                <tr>
                  <td  class="normalfnt">CDN From Date</td>
                  <td width="171" ><input name="cdnDateFrom" type="text"  class="txtbox" id="cdnDateFrom" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');" /></td>
                  <td class="normalfnt" align="left">CDN To Date</td>
                  <td class="normalfnt"><input name="cdnDateTo" type="text"  class="txtbox" id="cdnDateTo" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');" /></td>
                  <td class="normalfnt" style="text-align:right">
                    <input type="checkbox" name="chkCdnFilter" id="chkCdnFilter" />
                </td>
                  <td class="normalfnt">Filter By CDN Dates  &nbsp; &nbsp;
                   <input type="checkbox" name="chkBuyerFilter" id="chkBuyerFilter"  />
                   </td>
                  <td>Hela Alliance</td>
                  <td width="125"><div align="right"><img src="../../images/search.png" alt="Search" width="80" height="24" class="mouseover" onclick="gatDeta();" /></div></td>
                  <td width="17">&nbsp;</td>
                </tr>
              </table></td>
              </tr>
