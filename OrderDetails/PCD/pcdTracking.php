...
<tr><td>
  <table width="1100" border="0" align="center" bgcolor="#FFFFFF">
          ...
          <td colspan="2"><table width="100%" border="0">
            ...
            <tr>
              <td width="50%" height="21"><table width="1100" border="0" class="bcgl1">
                <tr>
                  <td width="85" height="25"  class="normalfnt">SC No</td>
                  <td width="151" ><select name="cboSR" class="txtbox" style="width:150px" id="cboSR" onchange="AutoSelect(this,'cboStNo'); loadOrderNo(this,'sc');">
	...
	?>
                  ...
                  <td width="69"  class="normalfnt">Style No </td>
                  <td width="150"><select name="cboStNo" class="txtbox" style="width:150px" id="cboStNo" onchange="AutoSelect(this,'cboSR');loadOrderNo(this,'style');">
                    <option value="Select One" selected="selected">Select One</option>
                    <?php
	...
	?>
                  ...
                  <td width="150" ><select name="cboBpo" class="txtbox" style="width:150px" id="cboBpo">
                    <option value="Select One" selected="selected">Select One</option>

                  </select></td>
                  <td width="112"  class="normalfnt">Buyer</td>
                  <td colspan="2" class="normalfnt"><select name="buyer" class="txtbox" style="width:150px" id="buyer">
                    <option value="Select One" selected="selected">Select One</option>
                    <?php
...
buyers.strName ASC";
	...
	?>
                ...
                <tr>
                 ...
                 <td width="150" ><input name="PcdDateTo" type="text"  class="txtbox" id="PcdDateTo" style="width:90px;" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%d/%m/%Y');"/><input type="reset" value=""  class="txtbox" style="visibility:hidden;"   onclick="return showCalendar(this.id, '%d/%m/%Y');" /></td>
                  <td class="normalfnt">Emb. Status</td>
                  <td ><input id="txtEmbType"  class="txtbox" type="text" style="width:150px; text-align:center" disabled="disabled" name="txtEmbType"></td>
                  <td nowrap="nowrap"><input type="checkbox" name="chkBuyerFilter" id="chkBuyerFilter"  />  &nbsp;  Hela Alliance</td>
                  <td width="257"><div align="right">
                    <input type="checkbox" name="chkSummary" id="chkSummary" onclick="loadSummary()" /> &nbsp;Summary Details
                    <img src="../../images/search.png" alt="Search" width="80" height="24" class="mouseover" onclick="gatDeta();" /></div></td>
                  <td width="2">&nbsp;</td>
                </tr>
              </table></td>
              </tr>
          ...
          <td align="center" colspan="2"><div align="center" id="divData" style="width:1100px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#99CCFF;">
            <table width="1090" border="0" cellpadding="0" cellspacing="1" class="bcgl1" id="tblBomDetails" >
              <tr>
                ...
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">RM IN Date</td>
