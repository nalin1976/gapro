...
<tr><td>
  <table width="1100" border="0" align="center" bgcolor="#FFFFFF">
	...
	?>
                  ...
                  <td width="189"><select name="cboBuyer" class="txtbox" id="cboBuyer" style="width:170px">
                    <option value="Select One" selected="selected">Select One</option>
                    <?php
                ...
                <tr>
                  ...
                  <td class="normalfnt">Filter By CDN Dates</td>
                  <td>&nbsp;</td>
