...
where RSH.intStatus='$intStatus'
 ...
 ";		
			...
			$sql_details .= " GROUP BY
			RSD.intMatdetailID,RSD.strColor,RSD.strSize,MIL.strItemDescription,MIL.strUnit,RSD.intGrnNo,o.strOrderNo,RSH.intReturnToSupNo  order by  RSH.intReturnToSupNo";	
