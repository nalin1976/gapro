...
WHERE GH.intStatus='$intStatus' ";
			...
			$detailSql = $detailSql." and DATE_FORMAT(GH.dtmRecievedDate,'%Y/%m/%d') <= DATE_FORMAT('$dtmDateTo','%Y/%m/%d')"; 
				...
				$detailSql .= " GROUP BY grndetails.intStyleId, grndetails.strBuyerPONO, grndetails.intMatDetailID, grndetails.strColor, grndetails.strSize order by GH.intGrnNo ";	
