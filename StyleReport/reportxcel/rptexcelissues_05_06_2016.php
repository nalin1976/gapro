...
INNER JOIN materialratio ON issuesdetails.intStyleId = materialratio.intStyleId AND issuesdetails.intMatDetailID = materialratio.strMatDetailID AND issuesdetails.strColor = materialratio.strColor AND issuesdetails.strSize = materialratio.strSize
