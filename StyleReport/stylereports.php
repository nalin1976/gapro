...
<table width="100%" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
	...
	<td width="3%" >
    	<input type="radio" name="radio" id="radPenAppPo" value="radPenAppPo" onclick="setReport('rptPendingApprovePOList.php',2);"/></td>
	<td width="30%" class="normalfnt">Pending Approve PO</td>
	</tr>
	</table>
	</fieldset>	</td>	
	</tr>
