...
<script type="text/javascript">
<?php
			$sql ="select * from financecost";
			$result = $db->RunQuery($sql);
			while($row=mysql_fetch_array($result))
			{
				$transport = $row["intTransport"];
				$clearing = $row["intClearing"];
				$interest = $row["intInterest"];
				$export = $row["intExport"];
			}
			
			$sql ="select dblRateq from currencytypes where strCurrency='LKR'";
			$result = $db->RunQuery($sql);
			while($row=mysql_fetch_array($result))
			{
				$dblRate = $row["dblRateq"];

			}
?>
 pub_slrrate = <?php echo $dblRate; ?>;
 pub_transport 	= <?php echo $transport; ?>;
 pub_clearing 	= <?php echo $clearing; ?>;
 pub_interest 	= <?php echo $interest; ?>;
 pub_export 		= <?php echo $export; ?>;
...
<script>
  ...
  $( function() {
    ...
    $("#cboStyleLevel").change(function(){
      var styleLevel = $("#cboStyleLevel").val();
...
<form id="frm_main" name="frm_main" method="post" action="">
  ...
  <table width="950" align="center" cellpadding="1" cellspacing="1" class="bcgl1" id="tblMain">
    <tr>
	...
	?>
		  ...
		  ?>
          <tr>
              <td height="286"><table width="100%" class="bcgl1" border="0">
                <tr>
                    <td width="73%" height="253"><table width="100%" border="0">
                      <tr>
	...
	?>
                      ...
                      <tr>
                        ...
                        <td class="normalfnt"><!-- onkeyup="ChangeOrderQuantity();"-->
                          ...
                          <!-- Description - To avoid calculation material requirement for excess qty remove ChangeOrderQuantity() function 
                                             from 'onblur' method-->
                          <!-- ============================================================================================== -->	
                        ...
                        <img src="images/calculator1.png" title="Calculate consumtion data" width="16" height="16" onclick="ChangeOrderQuantity();" style="visibility:hidden" /> -->
                          <!-- ============================================================================================== -->
                        <input name="txtEXQTY" type="text" class="txtbox" id="txtEXQTY" onblur="checkForValues(this);"  onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();"  onkeypress="return isValidZipCode(this.value,event);" value="0" style="width:20px; text-align:right" maxlength="3"/>
                                               </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><span class="normalfnt">
                          <input name="txtSMV" type="text"  disabled="disabled" class="txtbox" id="txtSMV" onblur="DisplayEfficiencyLevel();checkForValues(this);" onmousedown="DisableRightClickEvent();"  onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0" style="width:68px; text-align:right" maxlength="7" onkeyup="CalculateCMRate();CalculateESC();" />
                          <span class="normalfnt">&nbsp;&nbsp;&nbsp; Pack SMV</span>
                          <input name="txtPackSMV" type="text" class="txtbox" id="txtPackSMV" style="width:20px; text-align:right" maxlength="3"  />
                        </span></td>
                      </tr>
                      <tr>
	...
	while($row = mysql_fetch_array($result))
	{
		echo number_format($row["totConPc"],3);
	}	
	?>" style="width:68px; text-align:right" />                        </td>
                      </tr>
                      <tr>
                        <td height="23" class="normalfnt" ><span class="normalfnt" >Product Category<span class="compulsoryRed">*</span></span></td>
...
?>
                    ...
                    <tr>
                       <td height="22" class="normalfnt" ><span class="normalfnt" >Style Level<span class="compulsoryRed">*</span></span></td>
                       <td colspan="2" valign="bottom" >
                           <select name="cboStyleLevel" class="txtbox" style="width:210px"  id="cboStyleLevel">
                               <option value="-1"></option>
                               <option value="I">Initial</option>
                               <option value="R">Repeat</option>                               
                           </select>
                       </td>
                       <td height="22" class="normalfnt" >
                           <span class="normalfnt" id="OrderPCD" name="OrderPCD">RM IN Date</span>
                       </td>
                       <td>
                           <input name="dtPCD" type="text" class="txtboxRightAllign" onkeypress="return ControlableKeyAccess(event);" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" id="dtPCD" onclick="" style="width:75px;" value="  " />
                           
                       </td>
                    </tr>
                      <tr>
                        <td height="20" class="normalfnt" style="visibility:visible;" >EMB Types <!-- Labour Cost --> </td>
                        <td valign="bottom" style="visibility:visible;" >&nbsp;
                            <a href="#"><img src="images/view2.png" alt="save" width="62" height="21" border="0" onclick="popUpEmb();" /></a>
                            <input name="txtLabourCost" type="text" <?php if ($LabourCostEnabled == "false") { ?> disabled="disabled" <?php } ?> class="txtbox" id="txtLabourCost" onkeypress="return CheckforValidDecimal(this.value, 4,event);" onblur="checkForValues(this);" value="0" size="2" style="text-align:right; visibility:hidden;" /></td>
                        <td valign="bottom" ><span class="normalfnt" style="visibility:hidden">No of Lines
                        ...
                        <td height="20" class="normalfnt">Sub Contract Qty </td>
                        <td>
              ...
              <td colspan="2"><input name="txtFinancePercentage" type="text" class="txtbox" onblur="checkForValues(this);" id="txtFinancePercentage" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0" size="2"  onkeyup="CalculateFigures();" maxlength="4" style="text-align:right" />
                      ...
                      <tr>
                        ...
                        <td width="162" valign="top">
                          <input name="txtTargetFOB" type="text" class="txtbox" id="txtTargetFOB" onblur="checkForValues(this);" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" size="8" onkeyup="ChangeFOB();" value="0"/>
                        <!--  <input name="txtTargetFOB" type="text" class="txtbox" id="txtTargetFOB" onblur="set4deci(this);" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0"   onkeyup="CalculateESC();calculateProfit();" style="text-align:right;" maxlength="9" />-->
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                          <input name="txtUPCharge" type="text" class="txtbox" id="txtUPCharge" onblur="checkForValues(this);" onmousedown="DisableRightClickEvent();" onmouseout="EnableRightClickEvent();" onkeypress="return CheckforValidDecimal(this.value, 4,event);" value="0" size="12" onkeyup="ChangeFOB();" style="text-align:right" maxlength="9" />                        </td>
                      </tr>
                      <tr>
    ...
    <tr>
      <td height="80" valign="top"><table width="100" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="841" height="20" bgcolor="#FFD5AA"><div align="center" class="normalfnth2">Consumption</div></td>
            <td width="109" bgcolor="#FFD5AA"><a href="#"><img src="images/add-new.png" width="109" height="18" border="0"  onclick="ShowItems();" /></a></td>
          </tr>
           <tr>
            <td colspan="2">
				<table>
				<tr>
				<td>           
            <div id="divcons" style="overflow: -moz-scrollbars-horizontal; height:220px; width:930px;">
            


                <table width="1840px" id="tblConsumption" bgcolor="#CCCCFF"  cellpadding="0" cellspacing="1">
                  <tr bgcolor="#804000">
                    <td width="40px" height="27" class="normaltxtmidb2">Edit</td>
                    <td width="40px" class="normaltxtmidb2">Del</td>
                    <td width="255px" class="normaltxtmidb2">Description</td>
                    <td width="80px" class="normaltxtmidb2">Con. Pc</td>
                    <td width="80px" class="normaltxtmidb2">Unit</td>
                    <td width="17px" class="normaltxtmidb2">Unit Price</td>
                    <td width="13px" class="normaltxtmidb2">Waste</td>
                    <td width="60px" class="normaltxtmidb2"> Req. Qty</td>
                    <td width="60px" class="normaltxtmidb2">Total Qty </td>
                    <td width="60px" class="normaltxtmidb2">Tot Value </td>
                    <td width="60px" class="normaltxtmidb2">Cost PC</td>
                    <td width="68px" class="normaltxtmidb2">Origin</td>
                    <td width="40px" class="normaltxtmidb2">Freight</td>
                    <td width="80px" class="normaltxtmidb2">Purch. Qty</td>
                    <td width="80px" class="normaltxtmidb2">Purch. Price </td>
                    ...
                    <td width="30px" class="normaltxtmidb2">PSP</td>
                    <td width="30px" class="normaltxtmidb2">DP</td>
                    <td width="30px" class="normaltxtmidb2">EMB</td>
                    <td width="30px" class="normaltxtmidb2">PEOSP</td>
                    <td width="30px" class="normaltxtmidb2">DPE</td>
                    <td width="30px" class="normaltxtmidb2">GRW</td>
                    <td width="30px" class="normaltxtmidb2">GEW</td>
                    <td width="30px" class="normaltxtmidb2">GPD</td>
                    <td width="30px" class="normaltxtmidb2">SPE</td>
                    <td width="30px" class="normaltxtmidb2">PEODP</td>
                    <td width="30px" class="normaltxtmidb2">Lg.Panels</td>
                    <td width="30px" class="normaltxtmidb2">EMB.Panels</td>
                    <td width="30px" class="normaltxtmidb2">Prn. Panels</td>
                  </tr>
                </table>
    ...
    <tr>
      <td height="99" valign="top"><table id="tblDelivery"  width="100%" cellpadding="0" cellspacing="1">
       <!-- <tr>
        ...
        <tr>
          <td width="4%" height="24" bgcolor="#804000" class="normaltxtmidb2">Edit</td>
          <td width="3%" bgcolor="#804000" class="normaltxtmidb2">Del</td>
          <td width="9%" bgcolor="#804000" class="normaltxtmidb2">Delivery Date</td>
          <td width="4%" bgcolor="#804000" class="normaltxtmidb2">Qty.</td>
          <td width="5%" bgcolor="#804000" class="normaltxtmidb2">With Ex. Qty</td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">Shipping Mode</td>
          <td width="12%" bgcolor="#804000" class="normaltxtmidb2">Remarks</td>
          <td width="5%" bgcolor="#804000" class="normaltxtmidb2">BPO </td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">Estimated Date</td>
          <td width="10%" bgcolor="#804000" class="normaltxtmidb2">Hand Over Date</td>
          <td width="7%" bgcolor="#804000" class="normaltxtmidb2">Ref. No.</td>
          <td width="9%" bgcolor="#804000" class="normaltxtmidb2">Delivery Status</td>
          <td width="12%" bgcolor="#804000" class="normaltxtmidb2">Cut Off Date</td>
          <td width="12%" bgcolor="#804000" class="normaltxtmidb2">Manu. Location</td>
        </tr>
...
<input type="hidden" id="hndStyleId" value="<?php echo $styleNo ?>" name="hndStyleId" />
<script type="text/javascript">
