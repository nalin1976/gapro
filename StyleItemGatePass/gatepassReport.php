...
include "../Connector.php";
 ...
 $Year = $Gatepass[0];
	...
	while($row_header = mysql_fetch_array($result_header))
	{
		...
		$subLocation		= $row_header["strSubContractorID"];
		$mrnNo				= $row_header["intMrnNo"];
	}
?>
...
$sql="select strSubContractorID,strName from subcontractors  where  strSubContractorID='$subLocation'";
...
WHERE intDocumentNo=$GatepassNo AND intDocumentYear=$Year and strType='SGatePass' AND
...
.normalfnt2"><?php echo getEntryNoDetails($GatepassNo,$Year); ?></td>
       ...
       <tr>
        ...
        <td width="2%" class="normalfnth3B">:</td>
        <td colspan="2" class="normalfnt2"><?php echo $remarks;?> </td>
        <td width="14%" class="normalfnth3B">MRN No </td>   
        <td width="2%" class="normalfnth3B">: </td>   
        <td width="26%" class="normalfnt2"><?php echo $mrnNo;?> </td>  
      </tr>
