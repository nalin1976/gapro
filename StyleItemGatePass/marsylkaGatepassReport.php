  ...
  <tr>
    <td><table width="100%" border="0" class="head2BLCK">
      <tr>
		...
		?>
					GATE PASS - STYLE</td>
        <td width="13%" class="head2BLCK"><?php
...
while($row=mysql_fetch_array($result))
{
  ...
  <tr>
    <td height="69"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablez">
      <tr class="normalfnth2Bm">
        <td width="57%" height="35" class="">Description</td>
        <td width="15%" class="">Color</td>
		<td width="10%" class="">Size</td>
		<td width="9%" class="">Unit</td>
        
        <td width="10%" class="">Qty</td>
		<!--<td width="13%" class="">Bin Location</td>-->
        </tr>		
<?php
...
<td colspan="6" class="normalfntTAB">
		<table width="100%" border="0" class="">
          ...
          <tr>
            ...
            <td width="16%"><?php echo $row_header["strStyle"];?></td>
...
?>
            ...
            <td width="18%" align="center">Buyer PoNo :</td>
            <td width="15%" align="left"><?php echo $buyerPoName;?></td>
			</tr>
			<tr>
...
?>
      <tr>
        ...
        <td class="normalfntMid"><?php echo $row_details["strColor"];?></td>
        <td class="normalfntMid"><?php echo $row_details["strSize"];?></td>
<?php 
...
?>
		<td class="normalfntMid"><?php echo $unit;?></td>		
	...
	?>
      <tr class="normalfntMid">
        ...
        <td class=""><div align="right" class="normalfntRite"><?php echo $TotQty ;?></div></td>
