   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1" >
	  ...
	  <tr>
	  	<td width="20%" class="normalfnt">&nbsp;From SC No </td>
            <td width="30%" class="normalfnt">&nbsp;<select name="cboFromScno"  class="txtbox" id="cboFromScno" style="width:115px" onchange="SeachFromStyle(this);RemoveData();clearMainGrid();">
<?php
   ...
   <td width="98"></td>
	  ...
	  <tr>
		 <td width="5%" class="normalfnt">&nbsp;&nbsp;To SC No </td>
            <td width="9%" class="normalfnt">&nbsp;<select name="cboToScno"  class="txtbox" id="cboToScno" style="width:115px" onchange="SeachToStyle(this);RemoveData();clearMainGrid();">
<?php
