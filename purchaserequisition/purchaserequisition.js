...
{
	var fincalValue	= 0;
	var exRate 		= 1;//parseFloat(document.getElementById('txtExRate').value);
...
function SavePR()
{
	...
	var currencyId 	= 0;//document.getElementById('cboCurrencyId').value;
	var exRange		= 0;//document.getElementById('txtExRate').value;
	var companyId 	= document.getElementById('cboCostCenter').value;
	var supplierId 	= -1;//document.getElementById('cboSupplier').value;
