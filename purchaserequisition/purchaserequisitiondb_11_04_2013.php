...
if($booCheck)
	InsertPRHeader($serialNo,$serialYear,$prNo,$supplierId,$currencyId,$currRate,$deptId,$companyId,$userId,$attension,$intro,$jobNo,$discount,$totalValue,$totalPRValue,$costCenterId,$discountValue,$jobType,$commonSupName);
else
