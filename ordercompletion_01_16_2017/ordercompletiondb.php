...
{	
	...
	$SQL = "select specification.intSRNO,specification.intStyleId,orders.strStyle from specification inner join orders on specification.intStyleId = orders.intStyleId AND orders.intStatus <>13 " ;
	
		
	if($scNo != 'Select One')
		$SQL .= " and specification.intStyleId='$scNo' ";
