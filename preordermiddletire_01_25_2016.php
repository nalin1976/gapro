...
else if (strcmp($RequestType,"AddDeliveryBPO")==0)
{
	...
	$sql = "Insert into deliveryschedule(intStyleId,dtDateofDelivery,dblQty,dbExQty,strShippingMode,isDeliveryBase,intSerialNO,strRemarks,intUserId,dtmDate,dtmHandOverDate,intBPO,intRefNo,estimatedDate,intCountry,intDeliveryStatus, dtmCutOffDate, intManufacturingLocation)values('".$styleID."','".$bpoDelivery."',".$bpoQty.",'0',".$bpoShipMode.",'N',0,'$bpoRemarks','$userID','$bpoDelivery','$bpoHandover','$buyerPO','0','$bpoEstimate','$bpoCountry','$bpoDeliveryStatus','$bpoCutOffDate','$bpoManuLocation');";
...
function saveDeliveryDetails($strStyleID,$dtDateofDelivery,$dblQty,$exQty,$modeID,$dbExQty,$isbase,$leadID,$remarks,$estimateddate,$userID,$dtmDate,$handoverDate,$bpo,$refNo,$dtestimated,$contry,$deliStatus,$cutOffDate)
{
	global $db;
	$sql="Insert into deliveryschedule(intStyleId,dtDateofDelivery,dblQty,dbExQty,strShippingMode,isDeliveryBase,intSerialNO,strRemarks,intUserId,dtmDate,dtmHandOverDate,intBPO,intRefNo,estimatedDate,intCountry,intDeliveryStatus,dtmCutOffDate)values('".$strStyleID."','".$dtDateofDelivery."',".$dblQty.",".$dbExQty.",".$modeID.",'$isbase',$leadID,'$remarks','$userID','$dtmDate','$handoverDate','$bpo','$refNo','$dtestimated','$contry','$deliStatus','$cutOffDate');";
