    ...
    <td><table width="100%" border="0">
      <tr>
        <td colspan="2" class="normalfnt"><table width="105%" border="0" class="tablezRED">
          <tr>
            <td width="11%">Style id</td>
            <td width="24%"><select name="cboStyleID" id="cboStyleID" class="txtbox" style="width:120px" onchange="LoadSCNo();LoadBuyerPO();LoadMainCat();">
              <option>Select One</option>
            </select></td>
            <td width="11%">Buyer PO</td>
            <td width="22%"><select name="cbobuyerpono" class="txtbox" id="cbobuyerpono" style="width:110px" onchange="LoadQty();">
            </select>            </td>
            <td width="10%">SC No </td>
            <td width="22%"><select name="cboscno" class="txtbox" id="cboscno" style="width:110px" onchange="LoadQty();">
            </select></td>
          </tr>
          <tr>
            <td>Qty Reqd</td>
            ...
            <td width="22%"><input name="txtorderqty" type="text" class="txtbox" id="txtorderqty" size="16" readonly="true" /></td>
            <td colspan="2" rowspan="2" valign="bottom"><div align="right"><img src="images/search.png" alt="Search" width="80" height="24" onclick="MatToMRN();" /></div></td>
          </tr>
          <tr>
            <td>Materials</td>
        ...
        <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:130px; width:950px;">
          <table width="1100px" cellpadding="0" cellspacing="0" id="mrnMatGrid">
            <tr>
              ...
              <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">Con Pc</td>
              <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">Wastage</td>
              <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">App Qty</td>
              <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">Not App Qty</td>
              </tr>                     
          </table>
        </div></td>
        </tr>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#D6E7F5">
      <tr>
        ...
        <td width="10%"><a href="main.php"><img src="images/close.png" width="97" height="24" border="0" onclick="closeLayer();"/></a></td>
        <td width="39%">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
