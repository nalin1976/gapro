    ...
    <td><table width="100%" border="0">
      <tr>
        <td><table width="109%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="87%" height="35"  class="mainHeading"><div align="left">&nbsp;Assigning User Roles - <?php echo $emailAddress; ?> </div></td>
            <td width="13%"  class="mainHeading"><span class="normalfnBLD1"><a href="edituser.php" target="_self"><img src="images/resetPassword.png" width="115" height="24" border="0" /></a></span></td>
          </tr>
          <tr>
            <td height="165" colspan="2"><form id="frmcategories" name="frmcategories" method="post" >
              <table width="100%" height="172" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr class="bcgl1">
                  <td colspan="2">
				  <?php
				  $sql = "SELECT categoryID,categoryName,catDescription FROM rolecategories where intStatus=1 ORDER BY categoryName";
				  ...
				  while($rowrole = mysql_fetch_array($resultrole))
				 {
				  ...
				  <table width="100%" border="0" id="tblpermisions" class="bcgl1">
				   <tr>
                      <td colspan="4" class="mainHeading2"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<span class="normalfnt">
                        <input type="checkbox" name="checkall" id="checkall" onchange="checkAll(this);" />
                      </span>&nbsp;<?php echo $rowrole["categoryName"];?></div></td>
                      </tr>
                    <?php
				  
				  $SQL = "SELECT RoleID,categoryID,RoleName,roleDescription,(SELECT intUserID FROM userpermission WHERE RoleID = r.RoleID AND intUserID = $userID) AS permitted FROM role r WHERE categoryID = " . $rowrole["categoryID"] . " and intStatus=1 ORDER BY RoleName;" ;
                ...
                <tr>
                  <td colspan="2" ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
                    <tr>
                      <td width="35%">&nbsp;</td>
                        <td width="15%" class="normalfntp2"><div align="center"><a href="userManager.php"><img src="images/close.png" alt="close" width="97" height="24" border="0" class="mouseover" onclick="SaveSelectedPermisions();" /></a></div></td>
                        <td width="15%" class="normalfntp2"><div align="center"><a href="javascript:SaveSelectedPermisions();"><img src="images/finish.png" alt="finish" width="96" height="24" class="noborderforlink" /></a></div></td>
                        <td width="35%">&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
