          ...
          <td align="center" colspan="2"><div align="center" id="divData" style="width:1100px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#99CCFF;">
            <table width="1090" border="0" cellpadding="0" cellspacing="1" class="bcgl1" id="tblBomDetails" >
              <tr>
                ...
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">GP To FTY</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">Fac.Trans In</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">PCD</td>
                <td width="7%" bgcolor="#498CC2" class="normaltxtmidb2">EX.Factory Date</td>
