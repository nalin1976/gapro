  ...
  <table width="950" border="0" align="center" bgcolor="#FFFFFF">
                ...
                <tr class="bcgl1">
                  <td><table width="100%" border="0" class="bcgl1">
                      <tr>
                        ...
                        <td width="16%" class="normalfnth2"><label id="lblTotalQty" ><?php echo $Qty; ?></label></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
	...
	?>
                ...
                <tr>
                  <td><table width="100%" border="0" class="bcgl1">
                      <tr>
                        <td colspan="3"><div id="divcons" style="overflow:scroll; height:110px; width:578px;">
                ...
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="27%" bgcolor="#D6E7F5"><a href="#"><img src="images/save.png" alt="Save" width="84" height="24" border="0" onclick="MakeDatabaseForSaving();" /></a></td>
                      <td width="17%" bgcolor="#D6E7F5"><a href="buyerPOList.php"><img src="images/close.png" alt="Close" width="97" height="24" border="0" class="noborderforlink" /></a></td>
                      <td width="28%" bgcolor="#D6E7F5">&nbsp;</td>
                    </tr>
                  </table></td>
                </tr>
