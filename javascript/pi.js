$(function(){
    ...
    // =============================================================
    var url 		= "pimiddle.php?RequestType=LoadBuyers";
    ...
    // =============================================================
    var urlOrders	= "pimiddle.php?RequestType=LoadOrders";
    ...
    // Load styles to the selection list
    // =============================================================
    var urlSC       = "pimiddle.php?RequestType=LoadSC";
    ...
    $("#btnSearch").click(function(){
        ...
        var urlOrders   = "pimiddle.php?RequestType=LoadStyles&bc="+buyerCode;
        ...
        for ( var loop = 0; loop < XMLStyleCode.length; loop ++){
            ...
            $("#tblPreOders > tbody:last-child").append("<tr class=\"textformat\"><td>"+styleNo+"</td><td>"+scNo+"</td><td>"+styleDesc+"</td><td>"+sCompany+"</td><td>"+buyerName+"</td><td><button type=\"button\" class=\"btn btn-warning\" id="+styleCode+" name="+styleCode+" onclick='viewXLSReport(this.id)'><img src='../../images/excel.png'></img></button></td></tr>");
        }
