						  ...
						  "</tr>"+
							...
							"<td colspan=\"3\" height=\"30\" bgcolor=\"#D6E7F5\"><table width=\"100%\">"+
							  "<tr>"+
								...
								"<td width=\"17%\"><img src=\"images/close.png\" alt=\"Close\" width=\"97\" height=\"24\" onClick=\"closeWindow();\" id=\"butClose\" tabindex=\"15\"/></td>"+
								"<td width=\"30%\">&nbsp;</td>"+
							  "</tr>"+
						  "<tr>"+
...
function ShowEditForm(itemcode)
{
	...
	var itemUnitprice = getItemUnitprice(itemcode);
					  ...
					  "<td><table width=\"100%\" height=\"207\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
						  ...
						  "</tr>"+
						   "<tr>"+
							...
							"<td align=\"left\" valign=\"top\">"+
							  "<input type=\"text\" id=\"txtFilter\" " +  disableUnits + "  style=\"width:398px\" class=\"txtbox\"><img src=\"images/manage.png\" alt=\"Filter\" class=\"mouseover\" hspace=\"3\" vspace=\"0\" onClick=\"LoadCategoryItemsForText('" + itemcode + "');\"  "+imgvisibility+">"+
							"</td>"+
						  "</tr>"+
						  "<tr>"+
							"<td colspan=\"3\"><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
								  ...
								  "<tr>"+
									"<td><table width=\"100%\" height=\"80\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
									  "<tr>"+
										...
										"<input name=\"txtconsumpc2\"  onkeypress=\"return CheckforValidDecimal(this.value, consumptionDecimalLength,event);\" type=\"text\" class=\"txtbox\" id=\"txtconsumpc2\" tabindex=\"3\" value=\"" + conPC + "\" style=\"width:98px; text-align:right\" maxlength=\"9\" onblur=\"set4deci(this);\"/>"+
										"</td>"+
										"<td  align=\"left\" class=\"normalfnt\">Unit</td>"+
									  ...
									  "<tr>"+
										"<td height=\"25\" class=\"normalfnt\">Unit Price</td>"+
										"<td align=\"left\" id=\"itemPrice\" title=\""+itemUnitprice+"\">"+
										  "<input name=\"txtunitprice\" onkeypress=\"return CheckforValidDecimal(this.value, 3,event);\" type=\"text\" class=\"txtbox\" id=\"txtunitprice\" tabindex=\"5\" value=\"" + unitPrice + "\" style=\"width:98px; text-align:right\" maxlength=\"9\" onblur=\"set4deci(this);\" onkeyup=\"validateUnitprice();\"/>"+
										"</td>"+
										"<td width=\"14%\" class=\"normalfnt\">Wastage</td>"+
										"<td width=\"35%\" align=\"left\">"+
										  "<input name=\"txtwastage\" type=\"text\" onkeypress=\"return CheckforValidDecimal(this.value, 4,event);\" class=\"txtbox\" id=\"txtwastage\"  value=\"" + wastage + "\" tabindex=\"6\" style=\"width:118px; text-align:right\" maxlength=\"5\" onkeyup=\"checkMaxWastage();\" onblur=\"set4deci(this);\"/>"+
										"</td>"+
									  "</tr>"+
									  "<tr>"+
										"<td height=\"27\" class=\"normalfnt\">Origin</td>"+
						  ...
						  "</tr>"+
							...
							"<td colspan=\"3\" height=\"30\" bgcolor=\"#D6E7F5\"><table width=\"100%\">"+
							  "<tr>"+
								...
								"<td width=\"17%\"><img src=\"images/close.png\" alt=\"Close\" width=\"97\" height=\"24\" onClick=\"closeWindow();\" id=\"butClose\" tabindex=\"12\"/></td>"+
								"<td width=\"30%\">&nbsp;</td>"+
							  "</tr>"+
						 "<tr>"+
							"<td align=\"left\" class=\"fntwithWite\" ><input type=\"checkbox\" tabindex=\"9\"  name=\"chkvariations\" id=\"chkvariations\" onchange=\"RemoveVariations();\" />Have Variations</td>"+
						...
						"<td><table width=\"100%\" height=\"48\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">" +
							...
							"<tr>" +
							  ...
							  //Start 20-08-2010 Hide for orit
								"<td width=\"12%\" class=\"normalfnt\" style=\"visibility:hidden\">Buyer PO Qty</td>" +
								"<td width=\"21%\" class=\"normalfnt\" style=\"visibility:hidden\"><input name=\"txtbuyerpo\" type=\"text\" class=\"txtbox\" disabled=\"disabled\" id=\"txtbuyerpo\" size=\"20\" value=\"" + orderQty + "\" /></td>" +
					  ...
					  "<tr>" +
						"<td height=\"367\"><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">" +
						  ...
						  "<tr>" +
							...
							"</select>" +
							"<table><tr><td class=\"normalfntMid\">New:</td><td><input  class=\"txtbox\" type=\"text\" onkeypress=\"return string_constrain(event);\" size=\"18\" maxlength=\"30\" id=\"txtnewcolor\" style=\"text-transform:uppercase\" onkeyup=\"grabColorEnterKey(event);\"></td><td><img src=\"images/addmark.png\" class=\"mouseover\" onClick=\"AddNewColor();\" width=\"80%\" height=\"80%\"></td></tr></table>"+					
							"</td>" +
						  "</tr>" +
						 "<tr>" +
						  ...
						  "<tr>" +
							...
							"<td valign=\"top\"><select name=\"cboselectedsizes\" size=\"8\" class=\"txtbox\" id=\"cboselectedsizes\" style=\"width:225px\" ondblclick=\"MoveSizeLeft();\">" +
									"</select>"+
									"<table><tr><td class=\"normalfntMid\">New:</td><td><input  class=\"txtbox\" type=\"text\" size=\"18\"  onkeypress=\"return string_constrain(event);\" onkeyup=\"grabSizeEnterKey(event);\" maxlength=\"30\" id=\"txtnewSize\" style=\"text-transform:uppercase\"></td><td><img src=\"images/addmark.png\" class=\"mouseover\" onClick=\"AddNewSize();\"  width=\"80%\" height=\"80%\"></td></tr></table>"+					
							"</td>" +
						  "</tr>" +
						"</table></td>" +
					  "</tr>" +
			...
			for (x in colors)
			{
				...
				for (i in sizes)
				{
					HTMLText += "<td><div align=\"center\">" +
								"<input name=\"txtratio\" type=\"text\" class=\"txtbox\" value=\"" + Qtys[loopindex] + "\" onkeyup=\"ChangeCellValue(this);\" onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return IsNumberWithoutDecimals(this.value,event);\" id=\"txtratio" + x + "" + i + "\" size=\"7\" />" +
								"</div></td>";
					loopindex ++;
				}
...
function HandleLoadingMatRatio()
{
	if(xmlHttpreq[1].readyState == 4) 
    {
		...
		//
			var poqty = xmlHttpreq[1].responseXML.getElementsByTagName("TotalBuyerPoNo")[0].childNodes[0].nodeValue;
	...
	var itemName = curObj.parentNode.parentNode.parentNode.cells[5].lastChild.nodeValue;
	var conPC = parseFloat(curObj.parentNode.parentNode.parentNode.cells[6].lastChild.nodeValue);
	/*Start 05-11-2011 qty directly taken from the grid
	var totqty = parseInt(parseInt(poqty) + (parseInt(poqty) * parseFloat(ExQty) / 100) + (parseInt(poqty) * parseFloat(wastage) / 100) );
	//totqty  = Math.round(totqty * conPC);
	End 05-11-2011 qty directly taken from the grid
	*/
	var totqty = parseFloat(curObj.parentNode.parentNode.parentNode.cells[8].lastChild.nodeValue);
	document.getElementById('txttotalorder').value = totqty;
		//
			 var XMLStyleID 	= xmlHttpreq[1].responseXML.getElementsByTagName("StyleNo");
			 var XMLBuyerPO 	= xmlHttpreq[1].responseXML.getElementsByTagName("BuyerPONo");
...
//End 31-03-2010				
			...
			for (x in colors)
			{
				...
				for (i in sizes)
				{
					HTMLText += "<td id="+PoQty_loop[loopindex]+"><div align=\"center\">" +
								"<input name=\"txtratio\" type=\"text\" ondblClick=\"showMaterialRatioHelper(this);\" class=\"txtbox\" value=\"" + Qtys[loopindex] + "\" onkeyup=\"ChangeCellValue(this);\" onblur=\"ValidateWithPoQty(this);\" onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return IsNumberWithoutDecimals(this.value,event);\" id=\"txtratio" + x + "" + i + "\" size=\"7\" style=\"text-align:right\"/>" +
								"</div></td>";
					loopindex ++;
				}
	...
	var HTMLText = "<table width=\"800\" border=\"0\">" +
				  ...
				  "<tr>"+
					"<td height=\"203\" valign=\"top\"><div style=\"overflow:scroll;height:200px;\"><table  width=\"100%\" align=\"left\" cellpadding=\"0\" cellspacing=\"0\" id=\"tblDelivery\">"+
						"<tr>"+
						  "<td height=\"20\" colspan=\"5\" bgcolor=\"#9BBFDD\"><div align=\"center\" class=\"normalfnth2\"></div></td>"+
...
function ShowAddDeliverySchedule()
{
	...
	var HTMLText = " <table width=\"500\" class=\"bcgl1\" height=\"218\">"+
					"<tr>"+
					 " <td><table width=\"100%\" height=\"207\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
						  "<tr>"+
							/*"<td width=\"3%\" bgcolor=\"#0E4874\">&nbsp;</td>"+*/
							"<td colspan=\"5\" bgcolor=\"#0E4874\" class=\"PopoupTitleclass\" height=\"20\"><table width=\"100%\" border=\"0\">"+
								"<tr class=\"cursercross\" onmousedown=\"grab(document.getElementById('frmItems'),event);\">"+
						  ...
						  "<tr>"+
							"<td width=\"5\">&nbsp;</td>"+
							"<td class=\"normalfnt\" width=\"80\">Qty</td>"+
							"<td align=\"left\"  width=\"100\">"+
							  "<input name=\"quantity\" type=\"text\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return isNumberKey(event);\" id=\"quantity\" value=\"" + balanceQuantity + "\" maxlength=\"9\" style=\"width:75px; text-align:right\" onkeyup=\"calExQtyForDeliverySchedule(this.value);\" />"+
							"</td>"+
							"<td class=\"normalfnt\" width=\"80\">Qty + Ex.Qty</td>"+
							"<td align=\"left\"  width=\"100\"><label>"+
							  "<input name=\"excqty\" type=\"text\" disabled=\"disabled\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return isNumberKey(event);\" id=\"excqty\"  maxlength=\"9\" style=\"width:68px; text-align:right\"/>"+
							"</label></td>"+
						  "</tr>"+
						  /*"<tr>"+
							"<td>&nbsp;</td>"+
							...
							"<td align=\"left\"><label>"+
							  "<input name=\"excqty\" type=\"text\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return isNumberKey(event);\" id=\"excqty\" value=\"" + balanceQuantity +  "\" maxlength=\"9\" style=\"width:68px; text-align:right\"/>"+
							"</label></td>"+
						  "</tr>"+*/
						  "<tr>"+
							"<td>&nbsp;</td>"+
						 ...
						 "</tr>"+*/
						  "<tr>"+
							...
							"<td align=\"left\" colspan=\"3\">"+
							  "<input name=\"remarks\" type=\"text\" class=\"txtbox\" id=\"remarks\" style=\"width:360px\" maxlength=\"50\"/>"+
							"<br>&nbsp;</td>"+
						  "</tr>"+
						 /* "<tr>" +
						  ...
						  "</tr>" +*/
						  "<tr>"+
							"<td colspan=\"5\" bgcolor=\"#D6E7F5\"><table width=\"100%\" height=\"20\" align=\"right\">"+
							/*"<tr><td>&nbsp;</td></tr>"+*/
							  "<tr>"+
								"<td width=\"60%\">&nbsp;</td>"+
	...
	var HTMLText = " <table width=\"500\" class=\"bcgl1\" height=\"220\">"+
					"<tr>"+
					 " <td><table width=\"100%\" height=\"207\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
						  ...
						  "<tr>"+
							"<td width=\"5\">&nbsp;</td>"+
							"<td class=\"normalfnt\" width=\"90\">Quantity</td>"+
							"<td width=\"100\" align=\"left\"><label>"+
							  "<input name=\"quantity\" type=\"text\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return isNumberKey(event);\" id=\"quantity\" value=\"" + qty + "\" style=\"width:75px; text-align:right\" maxlength=\"9\" onkeyup=\"calExQtyForDeliverySchedule(this.value);\" />"+
							"</label></td>"+
							"<td class=\"normalfnt\" width=\"80\">Qty + Ex.Qty</td>"+
							"<td width=\"100\" align=\"left\"><label>"+
							  "<input name=\"excqty\" type=\"text\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"return isNumberKey(event);\" id=\"excqty\" value=\"" + exqty + "\" disabled=\"disabled\" style=\"width:75px; text-align:right\" maxlength=\"9\"/>"+
							"</label></td>"+
						  ...
						  "<tr>"+
							...
							"<td align=\"left\">"+
							  ...
							  "<input name=\"deliverydate\" type=\"text\" class=\"txtboxRightAllign\" onkeypress=\"return ControlableKeyAccess(event);\" id=\"deliverydate\" onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\" value=\"" + date + "\" onclick=\"return showCalendar('deliverydate', '%d/%m/%Y');\" style=\"width:75px\"/>"+
							  "<input type=\"reset\" value=\"\"  class=\"txtboxRightAllign\" style=\"visibility:hidden;\"  >" +
							  "<input type=\"reset\" value=\"\"  class=\"txtboxRightAllign\" style=\"visibility:hidden;\"   onclick=\"return showCalendar('deliverydate', '%d/%m/%Y');\">" +
							"</td>"+
							"<td class=\"normalfnt\">Shipping Mode</td>"+
						 ...
						 "</tr>"+*/
						  "<tr>"+
							"<td>&nbsp;</td>"+
							"<td class=\"normalfnt\" align=\"left\">Remarks</td>"+
							"<td colspan=\"3\" align=\"left\"><label>"+
							  "<input name=\"remarks\" type=\"text\" value=\"" + remarks + "\" class=\"txtboxRightAllign\" id=\"remarks\" style=\"width:357px\"  maxlength=\"50\"/>"+
							"</label></td>"+
						  "</tr>"+
						  ...
						  "<tr>"+*/
						  "<tr>"+
							"<td colspan=\"5\" bgcolor=\"#D6E7F5\" align=\"right\"><table width=\"100%\" height=\"34\">"+
							  "<tr>"+
								"<td width=\"60%\">&nbsp;</td>"+
								"<td width=\"20%\"><img src=\"images/save.png\" width=\"84\" class=\"mouseover\" height=\"24\" onClick=\"UpdateSchedule('" + itemcode + "'," + changeLocation + ");\" /></td>"+
								"<td width=\"20%\"><img src=\"images/close.png\" width=\"97\" class=\"mouseover\" height=\"24\" onClick=\"closeWindow();\" /></td>"+
								/*"<td width=\"28%\">&nbsp;</td>"+*/
							  "</tr>"+
							"</table></td>"+
						 " </tr>"+
...
function UpdateSchedule(deldate,deliveryID)
{
	...
	createAltXMLHttpRequest();
	altxmlHttp.onreadystatechange = HandleDeliveryUpdating;
	altxmlHttp.open("GET", 'preordermiddletire.php?RequestType=ChangeSchedule&StyleNo=' + URLEncode(StyleNo) + '&ScheduleDate=' + date + '&qty=' + qty + '&exqty=' + exqty  + '&modeID=' + modeID + '&remarks=' + URLEncode(remarks) + '&isbase=' + isbase + '&LeadID=' + leadTime + '&oldDate=' + deldate + '&estimateddate=' + estimateddate + '&updateEventSchedule=' + updateEventSchedule+'&needSendMail='+needSendMail, true);
	altxmlHttp.send(null); 
...
function SaveNewDeliverySchedule()
{
	...
	{			
		...
		altxmlHttp.open("GET", 'preordermiddletire.php?RequestType=SaveSchedule&StyleNo=' + URLEncode(StyleNo) + '&ScheduleDate=' + date + '&qty=' + qty + '&exqty=' + exqty  + '&modeID=' + modeID + '&remarks=' + URLEncode(remarks) + '&isbase=' + isbase + '&LeadID=' + LeadID+'&needSendMail='+needSendMail, true);
		altxmlHttp.send(null); 
...
function AddToMatRatioBox()
{
	...
	var ReqQty = Math.ceil((selectedQty * ColorSizeConsumption) + (((selectedQty * ColorSizeConsumption)*pub_wastage)/100));
