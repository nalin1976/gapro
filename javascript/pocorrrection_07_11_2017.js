...
$(function(){
    ...
    function LoadGrid(){
        ...
        var XMLETA = objPO.responseXML.getElementsByTagName("ETA");
        ...
        for ( var loop = 0; loop < XMLPONo.length; loop ++)
        {
            ...
            var POETD = XMLETA[loop].childNodes[0].nodeValue;
...
function UpdatePO(varPONo, varPOYear){
    ...
    var urlPOUpdate   = "pocorrection.php?RequestType=POUpdate&pono="+varPONo+"&poyear="+varPOYear+"&supplierId="+newSupplierId+"&paymodeid="+newPayMode+"&paytermid="+newPayTerm+"&shipmodeid="+newShipMode+"&shiptermid="+newShipTerm+"&invoiceto="+newInvoiceTo+"&deliveryto="+newDeliveryTo+"&deliverydate="+newDeliveryDate+"&etadate="+newETA+"&etddate="+newETD;
