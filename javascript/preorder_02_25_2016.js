...
function SaveNewDeliverySchedule()
{
	if (ValidateSchedule() && ValidateBPOAllocation() )
	{
		...
		altxmlHttp.open("GET", 'preordermiddletire.php?RequestType=SaveSchedule&StyleNo=' + URLEncode(StyleNo) + '&ScheduleDate=' + date + '&qty=' + qty + '&exqty=' + exqty  + '&modeID=' + modeID + '&remarks=' + URLEncode(remarks) + '&isbase=' + isbase + '&LeadID=' + LeadID + '&estimateddate=' + estimateddate+ '&bpo=' + bpo + '&handoverDate=' + handoverDate + '&refNo=' + refNo+ '&contry=' + contry + '&deliStatus=' + deliveryStatus + '&cutOffDate=' + dtCutOffDate, true);
		altxmlHttp.send(null); 	
	}
}
