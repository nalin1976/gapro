...
//		}
		...
		row.innerHTML = "<td style=\"width:20px;\"><img src=\"images/del.png\" alt=\"del\" width=\"15\" height=\"15\" border=\"0\" class=\"mouseover\" onclick=\"RemovePONumberFromGrid(this);\"  /></td>" +
                       "<td class=\"normalfnt\" ondblclick=\"changeToTextBoxBPO(this);\" style=\"width:88px;\" >"  + txtBuyerPO + "</td>"+
                       "<td class=\"normalfntRite\" ondblclick=\"changeToTextBoxBPO(this);\" style=\"width:64px;\" >" + txtQty +"</td>"+
                       "<td class=\"normalfntMid\" id=\"" + countryID + "\" style=\"width:73px;\">" + CountryName + "</td>"+
                       "<td class=\"normalfnt\" id=\"" + leadTimeID + "\" style=\"width:37px;\" >" + leadName + "</td>"+
                       "<td class=\"normalfnt\" style=\"width:78px;\">" + deliveryDate + "</td>"+
                       "<td class=\"normalfnt\" style=\"width:78px;\">" + estimatedDD + "</td>"+
					   "<td class=\"normalfnt\" style=\"width:75px;\">" + handoverDD + "</td>"+
					   ...
					   "<td class=\"normalfntBPO\" id=\"" + orderstatus + "\" style=\"width:72px;\">" + orderstatusText + "</td>" + 
					   "<td class=\"normalfnt\" style=\"width:70px;\">" + cutoffdate + "</td>"+
					   "<td class=\"normalfnt\" style=\"width:70px;\">"+shipStatus+"</td>"+
					   "<td class=\"normalfnt\" style=\"width:0px; display:none;\">" + previousBPO + "</td>";
...
function saveDelBPO()
{
	...
	if(ValidateBPOSaving())
	{
		...
		for (var loop = 0 ; loop < tbl.rows.length ; loop ++ )
		{
			...
			var bpoPrevoius			= tbl.rows[loop].cells[13].textContent;
...
function RemovePONumberFromGrid(obj)
{
	...
	$("#hndOldBuyerPo").val(tr.cells[13].textContent);
...
{	
	...
	drawPopupBox(880,670,'frmstylewise',1);
...
function ChangeBPONo(prmTotReqQty, prmTotOrderQty){
	...
	var reqBPOQty	= Math.ceil(conPc * buyerPOQty);
