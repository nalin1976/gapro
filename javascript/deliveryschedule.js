...
function exportExcel(){
	...
	var _iSelection = document.getElementById('cmbSelection').value;
	...
	switch(iDisplayOption){
		...
		case 1:
			window.location = "rptxlsallbuyersfull.php?prmfrom="+dtFromDate+"&prmto="+dtToDate+"&prmpc="+_intProductCategoryCode+"&selection="+_iSelection;
		break;		
