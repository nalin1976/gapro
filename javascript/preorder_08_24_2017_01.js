...
var POorderQty=0;
var intOrderQtyCode = -1;

var dblOtherWastage = 0;
...
function ShowItems()
{
	...
	drawPopupArea(570,630,'frmItems');
						  ...
						  "</tr>"+
						   "<tr>"+
							...
							"<td align=\"left\" width=\"30%\" class=\"normalfnt\"><label>"+
							  "<select name=\"cboMaterial\" onchange=\"LoadMaterialCategories();SelectMainFabric(this.value);ClearOptions('cboItems');ClearOptions('cboItemsID'); ClearTextOptions('txtFabricType');\" class=\"txtbox\" id=\"cboMaterial\" style=\"width:200px\" tabindex=\"1\">"+
								"<option value=\"1\">Fabric</option>"+
								"<option value=\"2\">Accessories</option>"+
								"<option value=\"3\">Packing Material</option>"+
								"<option value=\"4\">Services</option>"+
								...
								"<td><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"bcgl1\">"+
								  "<tr>"+
									"<td><table width=\"100%\" height=\"80\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
                                                                        "<tr id='tr_fab_type' name='tr_fab_type'>"+
										"<td height=\"27\" class=\"normalfnt\" >&nbsp;Fabric Type</td>"+
										"<td align=\"left\">"+
										  "<select type=\"text\" name=\"txtFabricType\" class=\"txtbox\" id=\"txtFabricType\" onchange=\"GetItemWastageFromFabricType()\" tabindex=\"10\" style=\"width:77px\">"+
                                                                                  "<option value=\"-1\">Select Fabric Type</option>"+
                                                                                  "<option value=\"1\">Solid</option>"+
                                                                                  "<option value=\"2\">AOP</option>"+
                                                                                  "<option value=\"3\">Yarn Dyed</option>"+
                                                                                  "<option value=\"4\">Heather</option>"+
                                                                                  "</select>"+
										"</td>"+
										"<td align=\"left\" ><span class=\"normalfnt\">No.Of large Panels</span></td>"+
										"<td  align=\"left\"><input type=\"text\" name=\"txtNoOfLgPanels\" class=\"txtbox\" id=\"txtNoOfLgPanels\" tabindex=\"14\" style=\"width:77px\" value=\"1\" /></td>"+
										"<td ></td>"+
									  "</tr>"+
									  "<tr>"+
									  ...
									  "<tr>"+
										...
										"<td  align=\"left\">"+
										  "<input name=\"txtwastage\" type=\"text\" onkeyup=\"checkMaxWastage();\" onkeypress=\"return CheckforValidDecimal(this.value, 4,event);\" class=\"txtbox\" id=\"txtwastage\"  value=\"0\" tabindex=\"9\" maxlength=\"5\" style=\"width:75px; text-align:right\" onblur=\"set4deci(this)\" disabled/>"+
										"</td>"+
									"<td ></td>"+
									  ...
									  "</tr>"+
                                                                          ...
                                                                          "<tr id=\"troperations\">"+
                                                                            "<td width=\"100%\" colspan=\"5\">"+
                                                                                "<div style=\"overflow:scroll;height:120px;\"><table width=\"100%\" id=\"tb_wastage\" name=\"tb_wastage\">"+
                                                                                   "<thead>"+
                                                                                    "<tr>"+
                                                                                        "<td width=\"6%\" bgcolor=\"#3E81B7\" class=\"normaltxtmidb2\">Select</td>"+
                                                                                        "<td width=\"49%\" bgcolor=\"#3E81B7\" class=\"normaltxtmidb2\">Operation Name</td>"+
                                                                                        "<td width=\"15%\" bgcolor=\"#3E81B7\" class=\"normaltxtmidb2\">Wastage</td>"+
                                                                                        "<td width=\"15%\" bgcolor=\"#3E81B7\" class=\"normaltxtmidb2\">Emb Panels</td>"+
                                                                                        "<td width=\"15%\" bgcolor=\"#3E81B7\" class=\"normaltxtmidb2\">Print Panels</td>"+
                                                                                    "</tr>"+
                                                                                    "</thead><tbody>"+
                                                                                "</table></div>"+
                                                                            "</td>"+
...
function HandleItemDetails()
{
    if(xmlHttp.readyState == 4) 
    {
        ...
        {  
            ...
            var XMLFabType = xmlHttp.responseXML.getElementsByTagName("FabType");
            var XMLFabTypeCode = xmlHttp.responseXML.getElementsByTagName("FabTypeCode");
            ...
            $("#txtFabricType").val(XMLFabType[0].childNodes[0].nodeValue);
            iFabricTypeCode = XMLFabTypeCode[0].childNodes[0].nodeValue;
            GetItemWastage(iFabricTypeCode);
        }
    }
}
...
function AddItem(itemCode,itemDescription,conPc,unitType,unitPrice,wastage,originName,freight,originid,selection,purchasedQty,
                 purchasedPrice,bintobinqty, wastePSP, wasteDP,wasteEMB,wastePEOSP,wasteDPE,wasteGRW,wasteGEW,wasteGPD,
                 wasteSPE,wastePEODP,varnopanels, varEmbPanels, varPrintPanels)
{
	...
	var dbl_ReqQty = 0;
       ...
       /*
        totalQty = Math.ceil(ReqQty + (ReqQty * wastage / 100));
        ...
        if ((selection== "1" || selection== "Fabric" || selection== "FABRIC") /*&& FABRICExcessAllowed == false */ )
	{
            ...
            totalQty = (ReqQty + ((ReqQty*wastage)/100));
            //alert("Before Add Wastage - " + totalQty)
            //var dblOpWastage = (((totalQty * wastePEODP)/100) * (conPc * (varPrintPanels/varnopanels))) + (((totalQty * prmFabOpWaste)/100) * (conPc * (int_EmbPanels/varnopanels)));
            var dblOpWastage = CalFabricOpWastage(conPc,wastePSP,wasteDP,wasteEMB,wastePEOSP,wasteDPE,wasteGRW,wasteGEW,wasteGPD,
                                                  wasteSPE,wastePEODP,varnopanels,varEmbPanels, varPrintPanels,totalQty);
            totalQty += dblOpWastage;
            //alert("Before Add Wastage - " + totalQty)
            //alert("Wastage " + wastage + " OP Wastage " + varopwastage + " No. of panels " + varnopanels  + " Order Qty " + parseFloat(document.getElementById('txtQTY').value) + " Con/PC " + conPc);
            //totalQty = CalculateItemRequirement(wastage, varopwastage, varnopanels, parseFloat(document.getElementById('txtQTY').value), conPc);
            //alert(totalQty);
	}
	else
	{
	...
	var price = 0;
        var iOrderQty = document.getElementById("txtQTY").value;
         ...
         * Comment For - Calculate cost per pc         * 
         * ===================================================================
         */
	...
	else
	{
        ...
        price = pub_totalvalue/iOrderQty;
	...
	//bookmark
        ...
        var cellMainCat = row.insertCell(20);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wastePSP;
        
        var cellMainCat = row.insertCell(21);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteDP;
        
        var cellMainCat = row.insertCell(22);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteEMB;
        
        var cellMainCat = row.insertCell(23);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wastePEOSP;
        
        var cellMainCat = row.insertCell(24);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteDPE;
        
        var cellMainCat = row.insertCell(25);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteGRW;
        
        var cellMainCat = row.insertCell(26);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteGEW;
        
        var cellMainCat = row.insertCell(27);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteGPD;
        
        var cellMainCat = row.insertCell(28);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wasteSPE;
        
        var cellMainCat = row.insertCell(29);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = wastePEODP;
                
        var cellMainCat = row.insertCell(30);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = varnopanels;
        
        var cellMainCat = row.insertCell(31);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = varEmbPanels;
        
        var cellMainCat = row.insertCell(32);     
	cellMainCat.className="normalfntRite";
	cellMainCat.innerHTML = varPrintPanels; 
...
function ValidateInterfaceComponents()
{
	...
	else 
	{
        ...
        if((document.getElementById('txtPackSMV').value == '0'))
        {
            alert("Packing SMV cannot be 0 or empty, enter packing SMV from 'Part Details' section .");
            document.getElementById('txtPackSMV').focus();
            return false;
        }
...
function showEditWindow(itemcode)
{
	...
	drawPopupArea(560,590,'frmItems');
                                                                          ...
                                                                          if(matCat == 'F'){
                                                                              ...
                                                                              HTMLText +=   "<tr>"+
                                                                                            ...
                                                                                            "<td align=\"left\">"+
                                                                                                ...
                                                                                                "</select>"+
                                                                                              "</td>"+
                                                                                            "<td align=\"left\" ><span class=\"normalfnt\">No.of Lg. Panels</span></td>"+
                                                                                            "<td  align=\"left\"><input type=\"text\" name=\"txtNoOfLgPanels\" class=\"txtbox\" id=\"txtNoOfLgPanels\" tabindex=\"10\" style=\"width:77px\" /></td>"+
                                                                                            "<td ></td>"+
                                                                                            "</tr>"+                                                                                            
                                                                                            "<tr id=\"tr_operations\">"+
	...
	document.getElementById('chkMainFabric').checked = (mainFabric==1 ? true:false)
        ...
        if(matCat == 'F'){
           ...
           LoadOperations();
           SetFabricOperation(styleID, itemcode);
        }else{
...
function SelectMainFabric(catID)
{
    if(catID == 1){
        ...
        //$("#tr_fab_type").css('visibility', 'visible');
        $("#tr_fab_type").show(); 
        $("#tr_no_panels").show();
        $("#tr_multi_emb_print").show();  
        $("#txtwastage").attr("disabled","disabled");
        $("#troperations").show();
    }	
    else{
        document.getElementById('mainFabDiv').style.visibility = 'hidden';
        $("#trWash").css('visibility','hidden');
        //$("#tr_fab_type").css('visibility', 'hidden');
        $("#tr_fab_type").hide();
        $("#tr_no_panels").hide();
        $("#tr_multi_emb_print").hide();
        $("#txtwastage").removeAttr("disabled");
        $("#troperations").hide();
    }
...
function ModifyItems(itemcode,conpc,unitType,unitPrice,wastage,originName,freight,originID,cat)
{
	//alert(unitPrice);
        ...
        var intEmbPanels = 0;
        var intPrintPanels = 0;
        var noOfPanels = 0;
        
        dblOtherWastage = 0;
        
        var qtyWithOpWaste = 0;
	var tbl = document.getElementById('tblConsumption');
	var position = -1;
    for ( var loop = 1 ;loop < tbl.rows.length ; loop ++ )
  	{
	...
	totalQty = Math.ceil(totalQty);
        ...
        if (cat == 'F'){
           ...
           /* 
            var url_waste = "bomMiddletire.php?RequestType=GetItemWastage&styleId="+styleCode+"&itemcode="+itemcode;
            var htmlobj = $.ajax({url:url_waste,async:false});


            var _dblPSP = htmlobj.responseXML.getElementsByTagName("PSP_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblDP = htmlobj.responseXML.getElementsByTagName("DP_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblEMB = htmlobj.responseXML.getElementsByTagName("EMB_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblPEOSP = htmlobj.responseXML.getElementsByTagName("PEOSP_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblDPE = htmlobj.responseXML.getElementsByTagName("DPE_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblGEW = htmlobj.responseXML.getElementsByTagName("GEW_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblGPD = htmlobj.responseXML.getElementsByTagName("GPD_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblSPE = htmlobj.responseXML.getElementsByTagName("SPE_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblPEODP = htmlobj.responseXML.getElementsByTagName("PEODP_WASTAGE")[0].childNodes[0].nodeValue;
            var _dblGRW = htmlobj.responseXML.getElementsByTagName("GRW_WASTAGE")[0].childNodes[0].nodeValue;
            var _intLGPanels = htmlobj.responseXML.getElementsByTagName("NO_LG_PANELS")[0].childNodes[0].nodeValue;
            var _intPrintPanels = htmlobj.responseXML.getElementsByTagName("PRINT_PANELS")[0].childNodes[0].nodeValue;
            var _intEmbPanels = htmlobj.responseXML.getElementsByTagName("EMB_PANELS")[0].childNodes[0].nodeValue;
            
            //var qtyWithOpWaste = Math.round(((totalQty * dblOpWastage)/100 * (conpc*(intPrintPanels/intLGPanels))) + ((totalQty * dblOpWastage)/100 * (conpc*(intEmbPanels/intLGPanels))));
           qtyWithOpWaste += Math.round(((totalQty * _dblPEODP)/100 * (conpc*(_intPrintPanels/_intLGPanels))) + ((totalQty * _dblPEODP)/100 * (conpc*(_intEmbPanels/_intLGPanels))));
           qtyWithOpWaste += Math.round(((totalQty * _dblPEOSP)/100 * (conpc*(_intPrintPanels/_intLGPanels))));
           qtyWithOpWaste += Math.round(((totalQty * _dblPSP)/100) * conpc)+Math.round(((totalQty * _dblDP)/100) * conpc)+ Math.round(((totalQty * _dblEMB)/100) * conpc) + Math.round(((totalQty * _dblDPE)/100) * conpc)+ Math.round(((totalQty * _dblGEW)/100) * conpc)+ Math.round(((totalQty * _dblGPD)/100) * conpc)+ Math.round(((totalQty * _dblSPE)/100) * conpc)+ Math.round(((totalQty * _dblSPE)/100) * conpc) + Math.round(((totalQty * _dblGRW)/100) * conpc) ;
           */
          
            noOfPanels = $("#txtNoOfLgPanels").val();
            //alert("Large Panels" + noOfPanels);
                $("#tb_wastage > tbody > tr").each(function(){
                ...
                var row = $(this);
                    ...
                    if(row.find('input[type="checkbox"]').is(':checked')){
                        ...
                        var intOperationId = obj.attr('id');
                        var strOperationName = row.find('td:eq(1)').text();                        
                      
                        
                      
                        switch(strOperationName){

                            case "Printing - Single Panel":
                                dblWastePSP = row.find('td:eq(2)').text();
                            break;
                            
                            case "Discharge Print":
                                dblWasteDP = row.find('td:eq(2)').text();
                            break;
                            
                            case "Embroidery":
                                dblWasteEMB = row.find('td:eq(2)').text();
                            break;
                            
                            case "Discharge printing & Embroidery":
                                dblWasteDPE = row.find('td:eq(2)').text();
                            break;
                            
                            case "Garment Regular Washed":
                                dblWasteGRW = row.find('td:eq(2)').text();
                            break;
                            
                            case "Garment enzyme washed":
                                dblWasteGEW = row.find('td:eq(2)').text();
                            break;
                            
                            case "Garment pigment dye":
                                dblWasteGPD = row.find('td:eq(2)').text();
                            break;
                            
                            case "Special effect (Towel dye/ Towel washed/ Art Line/ Acid washed)":
                                dblWasteSPE = row.find('td:eq(2)').text();
                            break;

                            case "Printing & Embroidery on different panels":
                                dblWastePEODP = row.find('td:eq(2)').text();
                                intEmbPanels = row.find('td:eq(3) input').val();
                                intPrintPanels = row.find('td:eq(4) input').val();
                            break;

                            case "Printing & Embroidery on same panel":
                                dblWastePEOSP  = row.find('td:eq(2)').text();
                                intEmbPanels = row.find('td:eq(3) input').val();
                            break;
                        }
                      
                      qtyWithOpWaste = CalculateItemRequirement(wastage, dblWastePSP,dblWasteDP,noOfPanels,dblWasteEMB,dblWasteDPE,dblWasteGRW,dblWasteGEW,dblWasteGPD,dblWasteSPE,dblWastePEODP,dblWastePEOSP,
                                                           parseFloat(document.getElementById('txtQTY').value), conpc, strOperationName, intEmbPanels, intPrintPanels);
                                            
                   }
                   
               });
           totalQty = qtyWithOpWaste;
        }
	...
	tbl.rows[position].cells[18].lastChild.nodeValue = RoundNumbers((pub_totalvalue*pub_export2)/100,2) ;
        ...
        tbl.rows[position].cells[20].lastChild.nodeValue = dblWastePSP ;
        tbl.rows[position].cells[21].lastChild.nodeValue = dblWasteDP ;
        tbl.rows[position].cells[22].lastChild.nodeValue = dblWasteEMB ;
        tbl.rows[position].cells[23].lastChild.nodeValue = dblWastePEOSP ;
        tbl.rows[position].cells[24].lastChild.nodeValue = dblWasteDPE ;
        tbl.rows[position].cells[25].lastChild.nodeValue = dblWasteGRW ;
        tbl.rows[position].cells[26].lastChild.nodeValue = dblWasteGEW ;
        tbl.rows[position].cells[27].lastChild.nodeValue = dblWasteGPD ;
        tbl.rows[position].cells[28].lastChild.nodeValue = dblWasteSPE ;
        tbl.rows[position].cells[29].lastChild.nodeValue = dblWastePEODP ;
        tbl.rows[position].cells[30].lastChild.nodeValue = noOfPanels ;
        tbl.rows[position].cells[31].lastChild.nodeValue = intEmbPanels ;
        tbl.rows[position].cells[32].lastChild.nodeValue = intPrintPanels ;
...
function CalculateCMValue()
{
	...
	var finance =  parseFloat(document.getElementById('txtFinanceAmount').value);
        /*
        *  ============================================================================================
        *  Comment On - 05/29/2017
        *  Comment By - Nalin Jayakody
        *  Comment For - Remove ESC & Finance charge from the CM calculation requested by Sanka Koralearachchi
        *  ============================================================================================ 
        */
	...
	var cm = currentFOB - pcmeterialCost;// - esc - finance;
        //alert(cm);
        //alert("Current FOB " + currentFOB + " Material Cost " + pcmeterialCost + " ESC " + esc + " Finance Charge " + finance);
					 ...
					 " <td><table width=\"100%\" height=\"207\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"+
						  ...
						  "<tr height=\"26\">"+
							...
							"<td align=\"left\" width=\"100\">"+
							 "<input name=\"txtBpo\" value =\"0\" type=\"text\" class=\"txtboxRightAllign\" onblur=\"checkForValues(this);validateSpecialCharacters(this.id);\"  onmousedown=\"DisableRightClickEvent();\" onmouseout=\"EnableRightClickEvent();\"  onkeypress=\"\" id=\"txtBpo\" maxlength=\"12\" style=\"width:75px; text-align:right\" onkeyup=\"\" />"+
...
/*	var pcmeterialCost =  parseFloat(document.getElementById('txtMaterialCost').value) ;
	...
	var currentfob = document.getElementById('txtTargetFOB').value;if(currentfob=='') {currentfob = 0}	else{currentfob = parseFloat(currentfob)};
        ...
        * ============================================================================================ 
        */
	var cmValue = (currentfob - pcmeterialCost) + + upcharge;// - esc - finance ;
	document.getElementById('txtCMValue').value = RoundNumbers(cmValue,4);
...
function LoadSavedOrderDetails()
{
		...
		var XMLOrderNo = xmlHttp.responseXML.getElementsByTagName("OrderNo");
			...
			var XMLIsSampleOrder = xmlHttp.responseXML.getElementsByTagName("IsSampleOrder")[0].childNodes[0].nodeValue;
                        ...
                        var XMLStyleLevel = xmlHttp.responseXML.getElementsByTagName("StyleLevel");
                        var XMLPCD = xmlHttp.responseXML.getElementsByTagName("PCD");
			...
			document.getElementById('cboManuFactory').value =  xmlHttp.responseXML.getElementsByTagName("manufacCompany")[0].childNodes[0].nodeValue;
                        ...
                        $("#cboStyleLevel").val(XMLStyleLevel[0].childNodes[0].nodeValue);
                        $("#dtPCD").val(XMLPCD[0].childNodes[0].nodeValue);
    ...
    if(altxmlHttp.readyState == 4) 
    {
        ...
        { 
			...
			var XMLbintobinqty = altxmlHttp.responseXML.getElementsByTagName("bintobinqty");
                        ...
                        /* */
                        var XMLPSP  = altxmlHttp.responseXML.getElementsByTagName("PSP");
                        var XMLDP = altxmlHttp.responseXML.getElementsByTagName("DP"); 
                        var XMLEMB = altxmlHttp.responseXML.getElementsByTagName("EMB"); 
                        var XMLPEOSP = altxmlHttp.responseXML.getElementsByTagName("PEOSP"); 
                        var XMLDPE = altxmlHttp.responseXML.getElementsByTagName("DPE"); 
                        var XMLGEW = altxmlHttp.responseXML.getElementsByTagName("GEW"); 
                        var XMLGPD = altxmlHttp.responseXML.getElementsByTagName("GPD"); 
                        var XMLSPE = altxmlHttp.responseXML.getElementsByTagName("SPE"); 
                        var XMLPEODP = altxmlHttp.responseXML.getElementsByTagName("PEODP"); 
                        var XMLGRW = altxmlHttp.responseXML.getElementsByTagName("GRW"); 
                        var XMLLGPANELS = altxmlHttp.responseXML.getElementsByTagName("LG_PANELS"); 
                        var XMLEMBPANELS = altxmlHttp.responseXML.getElementsByTagName("EMB_PANELS"); 
                        var XMLPRNPANELS = altxmlHttp.responseXML.getElementsByTagName("PRN_PANELS"); 
...
/*			var XMLtransport = altxmlHttp.responseXML.getElementsByTagName("transport");
			...
			for ( var loop = 0; loop < XMLstrOrderNo.length; loop ++)
			{
				...
				var purchasedPrice =  XMLPurchasePrice[loop].childNodes[0].nodeValue;
                                ...
                                var dblPSP = XMLPSP[loop].childNodes[0].nodeValue;
                                var dblDP = XMLDP[loop].childNodes[0].nodeValue;
                                var dblEMB = XMLEMB[loop].childNodes[0].nodeValue;
                                var dblPEOSP = XMLPEOSP[loop].childNodes[0].nodeValue;
                                var dblDPE = XMLDPE[loop].childNodes[0].nodeValue;
                                var dblGEW = XMLGEW[loop].childNodes[0].nodeValue;
                                var dblGPD = XMLGPD[loop].childNodes[0].nodeValue;
                                var dblSPE = XMLSPE[loop].childNodes[0].nodeValue;
                                var dblPEODP = XMLPEODP[loop].childNodes[0].nodeValue;
                                var dblGRW = XMLGRW[loop].childNodes[0].nodeValue;
                                var dblLGPANELS = XMLLGPANELS[loop].childNodes[0].nodeValue;
                                var dblEMBPANELS = XMLEMBPANELS[loop].childNodes[0].nodeValue;
                                var dblPRNPANELS = XMLPRNPANELS[loop].childNodes[0].nodeValue;
...
/*				var transport 	=  XMLtransport[loop].childNodes[0].nodeValue;
				...
				AddItem(itemCode,itemDescription,conPc,unitType,unitPrice,wastage,originName,freight,originid,
                                        category,purchasedQty,purchasedPrice,0,dblPSP,dblDP,dblEMB,dblPEOSP,dblDPE,dblGRW,dblGEW,
                                        dblGPD,dblSPE,dblPEODP,dblLGPANELS,dblEMBPANELS,dblPRNPANELS);
				arrayLocation ++
			}
			CalculateMatCost();
			CalculateCMValue();
    ...
    for ( var loop = 1 ;loop < tbl.rows.length ; loop ++ )
  	{
		...
		var freight = parseFloat(tbl.rows[loop].cells[12].lastChild.nodeValue) ;
                 ...
                 * Add By - Nalin Jayakody
                 * Add On - 08/10/2017
                 * Adding - Remove sub-contract charges sewing from material calcuation request by Sanka Koralearachchi
                 * ========================================================================
                 */
                if(itemid != '18388'){
                    
                    totalMaterialCost = totalMaterialCost+ (value);
                    //alert("Raw mat tot value" + totalMaterialCost );
                }else{
                    //alert("Sub Charge" + value );
                }    
...
function SaveItemInfo()
{
	...
	var exQty = document.getElementById('txtEXQTY').value;
        ...
        if(conpc == 0){alert('Please enter consumption to the item');return;}
        
        if($("#txtFabricType").val() == -1){alert('Select fabric type from the list'); return;}
	...
	if ((document.getElementById('cboMaterial').value == "1"  || document.getElementById('cboMaterial').value == "Fabric" || document.getElementById('cboMaterial').value == "FABRIC")/* && FABRICExcessAllowed == false && FABRICWastageAllowed == false*/)
	{
		//totalQty = ReqQty  ;
                ...
                // Calculate requirement and wastage based on grid
                // Add By - Nalin Jayakody
                // Add On - 07/20/2017
                // =================================================
                /*var noOfPanels = $("#txtNoOfPanels").val();
                var dblOpWastage = $("#txtOpWastage").val();
                operationId = $("#cboOperationType").val();*/
               ...
               /*
                switch(operationId){
                    ...
                    case "10":
                        ...
                        embPanels = $("#txtNoOfEmbPanels").val();
                        printPanels = $("#txtNoOfPrintPanels").val();
                        break;
                ...
                */
                //var noOfPanels = $("#txtNoOfPanels").val()
                var noOfPanels = $("#txtNoOfLgPanels").val()
                $("#tb_wastage > tbody > tr").each(function(){
                    ...
                    if(row.find('input[type="checkbox"]').is(':checked')){
                        ...
                        switch(strOperationName){
                            ...
                            case "Printing & Embroidery on different panels":
                                ...
                                if(intEmbPanels > noOfPanels){
                                    alert("No. of embroidery panels cannot be more than the large panels");return;
                                }
                                
                                if(intPrintPanels > noOfPanels){
                                    alert("No. of embroidery panels cannot be more than the large panels");return;
                                }
                      ...
                      //totalQty += CalculateItemRequirement(wastage, dblOpWastage, noOfPanels, parseFloat(document.getElementById('txtQTY').value), conpc, strOperationName, intEmbPanels, intPrintPanels);
                      totalQty = CalculateItemRequirement(wastage, dblWastePSP,dblWasteDP, noOfPanels,dblWasteEMB,dblWasteDPE,
                                                           dblWasteGRW,dblWasteGEW,dblWasteGPD,dblWasteSPE,dblWastePEODP,dblWastePEOSP,
                                                           parseFloat(document.getElementById('txtQTY').value), conpc, 
                                                           strOperationName, intEmbPanels, intPrintPanels);
                   }
	...
	//xmlHttp.open("GET",'preordermiddletire.php?RequestType=SaveItems&ItemCode=' + itemid + '&ConPc=' + conpc + '&UnitPrice=' + unitPrice + '&wastage=' + wastage + '&origin=' + originID  + '&StyleNo=' + URLEncode(StyleNo)  + '&ReqQty=' + ReqQty  + '&totalQty=' + totalQty + '&value=' + value + '&price=' + price + '&OrderNo=' + URLEncode(OrderNo) + '&freight=' + freight  + '&unitType=' + URLEncode(unitType) + '&washable='+IsWashable + '&opwastage='+dblOpWastage + '&nopanels='+noOfPanels, true);
	//xmlHttp.open("GET",'preordermiddletire.php?RequestType=SaveItems&ItemCode=' + itemid + '&ConPc=' + conpc + '&UnitPrice=' + unitPrice + '&wastage=' + wastage + '&origin=' + originID  + '&StyleNo=' + URLEncode(StyleNo)  + '&ReqQty=' + ReqQty  + '&totalQty=' + totalQty + '&value=' + value + '&price=' + price + '&OrderNo=' + URLEncode(OrderNo) + '&freight=' + freight  + '&unitType=' + URLEncode(unitType) + '&washable='+IsWashable + '&opwastage='+dblOpWastage + '&nopanels='+noOfPanels + '&embpanels='+embPanels + '&printpanels='+printPanels + '&opeid='+operationId, true);
	xmlHttp.open("GET",'preordermiddletire.php?RequestType=SaveItems&ItemCode=' + itemid + '&ConPc=' + conpc + '&UnitPrice=' + unitPrice + '&wastage=' + wastage + '&origin=' + originID  + 
                           '&StyleNo=' + URLEncode(StyleNo)  + '&ReqQty=' + ReqQty  + '&totalQty=' + totalQty + '&value=' + value + '&price=' + price + '&OrderNo=' + URLEncode(OrderNo) + 
                           '&freight=' + freight  + '&unitType=' + URLEncode(unitType) + '&washable='+IsWashable + '&wastepsp='+dblWastePSP + '&wastedp='+dblWasteDP + '&wasteemb='+dblWasteEMB + 
                           '&wastedpe='+dblWasteDPE + '&wastegrw='+dblWasteGRW+'&wastegew='+dblWasteGEW+'&wastegpd='+dblWasteGPD+'&wastespe='+dblWasteSPE+'&wastepeosp='+dblWastePEOSP+
                           '&wastepeodp='+dblWastePEODP+'&lgpanels='+noOfPanels+'&embpanels='+intEmbPanels+'&prnpanels='+intPrintPanels, true);
	xmlHttp.send(null); 
...
function AddNewDataToGrid()
{
		...
		var freight = parseFloat(document.getElementById('txtfreight').value);
                ...
                /*if(document.getElementById('cboMaterial').value == '1'){
                    noOfPanels = $("#txtNoOfPanels").val();
                    dblOpWastage =  $("#txtOpWastage").val();
                ...
                $("#tb_wastage > tbody > tr").each(function(){
                    ...
                    if(row.find('input[type="checkbox"]').is(':checked')){
                        ...
                        var intOperationId = obj.attr('id');
                        var strOperationName = row.find('td:eq(1)').text();
                        //dblOpWastage = row.find('td:eq(2)').text();
		...
		if (!checkAvailability(itemCode))
		{
			...
			//AddItem(itemCode,itemDescription,conPc,unitType,unitPrice,wastage,originName,freight,originID,document.getElementById('cboMaterial').value,0,0,0,dblWastePSP,noOfPanels);
			AddItem(itemCode,itemDescription,conPc,unitType,unitPrice,wastage,originName,freight,originID,
                                document.getElementById('cboMaterial').value,0,0,0,dblWastePSP,dblWasteDP,dblWasteEMB, 
                                dblWastePEOSP,dblWasteDPE,dblWasteGRW,dblWasteGEW,dblWasteGPD,dblWasteSPE,dblWastePEODP,noOfPanels,
                                intEmbPanels,intPrintPanels);
			//CollectVariations();
			CalculateFigures();
			RefreshAddingInterface();
		}
...
function UpdateItemInfo(locno,itemid,matCat,matMainCat)
{
	...
	else
	{
        ...
        if ((matCat == '1' || matCat == 'F')){
            /*
            var url_waste = "bomMiddletire.php?RequestType=GetItemWastage&styleId="+StyleNo+"&itemcode="+itemid;
            var htmlobj = $.ajax({url:url_waste,async:false});


            var XMLOpWastage = htmlobj.responseXML.getElementsByTagName("OP_WASTAGE");
            var XMLLGPanels = htmlobj.responseXML.getElementsByTagName("NO_LG_PANELS");
            var XMLPrintPanels = htmlobj.responseXML.getElementsByTagName("PRINT_PANELS"); 
            var XMLEMBPanels = htmlobj.responseXML.getElementsByTagName("EMB_PANELS"); 
            var XMLOPID = htmlobj.responseXML.getElementsByTagName("OP_ID");

            for(var wastLoop = 0; wastLoop<XMLOpWastage.length;wastLoop++){
                dblOpWastage = XMLOpWastage[wastLoop].childNodes[0].nodeValue;
                intLGPanels = XMLLGPanels[wastLoop].childNodes[0].nodeValue;
                intPrintPanels = XMLPrintPanels[wastLoop].childNodes[0].nodeValue;
                intEmbPanels = XMLEMBPanels[wastLoop].childNodes[0].nodeValue;
            }*/
            
            //totalQty = CalculateItemRequirement(wastage, dblOpWastage,intLGPanels,orderQty,conpc);
            //alert(totalQty);
                    ...
                    if(row.find('input[type="checkbox"]').is(':checked')){
                        ...
                        switch(strOperationName){
                            ...
                            case "Printing & Embroidery on same panel":
                                ...
                                intEmbPanels = row.find('td:eq(3) input').val();
                                if(intEmbPanels > noOfPanels){
                                    alert("No. of embroidery panels cannot be more than the large panels");
                                    row.find('td:eq(3) input').val(noOfPanels);
                                    return false;
                                }
                            break;
                        }
	...
	xmlHttp.open("GET",'preordermiddletire.php?RequestType=UpdateItems&ItemCode=' + itemid + '&ConPc=' + conpc + '&UnitPrice=' + unitPrice + '&wastage=' + wastage + '&origin=' + originID  + 
                           '&StyleNo=' + URLEncode(StyleNo)  + '&ReqQty=' + ReqQty  + '&totalQty=' + totalQty + '&value=' + value + '&price=' + price + '&OrderNo=' + URLEncode(OrderNo) + '&freight=' + freight  + 
                           '&unitType=' + URLEncode(unitType) + '&mill=' +mill+ '&mainFabric=' +mainFabric + '&iswashed='+IsToBeWashed + '&wastepsp='+dblWastePSP+'&wastedp='+dblWasteDP+'&wasteemb='+dblWasteEMB+
                           '&wastedpe='+dblWasteDPE+'&wastegrw='+dblWasteGRW+'&wastegew='+dblWasteGEW+'&wastegpd='+dblWasteGPD+'&wastespe='+dblWasteSPE+'&wastepeodp='+dblWastePEODP+'&wastepeosp='+dblWastePEOSP+
                           '&embpanels='+intEmbPanels+'&prnpanels='+intPrintPanels+'&lgpanels='+noOfPanels, true);
	xmlHttp.send(null); 
...
function LoadOperations(){
    ...
    var url_ops = "preordermiddletire.php?RequestType=GetFabOps&orderqty="+orderQty;
    var htmlObj_Ops = $.ajax({url:url_ops, async:false});
    
    var XMLOperationCode = htmlObj_Ops.responseXML.getElementsByTagName("OP_CODE");
    var XMLOperationName = htmlObj_Ops.responseXML.getElementsByTagName("OP_NAME");
    var XMLOperationWastage = htmlObj_Ops.responseXML.getElementsByTagName("OP_WASTAGE");
    
    
    $("#cboOperationType").append($('<option>',{value:'-1', text:''}));
    
    for (var loop = 0; loop < XMLOperationCode.length; loop ++){
        //$("#cboOperationType").append($('<option>',{value:XMLOperationCode[loop].childNodes[0].nodeValue, text:XMLOperationName[loop].childNodes[0].nodeValue}));
        
        switch(XMLOperationName[loop].childNodes[0].nodeValue){
            case "Printing & Embroidery on same panel":
                $("#tb_wastage tbody:last-child").append("<tr><td><input type=\"checkbox\" id=\""+ XMLOperationCode[loop].childNodes[0].nodeValue +"\"</td><td align=\"left\" class=\"normalfnt\">"+XMLOperationName[loop].childNodes[0].nodeValue +"</td><td align=\"right\" class=\"normalfntRite\">"+XMLOperationWastage[loop].childNodes[0].nodeValue +"</td><td align=\"right\" class=\"normalfntRite\"><input type=\"text\" value=\"0\" style=\"width:80px;text-align:right\" /></td></tr>");
                break;
                
            case "Printing & Embroidery on different panels":
                $("#tb_wastage tbody:last-child").append("<tr><td><input type=\"checkbox\" id=\""+ XMLOperationCode[loop].childNodes[0].nodeValue +"\"</td><td align=\"left\" class=\"normalfnt\">"+XMLOperationName[loop].childNodes[0].nodeValue +"</td><td align=\"right\" class=\"normalfntRite\">"+XMLOperationWastage[loop].childNodes[0].nodeValue +"</td><td align=\"right\" class=\"normalfntRite\"><input type=\"text\" value=\"0\" style=\"width:80px;text-align:right\" /></td><td><input type=\"text\" value=\"0\" style=\"width:80px;text-align:right\" /></td></tr>");
                break;
                
            default:
                $("#tb_wastage tbody:last-child").append("<tr><td><input type=\"checkbox\" id=\""+ XMLOperationCode[loop].childNodes[0].nodeValue +"\"</td><td align=\"left\" class=\"normalfnt\">"+XMLOperationName[loop].childNodes[0].nodeValue +"</td><td align=\"right\" class=\"normalfntRite\">"+XMLOperationWastage[loop].childNodes[0].nodeValue +"</td></tr>")
                break;
        }
...
function GetItemWastageFromFabricType(){
    
    var fabTypeCode = $("#txtFabricType").val();
    
    GetItemWastage(fabTypeCode);
}

function GetItemWastage(prmFabricType){
    
    var styleOrderQty = $("#txtQTY").val();
    
    
    // Get order qty id from order qty
    // =================================
    var url_OrderQty = "preordermiddletire.php?RequestType=GetOrderQtyCode&ordeqty="+styleOrderQty;
    var obj_OrderQty = $.ajax({url:url_OrderQty,async:false});
    var int_OrderQtyCode = obj_OrderQty.responseXML.getElementsByTagName("QTY_CODE")[0].childNodes[0].nodeValue;
    
    intOrderQtyCode = int_OrderQtyCode;
    // =================================
    
    /*
     * Get wastage for the fabric type
     * ========================================================
     */
    
    var url_fab_wastage = "preordermiddletire.php?RequestType=GetFabWastage&qtyid="+int_OrderQtyCode+"&fabtype="+prmFabricType;
    var obj_FabWastage = $.ajax({url:url_fab_wastage, async:false});
    var dbl_wastage = obj_FabWastage.responseXML.getElementsByTagName("WASTE_FIG")[0].childNodes[0].nodeValue;
    
    //$("#txtwastage").val(dbl_wastage);
    $("#txtwastage").val(dbl_wastage);
    $("#txtFabricType").val(prmFabricType);
    
    
}


function CalculateItemRequirement(prmFabTypeWaste, prmPSPWaste,prmDPWaste,prmNoOfPanels,prmEMBWaste,prmDPEWaste,prmGRWWaste,
                                  prmGEWWaste, prmGPDWaste,prmSPEWaste,prmPEODPWaste,prmPEOSPWaste,             
                                  prmOrderQty, prmCon, operationName, int_EmbPanels, int_PrintPanels){
    
   
   var dbl_ReqQty   = 0;
   var opReqQty     = 0;
      
   dbl_ReqQty = ((prmOrderQty * prmCon) + (((prmOrderQty * prmCon)*prmFabTypeWaste)/100));
   
   
   //var operationName = ($("#cboOperationType option:selected").text());
   
   switch(operationName){
        
        case "Printing & Embroidery on different panels":   
            
            /*var int_PrintPanels = $("#txtNoOfPrintPanels").val();
            var int_EmbPanels =  $("#txtNoOfEmbPanels").val();*/
            
            dblOtherWastage += (((dbl_ReqQty * prmPEODPWaste)/100) * (prmCon * (int_PrintPanels/prmNoOfPanels))) + (((dbl_ReqQty * prmPEODPWaste)/100) * (prmCon * (int_EmbPanels/prmNoOfPanels)));
            //alert("PEOSP ->" + dblOtherWastage);
        ...
        case "Printing & Embroidery on same panel":
           ...
           // var int_EmbPanels =  $("#txtNoOfEmbPanels").val();
           // alert("Emb Panels - " + int_EmbPanels +" Lg Panels - " + prmNoOfPanels + " PEOSP Waste % - " + prmPEOSPWaste);
            dblOtherWastage += (((dbl_ReqQty * prmPEOSPWaste)/100) * (prmCon * (int_EmbPanels/prmNoOfPanels)));
           // alert("PEOSP -->" + dblOtherWastage);
            break;
            
        default:
            
            dblOtherWastage = (((dbl_ReqQty * prmPSPWaste)/100)*prmCon) + (((dbl_ReqQty * prmDPWaste)/100)*prmCon) + (((dbl_ReqQty * prmEMBWaste)/100)*prmCon) + (((dbl_ReqQty * prmDPEWaste)/100)*prmCon) + (((dbl_ReqQty * prmGRWWaste)/100)*prmCon)+ (((dbl_ReqQty * prmGEWWaste)/100)*prmCon)+ (((dbl_ReqQty * prmGPDWaste)/100)*prmCon)+ (((dbl_ReqQty * prmSPEWaste)/100)*prmCon)
            //alert("Other --->" + dblOtherWastage);
            /*opReqQty =  (((dbl_ReqQty * prmFabOpWaste)/100) * (prmCon));
            alert("Operation Req Qty ==> " + dbl_ReqQty + " Wastage ==> " + prmFabOpWaste + " Consumption ==> " + prmCon)
            alert("Operation Waste Qty ==> " + opReqQty)
            //dbl_ReqQty = Math.round(dbl_ReqQty + (((dbl_ReqQty * prmFabOpWaste)/100) * (prmCon/prmNoOfPanels)));
             if (isNaN(opReqQty)){
                dbl_ReqQty = dbl_ReqQty + 0; 
             }else{
                dbl_ReqQty = Math.ceil(dbl_ReqQty + opReqQty) ;
             }
            */
            break;        
    }
    
    dbl_ReqQty += dblOtherWastage;
    //alert("From Cal" + dbl_ReqQty);
    return dbl_ReqQty;
    ...
    //var dbl_ReqQty = CalculateRequirement();
    
}

function CalFabricOpWastage(conPc,varPSP,varDP,varEMB,varPEOSP,varDPE,varGRW,varGEW,varGPD,varSPE,varPEODP,
                      varLgPanels, varEmbPanels, varPrintPanels,varTotReqQty){
                          
    var opWastage = 0;
 
   /* if((varEmbPanels > 0)&&(varPrintPanels > 0)){

        opWastage += (((varTotReqQty * varPEODP)/100) * (conPc * (varPrintPanels/varLgPanels))) + (((varTotReqQty * varPEODP)/100) * (conPc * (varEmbPanels/varLgPanels)));

    }else{
        
        if((varEmbPanels > 0)&&(varPrintPanels == 0)){

            opWastage += (((varTotReqQty * varPEOSP)/100) * (conPc * (varEmbPanels/varLgPanels)));

        }else{
           opWastage += (((varTotReqQty * varPSP)/100)*conPc) + (((varTotReqQty * varDP)/100)*conPc) + (((varTotReqQty * varEMB)/100)*conPc) + (((varTotReqQty * varDPE)/100)*conPc) + (((varTotReqQty * varGRW)/100)*conPc) + (((varTotReqQty * varGEW)/100)*conPc) + (((varTotReqQty * varGPD)/100)*conPc) + (((varTotReqQty * varSPE)/100)*conPc);
        }
...
function LoadWasgateByOperation(){
    
    var operatioName = ($("#cboOperationType option:selected").text());
    
    switch(operatioName){
        
        case "Printing & Embroidery on different panels":            
            $("#tr_multi_emb_print").show();
            $("#td_print_panels").show();
            $("#td_lbl_panels").show();
    ...
    var fabOPCode = $("#cboOperationType").val();
    
    var url_fab_wastage = "preordermiddletire.php?RequestType=GetFabOpWastage&qtyid="+intOrderQtyCode+"&fabOpCode="+fabOPCode;
    var obj_FabWastage = $.ajax({url:url_fab_wastage, async:false});
    var dbl_wastage = obj_FabWastage.responseXML.getElementsByTagName("WASTE_FIG_OP")[0].childNodes[0].nodeValue;
    
    $("#txtOpWastage").val(dbl_wastage);
}


function SetFabricOperation(styleCode, itemCode){
    ...
    $("#txtNoOfLgPanels").val(_intLGPanels);
    ...
    $("#tb_wastage > tbody > tr").each(function(){
        ...
        switch(strOperationName){
            ...
            case "Printing & Embroidery on different panels":
                if(_dblPEODP > 0){
                    row.find('input[type="checkbox"]').prop('checked', 'checked');
                    row.find('td:eq(3) input').val(_intEmbPanels);
                    row.find('td:eq(4) input').val(_intPrintPanels);
                }
            break;
