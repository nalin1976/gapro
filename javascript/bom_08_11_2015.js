...
//		}
		...
		if (document.getElementById('handoverDD').value != null && document.getElementById('handoverDD').value  != "" )
			{
...
//		}
		...
		row.innerHTML = "<td><img src=\"images/del.png\" alt=\"del\" width=\"15\" height=\"15\" border=\"0\" class=\"mouseover\" onclick=\"RemovePONumberFromGrid(this);\" /></td>" +
                       ...
                       "<td class=\"normalfnt\">" + estimatedDD + "</td>"+
					   "<td class=\"normalfnt\">" + handoverDD + "</td>"+
	...
	if(ValidateBPOSaving())
	{
		...
		var obj = $.ajax({url:url,async:false})
					...
					for (var loop = 1 ; loop < tbl.rows.length ; loop ++ )
					{
						...
						var url2 = 'preordermiddletire.php?RequestType=AddDeliveryBPO&styleID=' + URLEncode(StyleNo) + '&buyerPO=' + URLEncode(buyerPO) + '&bpoQty=' + bpoQty + '&bpoLeadTime=' + bpoLeadTime + '&bpoDelivery=' + bpoDelivery + '&bpoEstimate=' + bpoEstimate + '&bpoHandover=' + bpoHandover + '&bpoShipMode=' + bpoShipMode + '&bpoRemarks=' + URLEncode(bpoRemarks) + '&bpoCountry=' + URLEncode(bpoCountry) /*+ '&bpoRefNo=' +bpoRefNo+'&handOverDate='+handOverDate*/;
...
{	
	...
	drawPopupBox(820,496,'frmstylewise',1);
