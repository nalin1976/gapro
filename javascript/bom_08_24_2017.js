...
function RemovePONumberFromGrid(obj)
{
	...
	document.getElementById('dtmPcd').value 		= tr.cells[8].textContent;
	document.getElementById('cboShippingMode').value 	= tr.cells[9].id;
	document.getElementById('txtremarks').value 		= tr.cells[10].textContent;	
	document.getElementById('cmbDeliveryStatus').value 	= tr.cells[11].id;
	document.getElementById('dtCutOff').value 		= tr.cells[12].textContent;
        
        // Check 

	
	$("#cboPreviousBPO").val("-1");
	$("#hndShipStatus").val(tr.cells[13].textContent);
	$("#cmbProductionLocation").val(tr.cells[14].id);
	$("#hndOldBuyerPo").val(tr.cells[15].textContent);

//alert(tr.cells[17].textContent);
	if(tr.cells[17].textContent == '1')
		$("#chkShortShipped").attr("checked", true);
	else
		$("#chkShortShipped").attr("checked", false);
	...
	var dtmPcd = tr.cells[8].textContent;
	var shipMod = tr.cells[9].textContent;
	var rmarks  = tr.cells[10].textContent;
...
{	
	...
	drawPopupBox(1090,670,'frmstylewise',1);
