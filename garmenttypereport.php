...
<thead style="height:25px">
  <tr>
     <td colspan="5" class="normalfnt2bldBLACKmid">Garmenttype Report</td>
  </tr>
      <tr>
	  <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b> Garment Id</b></font></td>
	  <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b>Garment Name</b></font></td>
      ...
      <td class='normalfntBtab' align="center"><font  style='font-size: 9px;' ><b>Active</b></font></td>
	   ...
	   <?php
		...
		$SQL="SELECT * FROM was_garmenttype where intStatus !='10' order by strGarmentName asc"; 
