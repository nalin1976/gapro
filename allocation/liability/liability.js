...
function ClearForm()
{
	...
	RestricInterface(0);
	var url = 'liabilitydb.php?RequestType=ReloadAllocationNo';
...
function LoadDetails(obj)
{
	...
	var url = 'liabilitydb.php?RequestType=LoadDetails&no='+obj;
	htmlobj=$.ajax({url:url,async:false});
...
function LoadJobNo()
{
	...
	if (No=="")
	{
		var url = 'liabilitydb.php?RequestType=LoadNo';
		htmlobj=$.ajax({url:url,async:false});
...
function Save()
{
	...
	var url = 'liabilitydb.php?RequestType=SaveHeader&no=' +pub_No+ '&year=' +pub_Year+ '&remarks=' +URLEncode(remarks);
	htmlobj=$.ajax({url:url,async:false});
	...
	var url = 'liabilitydb.php?RequestType=SaveDetails&no=' +pub_No+ '&year=' +pub_Year+ '&styleId=' +styleId+ '&buyerPoNo=' +URLEncode(buyerPoNo)+ '&matDetailId=' +matDetailId+ '&color=' +URLEncode(color)+ '&size=' +URLEncode(size)+ '&units=' +units+ '&qty=' +qty+ '&grnNo='+grnNo+ '&grnType='+grnType;
	htmlobj=$.ajax({url:url,async:false});
...
{	
	var url = 'liabilitydb.php?RequestType=SaveValidate&no=' +pub_No+ '&year=' +pub_Year+ '&validateCount=' +pub_validateCount+ '&validateBinCount=' +pub_validateBinCount;
	htmlobj=$.ajax({url:url,async:false});
...
function LoadPopUpNo()
{
    ...
    var url = 'liabilitydb.php?RequestType=LoadPopNo&state='+state+'&year='+year;
    htmlobj=$.ajax({url:url,async:false});
...
{
    var url = 'liabilitydb.php?RequestType=LoadHeaderDetails&no='+obj;
  	htmlobj=$.ajax({url:url,async:false});
...
function Cancel()
{
	...
	showBackGroundBalck();
    var url = 'liabilitydb.php?RequestType=Cancel&no='+no +'&reason='+URLEncode(reason);
    htmlobj=$.ajax({url:url,async:false});
...
function loadStoreDetails()
{
	...
	if(mainstoreID != '')
	{
		var url = "liabilitydb.php?RequestType=getCommonBin";
