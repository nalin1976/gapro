...
<title>GaPro | Allocation - Left Over</title>
...
<table width="950" border="0" align="center" class="tableBorder">
  ...
  <tr>
    <td height="26" class="mainHeading">Allocation - Left Over</td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="1">&nbsp;</td>
        <td width="159" class="normalfnt">Left Over   No</td>
  ...
  <tr >
    <td height="30"><table width="100%" border="0" class="tableBorder">
      <tr>
        ...
        <?php if($PP_CancelLeftOverAllocation) {?>
...
var cancelLeftAllo = "<?php echo $PP_CancelLeftOverAllocation ?>";
</script>
</body>
</html>
