...
var totInputQty=0;
var ArrRemarks ="";
var pub_url = "/gaprohela/production/lineInput/";
var pub_styleId	= "";
//-----------------------------------------------------------
...
function HandleLoadEventsforLeadTime1(xmlHttp3)
{
	...
	var XMLColor =xmlHttp3.responseXML.getElementsByTagName("color");
	var tableText = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"1\" id=\"tblevents\" border=\"0\">"+
					"<tr>"+
					"<td width=\"10%\" height=\"25\" bgcolor=\"#498CC2\" class=\"grid_header\">Size</td>"+
					"<td width=\"8%\" bgcolor=\"#498CC2\" class=\"grid_header\">Bundle No</td>"+
					"<td width=\"10%\" bgcolor=\"#498CC2\" class=\"grid_header\">Range</td>"+
					"<td width=\"13%\" bgcolor=\"#498CC2\" class=\"grid_header\">Shade</td>"+
					"<td width=\"10%\" bgcolor=\"#498CC2\" class=\"grid_header\">Bal Qty</td>"+
