...
<script src="finish_line.js"></script>
...
<div class="main_bottom_center">
	<div class="main_top">
		<div class="main_text">Finish Line<span class="vol"></span></div>
	</div>
	<div class="main_body">
...
<select name="cboStyle" class="txtbox" id="cboStyle" style="width:203px" onchange="loadColors(this.value)">
		...
		$SQL="	SELECT DISTINCT o.intStyleId,o.strStyle 
 	    ...
 	    ?>
			...
			<td width="123"><input style="width: 100px;" class="txtbox" type="text" id="txtFinishLineID" name="txtFinishLineID" readonly=""></td> 
...
<input type="hidden" name="txtYear" id="txtYear" value="<?php echo date(Y); ?>" /><input type="hidden" name="txtUser" id="txtUser" value="<?php echo $_SESSION["UserID"] ?>" />	</td> 
	...
	<table width="658">
		<tr>
			...
			<td width="13%"><img src="../../images/save.png" alt="Save" name="Save" onclick="saveFinishLine()"></td>
