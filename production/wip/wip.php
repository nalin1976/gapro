...
function viewReport()
{
	...
	var shipCutRatioPercent = document.getElementById("shipCutRatioPercent").value;
	
	//alert(shipCutRatioPercent);
	
	if(document.getElementById("allOrders").checked)
	{
		var rdoOrder="allOrders";
	}
	else 
		var rdoOrder="afterCut";
		
	//alert(rdoOrder);
	
	var reportName = "wipReport_final.php";	
	var url  = reportName+"?txtDfrom="+txtDfrom+"&txtDto="+txtDto+"&companyId="+companyId+"&checkDate="+checkDate+"&PONo="+PONo+"&ReportType="+ReportType+"&style="+style+"&buyer="+buyer+"&division="+division+"&season="+season+"&rdoOrder="+rdoOrder+"&shipCutRatioPercent="+shipCutRatioPercent;
	
	window.open(url,reportName);	
}

function viewReportSimple()
{
	var ReportType = "N";
	var checkDate 	= document.getElementById("checkDate").checked;
	var txtDfrom  	= document.getElementById("txtDfrom").value;
	...
	var reportName = "wipReport_finalSimple.php";	
	var url  = reportName+"?txtDfrom="+txtDfrom+"&txtDto="+txtDto+"&companyId="+companyId+"&checkDate="+checkDate+"&PONo="+PONo+"&ReportType="+ReportType+"&style="+style+"&buyer="+buyer+"&division="+division+"&season="+season+"&rdoOrder="+rdoOrder+"&shipCutRatioPercent="+shipCutRatioPercent;
      ...
      <tr>
                      ...
                      <td class="normalfnt"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          <tr>
                            <td colspan="5" height="15"><fieldset class="roundedCorners" >
                              <legend class="legendHeader">&nbsp;Delivery Date&nbsp;</legend> 
                          ...
                          <tr>
                            <td colspan="5" height="15"><fieldset class="roundedCorners" >                             
                              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                  <td width="37" class="normalfntMid"><input name="radio" type="radio" id="allOrders" value="allOrders" checked="checked" />                                    <label for="radio"></label></td>
                                  <td width="101">All Orders</td>
                                 
                                  <td width="25"><span class="normalfntMid">
                                    <input type="radio" name="radio" id="afterCut" value="afterCut" />
                                  </span></td>
                                  <td width="380">After Cut</td>
		...
		?>
                        ...
                        <tr >
                          <td >&nbsp;</td>
                          <td >(Ship/Cut)%</td>
                          <td colspan="3" ><input name="shipCutRatioPercent" type="text" id="shipCutRatioPercent" style="width:90px;" onkeypress="return IsNumberWithoutDecimals(this.value,event);" value="97"/></td>
                        </tr>
                ...
                <td width="100%" bgcolor="#FFFFFF"><table width="100%" border="0">
                    <tr>
                      ...
                      <img src="../../images/new.png" alt="new" onclick="ClearForm();"/>
                     	<img src="../../images/report.png" alt="Report" name="Delete"  border="0" class="mouseover" onclick="viewReport();viewReportSimple();"/><img src="../../images/download.png"  border="0" onclick="ShowExcelReport();" />
