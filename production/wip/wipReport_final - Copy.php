    ...
    <td class=" main-border"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td><table  width="100%" cellspacing="1" cellpadding="5"  bgcolor="#D0D7E5" id="tblMain2" class="fixHeader">
          <thead>
            <tr bgcolor="#D9E2EE">
              <th  height="25" colspan="10" nowrap="nowrap" class="normalfntMid">Order</th>
              ...
              <th colspan="10" nowrap="nowrap" class="normalfntMid washing" style="background:#FFC666" id='group_washing'>Washing</th>
              <th nowrap="nowrap" class="normalfntMid qc_unhide" style="background:#CCC0D9">Finishing</th>
              <th colspan="4" nowrap="nowrap" class="normalfntMid qc" style="background:#CCC0D9" id="group_qc">Finishing</th>
              <th nowrap="nowrap" class="normalfntMid packing_unhide" style="background:
#e6bdf3">Packing</th>
              <th colspan="3" nowrap="nowrap" class="normalfntMid packing" style="background:
#e6bdf3" id="group_packing">Packing</th>
			...
			<th nowrap="nowrap" class="normalfntMid atYard_unhide" style="background:#F5AA78">At Yard</th>
			  <th nowrap="nowrap" class="normalfntMid shipping_unhide" style="background:#41E0DA">Com. Invoice</th>
              <th colspan="2" nowrap="nowrap" class="normalfntMid shipping" style="background:#41E0DA" id='group_shipping'>Com. Invoice</th>
            ...
            <tr bgcolor="#9EB6CE">
              ...
              <th  class="normalfntMid washing-sub washing" nowrap="nowrap">Return</th>
              <th  class="normalfntMid washing-sub washing" nowrap="nowrap">R-Received</th>
              <th  class="normalfntMid washing-sub washing" nowrap="nowrap">Variance</th>
              <th  class="normalfntMid washing-sub washing" nowrap="nowrap">QC Check</th>
              ...
              <th  class="normalfntMid washing-sub washing" nowrap="nowrap">Finishing Out</th>
              ...
              <th nowrap="nowrap"  class="normalfntMid qc-sub qc">Received</th>
              <th nowrap="nowrap"  class="normalfntMid qc-sub qc">Return</th>
              <th  class="normalfntMid qc-sub qc" nowrap="nowrap">Packing Out</th>
              ...
              <th nowrap="nowrap"  class="normalfntMid atYard-sub atYard_unhide" style="background-color:#E08141">Un-hide</th>
          ...
          <tbody class="ctbody1">
		   ...
		   $sql ="select comp.strName,
					...
					intWashSubIn,
					--intPackQty,
					(SELECT qty FROM wip_packing wp where pwip.intStyleId=wp.intStyleId) as intPackQty,
					FabricCostPerPCS,
					...
					WashingCostPerPCS,
					intShipped,
					UDW.dblWetQty as WetQty,
					UDW.dblDryQty as DryQty,
					UWW.dblWashIn,
					UWW.dblQCcheck,
					UWW.dblIssuedToFinishing,
					pwip.intFinishIn,
					pwip.intFinishOut,
...
group by DS.intStyleId) as deldate
					...
					left join update_wip_washing UWW on UWW.intStyleId=ordr.intStyleId
					left join upload_dry_wet UDW on UDW.intStyleId=pwip.intStyleId
		...
		while($row=mysql_fetch_array($result))
		{
			...
			//$cutShip=round(($row["intShipped"]/$row["intCutQty"])*100,0);
			//$orderShip=round(($row["intShipped"]/$row["intQty"])*100,0);
        ...
        ?>
            <tr bgcolor="<?php echo ($shipCutRatioPercent<=$cutShip?'#EDFFCC':'#FFFFFF')?>" class="trclass">
              ...
              <td  nowrap="nowrap"  class="normalfntRite cutting-fnt cutting"><a style="color:#000;text-decoration:underline" href="../../Reports/production/cutqtyrpt.php?orderNo=<?php echo $row['intStyleId'];?>" target="productDetailRpt.php"><?php echo number_format($row["intCutQty"],0); ?></a></td>
              <td  nowrap="nowrap"  style="color:#000" class="normalfntRite cutting-fnt cutting"><?php echo number_format($row["intCutIssueQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt cutting"><?php echo $cutnonbal=getNonVal($styleid,1);?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt cutting"><?php echo ($Cuttingbalance>=0?number_format($Cuttingbalance-$cutnonbal,0):'['.number_format($cutnonbal-$Cuttingbalance,0).']') ?></td>
              
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing_unhide"><?php echo number_format($row["intOutPutQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo number_format($row["intCutReceiveQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo number_format($row["intCutReturnQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo number_format($row["intCutIssueQty"]-$row["intCutReceiveQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo number_format($row["intInputQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo ($factoryCuttingBlance>=0?number_format($factoryCuttingBlance,0):'['.number_format(($row["intInputQty"]-$row["intCutReceiveQty"]),0).']')?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php echo number_format($cutRate,4); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite cutting-fnt sawing"><?php $faccutvalue=$factoryCuttingBlance*$cutRate;$cutvalue=$Cuttingbalance*$cutRate; echo number_format(($faccutvalue+$cutvalue),4);?></td>
              <td  nowrap="nowrap" style="color:#000"  class="normalfntRite sawing-fnt sawing"><?php echo number_format($row["intInputQty"],0); ?></td>
              
              <td  class="normalfntRite sawing-fnt sawing" style="color:#000" nowrap="nowrap"><?php echo number_format($row["intOutPutQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo number_format($inOutBal,0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo number_format($row["intWashReady"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo number_format($row["intFGgatePass"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo $sewnonbal=getNonVal($styleid,'2');?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing">
			  <?php 
			  $sewing_bal=$row["intWashReady"]-$row["intFGgatePass"]-$sewnonbal;			  
			  echo ($sewing_bal>=0?number_format($sewing_bal,0):'['.number_format(-$sewing_bal,0).']');			  
			 ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo $sewingRate?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite sawing-fnt sawing"><?php echo number_format($sewingRate*$sewing_bal,2);?></td>
              <td  nowrap="nowrap" style="color:#000"  class="normalfntRite washing-fnt washing_unhide"><?php echo number_format($row["WetQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000"  class="normalfntRite washing-fnt washing"><?php echo number_format($row["dblWashIn"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing"><?php echo number_format($row["intFGReturnsBeforeWash"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing">0</td>
              <td  class="normalfntRite washing-fnt washing" style="color:#000" nowrap="nowrap"><?php echo number_format($row["intFGgatePass"]-$row["dblWashIn"],0); ?></td>
              <td  class="normalfntRite washing-fnt washing" style="color:#000" nowrap="nowrap"><?php echo number_format($row["dblQCcheck"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing">0</td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing"><?php echo number_format($row["intWashSubOut"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000"  class="normalfntRite washing-fnt washing"><?php echo number_format($row["intWashSubIn"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing"><?php echo number_format($row["dblIssuedToFinishing"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite washing-fnt washing"><?php echo number_format($row["dblWashIn"]-$row["dblIssuedToFinishing"],0); ?></td>
              <td  nowrap="nowrap " style="color:#000" class="normalfntRite qc-fnt qc_unhide"><?php echo number_format($row["intFinishOut"],0); ?></td>
              <td  nowrap="nowrap " style="color:#000" class="normalfntRite qc-fnt qc"><?php echo number_format($row["intFinishIn"],0); ?></td>
              <td  nowrap="nowrap " style="color:#000" class="normalfntRite qc-fnt qc">0</td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite qc-fnt qc"><?php echo number_format($row["intFinishOut"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite qc-fnt qc"><?php echo number_format($row["intFinishIn"]-$row["intFinishOut"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite packing-fnt packing_unhide"><?php echo number_format($row["intPackQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite packing-fnt packing "><?php echo number_format($row["intPackQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite packing-fnt packing"><?php echo number_format($row["intExpGatepassQty"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite packing-fnt packing"><?php echo number_format($row["intPackQty"]-$row["intExpGatepassQty"],0); ?></td>
              ...
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite atYard-fnt  atYard_unhide"><?php echo (($row["intExpGatepassQty"]-$row["intShipped"])>=0?number_format($row["intExpGatepassQty"]-$row["intShipped"],0):'['.number_format($row["intShipped"]-$row["intExpGatepassQty"],0).']');?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite shipping-fnt  shipping_unhide"><?php echo number_format($row["intShipped"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite shipping-fnt shipping"><?php echo number_format($row["intShipped"],0); ?></td>
              <td  nowrap="nowrap" style="color:#000" class="normalfntRite shipping-fnt shipping">0</td>
		...
		?>
            <tr bgcolor="#FFFFFF" style="display:none">
              ...
              <td  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="4"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td  class="normalfntRite"  nowrap="nowrap">&nbsp;</td>
              <td colspan="2"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="2"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="1"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="1"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="3"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="2"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
              <td colspan="12"  nowrap="nowrap"  class="normalfntRite">&nbsp;</td>
            </tr>
