...
function HandleLoadGrid()
{
	...
	//	alert(xmlHttpreq[4].responseText);
			...
			var XMLColor = xmlHttpreq[4].responseXML.getElementsByTagName("color");
			...
			var tableText = "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"1\" id=\"tblevents\" border=\"0\">"+
                                "<tr>"+
								  ...
								  "<td width=\"12%\" class=\"grid_header\">Color</td>"+
								  "</tr>";
			...
			totOutputQty=0;
			 for ( var loop = 0; loop < XMLSize.length; loop ++)
			 {
				...
				tableText +=" <tr class=\"" + rowClass + "\">" +
							...
							" <td class=\"normalfntRite\" align=\"left\" id=\"" + XMLColor[loop].childNodes[0].nodeValue + "\" > "+ XMLColor[loop].childNodes[0].nodeValue +"&nbsp;</td>"+
							" </tr>";
