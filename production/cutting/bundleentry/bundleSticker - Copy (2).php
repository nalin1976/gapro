    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="stickerfnt">
     <tr>
	  ...
	  <tr>
        ...
        <td height="10" colspan="2" align="center" > <div style="height:30px;width:200px; overflow:hidden;">
 <img  src="barimg.php?id=<?php echo $row_detail["dblRefNo"]; ?>" border="0" alt="test" cellspacing="0" cellpadding="0"  /></div>	</td>
	    </tr>
