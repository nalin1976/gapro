...
$serial_no			= $serial_array[1];
$serial_year		= $serial_array[0];
   ...
   <tr>
     ...
     <thead>
	  ...
	  $str_details="select 	gpd.intGPnumber, 
					...
					pbh.strCutNo
					from 
					productiongpdetail gpd 
					inner join productionbundledetails pbd on pbd.intCutBundleSerial = gpd.intCutBundleSerial and pbd.dblBundleNo = gpd.dblBundleNo 
					inner join productionbundleheader pbh on pbh.intCutBundleSerial = gpd.intCutBundleSerial 
