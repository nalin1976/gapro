...
<title>Factory/Gate Pss-[PO wise]</title>
<link rel="stylesheet" type="text/css" href="../../javascript/calendar/theme.css" />
<script src="../../javascript/calendar/calendar.js" type="text/javascript"></script>
<script src="../../javascript/calendar/calendar-en.js" type="text/javascript"></script>
<link href="../../css/erpstyle.css" rel="stylesheet" type="text/css" />
<script src="../../javascript/script.js" type="text/javascript"></script>
<script src="../factoryGatepasses/factoryGatepass.js" type="text/javascript"></script>
<!--03-08-2011 //lasantha. New js file for cancel gpdetails-->
<script src="../factoryGatepasses/fgfactoryGP_js.js" type="text/javascript"></script>
                ...
                <tr>
                  ...
                  <td colspan="3"><select name="cboToFactory"  id="cboToFactory" class="txtbox" style="width:505px">
                    <?php //WHERE intManufacturing=1
						$SQL = "SELECT	intCompanyID,strName,companies.strCity FROM companies  ORDER BY strName ASC";
						$result = $db->RunQuery($SQL);
...
O.strOrderNo 
FROM
productionwashreadyheader PWRH
...
inner join orders O ON PWRH.intStyleId = O.intStyleId
WHERE PWRH.intFactory = '".$_SESSION["FactoryID"]."' 
and PWRD.dblBalQty>0
group by PWRH.intStyleId 
...
?>
			      ...
			      <td colspan="2" rowspan="3" class="normalfnt" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
			        <tr>
			          <td width="26%"><span class="normalfntRite">Style</span></td>
			          <td width="74%"><select name="cboStyle" id="cboStyle" class="txtbox" style="width:200px" onchange="loadStylePoNoGrids(this.value);">
			            <?php
			        ...
			        <tr>
			          <td>Remarks</td>
			          <td rowspan="2"><textarea name="txtareaRemaks" id="txtareaRemaks" cols="22" rows="2"></textarea></td>
			          </tr>
			        <tr>
			          <td>&nbsp;</td>
			          </tr>
			  ...
			  <td width="15%"></td>
			  <td width="15%"></td>
			  <td width="40%"><div id="divTable1" style="overflow:scroll; height:100px; width:300px;">
			  ...
			  <tr>
              <td height="17" colspan="5"><table width="100%" border="0">
			  <tr>
			  <td colspan="5" class="normalfnt" align="right"></td>
			  </tr>
			  <tr>
                  ...
                  <tr class="bcgl1">
                    <td bgcolor=""><table width="100%" border="0" class="tableFooter">
						...
						<td align="center">                       
                          ...
                          <img src="../../images/save.png" id="butSave" alt="Save"  class="mouseover"  onclick="SaveFinishGoodGPData();"/>
                          <img src="../../images/cancel.jpg" id="btnCancel" alt="Cancel" class="mouseover" onclick="cancelGatepass();" style="display:none;" />
						  <img src="../../images/report.png" alt="Report"  class="mouseover"  onclick="ViewReport();"/>
                          <a href="../../main.php"/><img src="../../images/close.png" alt="close"   border="0" class="normalfntMid" /></a>                        </td></tr>
                    </table></td>
                  </tr>
              </table></td>
            </tr>
