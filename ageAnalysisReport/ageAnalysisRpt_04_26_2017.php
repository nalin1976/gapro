...
INNER JOIN materialratio ON stocktransactions.intStyleId = materialratio.intStyleId
AND stocktransactions.strBuyerPoNo = materialratio.strBuyerPONO
AND stocktransactions.intMatDetailId = materialratio.strMatDetailID
AND stocktransactions.strColor = materialratio.strColor
AND stocktransactions.strSize = materialratio.strSize
...
INNER JOIN materialratio ON stocktransactions_history.intStyleId = materialratio.intStyleId
AND stocktransactions_history.strBuyerPoNo = materialratio.strBuyerPONO
AND stocktransactions_history.intMatDetailId = materialratio.strMatDetailID
AND stocktransactions_history.strColor = materialratio.strColor
AND stocktransactions_history.strSize = materialratio.strSize
				...
				while($row = mysql_fetch_array($result))
					{
						...
						$matDetailID = $row["intMatDetailId"];
												...
												$materialRatioID = $row["materialRatioID"];
...
//$bulkVal12 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size);
  ...
  ?></td>
			...
			$totStockValS += $totVal12;
			 ...
			 ?></td>
             <td class="normalfntRite"><?php echo $materialRatioID; ?></td>
          </tr>
          <?php 
			}
		  }
