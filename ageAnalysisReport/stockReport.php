      ...
      <tr>
        ...
        <table width="500" border="0" cellspacing="0" cellpadding="2" class="normalfnt">
          ...
          <tr>
            ...
            <td><select name="cboOrderStatus" id="cboOrderStatus" style="width:320px;">
          ...
          <tr>
            <td style="padding-left:20px">Item Listing</td>
            <td><select name="cboItemListing" id="cboItemListing" style="width:320px;">
                    <option value="1">WITH OUT BUYER PO</option>
                    <option value="2">WITH BUYER PO</option>
                </select>
            </td>
          </tr>
        </table></td>
