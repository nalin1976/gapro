...
where stocktransactions.strMainStoresID>0 ";
    ...
    $sql .= " group by intSRNO, strItemDescription, stocktransactions.strBuyerPoNo ) A" ;
...
where stocktransactions_history.strMainStoresID>0";
    if($mainStores != '')
		...
		if($txtmatItem!='')
			$sql .=" and matitemlist.strItemDescription like '%$txtmatItem%' ";
    $sql .= " group by intSRNO, strItemDescription, stocktransactions_history.strBuyerPoNo ) B" ;
