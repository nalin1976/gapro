...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><table width="1050" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="1658" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000">
          <tr bgcolor="#CCCCCC" class="normalfntMid">
            <th width="149" >Order No</th>
            <th width="149" >Style</th>
            <th width="149" >Style Description</th>
            <th width="149" >Item Category</th>
		  ...
		  $sqlOrders = "SELECT intStyleId, strOrderNo, strStyle, strDescription FROM orders WHERE intStatus=11 ";
		  $resOrders = $db->RunQuery($sqlOrders);
		  
		 while($rowOrders = mysql_fetch_array($resOrders))
		 {
			$styleId = $rowOrders['intStyleId'];
			$orderNo = $rowOrders['strOrderNo'];
			$style   = $rowOrders['strStyle'];
			$styleDesc = $rowOrders['strDescription'];
			
			
			?>
            <tr bgcolor="#FFFFFF">
              <td class="normalfnt" nowrap="nowrap"><?php echo $orderNo; ?></td>
              <td class="normalfnt" nowrap="nowrap"><?php echo $style; ?></td>
              <td class="normalfnt" nowrap="nowrap"><?php echo $styleDesc; ?></td>
              <td class="normalfnt" nowrap="nowrap">&nbsp;</td>
              <td class="normalfnt" nowrap="nowrap" height="20">&nbsp;</td>
...
$bulkGRNstockQty30 = getStock30daysBulkQty('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size,$styleId);
$bulkGRNstockQty30 = 0;
...
$bulkGRNstockVal30 = getStockBulkValue('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockVal30 = 0;	
...
$bulkGRNstockQty60 = getStock30daysBulkQty('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size,$styleId);
		$bulkGRNstockQty60 = 0;
...
$bulkGRNstockVal60 = getStockBulkValue('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockVal60 = 0;
...
$bulkGRNstockQty90 = getStock30daysBulkQty('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockQty90 = 0;	
...
$bulkGRNstockVal90 = getStockBulkValue('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockVal90 = 0;	
...
$bulkGRNstockQty120 = getStock30daysBulkQty('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size,$styleId);
...
$bulkGRNstockVal120 = getStockBulkValue('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size,$styleId);
...
$bulkGRNstockQty12 = getStock30daysBulkQty('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockQty12 = 0;
...
$bulkGRNstockVal12 = getStockBulkValue('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$styleId);
	$bulkGRNstockVal12 = 0;
  ...
  ?></td>
		  ...
		  ?>
           <tr bgcolor="#EBEBEB" class="normalfntRite">
            <td class="normalfntMid" nowrap="nowrap" height="20" colspan="6"><b>Grand Total</b></td>
...
function getStock30daysBulkQty($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$styleId)
{
	global $db;
...
where st.intMatDetailId=$matDetailID and bulkpurchaseorderheader.strBulkPOType!='1' and st.strGRNType='B' and st.intStyleId=$styleId  ";
	if($dayFrom == '120')
			$sql .= " and (TO_DAYS('$tdate')-TO_DAYS(gh.dtmConfirmedDate) > $dayFrom  )";
		else
			$sql .= " and (TO_DAYS('$tdate')-TO_DAYS(gh.dtmConfirmedDate) between $dayFrom and $dayTo )";
...
function getStockBulkValue($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$styleId)
{
	global $db;
