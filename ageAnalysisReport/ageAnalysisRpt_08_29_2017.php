...
//$bulkVal12 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size);
	$bulkVal12 = 0;		
			...
			{	
                            ...
                            $rsGRNQty = getGRNQty($row['intStyleId'], $row["intMatDetailId"], $row["strBuyerPoNo"],$mainStores);
...
function getGRNQty($styleId, $itemId, $buyerPO, $mainStoresId){
    ...
    $sql = " SELECT round(SUM(stocktransactions.dblQty),2) AS GRN_Qty,
             ...
             WHERE stocktransactions.intStyleId = '$styleId' AND stocktransactions.intMatDetailId = '$itemId' AND
                   stocktransactions.strBuyerPoNo = '$buyerPO' AND stocktransactions.strType = 'GRN'";
