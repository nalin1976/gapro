...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        <td><table width="1050" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000">
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <?php 
				# ==============================================================================
				# Get quantities older between days 1 to 30
				# ==============================================================================
				$sql30 = "select  sum(GST.dblQty) as qty 
						...
						if($qty30>=0){
						  echo	"<td class='normalfntRite'>".number_format($qty30,2)."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".number_format($qty30,2)."</td>";	
						}
			?>
            <!--</td>-->
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				# ==============================================================================
				# Get quantities older between days 31 to 60
				# ==============================================================================
				$sql60 = "select  sum(GST.dblQty) as qty 
						...
						if($qty60>=0){
						  echo	"<td class='normalfntRite'>".number_format($qty60,2)."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".number_format($qty60,2)."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--> <?php 
				# ==============================================================================
				# Get quantities older between days 61 to 90
				# ==============================================================================
				$sql90 = "select  sum(GST.dblQty) as qty 
						...
						//echo $qty90;
						if($qty90>=0){
						  echo	"<td class='normalfntRite'>".number_format($qty90,2)."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".number_format($qty90,2)."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				# ==============================================================================
				# Get quantities older between days 91 to 120
				# ==============================================================================
				$sql120 = "select  sum(GST.dblQty) as qty 
						...
						if($qty120>=0){
						  echo	"<td class='normalfntRite'>".number_format($qty120,2)."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".number_format($qty120,2)."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				# ==============================================================================
				# Get quantities old more than 120 days
				# ==============================================================================
				$sqlStock = "select  sum(GST.dblQty) as qty 
						...
						if($qtyS>=0){
						  echo	"<td class='normalfntRite'>".number_format($qtyS,2)."</td>";	
						}else{
							echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".number_format($qtyS,2)."</td>";	
						}
