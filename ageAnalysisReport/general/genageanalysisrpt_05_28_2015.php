          ...
          <tr bgcolor="#FFFFFF">
            ...
            <?php 
				$sql30 = "select  sum(GST.dblQty) as qty 
						...
						if($qty30>=0){
						  echo	"<td class='normalfntRite'>".$qty30."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".$qty30."</td>";	
						}
			?>
            <!--</td>-->
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				$sql60 = "select  sum(GST.dblQty) as qty 
						...
						if($qty60>=0){
						  echo	"<td class='normalfntRite'>".$qty60."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".$qty60."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--> <?php 
				$sql90 = "select  sum(GST.dblQty) as qty 
						...
						//echo $qty90;
						if($qty90>=0){
						  echo	"<td class='normalfntRite'>".$qty90."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".$qty90."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				$sql120 = "select  sum(GST.dblQty) as qty 
						...
						if($qty120>=0){
						  echo	"<td class='normalfntRite'>".$qty120."</td>";	
						}else{
						  echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".$qty120."</td>";	
						}
  ...
  ?></td>
            <!--<td class="normalfntRite">--><?php 
				$sqlStock = "select  sum(GST.dblQty) as qty 
						...
						if($qtyS>=0){
						  echo	"<td class='normalfntRite'>".$qtyS."</td>";	
						}else{
							echo	"<td class='normalfntRite' style='color:#FF0000; background-color:#0066FF;'>".$qtyS."</td>";	
						}
