...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        <td><table width="1050" border="0" cellspacing="1" cellpadding="1" bgcolor="#000000">
          <tr bgcolor="#FFFFFF">
            ...
            <td width="60" class="normalfnBLD1" align="center">1-30</td>
		  ...
		  $sql = " select GMT.strItemDescription, GMT.strUnit,GST.intMatDetailId
  ...
  ?></td>
            <td class="normalfntRite"><?php echo $totQty;
			$totQty =0;
			 ?></td>
