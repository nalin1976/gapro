    ...
    <td><table width="1050" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		?>
         ...
         <tr bgcolor="#CCCCCC" class="normalfntMid">
            <td  height="23" colspan="21" ><b><?php echo $rowMainCat['strDescription']; ?></b></td>
            </tr>
...
(select stt.intMatDetailId from stocktransactions stt inner join matitemlist mil on mil.intItemSerial= stt.intMatDetailId
 ...
 //echo $sql;
		  ...
		  ?>
          <?php 
$styleGRNstockQty30 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
$styleGRNleftQty30 =getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
//$bulkQty30 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size);
			...
			?>
            <?php 
			$styleGRNstockVal30 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$tempVal30 = 0;
$styleGRNleftVal30 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftVal30 = 0;
...
//$bulkVal30 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty60 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
$styleGRNleftQty60 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftQty60 = 0;
...
//$bulkQty60 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size);
			...
			?>
          <?php 
			$styleGRNstockVal60 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftVal60 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftVal60 = 0;
...
//$bulkVal60 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty90 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftQty90 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId']);
//$styleGRNleftQty90 = 0;
...
//$bulkQty90 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size);
	...
	$qty90 = $styleGRNstockQty90 + $bulkGRNstockQty90 +$tempQty90 + $styleGRNleftQty90 +$bulkGRNleftQty90 +$bulkQty90;
			...
			?>
            <?php 
			$styleGRNstockVal90 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftVal90 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftVal90 = 0;
...
//$bulkVal90 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty120 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
$styleGRNleftQty120 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
//$bulkQty120 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size);
	$bulkQty120 = 0;
		$qty120 =$styleGRNstockQty120 +$bulkGRNstockQty120+$tempQty120+$styleGRNleftQty120+$bulkGRNleftQty120+$bulkQty120;			
			...
			?>
            <?php 
			$styleGRNstockVal120 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftVal120 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId']);
...
//$bulkVal120 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty12 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftQty12 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftQty12 = 0;
...
$totRowQty1 += $qtyS;
			...
			?>
            <?php 
			$styleGRNstockVal12 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$row['intStyleId']);
...
$styleGRNleftVal12 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size, $row['intStyleId']);
//$styleGRNleftVal12 = 0;
...
//$bulkVal12 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size);
  ...
  ?></td>
          ...
          <tr bgcolor="#EBEBEB" class="normalfntRite">
               <td class="normalfntMid" nowrap="nowrap" height="20" colspan="2"><b><?php echo $rowMainCat['strDescription'] ?> Total</b></td>
...
//get Qty  details ------------------------------
function getStock30daysQty($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$prmStyleId)
{
	global $db;
...
function getStockQtyValue($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$prmStyleId)
{
	global $db;
	if($tbl != 'stocktransactions_bulk')
	{
