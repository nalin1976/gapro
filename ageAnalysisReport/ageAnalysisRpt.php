      ...
      <tr>
        ...
        <thead>
          <tr bgcolor="#CCCCCC" class="normalfntMid">
            ...
            <th width="59" >Unit</th>
            <th width="70" >Total GRN Qty</th>
            <th width="70" >GRN Location</th>
		...
		?>
         ...
         <tr bgcolor="#CCCCCC" class="normalfntMid">
            <td  height="23" colspan="25" ><b><?php echo $rowMainCat['strDescription']; ?></b></td>
            </tr>
...
switch($itemlisting){
    ...
    case "2":
        $sql .= " stocktransactions.strBuyerPoNo,";
        break;
}
...
where stocktransactions.strMainStoresID>0 "; //AND stocktransactions.intStyleId = 3463
		...
		if($txtmatItem!='')
			$sql .=" and matitemlist.strItemDescription like '%$txtmatItem%' ";
                ...
                switch($orderstatus){
                    case "16":
                        $sql .= " AND orders.intStatus = 16 ";
                        break;
                    case "10":
                        $sql .= " AND orders.intStatus <> 16 ";
                        break;
                }
    $sql .= " group by intSRNO, strItemDescription,";
...
switch($itemlisting){
    ...
    case "2":
        $sql .= " stocktransactions_history.strBuyerPoNo, ";
        break;
}    
...
(select stt.intMatDetailId from stocktransactions stt inner join matitemlist mil on mil.intItemSerial= stt.intMatDetailId
 ...
 //echo $sql;
		  ...
		  ?>
          <?php 
$styleGRNstockQty30 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId'],$row["strBuyerPoNo"],$subStoreID, $itemlisting);
...
$styleGRNleftQty30 =getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID, $itemlisting);
...
//$bulkQty30 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size);
			...
			?>
            <?php 
			$styleGRNstockVal30 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID, $itemlisting);
...
$tempVal30 = 0;
$styleGRNleftVal30 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftVal30 = 0;
...
//$bulkVal30 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],0,30,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty60 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftQty60 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftQty60 = 0;
...
//$bulkQty60 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size);
			...
			?>
          <?php 
			$styleGRNstockVal60 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftVal60 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftVal60 = 0;
...
//$bulkVal60 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],31,60,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty90 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftQty90 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftQty90 = 0;
...
//$bulkQty90 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size);
	...
	$qty90 = $styleGRNstockQty90 + $bulkGRNstockQty90 +$tempQty90 + $styleGRNleftQty90 +$bulkGRNleftQty90 +$bulkQty90;
			...
			?>
            <?php 
			$styleGRNstockVal90 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftVal90 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftVal90 = 0;
...
//$bulkVal90 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],61,90,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty120 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftQty120 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
//$bulkQty120 = getStock30daysQty('stocktransactions_bulk',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size);
	$bulkQty120 = 0;
		$qty120 =$styleGRNstockQty120 +$bulkGRNstockQty120+$tempQty120+$styleGRNleftQty120+$bulkGRNleftQty120+$bulkQty120;			
			...
			?>
            <?php 
			$styleGRNstockVal120 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftVal120 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
//$bulkVal120 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],91,120,$tdate,$mainStores,$color,$size);
  ...
  ?>
  <?php 
$styleGRNstockQty12 = getStock30daysQty('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftQty12 = getStock30daysQty('stocktransactions_history',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftQty12 = 0;
...
$totRowQty1 += $qtyS;
			...
			?>
            <?php 
			$styleGRNstockVal12 = getStockQtyValue('stocktransactions',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size,$row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
...
$styleGRNleftVal12 = getStockQtyValue('stocktransactions_history',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size, $row['intStyleId'], $row["strBuyerPoNo"], $subStoreID,$itemlisting);
//$styleGRNleftVal12 = 0;
...
//$bulkVal12 = getStockQtyValue('stocktransactions_bulk',$row["intMatDetailId"],120,120,$tdate,$mainStores,$color,$size);
	$bulkVal12 = 0;		
			...
			{	
                            ...
                            $intDeliveryQty = GetBuyerPOQty($row["intStyleId"], $row["strBuyerPoNo"], $row["intQty"],$itemlisting);
                            $mainCategory = GetItemType($row["intMainCatID"]);
                            
                            //Get GRN Qty for the item
                            $rsGRNQty = getGRNQty($row['intStyleId'], $row["intMatDetailId"], $row["strBuyerPoNo"],$mainStores,$itemlisting);
                                                        
                            
                            if(mysql_num_rows($rsGRNQty)>1){
                               while($rowGRN = mysql_fetch_array($rsGRNQty)){
                                    $dblGRNQty += $rowGRN["GRN_Qty"];
                                    $strGRNLocation += "/".  $rowGRN["strName"];
                                }
                            }else{
                                while($rowGRN = mysql_fetch_array($rsGRNQty)){
                                    $dblGRNQty = $rowGRN["GRN_Qty"];
  ...
  ?>
          <tr bgcolor="#FFFFFF">
            ...
            <td class="normalfntRite" nowrap="nowrap"><?php echo $dblGRNQty; ?></td>
            <td class="normalfntMid" nowrap="nowrap"><?php echo $strGRNLocation; ?></td>
...
//get Qty  details ------------------------------
function getStock30daysQty($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$prmStyleId, $prmBuyerPO, $prmSubStoreId, $prmItemListing)
{
	global $db;
	if($tbl != 'stocktransactions_bulk')
	{
		...
		where st.intMatDetailId=$matDetailID   and st.strGRNType='S' and st.intStyleId=$prmStyleId  ";
                
                if($prmItemListing == "2"){
                    $sql .= " and st.strBuyerPoNo = '$prmBuyerPO' ";
                }
...
function getStockQtyValue($tbl,$matDetailID,$dayFrom,$dayTo,$tdate,$mainStores,$color,$size,$prmStyleId, $prmBuyerPO, $prmSubStoreId, $prmItemListing)
{
	global $db;
	if($tbl != 'stocktransactions_bulk')
	{
		...
		from $tbl st inner join grnheader gh on gh.intGrnNo=st.intGrnNo 
		 and gh.intGRNYear = st.intGrnYear
		where st.intMatDetailId=$matDetailID and st.intStyleId=$prmStyleId ";
...
function GetBuyerPOQty($prmStyleCode, $prmBuyerPO, $prmOrderQty, $prmItemListing){
    ...
    switch($prmBuyerPO){
        ...
        default:
          $orderQty =  GetRelavantBuyerPOQty($prmStyleCode, $prmBuyerPO, $prmItemListing);
        break;
...
function GetRelavantBuyerPOQty($prmStyleCode, $prmBuyerPO, $prmItemListing){
    ...
    if($prmItemListing == "1"){
        $sql = " SELECT intQty AS dblQty FROM orders WHERE orders.intStyleId = '$prmStyleCode'";
    }else{
...
function getGRNQty($styleId, $itemId, $buyerPO, $mainStoresId,$itemListing){
    
    global $db;
    
    $_dblInQty = 0;
    
    $sql = " SELECT round(SUM(stocktransactions.dblQty),2) AS GRN_Qty,
                    mainstores.strName
             FROM stocktransactions INNER JOIN mainstores ON stocktransactions.strMainStoresID = mainstores.strMainID
             WHERE stocktransactions.intStyleId = '$styleId' AND stocktransactions.intMatDetailId = '$itemId'";
    
    if($itemListing == "2"){
        $sql .= " AND stocktransactions.strBuyerPoNo = '$buyerPO' ";
    }    
        
    $sql .= " AND stocktransactions.strType = 'GRN'";
            //GROUP BY mainstores.strName";
            
            //AND stocktransactions.strMainStoresID = '$mainStoresId'";
    
    
    $result = $db->RunQuery($sql);
    
    /*while($row = mysql_fetch_array($result)){
       $_dblInQty =  $row["GRN_Qty"]; 
    }*/
