              ...
              <form id="frmCostWorkSheet" action="">
					<table width="100%" border="0">
						<tr >
						    ...
						    <td width="31%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtInvFOB" disabled="disabled" /></td>
						</tr>
						<tr>
							<td width="19%" class="normalfnt">Color</td>
						  	<td width="27%" class="normalfnt">
								<select style="width: 152px;" class="txtbox" id="cboColor" disabled="disabled">
									<?php 
						...
						?>
						    ...
						    <td class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtPreorderFob"  disabled="disabled"/></td>
						</tr>
						<tr>
							<td width="19%" class="normalfnt">Style</td>
						  	<td width="27%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtStyle" disabled="disabled" /></td>
						...
						<tr>
							<td width="19%" class="normalfnt">Buyer</td>
						  	<td width="27%" class="normalfnt">
								<select style="width: 152px;" class="txtbox" id="cboBuyer" disabled="disabled">
									<option value=""></option>
									<?php 
						...
						while($row = mysql_fetch_array($result))
						{
						    ...
						    <td class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtCMV" disabled="disabled" /></td>
						</tr>
						<tr>
							<td width="19%" class="normalfnt">Order Qty</td>
						  	<td width="27%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="orderQty" disabled="disabled" /></td>
						...
						<tr>
							...
							<td width="27%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;" id="txtSMV"  disabled="disabled"/></td>
						...
						<tr>
							<td width="19%" class="normalfnt">PCS Per CTN</td>
						  	<td width="27%" class="normalfnt"><input type="text" class="txtbox" style="width:150px;"  id="txtpcsCarton" disabled="disabled" /></td>
						...
						<tr>
							...
							<td  class="normalfnt"><input type="text" class="txtbox" style="width:150px;"  id="txtFobDiff" disabled="disabled" /></td>	
                            <td class="normalfnt"><input type="checkbox" name="chkApproval" id="chkApproval" />
                              Need Apparel Approval</td>
                            <td class="normalfnt">&nbsp;</td>		
						</tr>
						<tr>
						  <td class="normalfnt">Final Destination</td>
						  <td class="normalfnt"><select name="cboConsignee" id="cboConsignee" style="width:152px;" disabled="disabled">
                           <?php 
						   $eshipDB = new eshipLoginDB();
							$sql_Buyer = " select strCityCode,strCountry from country c inner join city ci on ci.strCountryCode = c.strCountryCode
";
							...
							{
								echo "<option value=\"". $rowB["strCityCode"] ."\">" . $rowB["strCountry"] ."</option>" ;
							}
						?>
						    </select>
						  </td>
						  <td colspan="2" class="normalfnt"><input type="hidden" name="invoiceID" id="invoiceID" /></td>
					  </tr>
						<tr>
...
<table style="width:850px"  border="0" cellspacing="1" bgcolor="#C58B8B" class="bcgcolor" >						
						...
						<table style="width:847px"  border="0" cellspacing="1" id="tblItemList" bgcolor="#C58B8B" class="bcgcolor" >
							...
							<thead>
								<!--<tr class="mainHeading4">
								  <th colspan="6">Cost Work Sheet</th>
                                    <th><img src="../../images/additem2.png"  /></th>			
								</tr>	-->
								<tr  class="mainHeading4">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="44%" align="left"><table width="89%" border="0" cellspacing="1" class="main_border_line" >
                          <thead>
                            <!--<tr>
									<td colspan="2">Cost Work Sheet</td>			
								</tr>	-->
                            <tr >
                        ...
                        <td width="56%" valign="top"><table width="91%" border="0">
<tr>
	 ...
	 <!-- <table width="800" border="0">
		      ...
		      <table width="877" border="0" cellspacing="2" cellpadding="0" class="tableFooter">
               <!-- <tr>
                  <td width="25" class="txtbox bcgcolor-InvoiceCostFabric">&nbsp;</td>
                  <td width="115" class="normalfnt">Fabric</td>
                  <td width="25" class="txtbox bcgcolor-InvoiceCostTrim">&nbsp;</td>
                  <td width="115" class="normalfnt">Accessories</td>
                  <td width="25" class="txtbox bcgcolor-InvoiceCostPocketing">&nbsp;</td>
                  <td width="115" class="normalfnt">Hanger</td>
                  <td width="25" class="txtbox bcgcolor-CostWSBelts">&nbsp;</td>
                  <td width="115" class="normalfnt">Belts</td>
                  <td width="25" class="txtbox bcgcolor-InvoiceCostOther">&nbsp;</td>
                  <td width="87" class="normalfnt">Services</td>
                  <td width="25" class="txtbox bcgcolor-InvoiceCostICNA">&nbsp;</td>
                  <td width="95" class="normalfnt">CMPW</td>
                 
                </tr>-->
                <tr>
                 <td width="28" class="txtbox bcgcolor-leftAllo">&nbsp;</td>
                  <td width="182" class="normalfnt">Leftover Allo</td>
                  <td width="30" class="txtbox bcgcolor-interjobAllo">&nbsp;</td>
                  <td width="180" class="normalfnt">Interjob Allo</td>
                  <td width="30" class="txtbox bcgcolor-onlyPreorderItem">&nbsp;</td>
                  <td width="180" class="normalfnt">Not in Inv Cost</td>
                   <td width="27" class="txtbox bcgcolor-InvoiceCostICNA">&nbsp;</td>
                  <td width="200" class="normalfnt">Not Allocated Formula</td>
                </tr>
              </table>
<br />
					<table width="750" border="0" class="tableFooter" align="center">
						<tr>
						  ...
						  <img src="../../images/save.png" width="80" onclick="saveCostWorkSheet();" />
							<img src="../../images/send2app.png" width="171" height="24" style="display:none"; id="butSentApp" onclick="updateShipData();"/><img src="../../images/upload.jpg" id="butUpload" onclick="UploadFile();" />
						    <img src="../../images/download.png" width="115" height="24" onclick="OpenReportPopUp(0);" />
                            <img src="../../images/delete.png"  style="display:none" onclick="deleteFSdetails();" id="butDelete"/>
                            <img src="../../images/report.png" width="108" height="24" onclick="viewLeftoverDetailRpt('N');" /></td>
					  </tr>
					</table>
                    </form>
				</div>
				...
				<div id="tabs-2">
					...
					<table width="1000" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td><div style="overflow:scroll; height:600px; width:980px;">
                        	<table width="1200" border="0" cellspacing="1" cellpadding="1" bgcolor="#CCCCFF"  id="tblPendingList">
                          <tr class="mainHeading4" >
                            <td >Order No</td>
                            <td >Color</td>
                            <td >Ship Qty</td>
                            ...
                            <td >Fabric Cons</td>
                            <td >Fab Act Cons</td>
                            <td >Pocketing Price</td>
                            <td >Pocketing Cons</td>
                            <td >Poc Act cons</td>
                             <td >PI</td>
                            <td >Thread cons</td>
                             <td >Thread Act cons</td>
                            <td >Dry Washing Price</td>
                             <td >Dry Act Washing Price</td>
                              <td >Wet Washing Price</td>
                               <td >Wet Act Washing Price</td>
                            <td >Pcs Per CTN</td>
                            <td >CM</td>
                            <td >SMV</td>
                             <td >Act SMV</td>
...
$deci =2;	
				$sqlFSdetail = "(select fsh.intStyleId,fsh.strOrderNo,fsh.strColor,fsh.buyerFOB,fsh.intOrderQty,fsh.dblSMV,
fsh.dblPCScarton,fsh.dblCMvalue,fsh.dblPreorderFob,fsh.dblInvFob,fsh.dblFsaleFob,b.buyerCode,
fss.dblInvoiceId,fss.strComInvNo,fsh.intStatus,b.intinvFOB,fsh.dblInvoiceId as OCinvoiceNo,fsh.intExtraApprovalRequired
from firstsalecostworksheetheader fsh inner join orders o on 
o.intStyleId = fsh.intStyleId inner join buyers b on
b.intBuyerID = o.intBuyerID 
inner join  firstsale_shippingdata fss on fss.intStyleId = fsh.intStyleId
where fsh.intStatus in (0,1))
union 
(select fsh.intStyleId,fsh.strOrderNo,fsh.strColor,fsh.buyerFOB,fsh.intOrderQty,fsh.dblSMV,
fsh.dblPCScarton,fsh.dblCMvalue,fsh.dblPreorderFob,fsh.dblInvFob,fsh.dblFsaleFob,b.buyerCode,
1,1,0,b.intinvFOB,1,0
from firstsalecostworksheetheader fsh inner join orders o on 
o.intStyleId = fsh.intStyleId inner join buyers b on
b.intBuyerID = o.intBuyerID 
where  fsh.intStyleId not in (select intStyleId from firstsale_shippingdata ))
order by strOrderNo";			
		...
		//echo $sqlFSdetail;
						while($rowfs = mysql_fetch_array($resultFS))
						{
						  ...
						  {
						  ?>
                            <td id="<?php echo $styleID; ?>"><a href="<?php echo $strUrl; ?>" style="text-decoration:underline"><?php echo $preOrderNo;//$rowfs["strOrderNo"].'-'.$rowfs["strColor"]; ?></a></td>
                            <?php 
							}
							?>
                            <td ><?php echo $rowfs["strColor"]; ?></td>
                            <td height="25"><?php echo $shipQty;?></td>
                            <?php 
...
and mil.intMainCatID=1";*/
                            ...
                            <?php 
							$sql_FabInv = "select distinct bgh.intBulkGrnNo,bgh.intYear 
...
//end check leftover allocation availability
	if($numrows>1)
	{			
							?>
                            <td align="center"><img src="../../images/pdf.png" onclick="viewFabInvoice(<?php echo $styleID.','.$fabMatId; ?>);"/>
                            </td>
             <?php 
			 }
	else if($numrows==1)
	{
		...
		{	
			...
			//echo $file1;
		/*if($boo)
		 echo  "<td ><a href=\" $file1\" target=\"_blank\"><img src=\"../../images/pdf.png\" border=\"0\" /></a></td>";		 							else
			echo  "<td>&nbsp;</td>";*/
				/*if($boo==1)
					echo "<td>12</td>";
				else
	...
	else
	{
			 ...
			 ?>              
                            ...
                            <td class="bcgcolor-InvoiceCostFabric"><?php echo $fabConpc; ?></td>
                             <td class="<?php echo $tdCls; ?>"><?php echo $actFabconPc; ?></td>
                            <?php 
							$noOfPockRecords=0;
...
$fsPocUnitprice = '';
							...
							?>
                            <td class="bcgcolor-InvoiceCostPocketing"><?php echo $fsPocUnitprice; ?></td>
                            <td class="bcgcolor-InvoiceCostPocketing"><?php echo $fsPocConpc; ?></td>
...
//echo $pocMatDetailId.' '.$styleID;
	...
	$sql_poc_left = "SELECT  LCD.intGrnNo,LCD.intGrnYear
						FROM commonstock_leftoverdetails LCD INNER JOIN commonstock_leftoverheader LCH ON
						LCH.intTransferNo = LCD.intTransferNo AND 
						LCH.intTransferYear = LCD.intTransferYear
						WHERE LCH.intToStyleId = '$styleID'  and 
						LCD.intMatDetailId = '$pocMatDetailId' and LCH.intStatus=1 ";
	$res_left_POCgrn= $db->RunQuery($sql_poc_left);
	$POCnumrows += mysql_num_rows($res_left_POCgrn);	
					
	if($POCnumrows>1)
	{
	?>
   <td align="center"><img src="../../images/pdf.png" onclick="viewFabInvoice(<?php echo $styleID.','.$pocMatDetailId; ?>);"/>
                            </td>
    <?php
	}
	else if($POCnumrows==1)
	{
		$rowPOCGrn = mysql_fetch_array($res_POCgrn);	
			...
			if(file_exists($url))
			{
				...
				/*if($boo)
				 echo  "<td ><a href=\" $url$file1\" target=\"_blank\"><img src=\"../../images/pdf.png\" border=\"0\" /></a></td>";		 
				 else
					echo  "<td>&nbsp;</td>";*/
  ...
  ?>
                            <td><?php 
							$threadConpc = getThreadConpc($styleID);
							echo ($threadConpc != ''?round($threadConpc,$deci):''); ?></td>
                             <td><?php echo ($actThread != ''?round($actThread,$deci):''); ?></td>
                            <?php 
                            ...
                            <td class="<?php echo $tdDryCls; ?>"><?php echo ($actDryWashPrice!=0?round($actDryWashPrice,$deci):''); ?></td>
                            <td class="bcgcolor-InvoiceCostService"><?php echo ($wetWashPrice!=0?round($wetWashPrice,$deci):''); ?></td>
                            <td class="<?php echo $tdWetCls; ?>"><?php echo ($actWetWashPrice!=0?round($actWetWashPrice,$deci):''); ?></td>
                            <?php 
							$tdSMV ='bcgcolor-interjobAllo';
							if($actSMV > round($rowfs["dblSMV"],$deci))
								$tdSMV ='bcgcolor-InvoiceCostICNA';
							?>
                            <td><?php echo $rowfs["dblPCScarton"];	 ?></td>
                            <td><?php echo $rowfs["dblCMvalue"];	 ?></td>
                            <td class="bcgcolor-interjobAllo"><?php echo round($rowfs["dblSMV"],$deci);	 ?></td>
                             <td class="<?php echo $tdSMV; ?>"><?php echo ($actSMV!=0?round($actSMV,$deci):''); ?></td>
                            <td class="bcgcolor-CostWSBelts"><?php
							$preorderFOB = round($rowfs["dblPreorderFob"],$deci);
							$invFob = round(($rowfs["intinvFOB"]==1?$rowfs["dblInvFob"]:$rowfs["dblPreorderFob"]),$deci);
							 echo $invFob;	 ?></td>
							...
							if($preorderFOB != $invFob) 
								$tdFOB = 'bcgcolor-InvoiceCostICNA';
							?>
                   ...
                   <?php $tdFOB = ($buyerFOB != $invFob ?'bcgcolor-InvoiceCostICNA':'bcgcolor-CostWSBelts');?>
                            <td class="<?php echo $tdFOB ?>"><?php echo $buyerFOB; ?></td>
			...
			else
			{
			   ...
			   ?>
                ...
                <table width="1000" border="0" cellspacing="0" cellpadding="0" >
                      ...
                      <tr>
                        <td><table width="98%" border="0" cellspacing="0" cellpadding="1" class="bcgl1">
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="27%" class="normalfnt"><select name="cboAppBuyer" id="cboAppBuyer" style="width:252px;" class="txtbox">
...
?>
                            ...
                            <td width="16%"><input type="text" name="txtAppDfrom" id="txtAppDfrom" style="width:120px;" onMouseDown="DisableRightClickEvent();" onMouseOut="EnableRightClickEvent();" onKeyPress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%Y-%m-%d');" disabled="disabled"/><input type="text" value=""  class="txtbox" style="visibility:hidden;width:1px"   onclick="return showCalendar(this.id, '%Y-%m-%d');"></td>
                            <td width="10%" class="normalfnt">Date To</td>
                            <td width="14%" class="normalfnt"><input type="text" name="txtAppDateTo" id="txtAppDateTo" style="width:120px;" onMouseDown="DisableRightClickEvent();" onMouseOut="EnableRightClickEvent();" onKeyPress="return ControlableKeyAccess(event);"  onclick="return showCalendar(this.id, '%Y-%m-%d');"  disabled="disabled"/><input type="text" value=""  class="txtbox" style="visibility:hidden;width:1px"   onclick="return showCalendar(this.id, '%Y-%m-%d');"></td>
                            <td width="8%"><img src="../../images/search.png" alt="" width="80" height="24" onclick="loadApprovedCWS('appCWSlist');" /></td>
                          </tr>
                        </table></td>
                      </tr>
                      ...
                      <tr>
                        <td>
					<!--<div style="overflow:scroll; height:600px; width:1020px;">-->
					<table width="1020" border="0" cellspacing="1" cellpadding="1" bgcolor="#CCCCFF"id="appCWSlist">
                    <thead>
                          <tr class="mainHeading4">
                           <th >Order No</th>
                            <th >Color</th>
...
<div id="divReport" style="background-color: #999999;position:absolute;width:167px;left:650px;top:995px;visibility:hidden;border: 1px solid #333333">
  <table width="167">	
				<tr>
					<td width="8" class="normalfnt">&nbsp;</td>
					<td width="147" class="normalfnt"><input name="radiobutton" id="rdoPreorderReport" type="radio" value="radiobutton" onclick="ViewReport(this.id);" /> 
					  Preorder Report					</td>
			    </tr>	
				...
				<tr>
				    ...
				    <td ><span class="normalfnt">
				      <input name="radiobutton" id="rdoInvReport" type="radio" value="radiobutton" onclick="ViewReport(this.id);" />
				   Invoice Cost Report </span></td>
			    </tr>
                <tr>
					<td ><div align="center"></div></td>
				    <td ><span class="normalfnt">
				      <input name="radiobutton" id="rdoleftReport" type="radio" value="radiobutton" onclick="ViewReport(this.id);" />
				   Leftover Detail Report </span></td>
			    </tr>		
  </table>	
</div>
<?php 
...
function getFabricDetails($styleID,$category)
{
	...
	/*$sql = "select fsd.dblUnitPrice,fsd.reaConPc
from firstsalecostworksheetdetail fsd inner join matitemlist mil on mil.intItemSerial=fsd.intMatDetailID
where mil.strItemDescription like'%$itemLike%' and fsd.intStyleId='$styleID'";*/
//echo $sql;
