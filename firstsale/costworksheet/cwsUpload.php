...
<title>GaPro | CWS Document Uploader</title>
...
function RemoveFile(obj,url)
{
	...
	{		
		...
		var url = 'costworksheetXml.php?id=RemoveFile&url='+url;
...
function submit1()
{
	if(document.getElementById("fileBPO").value=="")
	{
		alert("Please Select a document.");
		//document.getElementById("file").focus();
		return false;
	}
//	var url = 'db.php?id=UploadFile&url='+
...
<form action="uploader_file.php" method="post" enctype="multipart/form-data" name="formstyle" id="formstyle">
  <table width="462" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td width="118" class="normalfnt">Buyer PO#</td>
      <td colspan="2"><input name="fileBPO" type="file" class="txtbox" id="fileBPO" size="40" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<!--<?php
$file = "";
$url = "../../upload files/cws/". $_SESSION["styleId"]."/fabInvoice/";
...
<?php
$file = "";
$url = "../../upload files/cws/". $_SESSION["styleId"]."/pocInvoice/";
$serverRoot = $_SERVER['DOCUMENT_ROOT'];
$dh = opendir($url);
while (($file = readdir($dh)) != false)
{
...
<?php
$file = "";
$url = "../../upload files/cws/". $_SESSION["styleId"]."/BPO/";
$serverRoot = $_SERVER['DOCUMENT_ROOT'];
$dh = opendir($url);
while (($file = readdir($dh)) != false)
{
...
?>
        ...
        <tr class="bcgcolor-tblrowWhite">
          ...
          <td width="79%" class="normalfnt">&nbsp;<?php echo $file;?></td>
          <td width="7%" class="normalfntMid"><a href="#" onclick="RemoveFile(this,'<?php echo $url.''.$file ;?>')"><img src="../../images/del.png" border="0" /></a></td>
          <td width="10%" class="normalfntMid"><a href="<?php echo $url.''.rawurlencode($file);?>" target="_blank" ><img src="../../images/pdf.png" border="0" /></a></td>
        </tr>
