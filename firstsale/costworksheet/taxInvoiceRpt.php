...
<title>First Sale Invoice</title>
  ...
  <tr>
    <td><table  border="0" cellspacing="0" cellpadding="2" style="width:100%; line-height:17PX;" align="center">
      ...
      <tr>
        ...
        <td colspan="2" class="border-Left-bottom-right-fntsize12"><?php echo getStyleName($styleID); ?></td>
        </tr>
      <tr>
      ...
      <tr>
        <td class="border-left-fntsize12"><?php echo getStyleName($styleID); ?></td>
...
?>
	  ...
	  if($PP_confirmTaxInvoiceInFS && $rowFSS["intTaxInvoiceConfirmBy"] == '' && $fsStatus ==1)
	  {
	  ?>
      <tr>
      
        <td colspan="8"><table width="98%" border="0" cellspacing="0" cellpadding="2" class="bcgl1">
          <tr>
            <td align="center"><img src="../../images/approve.png" width="113" height="24" onClick="approveTaxInvoice(<?php  echo $invoiceId; ?>,<?php echo $styleID ?>);"></td>
          </tr>
        </table></td>
        </tr>
        <?php 
...
function approveTaxInvoice(invoiceID,styleId)
{
	var url = "shippingCWSxml.php?id=confirmTaxInvoice&invoiceID="+invoiceID;
	var xml_http_obj	=$.ajax({url:url,async:false});
	if(xml_http_obj.responseText == 1)
		location = "taxInvoiceRpt.php?invoiceID=" + invoiceID+"&styleID="+styleId;
}
</script>
</body>
</html>
