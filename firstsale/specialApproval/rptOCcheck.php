...
function checkOC(styleId,invoiceId)
{	
	var ApprovalRemarks =document.getElementById("txtApprovalRemarks").value.trim();
	var url  = "../costworksheet/costworksheetXml.php?id=URLCheckedOC";
		url += "&styleId="+styleId;
    ...
    <td align="center"><table width="800px" align="center" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr >
        <td colspan="4" align="center">
       	<img src="../../images/approve.png" onclick="checkOC('<?php echo $styleID;?>','<?php echo $invoiceId;?>');" alt="view" /></div>
