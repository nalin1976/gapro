...
<select name="txtpono" class="txtbox" id="txtpono" style="width:298px" onchange="ShowItems();removePoItems();">
      ...
      <tr>
        ...
        <td width="115" class="normalfnt"><input name="txtsupadviceno" type="text" class="txtbox" id="txtsupadviceno" style="width:100px"  maxlength="80"/></td>
        ...
        <td class="normalfnt"><input name="txtinvoiceno" type="text" class="txtbox" id="txtinvoiceno" style="width:380px;text-transform: uppercase;" maxlength="80"/></td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#D6E7F5">
      <tr>
        ...
        <img src="../../images/sticker.gif" width="97" height="24" id="btnSticker" onclick="fnSticker();" />
		<img src="../../images/upload.jpg" width="97" height="24" id="Upload" onclick="UploadFile();" />
        
        <a href="../../main.php"><img src="../../images/close.png" width="97" height="24" border="0" class="mouseover" /></a></td>
        </tr>
    </table></td>
  </tr>
  <tr>
