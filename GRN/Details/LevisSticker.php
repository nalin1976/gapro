...
<style type="text/css">
.itemcode{font-size:70px; font-weight:bold; font-family:"Times New Roman", Times, serif;}
...
?>		
		<div style="border-width:1px;border:#ffffff;border-style:solid;overflow:hidden; height:147px; top:0;">
    		<table border="0">
            	<tr><td class="itemcode" rowspan="4"><?php echo "Levi's" ?></td><tr>	
                <tr><td colspan="5" class="itemColorSize">&nbsp;</td><tr>
