...
/*  else if ($_FILES["file"]["type"] != "image/jpeg")
  ...
  mkdir("../../upload files/Style grn", 0700);
  mkdir("../../upload files/Style grn/".$_SESSION["no"], 0700);
  ...
  move_uploaded_file($_FILES["file"]["tmp_name"],"../../upload files/Style grn/".$_SESSION["no"].'/'. $filename);
  }
