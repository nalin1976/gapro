...
RIGHT OUTER JOIN deliveryschedule ON deliveryschedule.intStyleId = purchaseorderdetails.intStyleId AND deliveryschedule.intBPO = purchaseorderdetails.strBuyerPONO
WHERE  
intPoNo= $strPoNo AND intPOType=0
		...
		if($itemDes != ''){
                ...
                $SQL .= " ORDER BY deliveryschedule.estimatedDate";
		//echo $SQL;
		$result = $db->RunQuery($SQL);
