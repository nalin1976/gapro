...
<select name="txtpono" class="txtbox" id="txtpono" style="width:298px" onchange="ShowItems();removePoItems();">
                <?php
				$SQL = 	"SELECT  DISTINCT ".
                      	"P.intPONo  AS dd,P.intPONo, S.strTitle, P.intYear, concat(P.intYear , '/' , '000',  P.intPONo , ' -- ' , S.strTitle) AS ListF, ".
      ...
      <tr>
       <!-- <td colspan="2" class="normalfnt">Supplier Advice No <span class="compulsoryRed">*</span></td>
        ...
        <td colspan="2" class="normalfnt">Cusdec No</td>
        <td width="115" class="normalfnt"><input type="text" name="txtCusdecNo" id="txtCusdecNo" style="width:90px;" maxlength="10"/></td>
