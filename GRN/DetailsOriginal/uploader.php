...
function RemoveFile(obj,url)
{
	...
	{		
		...
		var url = 'db.php?id=RemoveFile&url='+url;
...
<?php
$file = "";
$url = "../../upload files/Style grn/". $_SESSION["no"]."/";
...
?>
        ...
        <tr class="bcgcolor-tblrowWhite">
          ...
          <td width="10%" class="normalfntMid"><a href="<?php echo $url.''.$file ;?>"><img src="../../images/pdf.png" height="26" border="0" /></a></td>
        </tr>
