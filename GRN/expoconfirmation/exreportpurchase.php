...
<tr>
<td><span class="head2BLCK"><?php echo "PO NO -  $intYear / $po_No";?><span class="normalfnth2Bm">
&nbsp;
<?php
$mes = "";
if($intPrintStatus==0)
...
?></div></td>
<td class="normalfntMidTAB9"><div align="right"><?php echo round($row_podata["dblQty"] + $row_podata["dblAdditionalQty"],2); ?></div>
<?php
if($poStatus == 1 && $HighlightAdditionalPurchase == "true" && $row_podata["dblAdditionalQty"] > 0 )
{
echo "<br><div align=\"right\" class=\"error1\">(" . round($row_podata["dblQty"],2) . "+" . round($row_podata["dblAdditionalQty"],2). ")</div>";
...
<td width="7%" class="bigfntnm1rite"><?php echo round($totqty,2);?></td>
</tr>
</table></td>
</tr>
<tr>
