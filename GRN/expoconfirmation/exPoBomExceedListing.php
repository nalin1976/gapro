...
$reportname = "bomQtyExceedApprovalRpt.php";
...
<title>ePlan Web | Excess Purchase Order Bom Exceed Qty Listing</title>
...
<body>
<form id="frmcomplete" name="frmcomplete" method="post" action="exPoBomExceedListing.php">
 ...
 <table width="950" border="0" align="center" bgcolor="#FFFFFF">
    <tr>
      <td><table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="96%" class="head1"><div align="center">Excess Purchase Order BOM Exceed Qty Listing </div></td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%" border="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="50%" height="21"><table width="931" border="0" class="bcgl1">
                <tr>
	...
	?>
                  ...
                  <td><select name="cboStatus" class="txtbox" id="cboStatus" style="width:170px">
                    <option <?php if ($status ==2) {  ?> selected="selected" <?php } ?> value="2">Approval for BOM Exceedings</option>
                                     
                  </select>
                  </td>
                  <td  class="normalfnt">No Like</td>
                  <td><table><tr><td>
                  <input name="txtPO" type="text" class="txtbox" style="width:100px" id="txtPO" value="<?php echo $_POST["txtPO"]; ?>" />
						</td><td>						
        ...
        <tr>
          <td colspan="2"><div id="divData" style="width:930px; height:400px; overflow: scroll;" class="bcgl1">
            <table width="910" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF" class="bcgl1" id="tblPreOders" >
              <tr>
                <td width="9%" height="19" class="mainHeading2">PO No</td>
