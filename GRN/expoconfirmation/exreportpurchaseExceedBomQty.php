...
<p class="head2BLCK">EXCESS PURCHASE ORDER -  BOM EXCEED QTY </p>
<p class="head2BLCK">&nbsp;</p>
...
<tr>
<td width="35%" height="23" class="normalfnBLD1">Payment Method </td>
<td width="65%" class="normalfnt"><span class="normalfnBLD1">:</span> <?php 
...
<tr>
<td height="23" class="normalfnBLD1">Payment Terms</td>
<td class="normalfnt"><span class="normalfnBLD1">:</span> <?php 
...
<tr>
<td height="23" class="normalfnBLD1">Payment Method</td>
<td class="normalfnt"><span class="normalfnBLD1">:</span> <?php 
...
<td width="8%" bgcolor="#CCCCCC" class="bcgl1txt1B">Excess QTY</td>
<td width="8%" bgcolor="#CCCCCC" class="bcgl1txt1B">BOM Exceed QTY</td>
<td width="8%" bgcolor="#CCCCCC" class="bcgl1txt1B">Mat Ratio Qty</td>
...
purchaseorderdetails_excess.dblQtyExceedBom,
...
WHERE (((purchaseorderdetails_excess.intGrnNo)='$intPoNo')) and (((purchaseorderdetails_excess.intGrnYear)='$intYear')and purchaseorderdetails_excess.dblQtyExceedBom > 0)";
...
<td colspan="2" class="normalfntTAB9" id="<?php echo $matCode;?>"><?php echo $strDescription  ;  ?></td>
<td class="normalfntTAB9" id="<?php echo $row_podata["intStyleId"];?>"><?php echo $row_podata["strOrderNo"]."/".$row_podata["strStyleID"]; ?><table width="100%" border="0" cellpadding="0"><tr>
...
<td class="normalfntMidTAB9"><div align="right"><?php echo round($row_podata["dblQtyExceedBom"]); ?></div></td>
<td class="normalfntMidTAB9"><div align="right"><?php echo round($row_podata["dblBalQty"]); ?></div></td>
...
<td width="7%" class="bigfntnm1mid"><?php echo round($totqty);?></td>
