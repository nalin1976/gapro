...
function viewGRNdetails(grnNo,grnYear,status,ComID)
{
	var path = document.location.protocol+'//'+document.location.hostname+'/'+document.location.pathname.split("/")[1]+'/'+document.location.pathname.split("/")[2];
	path += "/Details/grndetails.php?id=1&GRNNo="+grnNo+'&intYear='+grnYear+'&intStatus='+status+'&thisGrnFactory='+ComID;
	
	window.open(path,'frmGrnList');
}

function viewReport(grnNo,grnYear)
{
	var path = document.location.protocol+'//'+document.location.hostname+'/'+document.location.pathname.split("/")[1]+'/'+document.location.pathname.split("/")[2];
	path += "/Details/grnReport.php?grnno="+grnNo+'&grnYear='+grnYear;
