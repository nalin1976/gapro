...
<title>GaPro | User Management</title>
      ...
      <blockquote>
        ...
        <table width="795" border="0">
          ...
          <tr>
            ...
            <td width="254"><div align="left"><a href="createnewuser.php"><img src="images/createUser.png" alt="Add user" border="0" class="mouseover" /></a></div></td>
          </tr>
        </table>
        </blockquote>
      </blockquote>
      <div id="divData" style="width:930px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#CCCCCC;">
