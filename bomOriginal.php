...
<table width="960" border="0" align="center" class="bcgl1">
  <tr>
    <td height="27" bgcolor="#316895" class="tophead"><div align="center" class="TitleN2white">BOM - Bill of Material</div></td>
  </tr>
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="19" style="visibility:hidden"><label class="normalfnth2" id="lblStyleNo"><?php echo $styleId; ?></label></td>
        <td width="74" class="normalfnt">SC No.</td>
        <td width="89">        <input type="text" name="txtSCNo" id="txtSCNo" disabled="disabled" maxlength="5"  value="<?php echo $SCNo;?>" style="width:70px;"/></td>
        <td  width="47" class="normalfnt">Buyer</td>
        <td class="normalfnth2" width="156">
  <input type="text" name="txtBuyerName" id="txtBuyerName" disabled="disabled" maxlength="30"  style="width:150px;" value="<?php echo $BuyerName; ?>" /></td>
        <td width="3">&nbsp;</td>
        <td width="263" rowspan="3" valign="top"><table style="visibility:visible;" width="100%" height="83" border="0">
          <tr>
	...
	?>
                    ...
                    <td><img src="images/go.png" alt="go" width="30" height="22" class="mouseover" onclick="reloadPreOrderSR(this.id);" /></td>
                  </tr>
                  <tr>
                  <td>Order No</td>
	...
	?>
      ...
      <tr>
        ...
        <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="128" class="normalfnt">Ex.Qty.(%)</td>
            <td width="221"><input name="txtexcessqty" type="text" class="txtbox" disabled="disabled" id="txtexcessqty" value="<?php echo $EXPercentage; ?>" style="width:25px;"/></td>
          </tr>
        </table></td>
        ...
        <td width="47" class="normalfnt">FOB</td>
        <td width="156"><span class="normalfnt">
      ...
      <tr>
        ...
        <td height="21" class="normalfnt">
            <input type="text" name="textfield" disabled="disabled" style="width:70px;" value="<?php echo $strOrderNo; ?>"/>
       </td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="89%" bgcolor="#9BBFDD" class="normaltxtmidb2">Consumptions</td>
        <td width="11%" bgcolor="#9BBFDD" class="normalfnt"><img src="images/add-new.png" <?php if (!$bomItemAddition) {  echo 'style="visibility:hidden;"';  }?> alt="add new" width="109" height="18" border="0" class="mouseover" onclick="ShowAddingForm();" /></td>
      </tr>
      <tr>
        <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:350px; width:950px;">
          <table id="tblConsumption" bgcolor="#CCCCFF"  width="1570" cellpadding="0" cellspacing="1">
            <tr>
              <td width="40" height="33" bgcolor="#498CC2" class="normaltxtmidb2">Edit</td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Del</td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Ratio </td>
              <td width="65" bgcolor="#498CC2" class="normaltxtmidb2">Material</td>
              <td width="100" bgcolor="#498CC2" class="normaltxtmidb2">Category</td>
              <td width="440" bgcolor="#498CC2" class="normaltxtmidb2">Description</td>
              <td width="50" bgcolor="#498CC2" class="normaltxtmidb2">ConPC</td>
              <td width="55" bgcolor="#498CC2" class="normaltxtmidb2">Waste</td>
              <td width="60" bgcolor="#498CC2" class="normaltxtmidb2">Tot Qty</td>
              <td width="50" bgcolor="#498CC2" class="normaltxtmidb2">Unit</td>
              <td width="70" bgcolor="#498CC2" class="normaltxtmidb2">Unit Price</td>
              <td width="50" bgcolor="#498CC2" class="normaltxtmidb2">Freight</td>
              <td width="70" bgcolor="#498CC2" class="normaltxtmidb2">Purchase Type </td>
              <td width="60" bgcolor="#498CC2" class="normaltxtmidb2">Cost PC</td>
              <td width="70" bgcolor="#498CC2" class="normaltxtmidb2">Value</td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Order Type</td>
              <td width="30" bgcolor="#498CC2" class="normaltxtmidb2">Placement</td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2"> Origin </td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Purch + Allo Qty </td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Average <br />
                Price </td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Average Value </td>
              <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Variation</td>
			  <td width="40" bgcolor="#498CC2" class="normaltxtmidb2">Left Over</td>
            </tr>
			<?php
...
$SQL = "select specificationdetails.intStyleId,specificationdetails.strMatDetailID,specificationdetails.strUnit,specificationdetails.dblUnitPrice,specificationdetails.sngConPc,specificationdetails.sngWastage,specificationdetails.strPurchaseMode,specificationdetails.strOrdType,specificationdetails.strPlacement, specificationdetails.intOriginNo ,specificationdetails.intRatioType,specificationdetails.dblReqQty, specificationdetails.dblTotalQty,specificationdetails.dblTotalValue,specificationdetails.dblCostPC,specificationdetails.dblfreight,matmaincategory.strDescription as matdesc,matmaincategory.intID,matsubcategory.StrCatName,matsubcategory.intSubCatNo, matitemlist.strItemDescription,itempurchasetype.strOriginType,itempurchasetype.intType as itemPurchType
  from specificationdetails,matitemlist,matmaincategory,matsubcategory,itempurchasetype
   where specificationdetails.strMatDetailID = matitemlist.intItemSerial AND matitemlist.intMainCatID =  matmaincategory.intID AND matitemlist.intSubCatID = matsubcategory.intSubCatNo AND specificationdetails.intStyleId = '" .  $reqStyleID . "' and itempurchasetype.intOriginNo = specificationdetails.intOriginNo
...
<!--			   <td><div id="<?php //echo $row["strMatDetailID"]; ?>"  onClick="ShowEditForm(this.id);" align="center"><img style="visibility:hidden;" src="images/edit.png" alt="edit" width="15" height="15" border="0" class="mouseover" /></div></td>-->
			 ...
			 echo ' <div align="center" id="' . $row["strMatDetailID"] .'" onclick="RemoveItem(this);" ><img src="images/del.png" alt="del" width="15" height="15" border="0" class="mouseover"/></div>';
              ...
              <?php
					...
					else if ($row["strPurchaseMode"] == "COLOR" || $row["strPurchaseMode"] == "BOTH")
					{
