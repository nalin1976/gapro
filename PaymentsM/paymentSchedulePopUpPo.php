<?php
	...
	$invNo=$_GET["invNo"];
	$Type	=$_GET['Type']; //18-04-2011 -to get the po type
?>
...
if($Type=="S"){
	...
	$strSQL= "SELECT 
			...
			$poRpt="BulkPo/bulkPurchaeOrderReport.php?bulkPoNo=";
			$year='intYear';
}
...
?>
            <tr class="backcolorGreen">
              <td class="normalfntMid"><?php echo $intPoNo ?></td>
              <td class="normalfntMid"><?php echo $intYear ?></td>
              <td class="normalfntMid" ><a target="_blank"  href=<?php echo "../$poRpt$intPoNo&$year=$intYear" ?>><img src="../images/view.png" alt="Report " name="butReport" border="0" id="butReport"/></a></td>
            </tr>
