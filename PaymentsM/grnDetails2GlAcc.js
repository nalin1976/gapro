...
function HandleShowAllGLAccounts()
{
	if(altxmlHttpArray[this.index].readyState == 4) 
    {
        if(altxmlHttpArray[this.index].status == 200) 
        {
			...
			drawPopupArea(670,430,'frmAllGLAccounts');
			...
			var tableText = "<table width=\"650\" cellpadding=\"0\" cellspacing=\"0\" id=\"tblsearch\" bgcolor=\"#FFF\"  > " +
							...
							"	<table width=\"670\">"+
							"		<tr>"+
			              	"			<td height=\"25\" bgcolor='#000000' style='color:#FFFFFF'>GL Accounts</td>"+
							"		</tr>"+
							"	</table>"+
							"<td>"+
            				"</tr>"+							
							...
							"<td width=\"8%\"><img src=\"../images/search.png\" alt=\"search\" width=\"86\" height=\"24\" /></td>"+
							"</td>"+
							"	</table>"+
							"		</tr>"+
							...
							"<table width=\"670\" cellpadding=\"0\" cellspacing=\"0\" id=\"tblallglaccounts\"> " +
