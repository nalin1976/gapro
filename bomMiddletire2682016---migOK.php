...
else if (strcmp($RequestType,"mailSend") == 0)
{
    ...
    $to = "malingaj@helaclothing.com";
    $from = "gapro@helaclothing.com";
    $subject = "Fabric Consumption Alert";
...
<html> 
  <body> 
    ...
    <span style=\"font-size:14px;\">Dear Malinga,</span>
                    ...
                    foreach ($sizes as $sizeName) 
			{
				...
				foreach ($colors as $colorName) 
				{
					...
					$matQty = round($initQty + $recutQty - $poQty - $bulkAlloQty - $leftAlloQty);
						...
						echo  $sqlColorInactive = " UPDATE materialratio SET intStatus = 0 WHERE intStyleId = '$styleNo' AND strMatDetailID = '$itemCode' AND strColor = 'N/A' AND strSize = '$sizeName' AND strBuyerPONO = '$poNumber' ";
