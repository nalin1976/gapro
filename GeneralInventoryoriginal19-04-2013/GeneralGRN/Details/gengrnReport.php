...
$result_alldetails = $db->RunQuery($SQL_alldetails);
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="tablez">
        <tr> 
          <td width="40%" class="normalfntBtab" height="25">Item Description</td>
            <td width="11%" class="normalfntBtab">Cost Center</td>
          <td width="11%" class="normalfntBtab">Unit</td>
          <!--<td width="8%" class="normalfntBtab">COLOR</td>
          <td width="9%" class="normalfntBtab">SIZE</td>-->
          <td width="12%" class="normalfntBtab">Rate</td>
          <td width="14%" class="normalfntBtab">Qty</td>
          <td width="10%" class="normalfntBtab">Excess Qty</td>
...
generalpurchaseorderdetails.dblUnitPrice,generalpurchaseorderdetails.intYear,
(select genmatitemlist.strItemDescription from genmatitemlist where genmatitemlist.intItemSerial = gengrndetails.intMatDetailID) as Description,
(select c.strDescription from costcenters c where c.intCostCenterId = gengrndetails.intCostCenterId ) as costCenter
FROM
genmatitemlist
Inner Join gengrndetails ON genmatitemlist.intItemSerial = gengrndetails.intMatDetailID
...
AND gengrnheader.intGenPOYear = generalpurchaseorderdetails.intYear
...
AND gengrnheader.intGenPONo = generalpurchaseorderdetails.intGenPONo and gengrndetails.intCostCenterId = generalpurchaseorderdetails.intCostCenterId ";
        ...
        <tr> 
          ...
          <td class="normalfntTAB"><?php echo $row["costCenter"];?></td>
