			...
			while($row = mysql_fetch_array($result_A))
			{
			   ...
			   $glAlloId	= $row["intGLAllowId"];
				...
				$qSQL = "UPDATE generalpurchaseorderdetails set dblPending = dblPending + $dblQty2
					   ...
					   AND intMatDetailID=$intMatDetailID2 and intCostCenterId='$costCenterId' and intGLAllowId='$glAlloId' ";
...
{	
			...
			$SQL = "insert into gengrndetails 
				(strGenGrnNo,intYear, intMatDetailID, strUnit,dblRate,dblQty,dblExQty,dblBalance, dblValueBalance, intCostCenterId,intGLAllowId)
				values  ('$intGrnNo', '$intGRNYear', '$intMatDetailID', '$strUnit', '$dblRate', '$dblQty',  '$dblExcessQty', 				 '$dblBalance', '$dblValueBalance','$costCenterId','$glAlloId')";
		...
		if ($intSave==1)
		{
		  ...
		  $SQL2 =  " UPDATE generalpurchaseorderdetails set dblPending = dblPending - $dblQty 
					   WHERE intGenPONo = $intGenPONo 
					   AND intYear=$intYear 
					   AND intMatDetailID=$intMatDetailID and intCostCenterId='$costCenterId' and intGLAllowId='$glAlloId' ";
				   //echo $SQL2;
