...
?>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bcgl1">
      ...
      <tr>
        <td colspan="2" class="normalfnt"><div id="divcons" style="overflow:scroll; height:320px; width:950px;">
          <table id="tblIssueList" width="1100" cellpadding="0" cellspacing="1" bgcolor="#CCCCFF">
            <tr class="mainHeading4">
              <td width="1%" height="33" >Del</td>              
			  <td width="12%" >Material</td>              
              <td width="25%" >Detail</td>			  
              <td width="5%" >Qty. Issued</td>
              <td width="6%" >Req. Qty</td>
			  <td width="6%" >Unit</td>
			  <td width="5%" >MRN No</td>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" class="bcgl1">
      <tr>
        <td height="29" style="text-align:center"><img src="../../images/new.png" alt="new" width="96" height="24" onclick="ClearForm();" /> <img src="../../images/save.png" alt="save" width="84" height="24" id="Save" onclick="getIssueNo();" /><img src="../../images/report.png" width="108" height="24" onclick="ReportPopup();" /><a href="../../main.php"><img src="../../images/close.png" width="97" height="24" border="0" /></a></td>
   		</tr>
    </table></td>
  </tr>
</table>
