...
$report_companyId  =$_SESSION["FactoryID"];
		...
		$sql_issu="SELECT genissues.dtmIssuedDate,genissues.intIssueNo,genissues.intUserid,genissues.strProdLineNo,genissues.intIssueYear,(SELECT useraccounts.Name FROM useraccounts WHERE genissues.intUserid = useraccounts.intUserID)AS preparedby,(SELECT department.strDepartment FROM department WHERE department.strDepartmentCode = genissues.strProdLineNo)AS recever FROM genissues WHERE genissues.intIssueNo = $intIssueNo AND genissues.intIssueYear = $year;";
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablez">
      <tr>
        <td width="17%" height="35" class="normalfntBtab">MRN NO</td>
        <td width="66%" height="35" class="normalfntBtab">DETAILS</td>
        <td width="17%" class="normalfntBtab">QTY</td>
        </tr>
   	  	   <?php

		
		$strSQL = "select genissuesdetails.intIssueNo,genissuesdetails.intMatDetailID,genissuesdetails.intMatRequisitionNo,genissuesdetails.intMatReqYear, genmatitemlist.strItemDescription, genissuesdetails.dblQty  from genissuesdetails, genmatitemlist where  genmatitemlist.intItemSerial = genissuesdetails.intMatDetailID AND genissuesdetails.intIssueNo = $intIssueNo;";
	  ...
	  ?>
		...
		?>
      <tr>
        <td colspan="2" class="normalfnt2bldBLACKmid">TOTAL</td>
