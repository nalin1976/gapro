...
$SQL= " INSERT INTO genissuesdetails (intIssueNo,intIssueYear,intGrnNo,intGrnYear,			intMatRequisitionNo,intMatReqYear,intMatDetailID,dblQty, ".
	  " dblBalanceQty,intCostCenterId,intGLAllowId)
	   VALUES ('$issueNo','$issueYear','$grnArray[1]','$grnArray[0]','$mrnArray[1]','$mrnArray[0]','$itemdDetailID','$qty','$qty','$CostCenterId','$GLAllowId') ";	
		$db->executeQuery($SQL);	
...
{		
	...
	$ResponseXML .= "<loadMrnDetailsToGrid>";
				...
				$SQL = "SELECT 			
						...
						GMR.intCostCenterId,
						CS.strDescription as CostCenterDes,
						...
						Inner Join costcenters CS ON CS.intCostCenterId=GMR.intCostCenterId
