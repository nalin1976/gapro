  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        <td valign="top" width="430"><table width="100%" border="0" class="tableBorder" height="75" cellspacing="0" cellpadding="1">
          <tr>
            <td width="97" class="normalfnt">PO No </td>
            <td width="93"><input type="text" name="txtBulkPoNo" class="txtbox" id="txtBulkPoNo" style="width:80px;" onfocus="this.blur();" onclick="loadfindPOpopup();" disabled="disabled"></td>
			<td width="93"><select name="cboPOYearBox" id="cboPOYearBox" class="txtbox"  style="width:62px" disabled="disabled">
	...
	?>
          ...
          <tr>
            ...
            <td><select name="cboCurrency" class="txtbox" id="cboCurrency" style="width:82px;" onchange="convertRates();">
              <?php
          ...
          <tr>
            ...
            <td colspan="3"><select name="cboSupplier" class="txtbox" id="cboSupplier" style="width:310px" onchange="SetDetails(this);convertRates();" tabindex="1"> <option value="" selected="selected" >Select One</option>
                          <?php
