...
{	
	...
	for(var n = 0; n < XMLintMatDetailID.length ; n++) 
	{
		...
		var intPRno  		= XMLPRNo[n].childNodes[0].nodeValue;
		var intPRyear  		= XMLPRYear[n].childNodes[0].nodeValue;
		var strPRno  		= XMLstrPRNo[n].childNodes[0].nodeValue;
		var costCenter		= xmlCostCenter[n].childNodes[0].nodeValue;
		var costCenterID	= xmlCostCenterID[n].childNodes[0].nodeValue;
		var GLCode		    = xmlGLCode[n].childNodes[0].nodeValue;
		var GLId			= xmlGLId[n].childNodes[0].nodeValue;
