...
{	
		...
		$SQL="SELECT genmatsubcategory.intSubCatNo,genmatsubcategory.StrCatName,genmatitemlist.strItemCode,genmatsubcategory.intCatNo FROM genmatsubcategory Inner Join genmatitemlist ON genmatsubcategory.StrCatCode = genmatitemlist.intSubCatID Inner Join genmatmaincategory ON genmatitemlist.intMainCatID = genmatmaincategory.intID WHERE genmatitemlist.intStatus=1";
		if($mainCatId != "")
