...
function ViewExcel(){
	...
	if(mainStoreID==''){alert('Select stores location');return;}
	
	var url = "goodnotinexcel.php?storescode="+mainStoreID+"&GatePassNo="+GatePassNo+"&chkBox="+chkBox+"&mainStore="+mainStore;
          ...
          <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr>
              ...
              <td width="62%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="35" bgcolor="#498CC2" class="TitleN2white" style="border:#00F thin solid">Gate Pass Transfer Not IN</td>
                  </tr>
                  <tr>
                    <td height="61"><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: #00F thin solid; border-right: #00F thin solid;">
                        <tr>
                        ...
                        <tr>
                          <td width="100%" bgcolor="#d6e7f5"><table width="100%" border="0">
                              <tr>
                                ...
                                <td width="10%">&nbsp;</td>
                                <td width="15%">&nbsp;</td>
                                <td width="55%" align="right" valign="middle">&nbsp;<img src="../images/report.png" alt="OK" width="86" height="24" onclick="report();" />&nbsp;<img src="../images/exceldw.gif" onclick="ViewExcel()" />&nbsp;</td>
                              </tr>
                          </table></td>
                        </tr>
                    </table></td>
