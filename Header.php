...
<script src="<?php echo $backwardseperator;?>js/jq/jquery-1.10.2.js"></script>
<script src="<?php echo $backwardseperator;?>js/jq/jquery-ui-1.10.4.custom.min.js"></script>
<script src="<?php echo $backwardseperator;?>js/jq/jquery-ui-1.10.4.custom.js"></script>

<!--<script src="<?php echo $backwardseperator;?>js/jquery-1.9.1.js"></script>
...
<tr bgcolor="#FFFFFF">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td width="94" class="tophead" id="companyName"><span class="normalfnth2B">Welcome <span class="normalfnth2"><label id="getName">
            <?php 
		...
		?></label>
!</span></span></td><label id="getUserID" style="visibility:hidden"><?php echo $_SESSION["UserID"];?></label>
...
<!--End - 28-02-2011 Account Addins   -->
		...
		<?php if ($preorderCosting) { ?>			
			...
			<?php if($viewSalesMonitoring) { ?>
				<li><a class="style2" href="<?php echo $backwardseperator;?>sales/salesmonitoring.php">Sales & Monitoring</a></li>
			<?php } ?>
			<?php if($freezeDeliverySchedule) { ?>
				<li><a class="style2" href="<?php echo $backwardseperator;?>freezeschedule/freeze.php">Freeze Delivery Schedule</a></li>
			<?php } ?>
		  </ul>
        </li>
		<?php
...
<?php if($reports) { ?>
	...
	<?php if($preorderReports) { ?>
		...
		<?php } ?>
          ...
          <?php } ?>  
          	<li><a class="style2"  href="<?php echo $backwardseperator;?>Reports/deliverycutoff.php">Blocked Orders</a></li>
	...
	<?php if($styleReports) { ?>
        ...
        <li><a class="style2" href="<?php echo $backwardseperator;?>QuickHistoryReport/QuickHistoryReport.php">Quick History report </a> </li>
        <li><a class="style2" href="<?php echo $backwardseperator;?>OrderDetails/DashBoard/OrderDetails.php">OrderDetails </a> </li>
        <li><a class="style2" href="<?php echo $backwardseperator;?>OrderDetails/PCD/pcdTracking.php">PCD Tracking</a> </li>
    <?php } ?> 
...
<li><a class="style2" href="<?php echo $backwardseperator;?>goodsInTransitReports/gatepass_TransactionRpt.php">Goods In Transit Report</a></li>
...
<li><a class="style2" href="<?php echo $backwardseperator;?>Reports/reconciliation/reconciliation.php">Left Over</a>
</ul>
</li>		
<?php } ?>
...
<?php if($PP_AllowProduction){?>
        ...
        <li><a class="style2" href="#">Production</a>
            <ul>
                <li><a class="style2" href="<?php echo $backwardseperator;?>Reports/pi/pi.php">Production Instruction</a></li>
            </ul>
	</li>
<?php }?>
...
<?php }
	...
	if($allowViewAuditReports){

?>
	 <li><a class="style2">Audit</a>
     	<ul>
     		<?php if($allowViewDeliveryAuditReport){ ?>
     		<li><a class="style2" href="<?php echo $backwardseperator;?>Reports/audit/delivery.php">Delivery Schedule</a></li>
            <?php } ?>
        </ul>
     </li>
<?php
...
?>    
 <li><a class="style2">KPI</a>
        <ul>
            <li><a class="style2" href="<?php echo $backwardseperator;?>Reports/kpi/supplierotd/supplierotd.php">Supplier OTD</a></li>
        </ul>
    </li>
...
<?php if($allowExtra){ ?>
<li><a href="#" class="style3 MenuBarItemSubmenu">Extra</a>
<ul>
	<?php if($allowFastReactDataTransfer){ ?>
		<li><a href="<?php echo $backwardseperator; ?>fr/loadorders.php" class="style2">GAPRO --> FR</a></li>
    <?php } ?>    

    <?php if($allowBudgetLine){ ?>
    	<li><a href="<?php echo $backwardseperator; ?>planline/loadorderlist.php" class="style2">Budget Line Transfer</a></li>
    <?php } ?>	
</ul>  
<?php } ?>
