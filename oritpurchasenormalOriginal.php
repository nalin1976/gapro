...
$SL_PODATA = "SELECT
	 ...
	 ?>
       <tr bgcolor="#F2F2F2" <?php if ($poStatus == 1 && round($costingPrice,4) < round($purchasedPrice,4) && $HighLightOverCostPO == "true") {?> bgcolor="#FF6633" <?php } ?>>
         <td height="20" colspan="11" class="normalfntTAB9">&nbsp;<b>Order No : </b><a href="<?php echo $strURLbom; ?>" target="bomitemreport.php"><?php echo $row_podata["strOrderNo"];?></a>&nbsp;&nbsp;&nbsp;<b>Style No : </b><?php echo $row_podata["strStyle"];?>&nbsp;&nbsp;<b>  Order Qty : </b><?php echo $row_podata["intQty"];?> </td>         
	    </tr>
