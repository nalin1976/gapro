...
<title>General Stock Movement</title>
<link rel="stylesheet" type="text/css" href="../../javascript/calendar/theme.css" />
<script src="../../javascript/calendar/calendar.js" type="text/javascript"></script>
<script src="../../javascript/calendar/calendar-en.js" type="text/javascript"></script>
<script src="../../javascript/script.js" type="text/javascript"></script>
<script src="genitemstock.js" type="text/javascript"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td class="mainHeading"> General Stock Movement</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
        ...
        <table width="500" border="0" cellspacing="0" cellpadding="2" class="normalfnt">
          ...
          <tr>
            ...
            <td><select name="cboSubcat" id="cboSubcat" style="width:285px;" onChange="getMatIemList();">
             <?php
						...
						$SQL = 	"SELECT GSC.intSubCatNo, GSC.StrCatName FROM genmatsubcategory  GSC
								WHERE GSC.intCatNo <>'' ";
								
						if($intMainCat!='')
							$SQL .= " AND GSC.intCatNo =  '$intMainCat'";
          ...
          <tr>
            ...
            <?php
						...
						while($row = mysql_fetch_array($result))
						{
						if($intMainStores==$row["intCompanyID"])
							echo "<option selected=\"selected\" value=\"". $row["intCompanyID"] ."\">" . trim($row["strName"]) ."</option>" ;								
						else
      ...
      <tr>
        <td><table width="99%" border="0" cellspacing="0" cellpadding="0" class="bcgl1" align="center" height="30">
          <tr>
      ...
      <tr>
        <td><table width="240" border="0" cellspacing="0" cellpadding="0" align="center" >
          <tr>
            ...
            <td width="42"><input name="rdoS" type="radio" id="rdoStyleWise" value="with" disabled="disabled" /></td>
