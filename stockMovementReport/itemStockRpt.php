...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><table width="800" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <td><table width="600" border="0" cellspacing="0" cellpadding="0" class="normalfnth2B">
          <tr>
            ...
            <?php 
				...
				if($size != '')
					$sqlOB .= "and strSize = '$size'";
					
				if($color != '')
					$sqlOB .= "and strColor = '$color'";
      ...
      <tr>
		...
		while($row=mysql_fetch_array($result))
		{
			...
			{
		  ?>
          <tr><td  height="25" colspan="11" ><table width="148" border="0" cellspacing="0" cellpadding="0">
            <tr>
          ...
          <tr>
            ...
            <td colspan="6" class="normalfntTAB" align="center">Starting Balance</td>
		  ...
		  $prevDate = $row["stockDate"];
			...
			else
			{
			   if($prevDate != $currentDate)
				{
		  ?>
          	 <tr><td colspan="11" height="25"><table width="148" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="50" class="normalfnth2B">Date :</td>
              <td width="98" class="normalfnth2B"><?php echo  $currentDate;?></td>
            </tr>
...
document.getElementById('txtClosingBal').innerHTML = '<?php echo number_format($BalQty,2);?>';
</script>