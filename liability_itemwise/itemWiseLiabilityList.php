...
<body>
<form id="frmItemWiseLeftOverList" name="frmItemWiseLeftOverList" method="post" action="itemWiseLiabilityList.php">
<tr>
	<td><?php include '../Header.php'; ?></td>
</tr>
<table width="950" border="0" align="center" bgcolor="#FFFFFF" class="tableBorder">
  <tr>
  <td height="25" colspan="5" class="mainHeading">Item Wise Liability Allocation Listing</td>
  </tr>
  <tr>
...
FROM itemwiseliability_detail IWLD 
        ...
        <td><div id="divGRNDetails" style="overflow:scroll; width:950px;height:400px">
            <table width="1100" border="0" cellpadding="0" cellspacing="1" id="tblGRNDetails" bgcolor="#CCCCFF">
              <tr class="mainHeading4">
                <td width="75" height="25" nowrap="nowrap" >&nbsp;Liability No&nbsp;</td>
...
?>
	<tr class="bcgcolor-tblrowWhite">
        ...
        <td class="normalfnt">&nbsp;<?php echo $row["CancelBy"]; ?>&nbsp;</td>
        <td class="normalfnt">&nbsp;<?php echo $row["CancelDate"]; ?>&nbsp;</td>
