...
{	
	...
	$gp_year=$gp_array[0];
	$str="select PGPH.intGPnumber,PGPH.intYear,PGPH.intStyleId,PGPH.dtmDate,PGPH.intFromFactory,PGPH.intTofactory,PGPH.dblTotQty,PGPH.dblTotBalQty,PGPH.strTransInSt,PGPH.intStatus,PGPH.strType,PGPH.intUserId,PGPH.strVehicleNo,PGPH.strPalletNo,O.intBuyerID from productiongpheader PGPH inner join orders O on O.intStyleId=PGPH.intStyleId where PGPH.intGPnumber='$gp_number' and PGPH.intYear='$gp_year'";
	$XMLString= "<Data>";
	$XMLString .= "<cutz>";
