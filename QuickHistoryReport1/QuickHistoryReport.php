        ...
        <tr>
          <td align="center" colspan="2"><div align="center" id="divData" style="width:1100px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#99CCFF;">
            <table width="1090" border="0" cellpadding="0" cellspacing="1" class="bcgl1" id="tblBomDetails" >
              <tr>
                <td width="9%" height="19" bgcolor="#498CC2" class="normaltxtmidb2">Sc No</td>
                ...
                <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">Po Qty</td>
                <td width="8%" bgcolor="#498CC2" class="normaltxtmidb2">GRN Qty</td>
            ...
            <tr>
          <td align="center" colspan="2"><div align="center" id="divGp" style="width:1100px; height:500px; overflow: scroll; border-width:3px; border-style:solid;border-color:#99CCFF;">
            <table width="1090" border="0" cellpadding="0" cellspacing="1" class="bcgl1" id="tblGpDetails" >
              <tr>
                <td width="9%" height="19" bgcolor="#498CC2" class="normaltxtmidb2">Sc No</td>
                <td width="9%" bgcolor="#498CC2" class="normaltxtmidb2">BPO</td>
                <td width="20%" bgcolor="#498CC2" class="normaltxtmidb2">Mat. Description</td>
