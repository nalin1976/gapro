...
<div id="divPart" style="overflow:hidden; height:300px; width:420px;">
<table id="tblMain" width="400" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
    <td> <table width="100%" height="237" border="0" class="bcgl1">
            ...
            <tr>
              <td height="3"><table width="69%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="17" bgcolor="#9BBFDD" class="normalfnth2"><div align="center"></div></td>
                  </tr>
                <tr>
                  <td><div id="divPartDetails" style="overflow:scroll; height:130px; width:400px;">
                      <table  id="tblPartDetails" width="380" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="13%" bgcolor="#498CC2" class="normaltxtmidb2">Del</td>
                          <td width="13%" height="33" bgcolor="#498CC2" class="normaltxtmidb2">No</td>
                          <td width="37%" bgcolor="#498CC2" class="normaltxtmidb2">Part</td>
                          <td width="19%" bgcolor="#498CC2" class="normaltxtmidb2">SMV</td>
                          <td width="18%" bgcolor="#498CC2" class="normaltxtmidb2">EFF%</td>
                        </tr>
<?php
