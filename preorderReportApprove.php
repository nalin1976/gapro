...
<table width="800" align="center">
  ...
  <tr>
    <td align="center"><table width="800px" align="center" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr bgcolor="#D6E7F5">
        <td>&nbsp;</td>
        <td width="212"><div align="right"><img src="images/approve.png" onclick="ApprovePreOders('<?php echo $strStyleID;?>',<?php echo $UserID;?>,<?php echo $dbl_cmum; ?>, '<?php echo $strOrderNo; ?>', <?php echo $reaSMVRate; ?>, <?php echo $dblApprovedEPMLevel; ?> );" alt="view" /></div></td>
