...
specificationdetails.strMatDetailID = '$intMatDetailID' "; 
	...
	while($rowItems=mysql_fetch_array($resultItems))
	{
		...
		$intstatus = $rowItems["intstatus"];
                ...
                $dblOpWastage = $rowItems["opWastage"];
                $intLgPanels =  $rowItems["noPanels"];
                $intEmbPanels =  $rowItems["embPanels"];
                $intPrintPanels =  $rowItems["printPanels"];
                $intOperatioId =  $rowItems["OperationId"];
