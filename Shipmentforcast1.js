...
var Decathlon   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Decathlon   += "&Criterion="+Criterion+"&FCLLCL="+FCLLCL+"&UnitPCSSETS="+UnitPCSSETS+"&Destination="+Destination+"&CBM="+CBM+"&FactoryDate="+FactoryDate;
...
var MANDS   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	MANDS   += "&KnitWoven="+KnitWoven+"&FCLLCL="+FCLLCL+"&UnitPCSSETS="+UnitPCSSETS+"&Destination="+Destination+"&CBM="+CBM+"&PCSPerCTNS="+PCSPerCTNS+"&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Reference="+Reference+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var Tesco   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Tesco	+= "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Reference="+Reference+"&PackType="+PackType+"&Season="+Season+"&FactoryDate="+FactoryDate;
...
var Next   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Next   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Reference="+Reference+"&ItemNo="+ItemNo+"&ContractNo="+ContractNo+"&FactoryDate="+FactoryDate;
...
var Sainsbury   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Sainsbury   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Color="+Color+"&TuPoNo="+TuPoNo+"&TuStyle="+TuStyle+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var FasionLab   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	FasionLab   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Color="+Color+"&TuPoNo="+TuPoNo+"&TuStyle="+TuStyle+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var OriginaMarines   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	OriginaMarines   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Color="+Color+"&TuPoNo="+TuPoNo+"&TuStyle="+TuStyle+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var Blues   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Blues   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Color="+Color+"&TuPoNo="+TuPoNo+"&TuStyle="+TuStyle+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var Feilding   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Feilding   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Color="+Color+"&TuPoNo="+TuPoNo+"&TuStyle="+TuStyle+"&PackType="+PackType+"&FactoryDate="+FactoryDate;
...
var Nike   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Nike   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Reference="+Reference+"&ItemNo="+ItemNo+"&ContractNo="+ContractNo+"&FactoryDate="+FactoryDate;
...
var Levis   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Levis   += "&KnitWoven="+KnitWoven+"&FCLLCL="+FCLLCL+"&UnitPCSSETS="+UnitPCSSETS+"&Destination="+Destination+"&CBM="+CBM+"&PCSPerCTNS="+PCSPerCTNS+"&FactoryDate="+FactoryDate;
...
var Asda   = "Shipmentforcastdb.php?REQUEST=adddata&SCNO="+SCNO+"&Buyer="+Buyer;
	...
	Asda   += "&KnitWoven="+KnitWoven+"&FCLLCL="+FCLLCL+"&UnitPCSSETS="+UnitPCSSETS+"&Destination="+Destination+"&CBM="+CBM+"&PCSPerCTNS="+PCSPerCTNS+"&FactoryDate="+FactoryDate;
...
function SearchBuyers(){
	if(document.getElementById('cboBuyer').value == "Select One" && document.getElementById('cboPoNo').value == "Select One"){
		...
		var url   = "Shipmentforcastdb.php?REQUEST=getdata&Buyer="+Buyer+'&PoNo='+PoNo;
...
/*		row.onmouseover=change;
		...
		var cellDelete = row.insertCell(1); 
				cellDelete.className ="normalfntMid";
				cellDelete.innerHTML = "<div class=\"getdata\" >" + document.getElementById('cboBuyer').value + "</div>";
...
var Tesco   = "Shipmentforcastdb.php?REQUEST=editforcast&SCNO="+SCNO+"&Buyer="+Buyer+"&Delivery="+Delivery;
	...
	Tesco   += "&Fabric="+Fabric+"&Country="+Country+"&Factory="+Factory+"&ShipMode="+ShipMode+"&EXFTY="+EXFTY+"&PordNo="+PordNo+"&PODesc="+PODesc;
	Tesco   += "&KnitWoven="+KnitWoven+"&FCLLCL="+FCLLCL+"&UnitPCSSETS="+UnitPCSSETS+"&Destination="+Destination+"&CBM="+CBM+"&PCSPerCTNS="+PCSPerCTNS;
	Tesco   += "&NETWTPPC="+NETWTPPC+"&GRSWTPPc="+GRSWTPPc+"&Reference="+Reference+"&packType="+packType+"&Season="+Season+"&ShipmentID="+ShipmentID+"&FactoryDate="+FactoryDate;
